...
define void @mmult_hw(i64* %in_stream_data_V, i8* %in_stream_keep_V, i8* %in_stream_strb_V, i4* %in_stream_user_V, i1* %in_stream_last_V, i5* %in_stream_id_V, i5* %in_stream_dest_V, i64* %out_stream_data_V, i8* %out_stream_keep_V, i8* %out_stream_strb_V, i4* %out_stream_user_V, i1* %out_stream_last_V, i5* %out_stream_id_V, i5* %out_stream_dest_V) {
  ...
  %in_buf = alloca [2048 x float], align 4        ; [#uses=3 type=[2048 x float]*]
  %out_buf = alloca [80 x float], align 4         ; [#uses=3 type=[80 x float]*]
...
; <label>:2                                       ; preds = %1
  ...
  call void @llvm.dbg.value(metadata !{i64 %ret}, i64 0, metadata !2773) nounwind, !dbg !2781 ; [debug line = 97:14@39:22] [debug variable = ret]
...
.preheader17.preheader:                           ; preds = %.preheader18
  br label %.preheader17, !dbg !2800              ; [debug line = 56:26]
...
; <label>:3                                       ; preds = %.preheader18
  ...
  %tmp_s = add i11 %is_idx_1, 128, !dbg !2804     ; [#uses=1 type=i11] [debug line = 48:23]
  %tmp_1 = call i12 @_ssdm_op_BitConcatenate.i12.i4.i8(i4 %i1, i8 0) ; [#uses=1 type=i12]
  %tmp_5_cast = zext i12 %tmp_1 to i13, !dbg !2807 ; [#uses=1 type=i13] [debug line = 46:27]
  br label %4, !dbg !2807                         ; [debug line = 46:27]

; <label>:4                                       ; preds = %5, %3
  %j = phi i9 [ 0, %3 ], [ %j_1, %5 ]             ; [#uses=3 type=i9]
  %is_idx_2 = phi i11 [ %is_idx_1, %3 ], [ %tmp_11, %5 ] ; [#uses=2 type=i11]
  %exitcond9 = icmp eq i11 %is_idx_2, %indvars_iv1, !dbg !2807 ; [#uses=1 type=i1] [debug line = 46:27]
  %empty_7 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 128, i64 128, i64 128) ; [#uses=0 type=i32]
  br i1 %exitcond9, label %6, label %5, !dbg !2807 ; [debug line = 46:27]

; <label>:5                                       ; preds = %4
  call void (...)* @_ssdm_op_SpecLoopName([9 x i8]* @p_str7) nounwind, !dbg !2808 ; [debug line = 46:69]
  %tmp_11 = add i11 1, %is_idx_2, !dbg !2804      ; [#uses=1 type=i11] [debug line = 48:23]
  ...
  call void @llvm.dbg.value(metadata !{i64 %ret_1}, i64 0, metadata !2809) nounwind, !dbg !2810 ; [debug line = 97:14@48:23] [debug variable = ret]
  call void @llvm.dbg.value(metadata !{i64 %ret_1}, i64 0, metadata !2782), !dbg !2804 ; [debug line = 48:23] [debug variable = converter]
  ...
  %tmp_18_cast = zext i13 %tmp_14 to i64, !dbg !2811 ; [#uses=1 type=i64] [debug line = 49:4]
  %weight_buf_addr = getelementptr [2560 x float]* %weight_buf, i64 0, i64 %tmp_18_cast, !dbg !2811 ; [#uses=1 type=float*] [debug line = 49:4]
  ...
  %tmp_18 = trunc i9 %j to i8, !dbg !2807         ; [#uses=1 type=i8] [debug line = 46:27]
  %tmp_17 = or i8 %tmp_18, 1, !dbg !2812          ; [#uses=1 type=i8] [debug line = 50:4]
  %tmp_19 = call i12 @_ssdm_op_BitConcatenate.i12.i4.i8(i4 %i1, i8 %tmp_17) ; [#uses=1 type=i12]
  %tmp_21 = zext i12 %tmp_19 to i64, !dbg !2812   ; [#uses=1 type=i64] [debug line = 50:4]
  %weight_buf_addr_1 = getelementptr [2560 x float]* %weight_buf, i64 0, i64 %tmp_21, !dbg !2812 ; [#uses=1 type=float*] [debug line = 50:4]
...
; <label>:6                                       ; preds = %4
  ...
  br label %.preheader18, !dbg !2799              ; [debug line = 45:36]
...
.preheader17:                                     ; preds = %10, %.preheader17.preheader
  ...
  %exitcond8 = icmp eq i4 %i2, -8, !dbg !2800     ; [#uses=1 type=i1] [debug line = 56:26]
  %empty_10 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  %i_3 = add i4 %i2, 1, !dbg !2817                ; [#uses=1 type=i4] [debug line = 56:72]
  br i1 %exitcond8, label %.preheader16.preheader, label %7, !dbg !2800 ; [debug line = 56:26]

.preheader16.preheader:                           ; preds = %.preheader17
  br label %.preheader16, !dbg !2818              ; [debug line = 66:20]

; <label>:7                                       ; preds = %.preheader17
  call void (...)* @_ssdm_op_SpecLoopName([9 x i8]* @p_str8) nounwind, !dbg !2820 ; [debug line = 56:78]
  %tmp_10 = call i32 (...)* @_ssdm_op_SpecRegionBegin([9 x i8]* @p_str8), !dbg !2820 ; [#uses=1 type=i32] [debug line = 56:78]
  %is_idx_5 = add i12 %is_idx_3, 128, !dbg !2768  ; [#uses=1 type=i12] [debug line = 39:22]
  call void @llvm.dbg.value(metadata !{i12 %is_idx_5}, i64 0, metadata !2822), !dbg !2768 ; [debug line = 39:22] [debug variable = is_idx]
  %tmp_12 = call i12 @_ssdm_op_BitConcatenate.i12.i4.i8(i4 %i2, i8 0) ; [#uses=1 type=i12]
  %tmp_14_cast = zext i12 %tmp_12 to i13, !dbg !2823 ; [#uses=1 type=i13] [debug line = 57:27]
  br label %8, !dbg !2823                         ; [debug line = 57:27]

; <label>:8                                       ; preds = %9, %7
  %j3 = phi i9 [ 0, %7 ], [ %j_2, %9 ]            ; [#uses=3 type=i9]
  %is_idx_4 = phi i12 [ %is_idx_3, %7 ], [ %is_idx_6, %9 ] ; [#uses=2 type=i12]
  %exitcond7 = icmp eq i12 %is_idx_4, %indvars_iv5, !dbg !2823 ; [#uses=1 type=i1] [debug line = 57:27]
  %empty_11 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 128, i64 128, i64 128) ; [#uses=0 type=i32]
  br i1 %exitcond7, label %10, label %9, !dbg !2823 ; [debug line = 57:27]

; <label>:9                                       ; preds = %8
  call void (...)* @_ssdm_op_SpecLoopName([9 x i8]* @p_str9) nounwind, !dbg !2825 ; [debug line = 57:69]
  %is_idx_6 = add i12 1, %is_idx_4, !dbg !2827    ; [#uses=1 type=i12] [debug line = 59:23]
  call void @llvm.dbg.value(metadata !{i12 %is_idx_6}, i64 0, metadata !2822), !dbg !2827 ; [debug line = 59:23] [debug variable = is_idx]
  ...
  call void @llvm.dbg.value(metadata !{i64 %ret_2}, i64 0, metadata !2828) nounwind, !dbg !2829 ; [debug line = 97:14@59:23] [debug variable = ret]
  call void @llvm.dbg.value(metadata !{i64 %ret_2}, i64 0, metadata !2782), !dbg !2827 ; [debug line = 59:23] [debug variable = converter]
  %tmp_33 = trunc i64 %ret_2 to i32               ; [#uses=1 type=i32]
  %bitcast = bitcast i32 %tmp_33 to float         ; [#uses=1 type=float]
  %tmp_21_cast = zext i9 %j3 to i13, !dbg !2830   ; [#uses=1 type=i13] [debug line = 60:4]
  %tmp_37 = add i13 %tmp_21_cast, %tmp_14_cast, !dbg !2830 ; [#uses=1 type=i13] [debug line = 60:4]
  %tmp_43_cast = zext i13 %tmp_37 to i64, !dbg !2830 ; [#uses=1 type=i64] [debug line = 60:4]
  %in_buf_addr = getelementptr [2048 x float]* %in_buf, i64 0, i64 %tmp_43_cast, !dbg !2830 ; [#uses=1 type=float*] [debug line = 60:4]
  store float %bitcast, float* %in_buf_addr, align 8, !dbg !2830 ; [debug line = 60:4]
  ...
  %tmp_40 = trunc i9 %j3 to i8, !dbg !2823        ; [#uses=1 type=i8] [debug line = 57:27]
  %tmp_25 = or i8 %tmp_40, 1, !dbg !2831          ; [#uses=1 type=i8] [debug line = 61:4]
  %tmp_41 = call i12 @_ssdm_op_BitConcatenate.i12.i4.i8(i4 %i2, i8 %tmp_25) ; [#uses=1 type=i12]
  %tmp_42 = zext i12 %tmp_41 to i64, !dbg !2831   ; [#uses=1 type=i64] [debug line = 61:4]
  %in_buf_addr_1 = getelementptr [2048 x float]* %in_buf, i64 0, i64 %tmp_42, !dbg !2831 ; [#uses=1 type=float*] [debug line = 61:4]
  store float %tmp_24, float* %in_buf_addr_1, align 4, !dbg !2831 ; [debug line = 61:4]
  %j_2 = add i9 2, %j3, !dbg !2832                ; [#uses=1 type=i9] [debug line = 57:38]
  call void @llvm.dbg.value(metadata !{i9 %j_2}, i64 0, metadata !2833), !dbg !2832 ; [debug line = 57:38] [debug variable = j]
  br label %8, !dbg !2832                         ; [debug line = 57:38]

; <label>:10                                      ; preds = %8
  %empty_13 = call i32 (...)* @_ssdm_op_SpecRegionEnd([9 x i8]* @p_str8, i32 %tmp_10), !dbg !2834 ; [#uses=0 type=i32] [debug line = 63:2]
  call void @llvm.dbg.value(metadata !{i4 %i_3}, i64 0, metadata !2835), !dbg !2817 ; [debug line = 56:72] [debug variable = i]
  %indvars_iv_next6 = add i12 %indvars_iv5, 128, !dbg !2817 ; [#uses=1 type=i12] [debug line = 56:72]
  br label %.preheader17, !dbg !2817              ; [debug line = 56:72]

.preheader16:                                     ; preds = %17, %.preheader16.preheader
  %i4 = phi i4 [ %i_4, %17 ], [ 0, %.preheader16.preheader ] ; [#uses=5 type=i4]
  %exitcond4 = icmp eq i4 %i4, -8, !dbg !2818     ; [#uses=1 type=i1] [debug line = 66:20]
  %empty_14 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  %i_4 = add i4 %i4, 1, !dbg !2836                ; [#uses=1 type=i4] [debug line = 66:66]
  br i1 %exitcond4, label %.preheader.preheader, label %11, !dbg !2818 ; [debug line = 66:20]

.preheader.preheader:                             ; preds = %.preheader16
  br label %.preheader, !dbg !2837                ; [debug line = 79:27]

; <label>:11                                      ; preds = %.preheader16
  call void (...)* @_ssdm_op_SpecLoopName([3 x i8]* @p_str10) nounwind, !dbg !2839 ; [debug line = 66:72]
  %tmp_20 = call i32 (...)* @_ssdm_op_SpecRegionBegin([3 x i8]* @p_str10), !dbg !2839 ; [#uses=1 type=i32] [debug line = 66:72]
  %tmp_22 = call i12 @_ssdm_op_BitConcatenate.i12.i4.i8(i4 %i4, i8 0) ; [#uses=1 type=i12]
  %tmp_27_cast = zext i12 %tmp_22 to i13          ; [#uses=1 type=i13]
  %tmp_26 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %i4, i3 0) ; [#uses=1 type=i7]
  %p_shl_cast = zext i7 %tmp_26 to i8             ; [#uses=1 type=i8]
  %tmp_27 = call i5 @_ssdm_op_BitConcatenate.i5.i4.i1(i4 %i4, i1 false) ; [#uses=1 type=i5]
  %p_shl1_cast = zext i5 %tmp_27 to i8, !dbg !2841 ; [#uses=1 type=i8] [debug line = 74:4]
  %tmp_29 = add i8 %p_shl1_cast, %p_shl_cast, !dbg !2841 ; [#uses=1 type=i8] [debug line = 74:4]
  br label %12, !dbg !2844                        ; [debug line = 68:21]

; <label>:12                                      ; preds = %16, %11
  %j5 = phi i4 [ 0, %11 ], [ %j_4, %16 ]          ; [#uses=5 type=i4]
  %exitcond3 = icmp eq i4 %j5, -6, !dbg !2844     ; [#uses=1 type=i1] [debug line = 68:21]
  %empty_15 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 10, i64 10, i64 10) ; [#uses=0 type=i32]
  %j_4 = add i4 %j5, 1, !dbg !2845                ; [#uses=1 type=i4] [debug line = 68:31]
  br i1 %exitcond3, label %17, label %13, !dbg !2844 ; [debug line = 68:21]

; <label>:13                                      ; preds = %12
  call void (...)* @_ssdm_op_SpecLoopName([3 x i8]* @p_str11) nounwind, !dbg !2846 ; [debug line = 68:37]
  %tmp_35 = call i32 (...)* @_ssdm_op_SpecRegionBegin([3 x i8]* @p_str11), !dbg !2846 ; [#uses=1 type=i32] [debug line = 68:37]
  %tmp_28 = zext i4 %j5 to i64, !dbg !2847        ; [#uses=1 type=i64] [debug line = 70:25]
  %tmp_28_cast = zext i4 %j5 to i8                ; [#uses=1 type=i8]
  %tmp_46 = call i12 @_ssdm_op_BitConcatenate.i12.i4.i8(i4 %j5, i8 0) ; [#uses=1 type=i12]
  %tmp_50_cast = zext i12 %tmp_46 to i13, !dbg !2841 ; [#uses=1 type=i13] [debug line = 74:4]
  %tmp_47 = add i8 %tmp_28_cast, %tmp_29, !dbg !2841 ; [#uses=1 type=i8] [debug line = 74:4]
  %tmp_51_cast = zext i8 %tmp_47 to i64, !dbg !2841 ; [#uses=1 type=i64] [debug line = 74:4]
  %out_buf_addr_2 = getelementptr [80 x float]* %out_buf, i64 0, i64 %tmp_51_cast, !dbg !2841 ; [#uses=1 type=float*] [debug line = 74:4]
  %offset_buf_addr_2 = getelementptr inbounds [10 x float]* %offset_buf, i64 0, i64 %tmp_28, !dbg !2847 ; [#uses=1 type=float*] [debug line = 70:25]
  %tmp = load float* %offset_buf_addr_2, align 4, !dbg !2847 ; [#uses=1 type=float] [debug line = 70:25]
  call void @llvm.dbg.value(metadata !{float %tmp}, i64 0, metadata !2848), !dbg !2847 ; [debug line = 70:25] [debug variable = tmp]
  br label %14, !dbg !2849                        ; [debug line = 71:21]

; <label>:14                                      ; preds = %15, %13
  %k = phi i9 [ 0, %13 ], [ %k_1, %15 ]           ; [#uses=3 type=i9]
  %tmp1 = phi float [ %tmp, %13 ], [ %tmp_39, %15 ] ; [#uses=2 type=float]
  %exitcond2 = icmp eq i9 %k, -256, !dbg !2849    ; [#uses=1 type=i1] [debug line = 71:21]
  %empty_16 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 256, i64 256, i64 256) ; [#uses=0 type=i32]
  %k_1 = add i9 %k, 1, !dbg !2851                 ; [#uses=1 type=i9] [debug line = 71:32]
  br i1 %exitcond2, label %16, label %15, !dbg !2849 ; [debug line = 71:21]

; <label>:15                                      ; preds = %14
  call void (...)* @_ssdm_op_SpecLoopName([3 x i8]* @p_str12) nounwind, !dbg !2852 ; [debug line = 71:38]
  %tmp_37_cast = zext i9 %k to i13, !dbg !2854    ; [#uses=2 type=i13] [debug line = 72:5]
  %tmp_50 = add i13 %tmp_50_cast, %tmp_37_cast, !dbg !2854 ; [#uses=1 type=i13] [debug line = 72:5]
  %tmp_54_cast = zext i13 %tmp_50 to i64, !dbg !2854 ; [#uses=1 type=i64] [debug line = 72:5]
  %weight_buf_addr_2 = getelementptr [2560 x float]* %weight_buf, i64 0, i64 %tmp_54_cast, !dbg !2854 ; [#uses=1 type=float*] [debug line = 72:5]
  %tmp_51 = add i13 %tmp_27_cast, %tmp_37_cast, !dbg !2854 ; [#uses=1 type=i13] [debug line = 72:5]
  %tmp_55_cast = zext i13 %tmp_51 to i64, !dbg !2854 ; [#uses=1 type=i64] [debug line = 72:5]
  %in_buf_addr_2 = getelementptr [2048 x float]* %in_buf, i64 0, i64 %tmp_55_cast, !dbg !2854 ; [#uses=1 type=float*] [debug line = 72:5]
  %in_buf_load = load float* %in_buf_addr_2, align 4, !dbg !2854 ; [#uses=1 type=float] [debug line = 72:5]
  %weight_buf_load = load float* %weight_buf_addr_2, align 4, !dbg !2854 ; [#uses=1 type=float] [debug line = 72:5]
  %tmp_38 = fmul float %in_buf_load, %weight_buf_load, !dbg !2854 ; [#uses=1 type=float] [debug line = 72:5]
  %tmp_39 = fadd float %tmp1, %tmp_38, !dbg !2854 ; [#uses=1 type=float] [debug line = 72:5]
  call void @llvm.dbg.value(metadata !{float %tmp_39}, i64 0, metadata !2848), !dbg !2854 ; [debug line = 72:5] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i9 %k_1}, i64 0, metadata !2855), !dbg !2851 ; [debug line = 71:32] [debug variable = k]
  br label %14, !dbg !2851                        ; [debug line = 71:32]

; <label>:16                                      ; preds = %14
  store float %tmp1, float* %out_buf_addr_2, align 4, !dbg !2841 ; [debug line = 74:4]
  %empty_17 = call i32 (...)* @_ssdm_op_SpecRegionEnd([3 x i8]* @p_str11, i32 %tmp_35), !dbg !2856 ; [#uses=0 type=i32] [debug line = 75:3]
  call void @llvm.dbg.value(metadata !{i4 %j_4}, i64 0, metadata !2857), !dbg !2845 ; [debug line = 68:31] [debug variable = j]
  br label %12, !dbg !2845                        ; [debug line = 68:31]

; <label>:17                                      ; preds = %12
  %empty_18 = call i32 (...)* @_ssdm_op_SpecRegionEnd([3 x i8]* @p_str10, i32 %tmp_20), !dbg !2858 ; [#uses=0 type=i32] [debug line = 76:2]
  call void @llvm.dbg.value(metadata !{i4 %i_4}, i64 0, metadata !2859), !dbg !2836 ; [debug line = 66:66] [debug variable = i]
  br label %.preheader16, !dbg !2836              ; [debug line = 66:66]

.preheader:                                       ; preds = %21, %.preheader.preheader
  %indvars_iv = phi i6 [ %indvars_iv_next, %21 ], [ 5, %.preheader.preheader ] ; [#uses=2 type=i6]
  %os_idx = phi i6 [ %os_idx_2, %21 ], [ 0, %.preheader.preheader ] ; [#uses=2 type=i6]
  %i6 = phi i4 [ %i_5, %21 ], [ 0, %.preheader.preheader ] ; [#uses=4 type=i4]
  %exitcond1 = icmp eq i4 %i6, -8, !dbg !2837     ; [#uses=1 type=i1] [debug line = 79:27]
  ...
  br i1 %exitcond1, label %22, label %18, !dbg !2837 ; [debug line = 79:27]

; <label>:18                                      ; preds = %.preheader
  call void (...)* @_ssdm_op_SpecLoopName([10 x i8]* @p_str13) nounwind, !dbg !2861 ; [debug line = 79:79]
  %tmp_31 = call i32 (...)* @_ssdm_op_SpecRegionBegin([10 x i8]* @p_str13), !dbg !2861 ; [#uses=1 type=i32] [debug line = 79:79]
  %os_idx_2 = add i6 %os_idx, 5, !dbg !2863       ; [#uses=1 type=i6] [debug line = 84:4]
  call void @llvm.dbg.value(metadata !{i6 %os_idx_2}, i64 0, metadata !2866), !dbg !2863 ; [debug line = 84:4] [debug variable = os_idx]
  %tmp_43 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %i6, i3 0) ; [#uses=1 type=i7]
  %p_shl2_cast = zext i7 %tmp_43 to i8            ; [#uses=1 type=i8]
  %tmp_44 = call i5 @_ssdm_op_BitConcatenate.i5.i4.i1(i4 %i6, i1 false) ; [#uses=1 type=i5]
  %p_shl3_cast = zext i5 %tmp_44 to i8, !dbg !2867 ; [#uses=1 type=i8] [debug line = 82:4]
  %tmp_45 = add i8 %p_shl3_cast, %p_shl2_cast, !dbg !2867 ; [#uses=2 type=i8] [debug line = 82:4]
  br label %19, !dbg !2868                        ; [debug line = 80:28]

; <label>:19                                      ; preds = %20, %18
  %os_idx_1 = phi i6 [ %os_idx, %18 ], [ %tmp_36, %20 ] ; [#uses=2 type=i6]
  %j7 = phi i4 [ 0, %18 ], [ %j_3, %20 ]          ; [#uses=3 type=i4]
  %exitcond = icmp eq i6 %os_idx_1, %indvars_iv, !dbg !2868 ; [#uses=1 type=i1] [debug line = 80:28]
  %empty_20 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 5, i64 5, i64 5) ; [#uses=0 type=i32]
  br i1 %exitcond, label %21, label %20, !dbg !2868 ; [debug line = 80:28]

; <label>:20                                      ; preds = %19
  call void (...)* @_ssdm_op_SpecLoopName([10 x i8]* @p_str14) nounwind, !dbg !2869 ; [debug line = 80:69]
  %tmp_29_cast = zext i4 %j7 to i8, !dbg !2867    ; [#uses=1 type=i8] [debug line = 82:4]
  %tmp_48 = add i8 %tmp_45, %tmp_29_cast, !dbg !2867 ; [#uses=1 type=i8] [debug line = 82:4]
  %tmp_52_cast = zext i8 %tmp_48 to i64, !dbg !2867 ; [#uses=1 type=i64] [debug line = 82:4]
  %out_buf_addr = getelementptr [80 x float]* %out_buf, i64 0, i64 %tmp_52_cast, !dbg !2867 ; [#uses=1 type=float*] [debug line = 82:4]
  %out_buf_load = load float* %out_buf_addr, align 8, !dbg !2867 ; [#uses=1 type=float] [debug line = 82:4]
  %tmp_30 = bitcast float %out_buf_load to i32, !dbg !2867 ; [#uses=1 type=i32] [debug line = 82:4]
  %tmp_32 = or i4 %j7, 1, !dbg !2870              ; [#uses=1 type=i4] [debug line = 83:4]
  %tmp_33_cast = zext i4 %tmp_32 to i8, !dbg !2870 ; [#uses=1 type=i8] [debug line = 83:4]
  %tmp_49 = add i8 %tmp_45, %tmp_33_cast, !dbg !2870 ; [#uses=1 type=i8] [debug line = 83:4]
  %tmp_53_cast = zext i8 %tmp_49 to i64, !dbg !2870 ; [#uses=1 type=i64] [debug line = 83:4]
  %out_buf_addr_1 = getelementptr [80 x float]* %out_buf, i64 0, i64 %tmp_53_cast, !dbg !2870 ; [#uses=1 type=float*] [debug line = 83:4]
  %out_buf_load_1 = load float* %out_buf_addr_1, align 4, !dbg !2870 ; [#uses=1 type=float] [debug line = 83:4]
  %tmp_34 = bitcast float %out_buf_load_1 to i32, !dbg !2870 ; [#uses=1 type=i32] [debug line = 83:4]
  %converter = call i64 @_ssdm_op_BitConcatenate.i64.i32.i32(i32 %tmp_34, i32 %tmp_30), !dbg !2870 ; [#uses=1 type=i64] [debug line = 83:4]
  call void @llvm.dbg.value(metadata !{i64 %converter}, i64 0, metadata !2782), !dbg !2870 ; [debug line = 83:4] [debug variable = converter]
  %tmp_36 = add i6 %os_idx_1, 1, !dbg !2863       ; [#uses=2 type=i6] [debug line = 84:4]
  %last_assign = icmp eq i6 %tmp_36, -24, !dbg !2871 ; [#uses=1 type=i1] [debug line = 84:27]
  call void @llvm.dbg.value(metadata !{i1 %last_assign}, i64 0, metadata !2872), !dbg !2878 ; [debug line = 109:42@84:27] [debug variable = last]
  call void @llvm.dbg.value(metadata !{i64 %converter}, i64 0, metadata !2879), !dbg !2883 ; [debug line = 256:70@115:2@84:27] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i64 %converter}, i64 0, metadata !2884), !dbg !2887 ; [debug line = 256:70@256:92@115:2@84:27] [debug variable = val]
  ...
  %j_3 = add i4 %j7, 2, !dbg !2888                ; [#uses=1 type=i4] [debug line = 80:38]
  call void @llvm.dbg.value(metadata !{i4 %j_3}, i64 0, metadata !2889), !dbg !2888 ; [debug line = 80:38] [debug variable = j]
  br label %19, !dbg !2888                        ; [debug line = 80:38]

; <label>:21                                      ; preds = %19
  %empty_21 = call i32 (...)* @_ssdm_op_SpecRegionEnd([10 x i8]* @p_str13, i32 %tmp_31), !dbg !2890 ; [#uses=0 type=i32] [debug line = 86:2]
  call void @llvm.dbg.value(metadata !{i4 %i_5}, i64 0, metadata !2891), !dbg !2860 ; [debug line = 79:73] [debug variable = i]
...
; <label>:22                                      ; preds = %.preheader
  ret void, !dbg !2892                            ; [debug line = 87:1]
}
...
entry:
  ...
  %empty_32 = zext i32 %1 to i64                  ; [#uses=1 type=i64]
...
!2773 = metadata !{i32 786688, metadata !2774, metadata !"ret", metadata !112, i32 97, metadata !2778, i32 0, metadata !2768} ; [ DW_TAG_auto_variable ]
!2774 = metadata !{i32 786443, metadata !2775, i32 94, i32 1, metadata !112, i32 21} ; [ DW_TAG_lexical_block ]
!2775 = metadata !{i32 786478, i32 0, metadata !112, metadata !"pop_stream", metadata !"pop_stream", metadata !"_Z10pop_streamRK7ap_axiuILi64ELi4ELi5ELi5EE", metadata !112, i32 93, metadata !2776, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !138, i32 94} ; [ DW_TAG_subprogram ]
...
!2781 = metadata !{i32 97, i32 14, metadata !2774, metadata !2768}
...
!2800 = metadata !{i32 56, i32 26, metadata !2801, null}
!2801 = metadata !{i32 786443, metadata !2745, i32 56, i32 12, metadata !112, i32 7} ; [ DW_TAG_lexical_block ]
...
!2804 = metadata !{i32 48, i32 23, metadata !2805, null}
!2805 = metadata !{i32 786443, metadata !2806, i32 46, i32 68, metadata !112, i32 6} ; [ DW_TAG_lexical_block ]
!2806 = metadata !{i32 786443, metadata !2803, i32 46, i32 13, metadata !112, i32 5} ; [ DW_TAG_lexical_block ]
!2807 = metadata !{i32 46, i32 27, metadata !2806, null}
!2808 = metadata !{i32 46, i32 69, metadata !2805, null}
!2809 = metadata !{i32 786688, metadata !2774, metadata !"ret", metadata !112, i32 97, metadata !2778, i32 0, metadata !2804} ; [ DW_TAG_auto_variable ]
!2810 = metadata !{i32 97, i32 14, metadata !2774, metadata !2804}
!2811 = metadata !{i32 49, i32 4, metadata !2805, null}
!2812 = metadata !{i32 50, i32 4, metadata !2805, null}
!2813 = metadata !{i32 46, i32 38, metadata !2806, null}
!2814 = metadata !{i32 786688, metadata !2806, metadata !"j", metadata !112, i32 46, metadata !142, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!2817 = metadata !{i32 56, i32 72, metadata !2801, null}
!2818 = metadata !{i32 66, i32 20, metadata !2819, null}
!2819 = metadata !{i32 786443, metadata !2745, i32 66, i32 6, metadata !112, i32 11} ; [ DW_TAG_lexical_block ]
!2820 = metadata !{i32 56, i32 78, metadata !2821, null}
!2821 = metadata !{i32 786443, metadata !2801, i32 56, i32 77, metadata !112, i32 8} ; [ DW_TAG_lexical_block ]
!2822 = metadata !{i32 786688, metadata !2745, metadata !"is_idx", metadata !112, i32 34, metadata !142, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2823 = metadata !{i32 57, i32 27, metadata !2824, null}
!2824 = metadata !{i32 786443, metadata !2821, i32 57, i32 13, metadata !112, i32 9} ; [ DW_TAG_lexical_block ]
!2825 = metadata !{i32 57, i32 69, metadata !2826, null}
!2826 = metadata !{i32 786443, metadata !2824, i32 57, i32 68, metadata !112, i32 10} ; [ DW_TAG_lexical_block ]
!2827 = metadata !{i32 59, i32 23, metadata !2826, null}
!2828 = metadata !{i32 786688, metadata !2774, metadata !"ret", metadata !112, i32 97, metadata !2778, i32 0, metadata !2827} ; [ DW_TAG_auto_variable ]
!2829 = metadata !{i32 97, i32 14, metadata !2774, metadata !2827}
!2830 = metadata !{i32 60, i32 4, metadata !2826, null}
!2831 = metadata !{i32 61, i32 4, metadata !2826, null}
!2832 = metadata !{i32 57, i32 38, metadata !2824, null}
!2833 = metadata !{i32 786688, metadata !2824, metadata !"j", metadata !112, i32 57, metadata !142, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2834 = metadata !{i32 63, i32 2, metadata !2821, null}
!2835 = metadata !{i32 786688, metadata !2801, metadata !"i", metadata !112, i32 56, metadata !142, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2836 = metadata !{i32 66, i32 66, metadata !2819, null}
!2837 = metadata !{i32 79, i32 27, metadata !2838, null}
!2838 = metadata !{i32 786443, metadata !2745, i32 79, i32 13, metadata !112, i32 17} ; [ DW_TAG_lexical_block ]
!2839 = metadata !{i32 66, i32 72, metadata !2840, null}
!2840 = metadata !{i32 786443, metadata !2819, i32 66, i32 71, metadata !112, i32 12} ; [ DW_TAG_lexical_block ]
!2841 = metadata !{i32 74, i32 4, metadata !2842, null}
!2842 = metadata !{i32 786443, metadata !2843, i32 68, i32 36, metadata !112, i32 14} ; [ DW_TAG_lexical_block ]
!2843 = metadata !{i32 786443, metadata !2840, i32 68, i32 7, metadata !112, i32 13} ; [ DW_TAG_lexical_block ]
!2844 = metadata !{i32 68, i32 21, metadata !2843, null}
!2845 = metadata !{i32 68, i32 31, metadata !2843, null}
!2846 = metadata !{i32 68, i32 37, metadata !2842, null}
!2847 = metadata !{i32 70, i32 25, metadata !2842, null}
!2848 = metadata !{i32 786688, metadata !2842, metadata !"tmp", metadata !112, i32 70, metadata !2748, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2849 = metadata !{i32 71, i32 21, metadata !2850, null}
!2850 = metadata !{i32 786443, metadata !2842, i32 71, i32 8, metadata !112, i32 15} ; [ DW_TAG_lexical_block ]
!2851 = metadata !{i32 71, i32 32, metadata !2850, null}
!2852 = metadata !{i32 71, i32 38, metadata !2853, null}
!2853 = metadata !{i32 786443, metadata !2850, i32 71, i32 37, metadata !112, i32 16} ; [ DW_TAG_lexical_block ]
!2854 = metadata !{i32 72, i32 5, metadata !2853, null}
!2855 = metadata !{i32 786688, metadata !2850, metadata !"k", metadata !112, i32 71, metadata !142, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2856 = metadata !{i32 75, i32 3, metadata !2842, null}
!2857 = metadata !{i32 786688, metadata !2843, metadata !"j", metadata !112, i32 68, metadata !142, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2858 = metadata !{i32 76, i32 2, metadata !2840, null}
!2859 = metadata !{i32 786688, metadata !2819, metadata !"i", metadata !112, i32 66, metadata !142, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2860 = metadata !{i32 79, i32 73, metadata !2838, null}
!2861 = metadata !{i32 79, i32 79, metadata !2862, null}
!2862 = metadata !{i32 786443, metadata !2838, i32 79, i32 78, metadata !112, i32 18} ; [ DW_TAG_lexical_block ]
!2863 = metadata !{i32 84, i32 4, metadata !2864, null}
!2864 = metadata !{i32 786443, metadata !2865, i32 80, i32 68, metadata !112, i32 20} ; [ DW_TAG_lexical_block ]
!2865 = metadata !{i32 786443, metadata !2862, i32 80, i32 14, metadata !112, i32 19} ; [ DW_TAG_lexical_block ]
!2866 = metadata !{i32 786688, metadata !2745, metadata !"os_idx", metadata !112, i32 35, metadata !142, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2867 = metadata !{i32 82, i32 4, metadata !2864, null}
!2868 = metadata !{i32 80, i32 28, metadata !2865, null}
!2869 = metadata !{i32 80, i32 69, metadata !2864, null}
!2870 = metadata !{i32 83, i32 4, metadata !2864, null}
!2871 = metadata !{i32 84, i32 27, metadata !2864, null}
!2872 = metadata !{i32 786689, metadata !2873, metadata !"last", metadata !112, i32 33554541, metadata !144, i32 0, metadata !2871} ; [ DW_TAG_arg_variable ]
!2873 = metadata !{i32 786478, i32 0, metadata !112, metadata !"push_stream", metadata !"push_stream", metadata !"_Z11push_streamRKyb", metadata !112, i32 109, metadata !2874, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !138, i32 110} ; [ DW_TAG_subprogram ]
...
!2875 = metadata !{metadata !116, metadata !2876, metadata !144}
!2876 = metadata !{i32 786448, null, null, null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !2877} ; [ DW_TAG_reference_type ]
!2877 = metadata !{i32 786470, null, metadata !"", null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !2778} ; [ DW_TAG_const_type ]
!2878 = metadata !{i32 109, i32 42, metadata !2873, metadata !2871}
!2879 = metadata !{i32 786689, metadata !2880, metadata !"val", metadata !122, i32 33554688, metadata !206, i32 0, metadata !2881} ; [ DW_TAG_arg_variable ]
!2880 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi64EEC1Ey", metadata !122, i32 256, metadata !758, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !757, metadata !138, i32 256} ; [ DW_TAG_subprogram ]
!2881 = metadata !{i32 115, i32 2, metadata !2882, metadata !2871}
!2882 = metadata !{i32 786443, metadata !2873, i32 110, i32 1, metadata !112, i32 22} ; [ DW_TAG_lexical_block ]
!2883 = metadata !{i32 256, i32 70, metadata !2880, metadata !2881}
!2884 = metadata !{i32 786689, metadata !2885, metadata !"val", metadata !122, i32 33554688, metadata !206, i32 0, metadata !2886} ; [ DW_TAG_arg_variable ]
!2885 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi64EEC2Ey", metadata !122, i32 256, metadata !758, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !757, metadata !138, i32 256} ; [ DW_TAG_subprogram ]
!2886 = metadata !{i32 256, i32 92, metadata !2880, metadata !2881}
!2887 = metadata !{i32 256, i32 70, metadata !2885, metadata !2886}
!2888 = metadata !{i32 80, i32 38, metadata !2865, null}
!2889 = metadata !{i32 786688, metadata !2865, metadata !"j", metadata !112, i32 80, metadata !142, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2890 = metadata !{i32 86, i32 2, metadata !2862, null}
!2891 = metadata !{i32 786688, metadata !2838, metadata !"i", metadata !112, i32 79, metadata !142, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2892 = metadata !{i32 87, i32 1, metadata !2745, null}
