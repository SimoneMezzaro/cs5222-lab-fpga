...
#ifndef __mmult_hw_in_buf_0_H__
#define __mmult_hw_in_buf_0_H__
...
mmult_hw_in_buf_0_ram* meminst;


SC_CTOR(mmult_hw_in_buf_0) {
meminst = new mmult_hw_in_buf_0_ram("mmult_hw_in_buf_0_ram");
