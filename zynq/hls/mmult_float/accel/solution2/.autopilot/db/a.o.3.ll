...
define void @mmult_hw(i64* %in_stream_data_V, i8* %in_stream_keep_V, i8* %in_stream_strb_V, i4* %in_stream_user_V, i1* %in_stream_last_V, i5* %in_stream_id_V, i5* %in_stream_dest_V, i64* %out_stream_data_V, i8* %out_stream_keep_V, i8* %out_stream_strb_V, i4* %out_stream_user_V, i1* %out_stream_last_V, i5* %out_stream_id_V, i5* %out_stream_dest_V) {
  ...
  call void @llvm.dbg.declare(metadata !{[4096 x float]* %in_buf_0}, metadata !2766), !dbg !2772 ; [debug line = 30:4] [debug variable = in_buf[0]]
  call void @llvm.dbg.declare(metadata !{[4096 x float]* %in_buf_1}, metadata !2773), !dbg !2772 ; [debug line = 30:4] [debug variable = in_buf[1]]
  call void @llvm.dbg.declare(metadata !{[4096 x float]* %in_buf_2}, metadata !2774), !dbg !2772 ; [debug line = 30:4] [debug variable = in_buf[2]]
  call void @llvm.dbg.declare(metadata !{[4096 x float]* %in_buf_3}, metadata !2775), !dbg !2772 ; [debug line = 30:4] [debug variable = in_buf[3]]
  call void @llvm.dbg.declare(metadata !{[4096 x float]* %in_buf_4}, metadata !2776), !dbg !2772 ; [debug line = 30:4] [debug variable = in_buf[4]]
  call void @llvm.dbg.declare(metadata !{[4096 x float]* %in_buf_5}, metadata !2777), !dbg !2772 ; [debug line = 30:4] [debug variable = in_buf[5]]
  call void @llvm.dbg.declare(metadata !{[4096 x float]* %in_buf_6}, metadata !2778), !dbg !2772 ; [debug line = 30:4] [debug variable = in_buf[6]]
  call void @llvm.dbg.declare(metadata !{[4096 x float]* %in_buf_7}, metadata !2779), !dbg !2772 ; [debug line = 30:4] [debug variable = in_buf[7]]
  call void @llvm.dbg.declare(metadata !{[1280 x float]* %out_buf}, metadata !2780), !dbg !2783 ; [debug line = 31:4] [debug variable = out_buf]
...
; <label>:1                                       ; preds = %2, %0
  ...
  br i1 %exitcond5, label %.preheader17.preheader, label %2, !dbg !2784 ; [debug line = 38:28]

.preheader17.preheader:                           ; preds = %1
  br label %.preheader17, !dbg !2788              ; [debug line = 45:26]
...
; <label>:2                                       ; preds = %1
  ...
  call void @llvm.dbg.value(metadata !{i64 %ret}, i64 0, metadata !2792) nounwind, !dbg !2800 ; [debug line = 100:14@39:22] [debug variable = ret]
...
.preheader17:                                     ; preds = %7, %.preheader17.preheader
  ...
  br i1 %exitcond6, label %.preheader16.preheader, label %3, !dbg !2788 ; [debug line = 45:26]

.preheader16.preheader:                           ; preds = %.preheader17
  br label %.preheader16, !dbg !2820              ; [debug line = 55:20]
...
; <label>:3                                       ; preds = %.preheader17
  ...
  %tmp_s = add i11 %is_idx_1, 128, !dbg !2824     ; [#uses=1 type=i11] [debug line = 46:27]
  br label %4, !dbg !2824                         ; [debug line = 46:27]

; <label>:4                                       ; preds = %6, %3
  %j = phi i9 [ 0, %3 ], [ %j_1, %6 ]             ; [#uses=3 type=i9]
  %is_idx_2 = phi i11 [ %is_idx_1, %3 ], [ %tmp_11, %6 ] ; [#uses=2 type=i11]
  %exitcond9 = icmp eq i11 %is_idx_2, %indvars_iv1, !dbg !2824 ; [#uses=1 type=i1] [debug line = 46:27]
  br i1 %exitcond9, label %7, label %5, !dbg !2824 ; [debug line = 46:27]

; <label>:5                                       ; preds = %4
  %empty_10 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 128, i64 128, i64 128) ; [#uses=0 type=i32]
  call void (...)* @_ssdm_op_SpecLoopName([9 x i8]* @p_str8) nounwind, !dbg !2826 ; [debug line = 46:69]
  %tmp_12 = call i32 (...)* @_ssdm_op_SpecRegionBegin([9 x i8]* @p_str8), !dbg !2826 ; [#uses=1 type=i32] [debug line = 46:69]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !2828 ; [debug line = 47:1]
  %tmp_11 = add i11 1, %is_idx_2, !dbg !2829      ; [#uses=1 type=i11] [debug line = 48:23]
  ...
  call void @llvm.dbg.value(metadata !{i64 %ret_1}, i64 0, metadata !2830) nounwind, !dbg !2831 ; [debug line = 100:14@48:23] [debug variable = ret]
  call void @llvm.dbg.value(metadata !{i64 %ret_1}, i64 0, metadata !2801), !dbg !2829 ; [debug line = 48:23] [debug variable = converter]
  %tmp_96 = trunc i64 %ret_1 to i32               ; [#uses=1 type=i32]
  %bitcast2 = bitcast i32 %tmp_96 to float        ; [#uses=8 type=float]
  %arrayNo_cast_cast = call i4 @_ssdm_op_PartSelect.i4.i9.i32.i32(i9 %j, i32 5, i32 8) ; [#uses=1 type=i4]
  %tmp_159 = trunc i9 %j to i5                    ; [#uses=2 type=i5]
  %tmp_13 = call i9 @_ssdm_op_BitConcatenate.i9.i4.i5(i4 %i1, i5 %tmp_159) ; [#uses=1 type=i9]
  %tmp_14 = zext i9 %tmp_13 to i64, !dbg !2832    ; [#uses=8 type=i64] [debug line = 49:4]
  %weight_buf_0_addr = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_14, !dbg !2832 ; [#uses=1 type=float*] [debug line = 49:4]
  %weight_buf_1_addr = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_14, !dbg !2832 ; [#uses=1 type=float*] [debug line = 49:4]
  %weight_buf_2_addr = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_14, !dbg !2832 ; [#uses=1 type=float*] [debug line = 49:4]
  %weight_buf_3_addr = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_14, !dbg !2832 ; [#uses=1 type=float*] [debug line = 49:4]
  %weight_buf_4_addr = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_14, !dbg !2832 ; [#uses=1 type=float*] [debug line = 49:4]
  %weight_buf_5_addr = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_14, !dbg !2832 ; [#uses=1 type=float*] [debug line = 49:4]
  %weight_buf_6_addr = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_14, !dbg !2832 ; [#uses=1 type=float*] [debug line = 49:4]
  %weight_buf_7_addr = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_14, !dbg !2832 ; [#uses=1 type=float*] [debug line = 49:4]
  ...
  %newIndex = or i5 %tmp_159, 1, !dbg !2833       ; [#uses=1 type=i5] [debug line = 50:4]
  %tmp_17 = call i9 @_ssdm_op_BitConcatenate.i9.i4.i5(i4 %i1, i5 %newIndex) ; [#uses=1 type=i9]
  %tmp_19 = zext i9 %tmp_17 to i64, !dbg !2833    ; [#uses=8 type=i64] [debug line = 50:4]
  %weight_buf_0_addr_1 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_19, !dbg !2833 ; [#uses=1 type=float*] [debug line = 50:4]
  %weight_buf_1_addr_1 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_19, !dbg !2833 ; [#uses=1 type=float*] [debug line = 50:4]
  %weight_buf_2_addr_1 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_19, !dbg !2833 ; [#uses=1 type=float*] [debug line = 50:4]
  %weight_buf_3_addr_1 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_19, !dbg !2833 ; [#uses=1 type=float*] [debug line = 50:4]
  %weight_buf_4_addr_1 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_19, !dbg !2833 ; [#uses=1 type=float*] [debug line = 50:4]
  %weight_buf_5_addr_1 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_19, !dbg !2833 ; [#uses=1 type=float*] [debug line = 50:4]
  %weight_buf_6_addr_1 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_19, !dbg !2833 ; [#uses=1 type=float*] [debug line = 50:4]
  %weight_buf_7_addr_1 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_19, !dbg !2833 ; [#uses=1 type=float*] [debug line = 50:4]
...
; <label>:6                                       ; preds = %branch15, %branch14, %branch13, %branch12, %branch11, %branch10, %branch9, %branch8
  %empty_12 = call i32 (...)* @_ssdm_op_SpecRegionEnd([9 x i8]* @p_str8, i32 %tmp_12), !dbg !2834 ; [#uses=0 type=i32] [debug line = 51:3]
...
; <label>:7                                       ; preds = %4
  ...
  br label %.preheader17, !dbg !2819              ; [debug line = 45:36]
...
.preheader16:                                     ; preds = %18, %.preheader16.preheader
  ...
  %tmp_22 = call i1 @_ssdm_op_BitSelect.i1.i12.i32(i12 %t, i32 11), !dbg !2820 ; [#uses=1 type=i1] [debug line = 55:20]
  br i1 %tmp_22, label %19, label %8, !dbg !2820  ; [debug line = 55:20]

; <label>:8                                       ; preds = %.preheader16
  %os_idx_cast = zext i14 %os_idx to i15, !dbg !2820 ; [#uses=1 type=i15] [debug line = 55:20]
  %empty_14 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 16, i64 16, i64 16) ; [#uses=0 type=i32]
  call void (...)* @_ssdm_op_SpecLoopName([3 x i8]* @p_str9) nounwind, !dbg !2839 ; [debug line = 55:78]
  %tmp_10 = call i32 (...)* @_ssdm_op_SpecRegionBegin([3 x i8]* @p_str9), !dbg !2839 ; [#uses=1 type=i32] [debug line = 55:78]
  %is_idx_4 = add i19 %is_idx_3, 16384, !dbg !2829 ; [#uses=1 type=i19] [debug line = 48:23]
  call void @llvm.dbg.value(metadata !{i19 %is_idx_4}, i64 0, metadata !2841), !dbg !2829 ; [debug line = 48:23] [debug variable = is_idx]
  br label %9, !dbg !2842                         ; [debug line = 58:27]

; <label>:9                                       ; preds = %14, %8
  %indvars_iv5_in = phi i19 [ %is_idx_3, %8 ], [ %is_idx_6, %14 ] ; [#uses=2 type=i19]
  %i2 = phi i8 [ 0, %8 ], [ %i_3, %14 ]           ; [#uses=4 type=i8]
  %exitcond8 = icmp eq i8 %i2, -128, !dbg !2842   ; [#uses=1 type=i1] [debug line = 58:27]
  %i_3 = add i8 %i2, 1, !dbg !2844                ; [#uses=1 type=i8] [debug line = 58:38]
  br i1 %exitcond8, label %.preheader.preheader.preheader, label %10, !dbg !2842 ; [debug line = 58:27]

.preheader.preheader.preheader:                   ; preds = %9
  br label %.preheader.preheader

; <label>:10                                      ; preds = %9
  %is_idx_6 = add i19 %indvars_iv5_in, 128, !dbg !2842 ; [#uses=2 type=i19] [debug line = 58:27]
  %empty_15 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 128, i64 128, i64 128) ; [#uses=0 type=i32]
  call void (...)* @_ssdm_op_SpecLoopName([9 x i8]* @p_str10) nounwind, !dbg !2845 ; [debug line = 58:44]
  %tmp_18 = call i32 (...)* @_ssdm_op_SpecRegionBegin([9 x i8]* @p_str10), !dbg !2845 ; [#uses=1 type=i32] [debug line = 58:44]
  call void @llvm.dbg.value(metadata !{i19 %is_idx_6}, i64 0, metadata !2841), !dbg !2786 ; [debug line = 39:22] [debug variable = is_idx]
  br label %11, !dbg !2847                        ; [debug line = 59:28]

; <label>:11                                      ; preds = %13, %10
  %j3 = phi i9 [ 0, %10 ], [ %j_2, %13 ]          ; [#uses=3 type=i9]
  %is_idx_5 = phi i19 [ %indvars_iv5_in, %10 ], [ %is_idx_7, %13 ] ; [#uses=2 type=i19]
  %exitcond7 = icmp eq i19 %is_idx_5, %is_idx_6, !dbg !2847 ; [#uses=1 type=i1] [debug line = 59:28]
  br i1 %exitcond7, label %14, label %12, !dbg !2847 ; [debug line = 59:28]

; <label>:12                                      ; preds = %11
  %empty_16 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 128, i64 128, i64 128) ; [#uses=0 type=i32]
  call void (...)* @_ssdm_op_SpecLoopName([9 x i8]* @p_str11) nounwind, !dbg !2849 ; [debug line = 59:70]
  %tmp_23 = call i32 (...)* @_ssdm_op_SpecRegionBegin([9 x i8]* @p_str11), !dbg !2849 ; [#uses=1 type=i32] [debug line = 59:70]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !2851 ; [debug line = 60:1]
  %is_idx_7 = add i19 1, %is_idx_5, !dbg !2852    ; [#uses=1 type=i19] [debug line = 61:24]
  call void @llvm.dbg.value(metadata !{i19 %is_idx_7}, i64 0, metadata !2841), !dbg !2852 ; [debug line = 61:24] [debug variable = is_idx]
  ...
  call void @llvm.dbg.value(metadata !{i64 %ret_2}, i64 0, metadata !2853) nounwind, !dbg !2854 ; [debug line = 100:14@61:24] [debug variable = ret]
  call void @llvm.dbg.value(metadata !{i64 %ret_2}, i64 0, metadata !2801), !dbg !2852 ; [debug line = 61:24] [debug variable = converter]
  %tmp_244 = trunc i64 %ret_2 to i32              ; [#uses=1 type=i32]
  %bitcast = bitcast i32 %tmp_244 to float        ; [#uses=8 type=float]
  %arrayNo1_cast_cast = call i4 @_ssdm_op_PartSelect.i4.i9.i32.i32(i9 %j3, i32 5, i32 8) ; [#uses=1 type=i4]
  %tmp_245 = trunc i9 %j3 to i5                   ; [#uses=2 type=i5]
  %tmp_227 = call i13 @_ssdm_op_BitConcatenate.i13.i8.i5(i8 %i2, i5 %tmp_245) ; [#uses=1 type=i13]
  %tmp_228 = zext i13 %tmp_227 to i64, !dbg !2855 ; [#uses=8 type=i64] [debug line = 62:5]
  %in_buf_0_addr = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %tmp_228, !dbg !2855 ; [#uses=1 type=float*] [debug line = 62:5]
  %in_buf_1_addr = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %tmp_228, !dbg !2855 ; [#uses=1 type=float*] [debug line = 62:5]
  %in_buf_2_addr = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %tmp_228, !dbg !2855 ; [#uses=1 type=float*] [debug line = 62:5]
  %in_buf_3_addr = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %tmp_228, !dbg !2855 ; [#uses=1 type=float*] [debug line = 62:5]
  %in_buf_4_addr = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %tmp_228, !dbg !2855 ; [#uses=1 type=float*] [debug line = 62:5]
  %in_buf_5_addr = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %tmp_228, !dbg !2855 ; [#uses=1 type=float*] [debug line = 62:5]
  %in_buf_6_addr = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %tmp_228, !dbg !2855 ; [#uses=1 type=float*] [debug line = 62:5]
  %in_buf_7_addr = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %tmp_228, !dbg !2855 ; [#uses=1 type=float*] [debug line = 62:5]
  ...
  %newIndex6 = or i5 %tmp_245, 1, !dbg !2856      ; [#uses=1 type=i5] [debug line = 63:5]
  %tmp_229 = call i13 @_ssdm_op_BitConcatenate.i13.i8.i5(i8 %i2, i5 %newIndex6) ; [#uses=1 type=i13]
  %tmp_230 = zext i13 %tmp_229 to i64, !dbg !2856 ; [#uses=8 type=i64] [debug line = 63:5]
  %in_buf_0_addr_1 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %tmp_230, !dbg !2856 ; [#uses=1 type=float*] [debug line = 63:5]
  %in_buf_1_addr_1 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %tmp_230, !dbg !2856 ; [#uses=1 type=float*] [debug line = 63:5]
  %in_buf_2_addr_1 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %tmp_230, !dbg !2856 ; [#uses=1 type=float*] [debug line = 63:5]
  %in_buf_3_addr_1 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %tmp_230, !dbg !2856 ; [#uses=1 type=float*] [debug line = 63:5]
  %in_buf_4_addr_1 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %tmp_230, !dbg !2856 ; [#uses=1 type=float*] [debug line = 63:5]
  %in_buf_5_addr_1 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %tmp_230, !dbg !2856 ; [#uses=1 type=float*] [debug line = 63:5]
  %in_buf_6_addr_1 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %tmp_230, !dbg !2856 ; [#uses=1 type=float*] [debug line = 63:5]
  %in_buf_7_addr_1 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %tmp_230, !dbg !2856 ; [#uses=1 type=float*] [debug line = 63:5]
  switch i4 %arrayNo1_cast_cast, label %branch31 [
    ...
    i4 5, label %branch29
    i4 6, label %branch30
  ], !dbg !2855                                   ; [debug line = 62:5]

; <label>:13                                      ; preds = %branch31, %branch30, %branch29, %branch28, %branch27, %branch26, %branch25, %branch24
  %empty_18 = call i32 (...)* @_ssdm_op_SpecRegionEnd([9 x i8]* @p_str11, i32 %tmp_23), !dbg !2857 ; [#uses=0 type=i32] [debug line = 64:4]
  %j_2 = add i9 %j3, 2, !dbg !2858                ; [#uses=1 type=i9] [debug line = 59:39]
  call void @llvm.dbg.value(metadata !{i9 %j_2}, i64 0, metadata !2859), !dbg !2858 ; [debug line = 59:39] [debug variable = j]
  br label %11, !dbg !2858                        ; [debug line = 59:39]

; <label>:14                                      ; preds = %11
  %empty_19 = call i32 (...)* @_ssdm_op_SpecRegionEnd([9 x i8]* @p_str10, i32 %tmp_18), !dbg !2860 ; [#uses=0 type=i32] [debug line = 65:3]
  call void @llvm.dbg.value(metadata !{i8 %i_3}, i64 0, metadata !2861), !dbg !2844 ; [debug line = 58:38] [debug variable = i]
  br label %9, !dbg !2844                         ; [debug line = 58:38]
...
.preheader:                                       ; preds = %.preheader.preheader
  %i_4 = add i8 %i4, 1, !dbg !2862                ; [#uses=2 type=i8] [debug line = 68:32]
  call void @llvm.dbg.value(metadata !{i8 %i_4}, i64 0, metadata !2864), !dbg !2862 ; [debug line = 68:32] [debug variable = i]
  ...
  %exitcond = icmp eq i4 %j5, -6, !dbg !2865      ; [#uses=34 type=i1] [debug line = 70:22]
  %j5_mid2 = select i1 %exitcond, i4 0, i4 %j5    ; [#uses=4 type=i4]
  %tmp_95 = call i13 @_ssdm_op_BitConcatenate.i13.i8.i5(i8 %i_4, i5 0) ; [#uses=32 type=i13]
  %tmp_97 = or i13 %tmp_95, 1                     ; [#uses=1 type=i13]
  %tmp_98 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_97) ; [#uses=1 type=i64]
  %tmp_99 = or i13 %tmp_95, 2                     ; [#uses=1 type=i13]
  %tmp_100 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_99) ; [#uses=1 type=i64]
  %tmp_101 = or i13 %tmp_95, 3                    ; [#uses=1 type=i13]
  %tmp_102 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_101) ; [#uses=1 type=i64]
  %tmp_103 = or i13 %tmp_95, 4                    ; [#uses=1 type=i13]
  %tmp_104 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_103) ; [#uses=1 type=i64]
  %tmp_105 = or i13 %tmp_95, 5                    ; [#uses=1 type=i13]
  %tmp_106 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_105) ; [#uses=1 type=i64]
  %tmp_107 = or i13 %tmp_95, 6                    ; [#uses=1 type=i13]
  %tmp_108 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_107) ; [#uses=1 type=i64]
  %tmp_109 = or i13 %tmp_95, 7                    ; [#uses=1 type=i13]
  %tmp_110 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_109) ; [#uses=1 type=i64]
  %tmp_111 = or i13 %tmp_95, 8                    ; [#uses=1 type=i13]
  %tmp_112 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_111) ; [#uses=1 type=i64]
  %tmp_113 = or i13 %tmp_95, 9                    ; [#uses=1 type=i13]
  %tmp_114 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_113) ; [#uses=1 type=i64]
  %tmp_115 = or i13 %tmp_95, 10                   ; [#uses=1 type=i13]
  %tmp_116 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_115) ; [#uses=1 type=i64]
  %tmp_117 = or i13 %tmp_95, 11                   ; [#uses=1 type=i13]
  %tmp_118 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_117) ; [#uses=1 type=i64]
  %tmp_119 = or i13 %tmp_95, 12                   ; [#uses=1 type=i13]
  %tmp_120 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_119) ; [#uses=1 type=i64]
  %tmp_121 = or i13 %tmp_95, 13                   ; [#uses=1 type=i13]
  %tmp_122 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_121) ; [#uses=1 type=i64]
  %tmp_123 = or i13 %tmp_95, 14                   ; [#uses=1 type=i13]
  %tmp_124 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_123) ; [#uses=1 type=i64]
  %tmp_125 = or i13 %tmp_95, 15                   ; [#uses=1 type=i13]
  %tmp_126 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_125) ; [#uses=1 type=i64]
  %tmp_127 = or i13 %tmp_95, 16                   ; [#uses=1 type=i13]
  %tmp_128 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_127) ; [#uses=1 type=i64]
  %tmp_129 = or i13 %tmp_95, 17                   ; [#uses=1 type=i13]
  %tmp_130 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_129) ; [#uses=1 type=i64]
  %tmp_131 = or i13 %tmp_95, 18                   ; [#uses=1 type=i13]
  %tmp_132 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_131) ; [#uses=1 type=i64]
  %tmp_133 = or i13 %tmp_95, 19                   ; [#uses=1 type=i13]
  %tmp_134 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_133) ; [#uses=1 type=i64]
  %tmp_135 = or i13 %tmp_95, 20                   ; [#uses=1 type=i13]
  %tmp_136 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_135) ; [#uses=1 type=i64]
  %tmp_137 = or i13 %tmp_95, 21                   ; [#uses=1 type=i13]
  %tmp_138 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_137) ; [#uses=1 type=i64]
  %tmp_139 = or i13 %tmp_95, 22                   ; [#uses=1 type=i13]
  %tmp_140 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_139) ; [#uses=1 type=i64]
  %tmp_141 = or i13 %tmp_95, 23                   ; [#uses=1 type=i13]
  %tmp_142 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_141) ; [#uses=1 type=i64]
  %tmp_143 = or i13 %tmp_95, 24                   ; [#uses=1 type=i13]
  %tmp_144 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_143) ; [#uses=1 type=i64]
  %tmp_145 = or i13 %tmp_95, 25                   ; [#uses=1 type=i13]
  %tmp_146 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_145) ; [#uses=1 type=i64]
  %tmp_147 = or i13 %tmp_95, 26                   ; [#uses=1 type=i13]
  %tmp_148 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_147) ; [#uses=1 type=i64]
  %tmp_149 = or i13 %tmp_95, 27                   ; [#uses=1 type=i13]
  %tmp_150 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_149) ; [#uses=1 type=i64]
  %tmp_151 = or i13 %tmp_95, 28                   ; [#uses=1 type=i13]
  %tmp_152 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_151) ; [#uses=1 type=i64]
  %tmp_153 = or i13 %tmp_95, 29                   ; [#uses=1 type=i13]
  %tmp_154 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_153) ; [#uses=1 type=i64]
  %tmp_155 = or i13 %tmp_95, 30                   ; [#uses=1 type=i13]
  %tmp_156 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_155) ; [#uses=1 type=i64]
  %tmp_157 = or i13 %tmp_95, 31                   ; [#uses=1 type=i13]
  %tmp_158 = call i64 @_ssdm_op_BitConcatenate.i64.i51.i13(i51 0, i13 %tmp_157) ; [#uses=1 type=i64]
  %tmp_21_mid2_v = select i1 %exitcond, i8 %i_4, i8 %i4, !dbg !2868 ; [#uses=3 type=i8] [debug line = 74:6]
  %tmp_160 = call i11 @_ssdm_op_BitConcatenate.i11.i8.i3(i8 %tmp_21_mid2_v, i3 0) ; [#uses=1 type=i11]
  %p_shl_cast = zext i11 %tmp_160 to i12          ; [#uses=1 type=i12]
  %tmp_243 = call i9 @_ssdm_op_BitConcatenate.i9.i8.i1(i8 %tmp_21_mid2_v, i1 false) ; [#uses=1 type=i9]
  %p_shl1_cast = zext i9 %tmp_243 to i12, !dbg !2872 ; [#uses=1 type=i12] [debug line = 76:5]
  %tmp_161 = add i12 %p_shl1_cast, %p_shl_cast, !dbg !2872 ; [#uses=1 type=i12] [debug line = 76:5]
  %in_buf_0_load_mid2_s = select i1 %exitcond, i13 %tmp_95, i13 %tmp_21, !dbg !2868 ; [#uses=1 type=i13] [debug line = 74:6]
  %in_buf_0_load_mid2 = zext i13 %in_buf_0_load_mid2_s to i64, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_2 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_mid2 ; [#uses=1 type=float*]
  %in_buf_0_load = load float* %in_buf_0_addr_2, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_1_mid = select i1 %exitcond, i64 %tmp_98, i64 %tmp_28, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_3 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_1_mid ; [#uses=1 type=float*]
  %in_buf_0_load_1 = load float* %in_buf_0_addr_3, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_2_mid = select i1 %exitcond, i64 %tmp_100, i64 %tmp_36, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_4 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_2_mid ; [#uses=1 type=float*]
  %in_buf_0_load_2 = load float* %in_buf_0_addr_4, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_3_mid = select i1 %exitcond, i64 %tmp_102, i64 %tmp_38, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_5 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_3_mid ; [#uses=1 type=float*]
  %in_buf_0_load_3 = load float* %in_buf_0_addr_5, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_4_mid = select i1 %exitcond, i64 %tmp_104, i64 %tmp_40, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_6 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_4_mid ; [#uses=1 type=float*]
  %in_buf_0_load_4 = load float* %in_buf_0_addr_6, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_5_mid = select i1 %exitcond, i64 %tmp_106, i64 %tmp_42, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_7 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_5_mid ; [#uses=1 type=float*]
  %in_buf_0_load_5 = load float* %in_buf_0_addr_7, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_6_mid = select i1 %exitcond, i64 %tmp_108, i64 %tmp_44, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_8 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_6_mid ; [#uses=1 type=float*]
  %in_buf_0_load_6 = load float* %in_buf_0_addr_8, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_7_mid = select i1 %exitcond, i64 %tmp_110, i64 %tmp_46, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_9 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_7_mid ; [#uses=1 type=float*]
  %in_buf_0_load_7 = load float* %in_buf_0_addr_9, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_8_mid = select i1 %exitcond, i64 %tmp_112, i64 %tmp_48, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_10 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_8_mid ; [#uses=1 type=float*]
  %in_buf_0_load_8 = load float* %in_buf_0_addr_10, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_9_mid = select i1 %exitcond, i64 %tmp_114, i64 %tmp_50, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_11 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_9_mid ; [#uses=1 type=float*]
  %in_buf_0_load_9 = load float* %in_buf_0_addr_11, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_10_mi = select i1 %exitcond, i64 %tmp_116, i64 %tmp_52, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_12 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_10_mi ; [#uses=1 type=float*]
  %in_buf_0_load_10 = load float* %in_buf_0_addr_12, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_11_mi = select i1 %exitcond, i64 %tmp_118, i64 %tmp_54, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_13 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_11_mi ; [#uses=1 type=float*]
  %in_buf_0_load_11 = load float* %in_buf_0_addr_13, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_12_mi = select i1 %exitcond, i64 %tmp_120, i64 %tmp_56, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_14 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_12_mi ; [#uses=1 type=float*]
  %in_buf_0_load_12 = load float* %in_buf_0_addr_14, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_13_mi = select i1 %exitcond, i64 %tmp_122, i64 %tmp_58, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_15 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_13_mi ; [#uses=1 type=float*]
  %in_buf_0_load_13 = load float* %in_buf_0_addr_15, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_14_mi = select i1 %exitcond, i64 %tmp_124, i64 %tmp_60, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_16 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_14_mi ; [#uses=1 type=float*]
  %in_buf_0_load_14 = load float* %in_buf_0_addr_16, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_15_mi = select i1 %exitcond, i64 %tmp_126, i64 %tmp_62, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_17 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_15_mi ; [#uses=1 type=float*]
  %in_buf_0_load_15 = load float* %in_buf_0_addr_17, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_16_mi = select i1 %exitcond, i64 %tmp_128, i64 %tmp_64, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_18 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_16_mi ; [#uses=1 type=float*]
  %in_buf_0_load_16 = load float* %in_buf_0_addr_18, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_17_mi = select i1 %exitcond, i64 %tmp_130, i64 %tmp_66, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_19 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_17_mi ; [#uses=1 type=float*]
  %in_buf_0_load_17 = load float* %in_buf_0_addr_19, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_18_mi = select i1 %exitcond, i64 %tmp_132, i64 %tmp_68, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_20 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_18_mi ; [#uses=1 type=float*]
  %in_buf_0_load_18 = load float* %in_buf_0_addr_20, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_19_mi = select i1 %exitcond, i64 %tmp_134, i64 %tmp_70, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_21 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_19_mi ; [#uses=1 type=float*]
  %in_buf_0_load_19 = load float* %in_buf_0_addr_21, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_20_mi = select i1 %exitcond, i64 %tmp_136, i64 %tmp_72, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_22 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_20_mi ; [#uses=1 type=float*]
  %in_buf_0_load_20 = load float* %in_buf_0_addr_22, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_21_mi = select i1 %exitcond, i64 %tmp_138, i64 %tmp_74, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_23 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_21_mi ; [#uses=1 type=float*]
  %in_buf_0_load_21 = load float* %in_buf_0_addr_23, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_22_mi = select i1 %exitcond, i64 %tmp_140, i64 %tmp_76, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_24 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_22_mi ; [#uses=1 type=float*]
  %in_buf_0_load_22 = load float* %in_buf_0_addr_24, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_23_mi = select i1 %exitcond, i64 %tmp_142, i64 %tmp_78, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_25 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_23_mi ; [#uses=1 type=float*]
  %in_buf_0_load_23 = load float* %in_buf_0_addr_25, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_24_mi = select i1 %exitcond, i64 %tmp_144, i64 %tmp_80, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_26 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_24_mi ; [#uses=1 type=float*]
  %in_buf_0_load_24 = load float* %in_buf_0_addr_26, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_25_mi = select i1 %exitcond, i64 %tmp_146, i64 %tmp_82, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_27 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_25_mi ; [#uses=1 type=float*]
  %in_buf_0_load_25 = load float* %in_buf_0_addr_27, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_26_mi = select i1 %exitcond, i64 %tmp_148, i64 %tmp_84, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_28 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_26_mi ; [#uses=1 type=float*]
  %in_buf_0_load_26 = load float* %in_buf_0_addr_28, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_27_mi = select i1 %exitcond, i64 %tmp_150, i64 %tmp_86, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_29 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_27_mi ; [#uses=1 type=float*]
  %in_buf_0_load_27 = load float* %in_buf_0_addr_29, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_28_mi = select i1 %exitcond, i64 %tmp_152, i64 %tmp_88, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_30 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_28_mi ; [#uses=1 type=float*]
  %in_buf_0_load_28 = load float* %in_buf_0_addr_30, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_29_mi = select i1 %exitcond, i64 %tmp_154, i64 %tmp_90, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_31 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_29_mi ; [#uses=1 type=float*]
  %in_buf_0_load_29 = load float* %in_buf_0_addr_31, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_30_mi = select i1 %exitcond, i64 %tmp_156, i64 %tmp_92, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_32 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_30_mi ; [#uses=1 type=float*]
  %in_buf_0_load_30 = load float* %in_buf_0_addr_32, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_31_mi = select i1 %exitcond, i64 %tmp_158, i64 %tmp_94, !dbg !2868 ; [#uses=8 type=i64] [debug line = 74:6]
  %in_buf_0_addr_33 = getelementptr [4096 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_31_mi ; [#uses=1 type=float*]
  %in_buf_0_load_31 = load float* %in_buf_0_addr_33, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_2 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_mid2 ; [#uses=1 type=float*]
  %in_buf_1_load = load float* %in_buf_1_addr_2, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_3 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_1_mid ; [#uses=1 type=float*]
  %in_buf_1_load_1 = load float* %in_buf_1_addr_3, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_4 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_2_mid ; [#uses=1 type=float*]
  %in_buf_1_load_2 = load float* %in_buf_1_addr_4, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_5 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_3_mid ; [#uses=1 type=float*]
  %in_buf_1_load_3 = load float* %in_buf_1_addr_5, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_6 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_4_mid ; [#uses=1 type=float*]
  %in_buf_1_load_4 = load float* %in_buf_1_addr_6, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_7 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_5_mid ; [#uses=1 type=float*]
  %in_buf_1_load_5 = load float* %in_buf_1_addr_7, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_8 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_6_mid ; [#uses=1 type=float*]
  %in_buf_1_load_6 = load float* %in_buf_1_addr_8, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_9 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_7_mid ; [#uses=1 type=float*]
  %in_buf_1_load_7 = load float* %in_buf_1_addr_9, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_10 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_8_mid ; [#uses=1 type=float*]
  %in_buf_1_load_8 = load float* %in_buf_1_addr_10, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_11 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_9_mid ; [#uses=1 type=float*]
  %in_buf_1_load_9 = load float* %in_buf_1_addr_11, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_12 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_10_mi ; [#uses=1 type=float*]
  %in_buf_1_load_10 = load float* %in_buf_1_addr_12, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_13 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_11_mi ; [#uses=1 type=float*]
  %in_buf_1_load_11 = load float* %in_buf_1_addr_13, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_14 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_12_mi ; [#uses=1 type=float*]
  %in_buf_1_load_12 = load float* %in_buf_1_addr_14, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_15 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_13_mi ; [#uses=1 type=float*]
  %in_buf_1_load_13 = load float* %in_buf_1_addr_15, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_16 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_14_mi ; [#uses=1 type=float*]
  %in_buf_1_load_14 = load float* %in_buf_1_addr_16, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_17 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_15_mi ; [#uses=1 type=float*]
  %in_buf_1_load_15 = load float* %in_buf_1_addr_17, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_18 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_16_mi ; [#uses=1 type=float*]
  %in_buf_1_load_16 = load float* %in_buf_1_addr_18, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_19 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_17_mi ; [#uses=1 type=float*]
  %in_buf_1_load_17 = load float* %in_buf_1_addr_19, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_20 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_18_mi ; [#uses=1 type=float*]
  %in_buf_1_load_18 = load float* %in_buf_1_addr_20, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_21 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_19_mi ; [#uses=1 type=float*]
  %in_buf_1_load_19 = load float* %in_buf_1_addr_21, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_22 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_20_mi ; [#uses=1 type=float*]
  %in_buf_1_load_20 = load float* %in_buf_1_addr_22, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_23 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_21_mi ; [#uses=1 type=float*]
  %in_buf_1_load_21 = load float* %in_buf_1_addr_23, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_24 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_22_mi ; [#uses=1 type=float*]
  %in_buf_1_load_22 = load float* %in_buf_1_addr_24, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_25 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_23_mi ; [#uses=1 type=float*]
  %in_buf_1_load_23 = load float* %in_buf_1_addr_25, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_26 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_24_mi ; [#uses=1 type=float*]
  %in_buf_1_load_24 = load float* %in_buf_1_addr_26, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_27 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_25_mi ; [#uses=1 type=float*]
  %in_buf_1_load_25 = load float* %in_buf_1_addr_27, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_28 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_26_mi ; [#uses=1 type=float*]
  %in_buf_1_load_26 = load float* %in_buf_1_addr_28, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_29 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_27_mi ; [#uses=1 type=float*]
  %in_buf_1_load_27 = load float* %in_buf_1_addr_29, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_30 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_28_mi ; [#uses=1 type=float*]
  %in_buf_1_load_28 = load float* %in_buf_1_addr_30, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_31 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_29_mi ; [#uses=1 type=float*]
  %in_buf_1_load_29 = load float* %in_buf_1_addr_31, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_32 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_30_mi ; [#uses=1 type=float*]
  %in_buf_1_load_30 = load float* %in_buf_1_addr_32, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_33 = getelementptr [4096 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_31_mi ; [#uses=1 type=float*]
  %in_buf_1_load_31 = load float* %in_buf_1_addr_33, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_2 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_mid2 ; [#uses=1 type=float*]
  %in_buf_2_load = load float* %in_buf_2_addr_2, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_3 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_1_mid ; [#uses=1 type=float*]
  %in_buf_2_load_1 = load float* %in_buf_2_addr_3, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_4 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_2_mid ; [#uses=1 type=float*]
  %in_buf_2_load_2 = load float* %in_buf_2_addr_4, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_5 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_3_mid ; [#uses=1 type=float*]
  %in_buf_2_load_3 = load float* %in_buf_2_addr_5, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_6 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_4_mid ; [#uses=1 type=float*]
  %in_buf_2_load_4 = load float* %in_buf_2_addr_6, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_7 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_5_mid ; [#uses=1 type=float*]
  %in_buf_2_load_5 = load float* %in_buf_2_addr_7, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_8 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_6_mid ; [#uses=1 type=float*]
  %in_buf_2_load_6 = load float* %in_buf_2_addr_8, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_9 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_7_mid ; [#uses=1 type=float*]
  %in_buf_2_load_7 = load float* %in_buf_2_addr_9, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_10 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_8_mid ; [#uses=1 type=float*]
  %in_buf_2_load_8 = load float* %in_buf_2_addr_10, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_11 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_9_mid ; [#uses=1 type=float*]
  %in_buf_2_load_9 = load float* %in_buf_2_addr_11, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_12 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_10_mi ; [#uses=1 type=float*]
  %in_buf_2_load_10 = load float* %in_buf_2_addr_12, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_13 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_11_mi ; [#uses=1 type=float*]
  %in_buf_2_load_11 = load float* %in_buf_2_addr_13, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_14 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_12_mi ; [#uses=1 type=float*]
  %in_buf_2_load_12 = load float* %in_buf_2_addr_14, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_15 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_13_mi ; [#uses=1 type=float*]
  %in_buf_2_load_13 = load float* %in_buf_2_addr_15, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_16 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_14_mi ; [#uses=1 type=float*]
  %in_buf_2_load_14 = load float* %in_buf_2_addr_16, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_17 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_15_mi ; [#uses=1 type=float*]
  %in_buf_2_load_15 = load float* %in_buf_2_addr_17, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_18 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_16_mi ; [#uses=1 type=float*]
  %in_buf_2_load_16 = load float* %in_buf_2_addr_18, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_19 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_17_mi ; [#uses=1 type=float*]
  %in_buf_2_load_17 = load float* %in_buf_2_addr_19, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_20 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_18_mi ; [#uses=1 type=float*]
  %in_buf_2_load_18 = load float* %in_buf_2_addr_20, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_21 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_19_mi ; [#uses=1 type=float*]
  %in_buf_2_load_19 = load float* %in_buf_2_addr_21, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_22 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_20_mi ; [#uses=1 type=float*]
  %in_buf_2_load_20 = load float* %in_buf_2_addr_22, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_23 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_21_mi ; [#uses=1 type=float*]
  %in_buf_2_load_21 = load float* %in_buf_2_addr_23, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_24 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_22_mi ; [#uses=1 type=float*]
  %in_buf_2_load_22 = load float* %in_buf_2_addr_24, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_25 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_23_mi ; [#uses=1 type=float*]
  %in_buf_2_load_23 = load float* %in_buf_2_addr_25, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_26 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_24_mi ; [#uses=1 type=float*]
  %in_buf_2_load_24 = load float* %in_buf_2_addr_26, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_27 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_25_mi ; [#uses=1 type=float*]
  %in_buf_2_load_25 = load float* %in_buf_2_addr_27, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_28 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_26_mi ; [#uses=1 type=float*]
  %in_buf_2_load_26 = load float* %in_buf_2_addr_28, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_29 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_27_mi ; [#uses=1 type=float*]
  %in_buf_2_load_27 = load float* %in_buf_2_addr_29, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_30 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_28_mi ; [#uses=1 type=float*]
  %in_buf_2_load_28 = load float* %in_buf_2_addr_30, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_31 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_29_mi ; [#uses=1 type=float*]
  %in_buf_2_load_29 = load float* %in_buf_2_addr_31, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_32 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_30_mi ; [#uses=1 type=float*]
  %in_buf_2_load_30 = load float* %in_buf_2_addr_32, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_33 = getelementptr [4096 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_31_mi ; [#uses=1 type=float*]
  %in_buf_2_load_31 = load float* %in_buf_2_addr_33, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_2 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_mid2 ; [#uses=1 type=float*]
  %in_buf_3_load = load float* %in_buf_3_addr_2, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_3 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_1_mid ; [#uses=1 type=float*]
  %in_buf_3_load_1 = load float* %in_buf_3_addr_3, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_4 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_2_mid ; [#uses=1 type=float*]
  %in_buf_3_load_2 = load float* %in_buf_3_addr_4, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_5 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_3_mid ; [#uses=1 type=float*]
  %in_buf_3_load_3 = load float* %in_buf_3_addr_5, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_6 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_4_mid ; [#uses=1 type=float*]
  %in_buf_3_load_4 = load float* %in_buf_3_addr_6, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_7 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_5_mid ; [#uses=1 type=float*]
  %in_buf_3_load_5 = load float* %in_buf_3_addr_7, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_8 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_6_mid ; [#uses=1 type=float*]
  %in_buf_3_load_6 = load float* %in_buf_3_addr_8, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_9 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_7_mid ; [#uses=1 type=float*]
  %in_buf_3_load_7 = load float* %in_buf_3_addr_9, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_10 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_8_mid ; [#uses=1 type=float*]
  %in_buf_3_load_8 = load float* %in_buf_3_addr_10, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_11 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_9_mid ; [#uses=1 type=float*]
  %in_buf_3_load_9 = load float* %in_buf_3_addr_11, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_12 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_10_mi ; [#uses=1 type=float*]
  %in_buf_3_load_10 = load float* %in_buf_3_addr_12, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_13 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_11_mi ; [#uses=1 type=float*]
  %in_buf_3_load_11 = load float* %in_buf_3_addr_13, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_14 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_12_mi ; [#uses=1 type=float*]
  %in_buf_3_load_12 = load float* %in_buf_3_addr_14, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_15 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_13_mi ; [#uses=1 type=float*]
  %in_buf_3_load_13 = load float* %in_buf_3_addr_15, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_16 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_14_mi ; [#uses=1 type=float*]
  %in_buf_3_load_14 = load float* %in_buf_3_addr_16, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_17 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_15_mi ; [#uses=1 type=float*]
  %in_buf_3_load_15 = load float* %in_buf_3_addr_17, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_18 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_16_mi ; [#uses=1 type=float*]
  %in_buf_3_load_16 = load float* %in_buf_3_addr_18, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_19 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_17_mi ; [#uses=1 type=float*]
  %in_buf_3_load_17 = load float* %in_buf_3_addr_19, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_20 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_18_mi ; [#uses=1 type=float*]
  %in_buf_3_load_18 = load float* %in_buf_3_addr_20, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_21 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_19_mi ; [#uses=1 type=float*]
  %in_buf_3_load_19 = load float* %in_buf_3_addr_21, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_22 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_20_mi ; [#uses=1 type=float*]
  %in_buf_3_load_20 = load float* %in_buf_3_addr_22, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_23 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_21_mi ; [#uses=1 type=float*]
  %in_buf_3_load_21 = load float* %in_buf_3_addr_23, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_24 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_22_mi ; [#uses=1 type=float*]
  %in_buf_3_load_22 = load float* %in_buf_3_addr_24, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_25 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_23_mi ; [#uses=1 type=float*]
  %in_buf_3_load_23 = load float* %in_buf_3_addr_25, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_26 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_24_mi ; [#uses=1 type=float*]
  %in_buf_3_load_24 = load float* %in_buf_3_addr_26, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_27 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_25_mi ; [#uses=1 type=float*]
  %in_buf_3_load_25 = load float* %in_buf_3_addr_27, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_28 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_26_mi ; [#uses=1 type=float*]
  %in_buf_3_load_26 = load float* %in_buf_3_addr_28, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_29 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_27_mi ; [#uses=1 type=float*]
  %in_buf_3_load_27 = load float* %in_buf_3_addr_29, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_30 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_28_mi ; [#uses=1 type=float*]
  %in_buf_3_load_28 = load float* %in_buf_3_addr_30, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_31 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_29_mi ; [#uses=1 type=float*]
  %in_buf_3_load_29 = load float* %in_buf_3_addr_31, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_32 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_30_mi ; [#uses=1 type=float*]
  %in_buf_3_load_30 = load float* %in_buf_3_addr_32, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_33 = getelementptr [4096 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_31_mi ; [#uses=1 type=float*]
  %in_buf_3_load_31 = load float* %in_buf_3_addr_33, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_2 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_mid2 ; [#uses=1 type=float*]
  %in_buf_4_load = load float* %in_buf_4_addr_2, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_3 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_1_mid ; [#uses=1 type=float*]
  %in_buf_4_load_1 = load float* %in_buf_4_addr_3, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_4 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_2_mid ; [#uses=1 type=float*]
  %in_buf_4_load_2 = load float* %in_buf_4_addr_4, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_5 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_3_mid ; [#uses=1 type=float*]
  %in_buf_4_load_3 = load float* %in_buf_4_addr_5, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_6 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_4_mid ; [#uses=1 type=float*]
  %in_buf_4_load_4 = load float* %in_buf_4_addr_6, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_7 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_5_mid ; [#uses=1 type=float*]
  %in_buf_4_load_5 = load float* %in_buf_4_addr_7, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_8 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_6_mid ; [#uses=1 type=float*]
  %in_buf_4_load_6 = load float* %in_buf_4_addr_8, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_9 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_7_mid ; [#uses=1 type=float*]
  %in_buf_4_load_7 = load float* %in_buf_4_addr_9, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_10 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_8_mid ; [#uses=1 type=float*]
  %in_buf_4_load_8 = load float* %in_buf_4_addr_10, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_11 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_9_mid ; [#uses=1 type=float*]
  %in_buf_4_load_9 = load float* %in_buf_4_addr_11, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_12 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_10_mi ; [#uses=1 type=float*]
  %in_buf_4_load_10 = load float* %in_buf_4_addr_12, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_13 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_11_mi ; [#uses=1 type=float*]
  %in_buf_4_load_11 = load float* %in_buf_4_addr_13, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_14 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_12_mi ; [#uses=1 type=float*]
  %in_buf_4_load_12 = load float* %in_buf_4_addr_14, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_15 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_13_mi ; [#uses=1 type=float*]
  %in_buf_4_load_13 = load float* %in_buf_4_addr_15, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_16 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_14_mi ; [#uses=1 type=float*]
  %in_buf_4_load_14 = load float* %in_buf_4_addr_16, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_17 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_15_mi ; [#uses=1 type=float*]
  %in_buf_4_load_15 = load float* %in_buf_4_addr_17, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_18 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_16_mi ; [#uses=1 type=float*]
  %in_buf_4_load_16 = load float* %in_buf_4_addr_18, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_19 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_17_mi ; [#uses=1 type=float*]
  %in_buf_4_load_17 = load float* %in_buf_4_addr_19, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_20 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_18_mi ; [#uses=1 type=float*]
  %in_buf_4_load_18 = load float* %in_buf_4_addr_20, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_21 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_19_mi ; [#uses=1 type=float*]
  %in_buf_4_load_19 = load float* %in_buf_4_addr_21, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_22 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_20_mi ; [#uses=1 type=float*]
  %in_buf_4_load_20 = load float* %in_buf_4_addr_22, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_23 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_21_mi ; [#uses=1 type=float*]
  %in_buf_4_load_21 = load float* %in_buf_4_addr_23, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_24 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_22_mi ; [#uses=1 type=float*]
  %in_buf_4_load_22 = load float* %in_buf_4_addr_24, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_25 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_23_mi ; [#uses=1 type=float*]
  %in_buf_4_load_23 = load float* %in_buf_4_addr_25, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_26 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_24_mi ; [#uses=1 type=float*]
  %in_buf_4_load_24 = load float* %in_buf_4_addr_26, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_27 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_25_mi ; [#uses=1 type=float*]
  %in_buf_4_load_25 = load float* %in_buf_4_addr_27, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_28 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_26_mi ; [#uses=1 type=float*]
  %in_buf_4_load_26 = load float* %in_buf_4_addr_28, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_29 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_27_mi ; [#uses=1 type=float*]
  %in_buf_4_load_27 = load float* %in_buf_4_addr_29, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_30 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_28_mi ; [#uses=1 type=float*]
  %in_buf_4_load_28 = load float* %in_buf_4_addr_30, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_31 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_29_mi ; [#uses=1 type=float*]
  %in_buf_4_load_29 = load float* %in_buf_4_addr_31, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_32 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_30_mi ; [#uses=1 type=float*]
  %in_buf_4_load_30 = load float* %in_buf_4_addr_32, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_4_addr_33 = getelementptr [4096 x float]* %in_buf_4, i64 0, i64 %in_buf_0_load_31_mi ; [#uses=1 type=float*]
  %in_buf_4_load_31 = load float* %in_buf_4_addr_33, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_2 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_mid2 ; [#uses=1 type=float*]
  %in_buf_5_load = load float* %in_buf_5_addr_2, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_3 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_1_mid ; [#uses=1 type=float*]
  %in_buf_5_load_1 = load float* %in_buf_5_addr_3, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_4 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_2_mid ; [#uses=1 type=float*]
  %in_buf_5_load_2 = load float* %in_buf_5_addr_4, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_5 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_3_mid ; [#uses=1 type=float*]
  %in_buf_5_load_3 = load float* %in_buf_5_addr_5, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_6 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_4_mid ; [#uses=1 type=float*]
  %in_buf_5_load_4 = load float* %in_buf_5_addr_6, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_7 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_5_mid ; [#uses=1 type=float*]
  %in_buf_5_load_5 = load float* %in_buf_5_addr_7, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_8 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_6_mid ; [#uses=1 type=float*]
  %in_buf_5_load_6 = load float* %in_buf_5_addr_8, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_9 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_7_mid ; [#uses=1 type=float*]
  %in_buf_5_load_7 = load float* %in_buf_5_addr_9, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_10 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_8_mid ; [#uses=1 type=float*]
  %in_buf_5_load_8 = load float* %in_buf_5_addr_10, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_11 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_9_mid ; [#uses=1 type=float*]
  %in_buf_5_load_9 = load float* %in_buf_5_addr_11, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_12 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_10_mi ; [#uses=1 type=float*]
  %in_buf_5_load_10 = load float* %in_buf_5_addr_12, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_13 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_11_mi ; [#uses=1 type=float*]
  %in_buf_5_load_11 = load float* %in_buf_5_addr_13, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_14 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_12_mi ; [#uses=1 type=float*]
  %in_buf_5_load_12 = load float* %in_buf_5_addr_14, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_15 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_13_mi ; [#uses=1 type=float*]
  %in_buf_5_load_13 = load float* %in_buf_5_addr_15, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_16 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_14_mi ; [#uses=1 type=float*]
  %in_buf_5_load_14 = load float* %in_buf_5_addr_16, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_17 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_15_mi ; [#uses=1 type=float*]
  %in_buf_5_load_15 = load float* %in_buf_5_addr_17, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_18 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_16_mi ; [#uses=1 type=float*]
  %in_buf_5_load_16 = load float* %in_buf_5_addr_18, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_19 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_17_mi ; [#uses=1 type=float*]
  %in_buf_5_load_17 = load float* %in_buf_5_addr_19, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_20 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_18_mi ; [#uses=1 type=float*]
  %in_buf_5_load_18 = load float* %in_buf_5_addr_20, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_21 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_19_mi ; [#uses=1 type=float*]
  %in_buf_5_load_19 = load float* %in_buf_5_addr_21, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_22 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_20_mi ; [#uses=1 type=float*]
  %in_buf_5_load_20 = load float* %in_buf_5_addr_22, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_23 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_21_mi ; [#uses=1 type=float*]
  %in_buf_5_load_21 = load float* %in_buf_5_addr_23, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_24 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_22_mi ; [#uses=1 type=float*]
  %in_buf_5_load_22 = load float* %in_buf_5_addr_24, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_25 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_23_mi ; [#uses=1 type=float*]
  %in_buf_5_load_23 = load float* %in_buf_5_addr_25, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_26 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_24_mi ; [#uses=1 type=float*]
  %in_buf_5_load_24 = load float* %in_buf_5_addr_26, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_27 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_25_mi ; [#uses=1 type=float*]
  %in_buf_5_load_25 = load float* %in_buf_5_addr_27, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_28 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_26_mi ; [#uses=1 type=float*]
  %in_buf_5_load_26 = load float* %in_buf_5_addr_28, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_29 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_27_mi ; [#uses=1 type=float*]
  %in_buf_5_load_27 = load float* %in_buf_5_addr_29, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_30 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_28_mi ; [#uses=1 type=float*]
  %in_buf_5_load_28 = load float* %in_buf_5_addr_30, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_31 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_29_mi ; [#uses=1 type=float*]
  %in_buf_5_load_29 = load float* %in_buf_5_addr_31, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_32 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_30_mi ; [#uses=1 type=float*]
  %in_buf_5_load_30 = load float* %in_buf_5_addr_32, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_5_addr_33 = getelementptr [4096 x float]* %in_buf_5, i64 0, i64 %in_buf_0_load_31_mi ; [#uses=1 type=float*]
  %in_buf_5_load_31 = load float* %in_buf_5_addr_33, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_2 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_mid2 ; [#uses=1 type=float*]
  %in_buf_6_load = load float* %in_buf_6_addr_2, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_3 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_1_mid ; [#uses=1 type=float*]
  %in_buf_6_load_1 = load float* %in_buf_6_addr_3, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_4 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_2_mid ; [#uses=1 type=float*]
  %in_buf_6_load_2 = load float* %in_buf_6_addr_4, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_5 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_3_mid ; [#uses=1 type=float*]
  %in_buf_6_load_3 = load float* %in_buf_6_addr_5, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_6 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_4_mid ; [#uses=1 type=float*]
  %in_buf_6_load_4 = load float* %in_buf_6_addr_6, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_7 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_5_mid ; [#uses=1 type=float*]
  %in_buf_6_load_5 = load float* %in_buf_6_addr_7, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_8 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_6_mid ; [#uses=1 type=float*]
  %in_buf_6_load_6 = load float* %in_buf_6_addr_8, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_9 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_7_mid ; [#uses=1 type=float*]
  %in_buf_6_load_7 = load float* %in_buf_6_addr_9, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_10 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_8_mid ; [#uses=1 type=float*]
  %in_buf_6_load_8 = load float* %in_buf_6_addr_10, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_11 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_9_mid ; [#uses=1 type=float*]
  %in_buf_6_load_9 = load float* %in_buf_6_addr_11, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_12 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_10_mi ; [#uses=1 type=float*]
  %in_buf_6_load_10 = load float* %in_buf_6_addr_12, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_13 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_11_mi ; [#uses=1 type=float*]
  %in_buf_6_load_11 = load float* %in_buf_6_addr_13, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_14 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_12_mi ; [#uses=1 type=float*]
  %in_buf_6_load_12 = load float* %in_buf_6_addr_14, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_15 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_13_mi ; [#uses=1 type=float*]
  %in_buf_6_load_13 = load float* %in_buf_6_addr_15, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_16 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_14_mi ; [#uses=1 type=float*]
  %in_buf_6_load_14 = load float* %in_buf_6_addr_16, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_17 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_15_mi ; [#uses=1 type=float*]
  %in_buf_6_load_15 = load float* %in_buf_6_addr_17, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_18 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_16_mi ; [#uses=1 type=float*]
  %in_buf_6_load_16 = load float* %in_buf_6_addr_18, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_19 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_17_mi ; [#uses=1 type=float*]
  %in_buf_6_load_17 = load float* %in_buf_6_addr_19, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_20 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_18_mi ; [#uses=1 type=float*]
  %in_buf_6_load_18 = load float* %in_buf_6_addr_20, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_21 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_19_mi ; [#uses=1 type=float*]
  %in_buf_6_load_19 = load float* %in_buf_6_addr_21, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_22 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_20_mi ; [#uses=1 type=float*]
  %in_buf_6_load_20 = load float* %in_buf_6_addr_22, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_23 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_21_mi ; [#uses=1 type=float*]
  %in_buf_6_load_21 = load float* %in_buf_6_addr_23, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_24 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_22_mi ; [#uses=1 type=float*]
  %in_buf_6_load_22 = load float* %in_buf_6_addr_24, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_25 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_23_mi ; [#uses=1 type=float*]
  %in_buf_6_load_23 = load float* %in_buf_6_addr_25, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_26 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_24_mi ; [#uses=1 type=float*]
  %in_buf_6_load_24 = load float* %in_buf_6_addr_26, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_27 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_25_mi ; [#uses=1 type=float*]
  %in_buf_6_load_25 = load float* %in_buf_6_addr_27, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_28 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_26_mi ; [#uses=1 type=float*]
  %in_buf_6_load_26 = load float* %in_buf_6_addr_28, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_29 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_27_mi ; [#uses=1 type=float*]
  %in_buf_6_load_27 = load float* %in_buf_6_addr_29, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_30 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_28_mi ; [#uses=1 type=float*]
  %in_buf_6_load_28 = load float* %in_buf_6_addr_30, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_31 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_29_mi ; [#uses=1 type=float*]
  %in_buf_6_load_29 = load float* %in_buf_6_addr_31, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_32 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_30_mi ; [#uses=1 type=float*]
  %in_buf_6_load_30 = load float* %in_buf_6_addr_32, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_6_addr_33 = getelementptr [4096 x float]* %in_buf_6, i64 0, i64 %in_buf_0_load_31_mi ; [#uses=1 type=float*]
  %in_buf_6_load_31 = load float* %in_buf_6_addr_33, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_2 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_mid2 ; [#uses=1 type=float*]
  %in_buf_7_load = load float* %in_buf_7_addr_2, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_3 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_1_mid ; [#uses=1 type=float*]
  %in_buf_7_load_1 = load float* %in_buf_7_addr_3, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_4 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_2_mid ; [#uses=1 type=float*]
  %in_buf_7_load_2 = load float* %in_buf_7_addr_4, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_5 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_3_mid ; [#uses=1 type=float*]
  %in_buf_7_load_3 = load float* %in_buf_7_addr_5, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_6 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_4_mid ; [#uses=1 type=float*]
  %in_buf_7_load_4 = load float* %in_buf_7_addr_6, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_7 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_5_mid ; [#uses=1 type=float*]
  %in_buf_7_load_5 = load float* %in_buf_7_addr_7, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_8 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_6_mid ; [#uses=1 type=float*]
  %in_buf_7_load_6 = load float* %in_buf_7_addr_8, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_9 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_7_mid ; [#uses=1 type=float*]
  %in_buf_7_load_7 = load float* %in_buf_7_addr_9, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_10 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_8_mid ; [#uses=1 type=float*]
  %in_buf_7_load_8 = load float* %in_buf_7_addr_10, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_11 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_9_mid ; [#uses=1 type=float*]
  %in_buf_7_load_9 = load float* %in_buf_7_addr_11, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_12 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_10_mi ; [#uses=1 type=float*]
  %in_buf_7_load_10 = load float* %in_buf_7_addr_12, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_13 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_11_mi ; [#uses=1 type=float*]
  %in_buf_7_load_11 = load float* %in_buf_7_addr_13, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_14 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_12_mi ; [#uses=1 type=float*]
  %in_buf_7_load_12 = load float* %in_buf_7_addr_14, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_15 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_13_mi ; [#uses=1 type=float*]
  %in_buf_7_load_13 = load float* %in_buf_7_addr_15, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_16 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_14_mi ; [#uses=1 type=float*]
  %in_buf_7_load_14 = load float* %in_buf_7_addr_16, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_17 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_15_mi ; [#uses=1 type=float*]
  %in_buf_7_load_15 = load float* %in_buf_7_addr_17, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_18 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_16_mi ; [#uses=1 type=float*]
  %in_buf_7_load_16 = load float* %in_buf_7_addr_18, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_19 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_17_mi ; [#uses=1 type=float*]
  %in_buf_7_load_17 = load float* %in_buf_7_addr_19, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_20 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_18_mi ; [#uses=1 type=float*]
  %in_buf_7_load_18 = load float* %in_buf_7_addr_20, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_21 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_19_mi ; [#uses=1 type=float*]
  %in_buf_7_load_19 = load float* %in_buf_7_addr_21, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_22 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_20_mi ; [#uses=1 type=float*]
  %in_buf_7_load_20 = load float* %in_buf_7_addr_22, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_23 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_21_mi ; [#uses=1 type=float*]
  %in_buf_7_load_21 = load float* %in_buf_7_addr_23, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_24 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_22_mi ; [#uses=1 type=float*]
  %in_buf_7_load_22 = load float* %in_buf_7_addr_24, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_25 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_23_mi ; [#uses=1 type=float*]
  %in_buf_7_load_23 = load float* %in_buf_7_addr_25, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_26 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_24_mi ; [#uses=1 type=float*]
  %in_buf_7_load_24 = load float* %in_buf_7_addr_26, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_27 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_25_mi ; [#uses=1 type=float*]
  %in_buf_7_load_25 = load float* %in_buf_7_addr_27, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_28 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_26_mi ; [#uses=1 type=float*]
  %in_buf_7_load_26 = load float* %in_buf_7_addr_28, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_29 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_27_mi ; [#uses=1 type=float*]
  %in_buf_7_load_27 = load float* %in_buf_7_addr_29, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_30 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_28_mi ; [#uses=1 type=float*]
  %in_buf_7_load_28 = load float* %in_buf_7_addr_30, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_31 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_29_mi ; [#uses=1 type=float*]
  %in_buf_7_load_29 = load float* %in_buf_7_addr_31, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_32 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_30_mi ; [#uses=1 type=float*]
  %in_buf_7_load_30 = load float* %in_buf_7_addr_32, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_7_addr_33 = getelementptr [4096 x float]* %in_buf_7, i64 0, i64 %in_buf_0_load_31_mi ; [#uses=1 type=float*]
  %in_buf_7_load_31 = load float* %in_buf_7_addr_33, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  call void (...)* @_ssdm_op_SpecLoopName([3 x i8]* @p_str13) nounwind, !dbg !2873 ; [debug line = 70:38]
  %tmp_32 = call i32 (...)* @_ssdm_op_SpecRegionBegin([3 x i8]* @p_str13), !dbg !2873 ; [#uses=1 type=i32] [debug line = 70:38]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !2874 ; [debug line = 71:1]
  %tmp_31 = zext i4 %j5_mid2 to i64, !dbg !2875   ; [#uses=1 type=i64] [debug line = 72:26]
  %tmp_31_cast = zext i4 %j5_mid2 to i12          ; [#uses=1 type=i12]
  %tmp_162 = call i9 @_ssdm_op_BitConcatenate.i9.i4.i5(i4 %j5_mid2, i5 0) ; [#uses=32 type=i9]
  %tmp_163 = zext i9 %tmp_162 to i64              ; [#uses=8 type=i64]
  %weight_buf_0_addr_2 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_163 ; [#uses=1 type=float*]
  %tmp_164 = or i9 %tmp_162, 1                    ; [#uses=1 type=i9]
  %tmp_165 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_164) ; [#uses=8 type=i64]
  %weight_buf_0_addr_3 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_165 ; [#uses=1 type=float*]
  %tmp_166 = or i9 %tmp_162, 2                    ; [#uses=1 type=i9]
  %tmp_167 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_166) ; [#uses=8 type=i64]
  %weight_buf_0_addr_4 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_167 ; [#uses=1 type=float*]
  %tmp_168 = or i9 %tmp_162, 3                    ; [#uses=1 type=i9]
  %tmp_169 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_168) ; [#uses=8 type=i64]
  %weight_buf_0_addr_5 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_169 ; [#uses=1 type=float*]
  %tmp_170 = or i9 %tmp_162, 4                    ; [#uses=1 type=i9]
  %tmp_171 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_170) ; [#uses=8 type=i64]
  %weight_buf_0_addr_6 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_171 ; [#uses=1 type=float*]
  %tmp_172 = or i9 %tmp_162, 5                    ; [#uses=1 type=i9]
  %tmp_173 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_172) ; [#uses=8 type=i64]
  %weight_buf_0_addr_7 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_173 ; [#uses=1 type=float*]
  %tmp_174 = or i9 %tmp_162, 6                    ; [#uses=1 type=i9]
  %tmp_175 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_174) ; [#uses=8 type=i64]
  %weight_buf_0_addr_8 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_175 ; [#uses=1 type=float*]
  %tmp_176 = or i9 %tmp_162, 7                    ; [#uses=1 type=i9]
  %tmp_177 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_176) ; [#uses=8 type=i64]
  %weight_buf_0_addr_9 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_177 ; [#uses=1 type=float*]
  %tmp_178 = or i9 %tmp_162, 8                    ; [#uses=1 type=i9]
  %tmp_179 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_178) ; [#uses=8 type=i64]
  %weight_buf_0_addr_10 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_179 ; [#uses=1 type=float*]
  %tmp_180 = or i9 %tmp_162, 9                    ; [#uses=1 type=i9]
  %tmp_181 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_180) ; [#uses=8 type=i64]
  %weight_buf_0_addr_11 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_181 ; [#uses=1 type=float*]
  %tmp_182 = or i9 %tmp_162, 10                   ; [#uses=1 type=i9]
  %tmp_183 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_182) ; [#uses=8 type=i64]
  %weight_buf_0_addr_12 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_183 ; [#uses=1 type=float*]
  %tmp_184 = or i9 %tmp_162, 11                   ; [#uses=1 type=i9]
  %tmp_185 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_184) ; [#uses=8 type=i64]
  %weight_buf_0_addr_13 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_185 ; [#uses=1 type=float*]
  %tmp_186 = or i9 %tmp_162, 12                   ; [#uses=1 type=i9]
  %tmp_187 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_186) ; [#uses=8 type=i64]
  %weight_buf_0_addr_14 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_187 ; [#uses=1 type=float*]
  %tmp_188 = or i9 %tmp_162, 13                   ; [#uses=1 type=i9]
  %tmp_189 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_188) ; [#uses=8 type=i64]
  %weight_buf_0_addr_15 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_189 ; [#uses=1 type=float*]
  %tmp_190 = or i9 %tmp_162, 14                   ; [#uses=1 type=i9]
  %tmp_191 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_190) ; [#uses=8 type=i64]
  %weight_buf_0_addr_16 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_191 ; [#uses=1 type=float*]
  %tmp_192 = or i9 %tmp_162, 15                   ; [#uses=1 type=i9]
  %tmp_193 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_192) ; [#uses=8 type=i64]
  %weight_buf_0_addr_17 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_193 ; [#uses=1 type=float*]
  %tmp_194 = or i9 %tmp_162, 16                   ; [#uses=1 type=i9]
  %tmp_195 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_194) ; [#uses=8 type=i64]
  %weight_buf_0_addr_18 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_195 ; [#uses=1 type=float*]
  %tmp_196 = or i9 %tmp_162, 17                   ; [#uses=1 type=i9]
  %tmp_197 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_196) ; [#uses=8 type=i64]
  %weight_buf_0_addr_19 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_197 ; [#uses=1 type=float*]
  %tmp_198 = or i9 %tmp_162, 18                   ; [#uses=1 type=i9]
  %tmp_199 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_198) ; [#uses=8 type=i64]
  %weight_buf_0_addr_20 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_199 ; [#uses=1 type=float*]
  %tmp_200 = or i9 %tmp_162, 19                   ; [#uses=1 type=i9]
  %tmp_201 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_200) ; [#uses=8 type=i64]
  %weight_buf_0_addr_21 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_201 ; [#uses=1 type=float*]
  %tmp_202 = or i9 %tmp_162, 20                   ; [#uses=1 type=i9]
  %tmp_203 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_202) ; [#uses=8 type=i64]
  %weight_buf_0_addr_22 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_203 ; [#uses=1 type=float*]
  %tmp_204 = or i9 %tmp_162, 21                   ; [#uses=1 type=i9]
  %tmp_205 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_204) ; [#uses=8 type=i64]
  %weight_buf_0_addr_23 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_205 ; [#uses=1 type=float*]
  %tmp_206 = or i9 %tmp_162, 22                   ; [#uses=1 type=i9]
  %tmp_207 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_206) ; [#uses=8 type=i64]
  %weight_buf_0_addr_24 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_207 ; [#uses=1 type=float*]
  %tmp_208 = or i9 %tmp_162, 23                   ; [#uses=1 type=i9]
  %tmp_209 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_208) ; [#uses=8 type=i64]
  %weight_buf_0_addr_25 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_209 ; [#uses=1 type=float*]
  %tmp_210 = or i9 %tmp_162, 24                   ; [#uses=1 type=i9]
  %tmp_211 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_210) ; [#uses=8 type=i64]
  %weight_buf_0_addr_26 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_211 ; [#uses=1 type=float*]
  %tmp_212 = or i9 %tmp_162, 25                   ; [#uses=1 type=i9]
  %tmp_213 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_212) ; [#uses=8 type=i64]
  %weight_buf_0_addr_27 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_213 ; [#uses=1 type=float*]
  %tmp_214 = or i9 %tmp_162, 26                   ; [#uses=1 type=i9]
  %tmp_215 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_214) ; [#uses=8 type=i64]
  %weight_buf_0_addr_28 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_215 ; [#uses=1 type=float*]
  %tmp_216 = or i9 %tmp_162, 27                   ; [#uses=1 type=i9]
  %tmp_217 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_216) ; [#uses=8 type=i64]
  %weight_buf_0_addr_29 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_217 ; [#uses=1 type=float*]
  %tmp_218 = or i9 %tmp_162, 28                   ; [#uses=1 type=i9]
  %tmp_219 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_218) ; [#uses=8 type=i64]
  %weight_buf_0_addr_30 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_219 ; [#uses=1 type=float*]
  %tmp_220 = or i9 %tmp_162, 29                   ; [#uses=1 type=i9]
  %tmp_221 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_220) ; [#uses=8 type=i64]
  %weight_buf_0_addr_31 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_221 ; [#uses=1 type=float*]
  %tmp_222 = or i9 %tmp_162, 30                   ; [#uses=1 type=i9]
  %tmp_223 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_222) ; [#uses=8 type=i64]
  %weight_buf_0_addr_32 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_223 ; [#uses=1 type=float*]
  %tmp_224 = or i9 %tmp_162, 31                   ; [#uses=1 type=i9]
  %tmp_225 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_224) ; [#uses=8 type=i64]
  %weight_buf_0_addr_33 = getelementptr [320 x float]* %weight_buf_0, i64 0, i64 %tmp_225 ; [#uses=1 type=float*]
  %weight_buf_1_addr_2 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_163 ; [#uses=1 type=float*]
  %weight_buf_1_addr_3 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_165 ; [#uses=1 type=float*]
  %weight_buf_1_addr_4 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_167 ; [#uses=1 type=float*]
  %weight_buf_1_addr_5 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_169 ; [#uses=1 type=float*]
  %weight_buf_1_addr_6 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_171 ; [#uses=1 type=float*]
  %weight_buf_1_addr_7 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_173 ; [#uses=1 type=float*]
  %weight_buf_1_addr_8 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_175 ; [#uses=1 type=float*]
  %weight_buf_1_addr_9 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_177 ; [#uses=1 type=float*]
  %weight_buf_1_addr_10 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_179 ; [#uses=1 type=float*]
  %weight_buf_1_addr_11 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_181 ; [#uses=1 type=float*]
  %weight_buf_1_addr_12 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_183 ; [#uses=1 type=float*]
  %weight_buf_1_addr_13 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_185 ; [#uses=1 type=float*]
  %weight_buf_1_addr_14 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_187 ; [#uses=1 type=float*]
  %weight_buf_1_addr_15 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_189 ; [#uses=1 type=float*]
  %weight_buf_1_addr_16 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_191 ; [#uses=1 type=float*]
  %weight_buf_1_addr_17 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_193 ; [#uses=1 type=float*]
  %weight_buf_1_addr_18 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_195 ; [#uses=1 type=float*]
  %weight_buf_1_addr_19 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_197 ; [#uses=1 type=float*]
  %weight_buf_1_addr_20 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_199 ; [#uses=1 type=float*]
  %weight_buf_1_addr_21 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_201 ; [#uses=1 type=float*]
  %weight_buf_1_addr_22 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_203 ; [#uses=1 type=float*]
  %weight_buf_1_addr_23 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_205 ; [#uses=1 type=float*]
  %weight_buf_1_addr_24 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_207 ; [#uses=1 type=float*]
  %weight_buf_1_addr_25 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_209 ; [#uses=1 type=float*]
  %weight_buf_1_addr_26 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_211 ; [#uses=1 type=float*]
  %weight_buf_1_addr_27 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_213 ; [#uses=1 type=float*]
  %weight_buf_1_addr_28 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_215 ; [#uses=1 type=float*]
  %weight_buf_1_addr_29 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_217 ; [#uses=1 type=float*]
  %weight_buf_1_addr_30 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_219 ; [#uses=1 type=float*]
  %weight_buf_1_addr_31 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_221 ; [#uses=1 type=float*]
  %weight_buf_1_addr_32 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_223 ; [#uses=1 type=float*]
  %weight_buf_1_addr_33 = getelementptr [320 x float]* %weight_buf_1, i64 0, i64 %tmp_225 ; [#uses=1 type=float*]
  %weight_buf_2_addr_2 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_163 ; [#uses=1 type=float*]
  %weight_buf_2_addr_3 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_165 ; [#uses=1 type=float*]
  %weight_buf_2_addr_4 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_167 ; [#uses=1 type=float*]
  %weight_buf_2_addr_5 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_169 ; [#uses=1 type=float*]
  %weight_buf_2_addr_6 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_171 ; [#uses=1 type=float*]
  %weight_buf_2_addr_7 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_173 ; [#uses=1 type=float*]
  %weight_buf_2_addr_8 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_175 ; [#uses=1 type=float*]
  %weight_buf_2_addr_9 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_177 ; [#uses=1 type=float*]
  %weight_buf_2_addr_10 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_179 ; [#uses=1 type=float*]
  %weight_buf_2_addr_11 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_181 ; [#uses=1 type=float*]
  %weight_buf_2_addr_12 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_183 ; [#uses=1 type=float*]
  %weight_buf_2_addr_13 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_185 ; [#uses=1 type=float*]
  %weight_buf_2_addr_14 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_187 ; [#uses=1 type=float*]
  %weight_buf_2_addr_15 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_189 ; [#uses=1 type=float*]
  %weight_buf_2_addr_16 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_191 ; [#uses=1 type=float*]
  %weight_buf_2_addr_17 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_193 ; [#uses=1 type=float*]
  %weight_buf_2_addr_18 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_195 ; [#uses=1 type=float*]
  %weight_buf_2_addr_19 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_197 ; [#uses=1 type=float*]
  %weight_buf_2_addr_20 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_199 ; [#uses=1 type=float*]
  %weight_buf_2_addr_21 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_201 ; [#uses=1 type=float*]
  %weight_buf_2_addr_22 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_203 ; [#uses=1 type=float*]
  %weight_buf_2_addr_23 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_205 ; [#uses=1 type=float*]
  %weight_buf_2_addr_24 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_207 ; [#uses=1 type=float*]
  %weight_buf_2_addr_25 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_209 ; [#uses=1 type=float*]
  %weight_buf_2_addr_26 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_211 ; [#uses=1 type=float*]
  %weight_buf_2_addr_27 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_213 ; [#uses=1 type=float*]
  %weight_buf_2_addr_28 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_215 ; [#uses=1 type=float*]
  %weight_buf_2_addr_29 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_217 ; [#uses=1 type=float*]
  %weight_buf_2_addr_30 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_219 ; [#uses=1 type=float*]
  %weight_buf_2_addr_31 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_221 ; [#uses=1 type=float*]
  %weight_buf_2_addr_32 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_223 ; [#uses=1 type=float*]
  %weight_buf_2_addr_33 = getelementptr [320 x float]* %weight_buf_2, i64 0, i64 %tmp_225 ; [#uses=1 type=float*]
  %weight_buf_3_addr_2 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_163 ; [#uses=1 type=float*]
  %weight_buf_3_addr_3 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_165 ; [#uses=1 type=float*]
  %weight_buf_3_addr_4 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_167 ; [#uses=1 type=float*]
  %weight_buf_3_addr_5 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_169 ; [#uses=1 type=float*]
  %weight_buf_3_addr_6 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_171 ; [#uses=1 type=float*]
  %weight_buf_3_addr_7 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_173 ; [#uses=1 type=float*]
  %weight_buf_3_addr_8 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_175 ; [#uses=1 type=float*]
  %weight_buf_3_addr_9 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_177 ; [#uses=1 type=float*]
  %weight_buf_3_addr_10 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_179 ; [#uses=1 type=float*]
  %weight_buf_3_addr_11 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_181 ; [#uses=1 type=float*]
  %weight_buf_3_addr_12 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_183 ; [#uses=1 type=float*]
  %weight_buf_3_addr_13 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_185 ; [#uses=1 type=float*]
  %weight_buf_3_addr_14 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_187 ; [#uses=1 type=float*]
  %weight_buf_3_addr_15 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_189 ; [#uses=1 type=float*]
  %weight_buf_3_addr_16 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_191 ; [#uses=1 type=float*]
  %weight_buf_3_addr_17 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_193 ; [#uses=1 type=float*]
  %weight_buf_3_addr_18 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_195 ; [#uses=1 type=float*]
  %weight_buf_3_addr_19 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_197 ; [#uses=1 type=float*]
  %weight_buf_3_addr_20 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_199 ; [#uses=1 type=float*]
  %weight_buf_3_addr_21 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_201 ; [#uses=1 type=float*]
  %weight_buf_3_addr_22 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_203 ; [#uses=1 type=float*]
  %weight_buf_3_addr_23 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_205 ; [#uses=1 type=float*]
  %weight_buf_3_addr_24 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_207 ; [#uses=1 type=float*]
  %weight_buf_3_addr_25 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_209 ; [#uses=1 type=float*]
  %weight_buf_3_addr_26 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_211 ; [#uses=1 type=float*]
  %weight_buf_3_addr_27 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_213 ; [#uses=1 type=float*]
  %weight_buf_3_addr_28 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_215 ; [#uses=1 type=float*]
  %weight_buf_3_addr_29 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_217 ; [#uses=1 type=float*]
  %weight_buf_3_addr_30 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_219 ; [#uses=1 type=float*]
  %weight_buf_3_addr_31 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_221 ; [#uses=1 type=float*]
  %weight_buf_3_addr_32 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_223 ; [#uses=1 type=float*]
  %weight_buf_3_addr_33 = getelementptr [320 x float]* %weight_buf_3, i64 0, i64 %tmp_225 ; [#uses=1 type=float*]
  %weight_buf_4_addr_2 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_163 ; [#uses=1 type=float*]
  %weight_buf_4_addr_3 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_165 ; [#uses=1 type=float*]
  %weight_buf_4_addr_4 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_167 ; [#uses=1 type=float*]
  %weight_buf_4_addr_5 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_169 ; [#uses=1 type=float*]
  %weight_buf_4_addr_6 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_171 ; [#uses=1 type=float*]
  %weight_buf_4_addr_7 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_173 ; [#uses=1 type=float*]
  %weight_buf_4_addr_8 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_175 ; [#uses=1 type=float*]
  %weight_buf_4_addr_9 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_177 ; [#uses=1 type=float*]
  %weight_buf_4_addr_10 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_179 ; [#uses=1 type=float*]
  %weight_buf_4_addr_11 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_181 ; [#uses=1 type=float*]
  %weight_buf_4_addr_12 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_183 ; [#uses=1 type=float*]
  %weight_buf_4_addr_13 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_185 ; [#uses=1 type=float*]
  %weight_buf_4_addr_14 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_187 ; [#uses=1 type=float*]
  %weight_buf_4_addr_15 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_189 ; [#uses=1 type=float*]
  %weight_buf_4_addr_16 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_191 ; [#uses=1 type=float*]
  %weight_buf_4_addr_17 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_193 ; [#uses=1 type=float*]
  %weight_buf_4_addr_18 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_195 ; [#uses=1 type=float*]
  %weight_buf_4_addr_19 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_197 ; [#uses=1 type=float*]
  %weight_buf_4_addr_20 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_199 ; [#uses=1 type=float*]
  %weight_buf_4_addr_21 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_201 ; [#uses=1 type=float*]
  %weight_buf_4_addr_22 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_203 ; [#uses=1 type=float*]
  %weight_buf_4_addr_23 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_205 ; [#uses=1 type=float*]
  %weight_buf_4_addr_24 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_207 ; [#uses=1 type=float*]
  %weight_buf_4_addr_25 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_209 ; [#uses=1 type=float*]
  %weight_buf_4_addr_26 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_211 ; [#uses=1 type=float*]
  %weight_buf_4_addr_27 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_213 ; [#uses=1 type=float*]
  %weight_buf_4_addr_28 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_215 ; [#uses=1 type=float*]
  %weight_buf_4_addr_29 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_217 ; [#uses=1 type=float*]
  %weight_buf_4_addr_30 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_219 ; [#uses=1 type=float*]
  %weight_buf_4_addr_31 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_221 ; [#uses=1 type=float*]
  %weight_buf_4_addr_32 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_223 ; [#uses=1 type=float*]
  %weight_buf_4_addr_33 = getelementptr [320 x float]* %weight_buf_4, i64 0, i64 %tmp_225 ; [#uses=1 type=float*]
  %weight_buf_5_addr_2 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_163 ; [#uses=1 type=float*]
  %weight_buf_5_addr_3 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_165 ; [#uses=1 type=float*]
  %weight_buf_5_addr_4 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_167 ; [#uses=1 type=float*]
  %weight_buf_5_addr_5 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_169 ; [#uses=1 type=float*]
  %weight_buf_5_addr_6 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_171 ; [#uses=1 type=float*]
  %weight_buf_5_addr_7 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_173 ; [#uses=1 type=float*]
  %weight_buf_5_addr_8 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_175 ; [#uses=1 type=float*]
  %weight_buf_5_addr_9 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_177 ; [#uses=1 type=float*]
  %weight_buf_5_addr_10 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_179 ; [#uses=1 type=float*]
  %weight_buf_5_addr_11 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_181 ; [#uses=1 type=float*]
  %weight_buf_5_addr_12 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_183 ; [#uses=1 type=float*]
  %weight_buf_5_addr_13 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_185 ; [#uses=1 type=float*]
  %weight_buf_5_addr_14 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_187 ; [#uses=1 type=float*]
  %weight_buf_5_addr_15 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_189 ; [#uses=1 type=float*]
  %weight_buf_5_addr_16 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_191 ; [#uses=1 type=float*]
  %weight_buf_5_addr_17 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_193 ; [#uses=1 type=float*]
  %weight_buf_5_addr_18 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_195 ; [#uses=1 type=float*]
  %weight_buf_5_addr_19 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_197 ; [#uses=1 type=float*]
  %weight_buf_5_addr_20 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_199 ; [#uses=1 type=float*]
  %weight_buf_5_addr_21 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_201 ; [#uses=1 type=float*]
  %weight_buf_5_addr_22 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_203 ; [#uses=1 type=float*]
  %weight_buf_5_addr_23 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_205 ; [#uses=1 type=float*]
  %weight_buf_5_addr_24 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_207 ; [#uses=1 type=float*]
  %weight_buf_5_addr_25 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_209 ; [#uses=1 type=float*]
  %weight_buf_5_addr_26 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_211 ; [#uses=1 type=float*]
  %weight_buf_5_addr_27 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_213 ; [#uses=1 type=float*]
  %weight_buf_5_addr_28 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_215 ; [#uses=1 type=float*]
  %weight_buf_5_addr_29 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_217 ; [#uses=1 type=float*]
  %weight_buf_5_addr_30 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_219 ; [#uses=1 type=float*]
  %weight_buf_5_addr_31 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_221 ; [#uses=1 type=float*]
  %weight_buf_5_addr_32 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_223 ; [#uses=1 type=float*]
  %weight_buf_5_addr_33 = getelementptr [320 x float]* %weight_buf_5, i64 0, i64 %tmp_225 ; [#uses=1 type=float*]
  %weight_buf_6_addr_2 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_163 ; [#uses=1 type=float*]
  %weight_buf_6_addr_3 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_165 ; [#uses=1 type=float*]
  %weight_buf_6_addr_4 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_167 ; [#uses=1 type=float*]
  %weight_buf_6_addr_5 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_169 ; [#uses=1 type=float*]
  %weight_buf_6_addr_6 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_171 ; [#uses=1 type=float*]
  %weight_buf_6_addr_7 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_173 ; [#uses=1 type=float*]
  %weight_buf_6_addr_8 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_175 ; [#uses=1 type=float*]
  %weight_buf_6_addr_9 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_177 ; [#uses=1 type=float*]
  %weight_buf_6_addr_10 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_179 ; [#uses=1 type=float*]
  %weight_buf_6_addr_11 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_181 ; [#uses=1 type=float*]
  %weight_buf_6_addr_12 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_183 ; [#uses=1 type=float*]
  %weight_buf_6_addr_13 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_185 ; [#uses=1 type=float*]
  %weight_buf_6_addr_14 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_187 ; [#uses=1 type=float*]
  %weight_buf_6_addr_15 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_189 ; [#uses=1 type=float*]
  %weight_buf_6_addr_16 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_191 ; [#uses=1 type=float*]
  %weight_buf_6_addr_17 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_193 ; [#uses=1 type=float*]
  %weight_buf_6_addr_18 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_195 ; [#uses=1 type=float*]
  %weight_buf_6_addr_19 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_197 ; [#uses=1 type=float*]
  %weight_buf_6_addr_20 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_199 ; [#uses=1 type=float*]
  %weight_buf_6_addr_21 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_201 ; [#uses=1 type=float*]
  %weight_buf_6_addr_22 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_203 ; [#uses=1 type=float*]
  %weight_buf_6_addr_23 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_205 ; [#uses=1 type=float*]
  %weight_buf_6_addr_24 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_207 ; [#uses=1 type=float*]
  %weight_buf_6_addr_25 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_209 ; [#uses=1 type=float*]
  %weight_buf_6_addr_26 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_211 ; [#uses=1 type=float*]
  %weight_buf_6_addr_27 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_213 ; [#uses=1 type=float*]
  %weight_buf_6_addr_28 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_215 ; [#uses=1 type=float*]
  %weight_buf_6_addr_29 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_217 ; [#uses=1 type=float*]
  %weight_buf_6_addr_30 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_219 ; [#uses=1 type=float*]
  %weight_buf_6_addr_31 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_221 ; [#uses=1 type=float*]
  %weight_buf_6_addr_32 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_223 ; [#uses=1 type=float*]
  %weight_buf_6_addr_33 = getelementptr [320 x float]* %weight_buf_6, i64 0, i64 %tmp_225 ; [#uses=1 type=float*]
  %weight_buf_7_addr_2 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_163 ; [#uses=1 type=float*]
  %weight_buf_7_addr_3 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_165 ; [#uses=1 type=float*]
  %weight_buf_7_addr_4 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_167 ; [#uses=1 type=float*]
  %weight_buf_7_addr_5 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_169 ; [#uses=1 type=float*]
  %weight_buf_7_addr_6 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_171 ; [#uses=1 type=float*]
  %weight_buf_7_addr_7 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_173 ; [#uses=1 type=float*]
  %weight_buf_7_addr_8 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_175 ; [#uses=1 type=float*]
  %weight_buf_7_addr_9 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_177 ; [#uses=1 type=float*]
  %weight_buf_7_addr_10 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_179 ; [#uses=1 type=float*]
  %weight_buf_7_addr_11 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_181 ; [#uses=1 type=float*]
  %weight_buf_7_addr_12 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_183 ; [#uses=1 type=float*]
  %weight_buf_7_addr_13 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_185 ; [#uses=1 type=float*]
  %weight_buf_7_addr_14 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_187 ; [#uses=1 type=float*]
  %weight_buf_7_addr_15 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_189 ; [#uses=1 type=float*]
  %weight_buf_7_addr_16 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_191 ; [#uses=1 type=float*]
  %weight_buf_7_addr_17 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_193 ; [#uses=1 type=float*]
  %weight_buf_7_addr_18 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_195 ; [#uses=1 type=float*]
  %weight_buf_7_addr_19 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_197 ; [#uses=1 type=float*]
  %weight_buf_7_addr_20 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_199 ; [#uses=1 type=float*]
  %weight_buf_7_addr_21 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_201 ; [#uses=1 type=float*]
  %weight_buf_7_addr_22 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_203 ; [#uses=1 type=float*]
  %weight_buf_7_addr_23 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_205 ; [#uses=1 type=float*]
  %weight_buf_7_addr_24 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_207 ; [#uses=1 type=float*]
  %weight_buf_7_addr_25 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_209 ; [#uses=1 type=float*]
  %weight_buf_7_addr_26 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_211 ; [#uses=1 type=float*]
  %weight_buf_7_addr_27 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_213 ; [#uses=1 type=float*]
  %weight_buf_7_addr_28 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_215 ; [#uses=1 type=float*]
  %weight_buf_7_addr_29 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_217 ; [#uses=1 type=float*]
  %weight_buf_7_addr_30 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_219 ; [#uses=1 type=float*]
  %weight_buf_7_addr_31 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_221 ; [#uses=1 type=float*]
  %weight_buf_7_addr_32 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_223 ; [#uses=1 type=float*]
  %weight_buf_7_addr_33 = getelementptr [320 x float]* %weight_buf_7, i64 0, i64 %tmp_225 ; [#uses=1 type=float*]
  %tmp_226 = add i12 %tmp_161, %tmp_31_cast, !dbg !2872 ; [#uses=1 type=i12] [debug line = 76:5]
  %tmp_226_cast = zext i12 %tmp_226 to i64, !dbg !2872 ; [#uses=1 type=i64] [debug line = 76:5]
  %out_buf_addr_2 = getelementptr [1280 x float]* %out_buf, i64 0, i64 %tmp_226_cast, !dbg !2872 ; [#uses=1 type=float*] [debug line = 76:5]
  %offset_buf_addr_2 = getelementptr inbounds [10 x float]* %offset_buf, i64 0, i64 %tmp_31, !dbg !2875 ; [#uses=1 type=float*] [debug line = 72:26]
  %tmp = load float* %offset_buf_addr_2, align 4, !dbg !2875 ; [#uses=1 type=float] [debug line = 72:26]
  call void @llvm.dbg.value(metadata !{float %tmp}, i64 0, metadata !2876), !dbg !2875 ; [debug line = 72:26] [debug variable = tmp]
  %weight_buf_0_load = load float* %weight_buf_0_addr_2, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_33 = fmul float %in_buf_0_load, %weight_buf_0_load, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_34 = fadd float %tmp, %tmp_33, !dbg !2868  ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_1 = load float* %weight_buf_0_addr_3, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_1 = fmul float %in_buf_0_load_1, %weight_buf_0_load_1, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_1 = fadd float %tmp_34, %tmp_43_1, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_2 = load float* %weight_buf_0_addr_4, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_2 = fmul float %in_buf_0_load_2, %weight_buf_0_load_2, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_2 = fadd float %tmp_44_1, %tmp_43_2, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_3 = load float* %weight_buf_0_addr_5, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_3 = fmul float %in_buf_0_load_3, %weight_buf_0_load_3, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_3 = fadd float %tmp_44_2, %tmp_43_3, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_4 = load float* %weight_buf_0_addr_6, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_4 = fmul float %in_buf_0_load_4, %weight_buf_0_load_4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_4 = fadd float %tmp_44_3, %tmp_43_4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_5 = load float* %weight_buf_0_addr_7, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_5 = fmul float %in_buf_0_load_5, %weight_buf_0_load_5, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_5 = fadd float %tmp_44_4, %tmp_43_5, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_6 = load float* %weight_buf_0_addr_8, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_6 = fmul float %in_buf_0_load_6, %weight_buf_0_load_6, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_6 = fadd float %tmp_44_5, %tmp_43_6, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_7 = load float* %weight_buf_0_addr_9, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_7 = fmul float %in_buf_0_load_7, %weight_buf_0_load_7, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_7 = fadd float %tmp_44_6, %tmp_43_7, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_8 = load float* %weight_buf_0_addr_10, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_8 = fmul float %in_buf_0_load_8, %weight_buf_0_load_8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_8 = fadd float %tmp_44_7, %tmp_43_8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_9 = load float* %weight_buf_0_addr_11, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_9 = fmul float %in_buf_0_load_9, %weight_buf_0_load_9, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_9 = fadd float %tmp_44_8, %tmp_43_9, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_10 = load float* %weight_buf_0_addr_12, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_s = fmul float %in_buf_0_load_10, %weight_buf_0_load_10, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_s = fadd float %tmp_44_9, %tmp_43_s, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_11 = load float* %weight_buf_0_addr_13, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_10 = fmul float %in_buf_0_load_11, %weight_buf_0_load_11, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_10 = fadd float %tmp_44_s, %tmp_43_10, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_12 = load float* %weight_buf_0_addr_14, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_11 = fmul float %in_buf_0_load_12, %weight_buf_0_load_12, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_11 = fadd float %tmp_44_10, %tmp_43_11, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_13 = load float* %weight_buf_0_addr_15, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_12 = fmul float %in_buf_0_load_13, %weight_buf_0_load_13, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_12 = fadd float %tmp_44_11, %tmp_43_12, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_14 = load float* %weight_buf_0_addr_16, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_13 = fmul float %in_buf_0_load_14, %weight_buf_0_load_14, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_13 = fadd float %tmp_44_12, %tmp_43_13, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_15 = load float* %weight_buf_0_addr_17, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_14 = fmul float %in_buf_0_load_15, %weight_buf_0_load_15, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_14 = fadd float %tmp_44_13, %tmp_43_14, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_16 = load float* %weight_buf_0_addr_18, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_15 = fmul float %in_buf_0_load_16, %weight_buf_0_load_16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_15 = fadd float %tmp_44_14, %tmp_43_15, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_17 = load float* %weight_buf_0_addr_19, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_16 = fmul float %in_buf_0_load_17, %weight_buf_0_load_17, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_16 = fadd float %tmp_44_15, %tmp_43_16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_18 = load float* %weight_buf_0_addr_20, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_17 = fmul float %in_buf_0_load_18, %weight_buf_0_load_18, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_17 = fadd float %tmp_44_16, %tmp_43_17, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_19 = load float* %weight_buf_0_addr_21, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_18 = fmul float %in_buf_0_load_19, %weight_buf_0_load_19, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_18 = fadd float %tmp_44_17, %tmp_43_18, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_20 = load float* %weight_buf_0_addr_22, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_19 = fmul float %in_buf_0_load_20, %weight_buf_0_load_20, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_19 = fadd float %tmp_44_18, %tmp_43_19, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_21 = load float* %weight_buf_0_addr_23, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_20 = fmul float %in_buf_0_load_21, %weight_buf_0_load_21, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_20 = fadd float %tmp_44_19, %tmp_43_20, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_22 = load float* %weight_buf_0_addr_24, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_21 = fmul float %in_buf_0_load_22, %weight_buf_0_load_22, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_21 = fadd float %tmp_44_20, %tmp_43_21, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_23 = load float* %weight_buf_0_addr_25, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_22 = fmul float %in_buf_0_load_23, %weight_buf_0_load_23, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_22 = fadd float %tmp_44_21, %tmp_43_22, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_24 = load float* %weight_buf_0_addr_26, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_23 = fmul float %in_buf_0_load_24, %weight_buf_0_load_24, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_23 = fadd float %tmp_44_22, %tmp_43_23, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_25 = load float* %weight_buf_0_addr_27, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_24 = fmul float %in_buf_0_load_25, %weight_buf_0_load_25, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_24 = fadd float %tmp_44_23, %tmp_43_24, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_26 = load float* %weight_buf_0_addr_28, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_25 = fmul float %in_buf_0_load_26, %weight_buf_0_load_26, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_25 = fadd float %tmp_44_24, %tmp_43_25, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_27 = load float* %weight_buf_0_addr_29, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_26 = fmul float %in_buf_0_load_27, %weight_buf_0_load_27, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_26 = fadd float %tmp_44_25, %tmp_43_26, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_28 = load float* %weight_buf_0_addr_30, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_27 = fmul float %in_buf_0_load_28, %weight_buf_0_load_28, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_27 = fadd float %tmp_44_26, %tmp_43_27, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_29 = load float* %weight_buf_0_addr_31, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_28 = fmul float %in_buf_0_load_29, %weight_buf_0_load_29, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_28 = fadd float %tmp_44_27, %tmp_43_28, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_30 = load float* %weight_buf_0_addr_32, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_29 = fmul float %in_buf_0_load_30, %weight_buf_0_load_30, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_29 = fadd float %tmp_44_28, %tmp_43_29, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_31 = load float* %weight_buf_0_addr_33, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_30 = fmul float %in_buf_0_load_31, %weight_buf_0_load_31, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_30 = fadd float %tmp_44_29, %tmp_43_30, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load = load float* %weight_buf_1_addr_2, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_31 = fmul float %in_buf_1_load, %weight_buf_1_load, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_31 = fadd float %tmp_44_30, %tmp_43_31, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_1 = load float* %weight_buf_1_addr_3, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_32 = fmul float %in_buf_1_load_1, %weight_buf_1_load_1, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_32 = fadd float %tmp_44_31, %tmp_43_32, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_2 = load float* %weight_buf_1_addr_4, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_33 = fmul float %in_buf_1_load_2, %weight_buf_1_load_2, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_33 = fadd float %tmp_44_32, %tmp_43_33, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_3 = load float* %weight_buf_1_addr_5, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_34 = fmul float %in_buf_1_load_3, %weight_buf_1_load_3, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_34 = fadd float %tmp_44_33, %tmp_43_34, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_4 = load float* %weight_buf_1_addr_6, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_35 = fmul float %in_buf_1_load_4, %weight_buf_1_load_4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_35 = fadd float %tmp_44_34, %tmp_43_35, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_5 = load float* %weight_buf_1_addr_7, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_36 = fmul float %in_buf_1_load_5, %weight_buf_1_load_5, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_36 = fadd float %tmp_44_35, %tmp_43_36, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_6 = load float* %weight_buf_1_addr_8, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_37 = fmul float %in_buf_1_load_6, %weight_buf_1_load_6, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_37 = fadd float %tmp_44_36, %tmp_43_37, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_7 = load float* %weight_buf_1_addr_9, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_38 = fmul float %in_buf_1_load_7, %weight_buf_1_load_7, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_38 = fadd float %tmp_44_37, %tmp_43_38, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_8 = load float* %weight_buf_1_addr_10, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_39 = fmul float %in_buf_1_load_8, %weight_buf_1_load_8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_39 = fadd float %tmp_44_38, %tmp_43_39, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_9 = load float* %weight_buf_1_addr_11, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_40 = fmul float %in_buf_1_load_9, %weight_buf_1_load_9, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_40 = fadd float %tmp_44_39, %tmp_43_40, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_10 = load float* %weight_buf_1_addr_12, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_41 = fmul float %in_buf_1_load_10, %weight_buf_1_load_10, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_41 = fadd float %tmp_44_40, %tmp_43_41, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_11 = load float* %weight_buf_1_addr_13, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_42 = fmul float %in_buf_1_load_11, %weight_buf_1_load_11, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_42 = fadd float %tmp_44_41, %tmp_43_42, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_12 = load float* %weight_buf_1_addr_14, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_43 = fmul float %in_buf_1_load_12, %weight_buf_1_load_12, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_43 = fadd float %tmp_44_42, %tmp_43_43, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_13 = load float* %weight_buf_1_addr_15, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_44 = fmul float %in_buf_1_load_13, %weight_buf_1_load_13, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_44 = fadd float %tmp_44_43, %tmp_43_44, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_14 = load float* %weight_buf_1_addr_16, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_45 = fmul float %in_buf_1_load_14, %weight_buf_1_load_14, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_45 = fadd float %tmp_44_44, %tmp_43_45, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_15 = load float* %weight_buf_1_addr_17, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_46 = fmul float %in_buf_1_load_15, %weight_buf_1_load_15, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_46 = fadd float %tmp_44_45, %tmp_43_46, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_16 = load float* %weight_buf_1_addr_18, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_47 = fmul float %in_buf_1_load_16, %weight_buf_1_load_16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_47 = fadd float %tmp_44_46, %tmp_43_47, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_17 = load float* %weight_buf_1_addr_19, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_48 = fmul float %in_buf_1_load_17, %weight_buf_1_load_17, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_48 = fadd float %tmp_44_47, %tmp_43_48, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_18 = load float* %weight_buf_1_addr_20, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_49 = fmul float %in_buf_1_load_18, %weight_buf_1_load_18, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_49 = fadd float %tmp_44_48, %tmp_43_49, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_19 = load float* %weight_buf_1_addr_21, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_50 = fmul float %in_buf_1_load_19, %weight_buf_1_load_19, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_50 = fadd float %tmp_44_49, %tmp_43_50, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_20 = load float* %weight_buf_1_addr_22, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_51 = fmul float %in_buf_1_load_20, %weight_buf_1_load_20, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_51 = fadd float %tmp_44_50, %tmp_43_51, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_21 = load float* %weight_buf_1_addr_23, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_52 = fmul float %in_buf_1_load_21, %weight_buf_1_load_21, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_52 = fadd float %tmp_44_51, %tmp_43_52, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_22 = load float* %weight_buf_1_addr_24, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_53 = fmul float %in_buf_1_load_22, %weight_buf_1_load_22, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_53 = fadd float %tmp_44_52, %tmp_43_53, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_23 = load float* %weight_buf_1_addr_25, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_54 = fmul float %in_buf_1_load_23, %weight_buf_1_load_23, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_54 = fadd float %tmp_44_53, %tmp_43_54, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_24 = load float* %weight_buf_1_addr_26, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_55 = fmul float %in_buf_1_load_24, %weight_buf_1_load_24, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_55 = fadd float %tmp_44_54, %tmp_43_55, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_25 = load float* %weight_buf_1_addr_27, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_56 = fmul float %in_buf_1_load_25, %weight_buf_1_load_25, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_56 = fadd float %tmp_44_55, %tmp_43_56, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_26 = load float* %weight_buf_1_addr_28, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_57 = fmul float %in_buf_1_load_26, %weight_buf_1_load_26, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_57 = fadd float %tmp_44_56, %tmp_43_57, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_27 = load float* %weight_buf_1_addr_29, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_58 = fmul float %in_buf_1_load_27, %weight_buf_1_load_27, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_58 = fadd float %tmp_44_57, %tmp_43_58, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_28 = load float* %weight_buf_1_addr_30, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_59 = fmul float %in_buf_1_load_28, %weight_buf_1_load_28, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_59 = fadd float %tmp_44_58, %tmp_43_59, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_29 = load float* %weight_buf_1_addr_31, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_60 = fmul float %in_buf_1_load_29, %weight_buf_1_load_29, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_60 = fadd float %tmp_44_59, %tmp_43_60, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_30 = load float* %weight_buf_1_addr_32, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_61 = fmul float %in_buf_1_load_30, %weight_buf_1_load_30, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_61 = fadd float %tmp_44_60, %tmp_43_61, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_31 = load float* %weight_buf_1_addr_33, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_62 = fmul float %in_buf_1_load_31, %weight_buf_1_load_31, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_62 = fadd float %tmp_44_61, %tmp_43_62, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load = load float* %weight_buf_2_addr_2, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_63 = fmul float %in_buf_2_load, %weight_buf_2_load, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_63 = fadd float %tmp_44_62, %tmp_43_63, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_1 = load float* %weight_buf_2_addr_3, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_64 = fmul float %in_buf_2_load_1, %weight_buf_2_load_1, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_64 = fadd float %tmp_44_63, %tmp_43_64, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_2 = load float* %weight_buf_2_addr_4, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_65 = fmul float %in_buf_2_load_2, %weight_buf_2_load_2, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_65 = fadd float %tmp_44_64, %tmp_43_65, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_3 = load float* %weight_buf_2_addr_5, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_66 = fmul float %in_buf_2_load_3, %weight_buf_2_load_3, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_66 = fadd float %tmp_44_65, %tmp_43_66, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_4 = load float* %weight_buf_2_addr_6, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_67 = fmul float %in_buf_2_load_4, %weight_buf_2_load_4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_67 = fadd float %tmp_44_66, %tmp_43_67, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_5 = load float* %weight_buf_2_addr_7, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_68 = fmul float %in_buf_2_load_5, %weight_buf_2_load_5, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_68 = fadd float %tmp_44_67, %tmp_43_68, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_6 = load float* %weight_buf_2_addr_8, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_69 = fmul float %in_buf_2_load_6, %weight_buf_2_load_6, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_69 = fadd float %tmp_44_68, %tmp_43_69, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_7 = load float* %weight_buf_2_addr_9, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_70 = fmul float %in_buf_2_load_7, %weight_buf_2_load_7, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_70 = fadd float %tmp_44_69, %tmp_43_70, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_8 = load float* %weight_buf_2_addr_10, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_71 = fmul float %in_buf_2_load_8, %weight_buf_2_load_8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_71 = fadd float %tmp_44_70, %tmp_43_71, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_9 = load float* %weight_buf_2_addr_11, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_72 = fmul float %in_buf_2_load_9, %weight_buf_2_load_9, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_72 = fadd float %tmp_44_71, %tmp_43_72, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_10 = load float* %weight_buf_2_addr_12, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_73 = fmul float %in_buf_2_load_10, %weight_buf_2_load_10, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_73 = fadd float %tmp_44_72, %tmp_43_73, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_11 = load float* %weight_buf_2_addr_13, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_74 = fmul float %in_buf_2_load_11, %weight_buf_2_load_11, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_74 = fadd float %tmp_44_73, %tmp_43_74, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_12 = load float* %weight_buf_2_addr_14, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_75 = fmul float %in_buf_2_load_12, %weight_buf_2_load_12, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_75 = fadd float %tmp_44_74, %tmp_43_75, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_13 = load float* %weight_buf_2_addr_15, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_76 = fmul float %in_buf_2_load_13, %weight_buf_2_load_13, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_76 = fadd float %tmp_44_75, %tmp_43_76, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_14 = load float* %weight_buf_2_addr_16, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_77 = fmul float %in_buf_2_load_14, %weight_buf_2_load_14, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_77 = fadd float %tmp_44_76, %tmp_43_77, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_15 = load float* %weight_buf_2_addr_17, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_78 = fmul float %in_buf_2_load_15, %weight_buf_2_load_15, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_78 = fadd float %tmp_44_77, %tmp_43_78, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_16 = load float* %weight_buf_2_addr_18, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_79 = fmul float %in_buf_2_load_16, %weight_buf_2_load_16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_79 = fadd float %tmp_44_78, %tmp_43_79, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_17 = load float* %weight_buf_2_addr_19, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_80 = fmul float %in_buf_2_load_17, %weight_buf_2_load_17, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_80 = fadd float %tmp_44_79, %tmp_43_80, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_18 = load float* %weight_buf_2_addr_20, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_81 = fmul float %in_buf_2_load_18, %weight_buf_2_load_18, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_81 = fadd float %tmp_44_80, %tmp_43_81, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_19 = load float* %weight_buf_2_addr_21, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_82 = fmul float %in_buf_2_load_19, %weight_buf_2_load_19, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_82 = fadd float %tmp_44_81, %tmp_43_82, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_20 = load float* %weight_buf_2_addr_22, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_83 = fmul float %in_buf_2_load_20, %weight_buf_2_load_20, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_83 = fadd float %tmp_44_82, %tmp_43_83, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_21 = load float* %weight_buf_2_addr_23, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_84 = fmul float %in_buf_2_load_21, %weight_buf_2_load_21, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_84 = fadd float %tmp_44_83, %tmp_43_84, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_22 = load float* %weight_buf_2_addr_24, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_85 = fmul float %in_buf_2_load_22, %weight_buf_2_load_22, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_85 = fadd float %tmp_44_84, %tmp_43_85, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_23 = load float* %weight_buf_2_addr_25, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_86 = fmul float %in_buf_2_load_23, %weight_buf_2_load_23, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_86 = fadd float %tmp_44_85, %tmp_43_86, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_24 = load float* %weight_buf_2_addr_26, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_87 = fmul float %in_buf_2_load_24, %weight_buf_2_load_24, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_87 = fadd float %tmp_44_86, %tmp_43_87, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_25 = load float* %weight_buf_2_addr_27, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_88 = fmul float %in_buf_2_load_25, %weight_buf_2_load_25, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_88 = fadd float %tmp_44_87, %tmp_43_88, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_26 = load float* %weight_buf_2_addr_28, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_89 = fmul float %in_buf_2_load_26, %weight_buf_2_load_26, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_89 = fadd float %tmp_44_88, %tmp_43_89, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_27 = load float* %weight_buf_2_addr_29, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_90 = fmul float %in_buf_2_load_27, %weight_buf_2_load_27, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_90 = fadd float %tmp_44_89, %tmp_43_90, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_28 = load float* %weight_buf_2_addr_30, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_91 = fmul float %in_buf_2_load_28, %weight_buf_2_load_28, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_91 = fadd float %tmp_44_90, %tmp_43_91, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_29 = load float* %weight_buf_2_addr_31, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_92 = fmul float %in_buf_2_load_29, %weight_buf_2_load_29, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_92 = fadd float %tmp_44_91, %tmp_43_92, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_30 = load float* %weight_buf_2_addr_32, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_93 = fmul float %in_buf_2_load_30, %weight_buf_2_load_30, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_93 = fadd float %tmp_44_92, %tmp_43_93, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_31 = load float* %weight_buf_2_addr_33, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_94 = fmul float %in_buf_2_load_31, %weight_buf_2_load_31, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_94 = fadd float %tmp_44_93, %tmp_43_94, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load = load float* %weight_buf_3_addr_2, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_95 = fmul float %in_buf_3_load, %weight_buf_3_load, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_95 = fadd float %tmp_44_94, %tmp_43_95, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_1 = load float* %weight_buf_3_addr_3, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_96 = fmul float %in_buf_3_load_1, %weight_buf_3_load_1, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_96 = fadd float %tmp_44_95, %tmp_43_96, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_2 = load float* %weight_buf_3_addr_4, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_97 = fmul float %in_buf_3_load_2, %weight_buf_3_load_2, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_97 = fadd float %tmp_44_96, %tmp_43_97, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_3 = load float* %weight_buf_3_addr_5, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_98 = fmul float %in_buf_3_load_3, %weight_buf_3_load_3, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_98 = fadd float %tmp_44_97, %tmp_43_98, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_4 = load float* %weight_buf_3_addr_6, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_99 = fmul float %in_buf_3_load_4, %weight_buf_3_load_4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_99 = fadd float %tmp_44_98, %tmp_43_99, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_5 = load float* %weight_buf_3_addr_7, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_100 = fmul float %in_buf_3_load_5, %weight_buf_3_load_5, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_100 = fadd float %tmp_44_99, %tmp_43_100, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_6 = load float* %weight_buf_3_addr_8, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_101 = fmul float %in_buf_3_load_6, %weight_buf_3_load_6, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_101 = fadd float %tmp_44_100, %tmp_43_101, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_7 = load float* %weight_buf_3_addr_9, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_102 = fmul float %in_buf_3_load_7, %weight_buf_3_load_7, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_102 = fadd float %tmp_44_101, %tmp_43_102, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_8 = load float* %weight_buf_3_addr_10, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_103 = fmul float %in_buf_3_load_8, %weight_buf_3_load_8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_103 = fadd float %tmp_44_102, %tmp_43_103, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_9 = load float* %weight_buf_3_addr_11, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_104 = fmul float %in_buf_3_load_9, %weight_buf_3_load_9, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_104 = fadd float %tmp_44_103, %tmp_43_104, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_10 = load float* %weight_buf_3_addr_12, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_105 = fmul float %in_buf_3_load_10, %weight_buf_3_load_10, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_105 = fadd float %tmp_44_104, %tmp_43_105, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_11 = load float* %weight_buf_3_addr_13, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_106 = fmul float %in_buf_3_load_11, %weight_buf_3_load_11, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_106 = fadd float %tmp_44_105, %tmp_43_106, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_12 = load float* %weight_buf_3_addr_14, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_107 = fmul float %in_buf_3_load_12, %weight_buf_3_load_12, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_107 = fadd float %tmp_44_106, %tmp_43_107, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_13 = load float* %weight_buf_3_addr_15, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_108 = fmul float %in_buf_3_load_13, %weight_buf_3_load_13, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_108 = fadd float %tmp_44_107, %tmp_43_108, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_14 = load float* %weight_buf_3_addr_16, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_109 = fmul float %in_buf_3_load_14, %weight_buf_3_load_14, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_109 = fadd float %tmp_44_108, %tmp_43_109, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_15 = load float* %weight_buf_3_addr_17, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_110 = fmul float %in_buf_3_load_15, %weight_buf_3_load_15, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_110 = fadd float %tmp_44_109, %tmp_43_110, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_16 = load float* %weight_buf_3_addr_18, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_111 = fmul float %in_buf_3_load_16, %weight_buf_3_load_16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_111 = fadd float %tmp_44_110, %tmp_43_111, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_17 = load float* %weight_buf_3_addr_19, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_112 = fmul float %in_buf_3_load_17, %weight_buf_3_load_17, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_112 = fadd float %tmp_44_111, %tmp_43_112, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_18 = load float* %weight_buf_3_addr_20, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_113 = fmul float %in_buf_3_load_18, %weight_buf_3_load_18, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_113 = fadd float %tmp_44_112, %tmp_43_113, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_19 = load float* %weight_buf_3_addr_21, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_114 = fmul float %in_buf_3_load_19, %weight_buf_3_load_19, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_114 = fadd float %tmp_44_113, %tmp_43_114, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_20 = load float* %weight_buf_3_addr_22, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_115 = fmul float %in_buf_3_load_20, %weight_buf_3_load_20, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_115 = fadd float %tmp_44_114, %tmp_43_115, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_21 = load float* %weight_buf_3_addr_23, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_116 = fmul float %in_buf_3_load_21, %weight_buf_3_load_21, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_116 = fadd float %tmp_44_115, %tmp_43_116, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_22 = load float* %weight_buf_3_addr_24, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_117 = fmul float %in_buf_3_load_22, %weight_buf_3_load_22, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_117 = fadd float %tmp_44_116, %tmp_43_117, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_23 = load float* %weight_buf_3_addr_25, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_118 = fmul float %in_buf_3_load_23, %weight_buf_3_load_23, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_118 = fadd float %tmp_44_117, %tmp_43_118, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_24 = load float* %weight_buf_3_addr_26, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_119 = fmul float %in_buf_3_load_24, %weight_buf_3_load_24, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_119 = fadd float %tmp_44_118, %tmp_43_119, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_25 = load float* %weight_buf_3_addr_27, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_120 = fmul float %in_buf_3_load_25, %weight_buf_3_load_25, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_120 = fadd float %tmp_44_119, %tmp_43_120, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_26 = load float* %weight_buf_3_addr_28, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_121 = fmul float %in_buf_3_load_26, %weight_buf_3_load_26, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_121 = fadd float %tmp_44_120, %tmp_43_121, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_27 = load float* %weight_buf_3_addr_29, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_122 = fmul float %in_buf_3_load_27, %weight_buf_3_load_27, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_122 = fadd float %tmp_44_121, %tmp_43_122, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_28 = load float* %weight_buf_3_addr_30, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_123 = fmul float %in_buf_3_load_28, %weight_buf_3_load_28, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_123 = fadd float %tmp_44_122, %tmp_43_123, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_29 = load float* %weight_buf_3_addr_31, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_124 = fmul float %in_buf_3_load_29, %weight_buf_3_load_29, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_124 = fadd float %tmp_44_123, %tmp_43_124, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_30 = load float* %weight_buf_3_addr_32, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_125 = fmul float %in_buf_3_load_30, %weight_buf_3_load_30, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_125 = fadd float %tmp_44_124, %tmp_43_125, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_31 = load float* %weight_buf_3_addr_33, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_126 = fmul float %in_buf_3_load_31, %weight_buf_3_load_31, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_126 = fadd float %tmp_44_125, %tmp_43_126, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load = load float* %weight_buf_4_addr_2, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_127 = fmul float %in_buf_4_load, %weight_buf_4_load, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_127 = fadd float %tmp_44_126, %tmp_43_127, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_1 = load float* %weight_buf_4_addr_3, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_128 = fmul float %in_buf_4_load_1, %weight_buf_4_load_1, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_128 = fadd float %tmp_44_127, %tmp_43_128, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_2 = load float* %weight_buf_4_addr_4, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_129 = fmul float %in_buf_4_load_2, %weight_buf_4_load_2, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_129 = fadd float %tmp_44_128, %tmp_43_129, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_3 = load float* %weight_buf_4_addr_5, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_130 = fmul float %in_buf_4_load_3, %weight_buf_4_load_3, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_130 = fadd float %tmp_44_129, %tmp_43_130, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_4 = load float* %weight_buf_4_addr_6, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_131 = fmul float %in_buf_4_load_4, %weight_buf_4_load_4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_131 = fadd float %tmp_44_130, %tmp_43_131, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_5 = load float* %weight_buf_4_addr_7, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_132 = fmul float %in_buf_4_load_5, %weight_buf_4_load_5, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_132 = fadd float %tmp_44_131, %tmp_43_132, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_6 = load float* %weight_buf_4_addr_8, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_133 = fmul float %in_buf_4_load_6, %weight_buf_4_load_6, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_133 = fadd float %tmp_44_132, %tmp_43_133, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_7 = load float* %weight_buf_4_addr_9, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_134 = fmul float %in_buf_4_load_7, %weight_buf_4_load_7, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_134 = fadd float %tmp_44_133, %tmp_43_134, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_8 = load float* %weight_buf_4_addr_10, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_135 = fmul float %in_buf_4_load_8, %weight_buf_4_load_8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_135 = fadd float %tmp_44_134, %tmp_43_135, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_9 = load float* %weight_buf_4_addr_11, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_136 = fmul float %in_buf_4_load_9, %weight_buf_4_load_9, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_136 = fadd float %tmp_44_135, %tmp_43_136, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_10 = load float* %weight_buf_4_addr_12, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_137 = fmul float %in_buf_4_load_10, %weight_buf_4_load_10, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_137 = fadd float %tmp_44_136, %tmp_43_137, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_11 = load float* %weight_buf_4_addr_13, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_138 = fmul float %in_buf_4_load_11, %weight_buf_4_load_11, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_138 = fadd float %tmp_44_137, %tmp_43_138, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_12 = load float* %weight_buf_4_addr_14, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_139 = fmul float %in_buf_4_load_12, %weight_buf_4_load_12, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_139 = fadd float %tmp_44_138, %tmp_43_139, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_13 = load float* %weight_buf_4_addr_15, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_140 = fmul float %in_buf_4_load_13, %weight_buf_4_load_13, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_140 = fadd float %tmp_44_139, %tmp_43_140, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_14 = load float* %weight_buf_4_addr_16, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_141 = fmul float %in_buf_4_load_14, %weight_buf_4_load_14, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_141 = fadd float %tmp_44_140, %tmp_43_141, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_15 = load float* %weight_buf_4_addr_17, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_142 = fmul float %in_buf_4_load_15, %weight_buf_4_load_15, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_142 = fadd float %tmp_44_141, %tmp_43_142, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_16 = load float* %weight_buf_4_addr_18, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_143 = fmul float %in_buf_4_load_16, %weight_buf_4_load_16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_143 = fadd float %tmp_44_142, %tmp_43_143, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_17 = load float* %weight_buf_4_addr_19, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_144 = fmul float %in_buf_4_load_17, %weight_buf_4_load_17, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_144 = fadd float %tmp_44_143, %tmp_43_144, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_18 = load float* %weight_buf_4_addr_20, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_145 = fmul float %in_buf_4_load_18, %weight_buf_4_load_18, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_145 = fadd float %tmp_44_144, %tmp_43_145, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_19 = load float* %weight_buf_4_addr_21, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_146 = fmul float %in_buf_4_load_19, %weight_buf_4_load_19, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_146 = fadd float %tmp_44_145, %tmp_43_146, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_20 = load float* %weight_buf_4_addr_22, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_147 = fmul float %in_buf_4_load_20, %weight_buf_4_load_20, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_147 = fadd float %tmp_44_146, %tmp_43_147, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_21 = load float* %weight_buf_4_addr_23, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_148 = fmul float %in_buf_4_load_21, %weight_buf_4_load_21, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_148 = fadd float %tmp_44_147, %tmp_43_148, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_22 = load float* %weight_buf_4_addr_24, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_149 = fmul float %in_buf_4_load_22, %weight_buf_4_load_22, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_149 = fadd float %tmp_44_148, %tmp_43_149, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_23 = load float* %weight_buf_4_addr_25, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_150 = fmul float %in_buf_4_load_23, %weight_buf_4_load_23, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_150 = fadd float %tmp_44_149, %tmp_43_150, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_24 = load float* %weight_buf_4_addr_26, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_151 = fmul float %in_buf_4_load_24, %weight_buf_4_load_24, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_151 = fadd float %tmp_44_150, %tmp_43_151, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_25 = load float* %weight_buf_4_addr_27, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_152 = fmul float %in_buf_4_load_25, %weight_buf_4_load_25, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_152 = fadd float %tmp_44_151, %tmp_43_152, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_26 = load float* %weight_buf_4_addr_28, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_153 = fmul float %in_buf_4_load_26, %weight_buf_4_load_26, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_153 = fadd float %tmp_44_152, %tmp_43_153, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_27 = load float* %weight_buf_4_addr_29, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_154 = fmul float %in_buf_4_load_27, %weight_buf_4_load_27, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_154 = fadd float %tmp_44_153, %tmp_43_154, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_28 = load float* %weight_buf_4_addr_30, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_155 = fmul float %in_buf_4_load_28, %weight_buf_4_load_28, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_155 = fadd float %tmp_44_154, %tmp_43_155, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_29 = load float* %weight_buf_4_addr_31, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_156 = fmul float %in_buf_4_load_29, %weight_buf_4_load_29, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_156 = fadd float %tmp_44_155, %tmp_43_156, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_30 = load float* %weight_buf_4_addr_32, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_157 = fmul float %in_buf_4_load_30, %weight_buf_4_load_30, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_157 = fadd float %tmp_44_156, %tmp_43_157, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_4_load_31 = load float* %weight_buf_4_addr_33, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_158 = fmul float %in_buf_4_load_31, %weight_buf_4_load_31, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_158 = fadd float %tmp_44_157, %tmp_43_158, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load = load float* %weight_buf_5_addr_2, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_159 = fmul float %in_buf_5_load, %weight_buf_5_load, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_159 = fadd float %tmp_44_158, %tmp_43_159, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_1 = load float* %weight_buf_5_addr_3, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_160 = fmul float %in_buf_5_load_1, %weight_buf_5_load_1, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_160 = fadd float %tmp_44_159, %tmp_43_160, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_2 = load float* %weight_buf_5_addr_4, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_161 = fmul float %in_buf_5_load_2, %weight_buf_5_load_2, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_161 = fadd float %tmp_44_160, %tmp_43_161, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_3 = load float* %weight_buf_5_addr_5, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_162 = fmul float %in_buf_5_load_3, %weight_buf_5_load_3, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_162 = fadd float %tmp_44_161, %tmp_43_162, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_4 = load float* %weight_buf_5_addr_6, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_163 = fmul float %in_buf_5_load_4, %weight_buf_5_load_4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_163 = fadd float %tmp_44_162, %tmp_43_163, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_5 = load float* %weight_buf_5_addr_7, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_164 = fmul float %in_buf_5_load_5, %weight_buf_5_load_5, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_164 = fadd float %tmp_44_163, %tmp_43_164, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_6 = load float* %weight_buf_5_addr_8, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_165 = fmul float %in_buf_5_load_6, %weight_buf_5_load_6, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_165 = fadd float %tmp_44_164, %tmp_43_165, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_7 = load float* %weight_buf_5_addr_9, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_166 = fmul float %in_buf_5_load_7, %weight_buf_5_load_7, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_166 = fadd float %tmp_44_165, %tmp_43_166, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_8 = load float* %weight_buf_5_addr_10, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_167 = fmul float %in_buf_5_load_8, %weight_buf_5_load_8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_167 = fadd float %tmp_44_166, %tmp_43_167, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_9 = load float* %weight_buf_5_addr_11, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_168 = fmul float %in_buf_5_load_9, %weight_buf_5_load_9, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_168 = fadd float %tmp_44_167, %tmp_43_168, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_10 = load float* %weight_buf_5_addr_12, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_169 = fmul float %in_buf_5_load_10, %weight_buf_5_load_10, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_169 = fadd float %tmp_44_168, %tmp_43_169, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_11 = load float* %weight_buf_5_addr_13, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_170 = fmul float %in_buf_5_load_11, %weight_buf_5_load_11, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_170 = fadd float %tmp_44_169, %tmp_43_170, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_12 = load float* %weight_buf_5_addr_14, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_171 = fmul float %in_buf_5_load_12, %weight_buf_5_load_12, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_171 = fadd float %tmp_44_170, %tmp_43_171, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_13 = load float* %weight_buf_5_addr_15, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_172 = fmul float %in_buf_5_load_13, %weight_buf_5_load_13, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_172 = fadd float %tmp_44_171, %tmp_43_172, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_14 = load float* %weight_buf_5_addr_16, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_173 = fmul float %in_buf_5_load_14, %weight_buf_5_load_14, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_173 = fadd float %tmp_44_172, %tmp_43_173, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_15 = load float* %weight_buf_5_addr_17, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_174 = fmul float %in_buf_5_load_15, %weight_buf_5_load_15, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_174 = fadd float %tmp_44_173, %tmp_43_174, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_16 = load float* %weight_buf_5_addr_18, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_175 = fmul float %in_buf_5_load_16, %weight_buf_5_load_16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_175 = fadd float %tmp_44_174, %tmp_43_175, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_17 = load float* %weight_buf_5_addr_19, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_176 = fmul float %in_buf_5_load_17, %weight_buf_5_load_17, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_176 = fadd float %tmp_44_175, %tmp_43_176, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_18 = load float* %weight_buf_5_addr_20, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_177 = fmul float %in_buf_5_load_18, %weight_buf_5_load_18, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_177 = fadd float %tmp_44_176, %tmp_43_177, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_19 = load float* %weight_buf_5_addr_21, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_178 = fmul float %in_buf_5_load_19, %weight_buf_5_load_19, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_178 = fadd float %tmp_44_177, %tmp_43_178, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_20 = load float* %weight_buf_5_addr_22, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_179 = fmul float %in_buf_5_load_20, %weight_buf_5_load_20, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_179 = fadd float %tmp_44_178, %tmp_43_179, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_21 = load float* %weight_buf_5_addr_23, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_180 = fmul float %in_buf_5_load_21, %weight_buf_5_load_21, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_180 = fadd float %tmp_44_179, %tmp_43_180, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_22 = load float* %weight_buf_5_addr_24, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_181 = fmul float %in_buf_5_load_22, %weight_buf_5_load_22, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_181 = fadd float %tmp_44_180, %tmp_43_181, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_23 = load float* %weight_buf_5_addr_25, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_182 = fmul float %in_buf_5_load_23, %weight_buf_5_load_23, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_182 = fadd float %tmp_44_181, %tmp_43_182, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_24 = load float* %weight_buf_5_addr_26, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_183 = fmul float %in_buf_5_load_24, %weight_buf_5_load_24, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_183 = fadd float %tmp_44_182, %tmp_43_183, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_25 = load float* %weight_buf_5_addr_27, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_184 = fmul float %in_buf_5_load_25, %weight_buf_5_load_25, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_184 = fadd float %tmp_44_183, %tmp_43_184, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_26 = load float* %weight_buf_5_addr_28, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_185 = fmul float %in_buf_5_load_26, %weight_buf_5_load_26, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_185 = fadd float %tmp_44_184, %tmp_43_185, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_27 = load float* %weight_buf_5_addr_29, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_186 = fmul float %in_buf_5_load_27, %weight_buf_5_load_27, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_186 = fadd float %tmp_44_185, %tmp_43_186, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_28 = load float* %weight_buf_5_addr_30, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_187 = fmul float %in_buf_5_load_28, %weight_buf_5_load_28, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_187 = fadd float %tmp_44_186, %tmp_43_187, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_29 = load float* %weight_buf_5_addr_31, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_188 = fmul float %in_buf_5_load_29, %weight_buf_5_load_29, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_188 = fadd float %tmp_44_187, %tmp_43_188, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_30 = load float* %weight_buf_5_addr_32, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_189 = fmul float %in_buf_5_load_30, %weight_buf_5_load_30, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_189 = fadd float %tmp_44_188, %tmp_43_189, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_5_load_31 = load float* %weight_buf_5_addr_33, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_190 = fmul float %in_buf_5_load_31, %weight_buf_5_load_31, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_190 = fadd float %tmp_44_189, %tmp_43_190, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load = load float* %weight_buf_6_addr_2, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_191 = fmul float %in_buf_6_load, %weight_buf_6_load, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_191 = fadd float %tmp_44_190, %tmp_43_191, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_1 = load float* %weight_buf_6_addr_3, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_192 = fmul float %in_buf_6_load_1, %weight_buf_6_load_1, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_192 = fadd float %tmp_44_191, %tmp_43_192, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_2 = load float* %weight_buf_6_addr_4, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_193 = fmul float %in_buf_6_load_2, %weight_buf_6_load_2, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_193 = fadd float %tmp_44_192, %tmp_43_193, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_3 = load float* %weight_buf_6_addr_5, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_194 = fmul float %in_buf_6_load_3, %weight_buf_6_load_3, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_194 = fadd float %tmp_44_193, %tmp_43_194, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_4 = load float* %weight_buf_6_addr_6, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_195 = fmul float %in_buf_6_load_4, %weight_buf_6_load_4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_195 = fadd float %tmp_44_194, %tmp_43_195, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_5 = load float* %weight_buf_6_addr_7, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_196 = fmul float %in_buf_6_load_5, %weight_buf_6_load_5, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_196 = fadd float %tmp_44_195, %tmp_43_196, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_6 = load float* %weight_buf_6_addr_8, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_197 = fmul float %in_buf_6_load_6, %weight_buf_6_load_6, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_197 = fadd float %tmp_44_196, %tmp_43_197, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_7 = load float* %weight_buf_6_addr_9, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_198 = fmul float %in_buf_6_load_7, %weight_buf_6_load_7, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_198 = fadd float %tmp_44_197, %tmp_43_198, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_8 = load float* %weight_buf_6_addr_10, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_199 = fmul float %in_buf_6_load_8, %weight_buf_6_load_8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_199 = fadd float %tmp_44_198, %tmp_43_199, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_9 = load float* %weight_buf_6_addr_11, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_200 = fmul float %in_buf_6_load_9, %weight_buf_6_load_9, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_200 = fadd float %tmp_44_199, %tmp_43_200, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_10 = load float* %weight_buf_6_addr_12, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_201 = fmul float %in_buf_6_load_10, %weight_buf_6_load_10, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_201 = fadd float %tmp_44_200, %tmp_43_201, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_11 = load float* %weight_buf_6_addr_13, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_202 = fmul float %in_buf_6_load_11, %weight_buf_6_load_11, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_202 = fadd float %tmp_44_201, %tmp_43_202, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_12 = load float* %weight_buf_6_addr_14, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_203 = fmul float %in_buf_6_load_12, %weight_buf_6_load_12, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_203 = fadd float %tmp_44_202, %tmp_43_203, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_13 = load float* %weight_buf_6_addr_15, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_204 = fmul float %in_buf_6_load_13, %weight_buf_6_load_13, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_204 = fadd float %tmp_44_203, %tmp_43_204, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_14 = load float* %weight_buf_6_addr_16, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_205 = fmul float %in_buf_6_load_14, %weight_buf_6_load_14, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_205 = fadd float %tmp_44_204, %tmp_43_205, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_15 = load float* %weight_buf_6_addr_17, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_206 = fmul float %in_buf_6_load_15, %weight_buf_6_load_15, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_206 = fadd float %tmp_44_205, %tmp_43_206, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_16 = load float* %weight_buf_6_addr_18, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_207 = fmul float %in_buf_6_load_16, %weight_buf_6_load_16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_207 = fadd float %tmp_44_206, %tmp_43_207, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_17 = load float* %weight_buf_6_addr_19, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_208 = fmul float %in_buf_6_load_17, %weight_buf_6_load_17, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_208 = fadd float %tmp_44_207, %tmp_43_208, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_18 = load float* %weight_buf_6_addr_20, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_209 = fmul float %in_buf_6_load_18, %weight_buf_6_load_18, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_209 = fadd float %tmp_44_208, %tmp_43_209, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_19 = load float* %weight_buf_6_addr_21, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_210 = fmul float %in_buf_6_load_19, %weight_buf_6_load_19, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_210 = fadd float %tmp_44_209, %tmp_43_210, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_20 = load float* %weight_buf_6_addr_22, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_211 = fmul float %in_buf_6_load_20, %weight_buf_6_load_20, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_211 = fadd float %tmp_44_210, %tmp_43_211, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_21 = load float* %weight_buf_6_addr_23, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_212 = fmul float %in_buf_6_load_21, %weight_buf_6_load_21, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_212 = fadd float %tmp_44_211, %tmp_43_212, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_22 = load float* %weight_buf_6_addr_24, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_213 = fmul float %in_buf_6_load_22, %weight_buf_6_load_22, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_213 = fadd float %tmp_44_212, %tmp_43_213, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_23 = load float* %weight_buf_6_addr_25, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_214 = fmul float %in_buf_6_load_23, %weight_buf_6_load_23, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_214 = fadd float %tmp_44_213, %tmp_43_214, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_24 = load float* %weight_buf_6_addr_26, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_215 = fmul float %in_buf_6_load_24, %weight_buf_6_load_24, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_215 = fadd float %tmp_44_214, %tmp_43_215, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_25 = load float* %weight_buf_6_addr_27, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_216 = fmul float %in_buf_6_load_25, %weight_buf_6_load_25, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_216 = fadd float %tmp_44_215, %tmp_43_216, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_26 = load float* %weight_buf_6_addr_28, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_217 = fmul float %in_buf_6_load_26, %weight_buf_6_load_26, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_217 = fadd float %tmp_44_216, %tmp_43_217, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_27 = load float* %weight_buf_6_addr_29, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_218 = fmul float %in_buf_6_load_27, %weight_buf_6_load_27, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_218 = fadd float %tmp_44_217, %tmp_43_218, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_28 = load float* %weight_buf_6_addr_30, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_219 = fmul float %in_buf_6_load_28, %weight_buf_6_load_28, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_219 = fadd float %tmp_44_218, %tmp_43_219, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_29 = load float* %weight_buf_6_addr_31, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_220 = fmul float %in_buf_6_load_29, %weight_buf_6_load_29, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_220 = fadd float %tmp_44_219, %tmp_43_220, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_30 = load float* %weight_buf_6_addr_32, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_221 = fmul float %in_buf_6_load_30, %weight_buf_6_load_30, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_221 = fadd float %tmp_44_220, %tmp_43_221, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_6_load_31 = load float* %weight_buf_6_addr_33, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_222 = fmul float %in_buf_6_load_31, %weight_buf_6_load_31, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_222 = fadd float %tmp_44_221, %tmp_43_222, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load = load float* %weight_buf_7_addr_2, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_223 = fmul float %in_buf_7_load, %weight_buf_7_load, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_223 = fadd float %tmp_44_222, %tmp_43_223, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_1 = load float* %weight_buf_7_addr_3, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_224 = fmul float %in_buf_7_load_1, %weight_buf_7_load_1, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_224 = fadd float %tmp_44_223, %tmp_43_224, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_2 = load float* %weight_buf_7_addr_4, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_225 = fmul float %in_buf_7_load_2, %weight_buf_7_load_2, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_225 = fadd float %tmp_44_224, %tmp_43_225, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_3 = load float* %weight_buf_7_addr_5, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_226 = fmul float %in_buf_7_load_3, %weight_buf_7_load_3, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_226 = fadd float %tmp_44_225, %tmp_43_226, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_4 = load float* %weight_buf_7_addr_6, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_227 = fmul float %in_buf_7_load_4, %weight_buf_7_load_4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_227 = fadd float %tmp_44_226, %tmp_43_227, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_5 = load float* %weight_buf_7_addr_7, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_228 = fmul float %in_buf_7_load_5, %weight_buf_7_load_5, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_228 = fadd float %tmp_44_227, %tmp_43_228, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_6 = load float* %weight_buf_7_addr_8, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_229 = fmul float %in_buf_7_load_6, %weight_buf_7_load_6, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_229 = fadd float %tmp_44_228, %tmp_43_229, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_7 = load float* %weight_buf_7_addr_9, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_230 = fmul float %in_buf_7_load_7, %weight_buf_7_load_7, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_230 = fadd float %tmp_44_229, %tmp_43_230, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_8 = load float* %weight_buf_7_addr_10, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_231 = fmul float %in_buf_7_load_8, %weight_buf_7_load_8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_231 = fadd float %tmp_44_230, %tmp_43_231, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_9 = load float* %weight_buf_7_addr_11, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_232 = fmul float %in_buf_7_load_9, %weight_buf_7_load_9, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_232 = fadd float %tmp_44_231, %tmp_43_232, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_10 = load float* %weight_buf_7_addr_12, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_233 = fmul float %in_buf_7_load_10, %weight_buf_7_load_10, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_233 = fadd float %tmp_44_232, %tmp_43_233, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_11 = load float* %weight_buf_7_addr_13, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_234 = fmul float %in_buf_7_load_11, %weight_buf_7_load_11, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_234 = fadd float %tmp_44_233, %tmp_43_234, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_12 = load float* %weight_buf_7_addr_14, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_235 = fmul float %in_buf_7_load_12, %weight_buf_7_load_12, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_235 = fadd float %tmp_44_234, %tmp_43_235, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_13 = load float* %weight_buf_7_addr_15, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_236 = fmul float %in_buf_7_load_13, %weight_buf_7_load_13, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_236 = fadd float %tmp_44_235, %tmp_43_236, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_14 = load float* %weight_buf_7_addr_16, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_237 = fmul float %in_buf_7_load_14, %weight_buf_7_load_14, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_237 = fadd float %tmp_44_236, %tmp_43_237, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_15 = load float* %weight_buf_7_addr_17, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_238 = fmul float %in_buf_7_load_15, %weight_buf_7_load_15, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_238 = fadd float %tmp_44_237, %tmp_43_238, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_16 = load float* %weight_buf_7_addr_18, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_239 = fmul float %in_buf_7_load_16, %weight_buf_7_load_16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_239 = fadd float %tmp_44_238, %tmp_43_239, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_17 = load float* %weight_buf_7_addr_19, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_240 = fmul float %in_buf_7_load_17, %weight_buf_7_load_17, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_240 = fadd float %tmp_44_239, %tmp_43_240, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_18 = load float* %weight_buf_7_addr_20, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_241 = fmul float %in_buf_7_load_18, %weight_buf_7_load_18, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_241 = fadd float %tmp_44_240, %tmp_43_241, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_19 = load float* %weight_buf_7_addr_21, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_242 = fmul float %in_buf_7_load_19, %weight_buf_7_load_19, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_242 = fadd float %tmp_44_241, %tmp_43_242, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_20 = load float* %weight_buf_7_addr_22, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_243 = fmul float %in_buf_7_load_20, %weight_buf_7_load_20, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_243 = fadd float %tmp_44_242, %tmp_43_243, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_21 = load float* %weight_buf_7_addr_23, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_244 = fmul float %in_buf_7_load_21, %weight_buf_7_load_21, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_244 = fadd float %tmp_44_243, %tmp_43_244, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_22 = load float* %weight_buf_7_addr_24, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_245 = fmul float %in_buf_7_load_22, %weight_buf_7_load_22, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_245 = fadd float %tmp_44_244, %tmp_43_245, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_23 = load float* %weight_buf_7_addr_25, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_246 = fmul float %in_buf_7_load_23, %weight_buf_7_load_23, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_246 = fadd float %tmp_44_245, %tmp_43_246, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_24 = load float* %weight_buf_7_addr_26, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_247 = fmul float %in_buf_7_load_24, %weight_buf_7_load_24, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_247 = fadd float %tmp_44_246, %tmp_43_247, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_25 = load float* %weight_buf_7_addr_27, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_248 = fmul float %in_buf_7_load_25, %weight_buf_7_load_25, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_248 = fadd float %tmp_44_247, %tmp_43_248, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_26 = load float* %weight_buf_7_addr_28, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_249 = fmul float %in_buf_7_load_26, %weight_buf_7_load_26, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_249 = fadd float %tmp_44_248, %tmp_43_249, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_27 = load float* %weight_buf_7_addr_29, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_250 = fmul float %in_buf_7_load_27, %weight_buf_7_load_27, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_250 = fadd float %tmp_44_249, %tmp_43_250, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_28 = load float* %weight_buf_7_addr_30, align 16, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_251 = fmul float %in_buf_7_load_28, %weight_buf_7_load_28, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_251 = fadd float %tmp_44_250, %tmp_43_251, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_29 = load float* %weight_buf_7_addr_31, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_252 = fmul float %in_buf_7_load_29, %weight_buf_7_load_29, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_252 = fadd float %tmp_44_251, %tmp_43_252, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_30 = load float* %weight_buf_7_addr_32, align 8, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_253 = fmul float %in_buf_7_load_30, %weight_buf_7_load_30, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_253 = fadd float %tmp_44_252, %tmp_43_253, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_7_load_31 = load float* %weight_buf_7_addr_33, align 4, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_254 = fmul float %in_buf_7_load_31, %weight_buf_7_load_31, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_254 = fadd float %tmp_44_253, %tmp_43_254, !dbg !2868 ; [#uses=1 type=float] [debug line = 74:6]
  store float %tmp_44_254, float* %out_buf_addr_2, align 4, !dbg !2872 ; [debug line = 76:5]
  %empty_21 = call i32 (...)* @_ssdm_op_SpecRegionEnd([3 x i8]* @p_str13, i32 %tmp_32), !dbg !2877 ; [#uses=0 type=i32] [debug line = 77:4]
  %j_3 = add i4 %j5_mid2, 1, !dbg !2878           ; [#uses=1 type=i4] [debug line = 70:32]
  call void @llvm.dbg.value(metadata !{i4 %j_3}, i64 0, metadata !2879), !dbg !2878 ; [debug line = 70:32] [debug variable = j]
  br label %.preheader.preheader

; <label>:15                                      ; preds = %.preheader.preheader
  %tmp_20 = or i14 %os_idx, 5, !dbg !2880         ; [#uses=1 type=i14] [debug line = 81:28]
  %tmp_20_cast = zext i14 %tmp_20 to i15, !dbg !2880 ; [#uses=1 type=i15] [debug line = 81:28]
  %os_idx_2 = add i14 %os_idx, 640, !dbg !2882    ; [#uses=1 type=i14] [debug line = 86:5]
  call void @llvm.dbg.value(metadata !{i14 %os_idx_2}, i64 0, metadata !2886), !dbg !2882 ; [debug line = 86:5] [debug variable = os_idx]
  br label %16, !dbg !2880                        ; [debug line = 81:28]
...
; <label>:16                                      ; preds = %17, %15
  ...
  %exitcond1 = icmp eq i8 %i6, -128, !dbg !2880   ; [#uses=1 type=i1] [debug line = 81:28]
  %i_5 = add i8 %i6, 1, !dbg !2887                ; [#uses=1 type=i8] [debug line = 81:39]
  br i1 %exitcond1, label %18, label %17, !dbg !2880 ; [debug line = 81:28]

; <label>:17                                      ; preds = %16
  %empty_22 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 128, i64 128, i64 128) ; [#uses=0 type=i32]
  call void (...)* @_ssdm_op_SpecLoopName([10 x i8]* @p_str15) nounwind, !dbg !2888 ; [debug line = 81:45]
  %tmp_27 = call i32 (...)* @_ssdm_op_SpecRegionBegin([10 x i8]* @p_str15), !dbg !2888 ; [#uses=1 type=i32] [debug line = 81:45]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !2889 ; [debug line = 82:1]
  %tmp_231 = call i11 @_ssdm_op_BitConcatenate.i11.i8.i3(i8 %i6, i3 0) ; [#uses=1 type=i11]
  %p_shl2_cast = zext i11 %tmp_231 to i12         ; [#uses=1 type=i12]
  %tmp_232 = call i9 @_ssdm_op_BitConcatenate.i9.i8.i1(i8 %i6, i1 false) ; [#uses=1 type=i9]
  %p_shl3_cast = zext i9 %tmp_232 to i12, !dbg !2890 ; [#uses=1 type=i12] [debug line = 84:5]
  %tmp_233 = add i12 %p_shl3_cast, %p_shl2_cast, !dbg !2890 ; [#uses=10 type=i12] [debug line = 84:5]
  %tmp_233_cast = zext i12 %tmp_233 to i64, !dbg !2890 ; [#uses=1 type=i64] [debug line = 84:5]
  %out_buf_addr = getelementptr [1280 x float]* %out_buf, i64 0, i64 %tmp_233_cast, !dbg !2890 ; [#uses=1 type=float*] [debug line = 84:5]
  %tmp_234 = or i12 %tmp_233, 1, !dbg !2891       ; [#uses=1 type=i12] [debug line = 85:5]
  %tmp_234_cast = zext i12 %tmp_234 to i64, !dbg !2891 ; [#uses=1 type=i64] [debug line = 85:5]
  %out_buf_addr_1 = getelementptr [1280 x float]* %out_buf, i64 0, i64 %tmp_234_cast, !dbg !2891 ; [#uses=1 type=float*] [debug line = 85:5]
  %tmp_235 = add i12 %tmp_233, 2, !dbg !2890      ; [#uses=1 type=i12] [debug line = 84:5]
  %tmp_235_cast = sext i12 %tmp_235 to i64, !dbg !2890 ; [#uses=1 type=i64] [debug line = 84:5]
  %out_buf_addr_5 = getelementptr [1280 x float]* %out_buf, i64 0, i64 %tmp_235_cast, !dbg !2890 ; [#uses=1 type=float*] [debug line = 84:5]
  %tmp_236 = add i12 %tmp_233, 3, !dbg !2891      ; [#uses=1 type=i12] [debug line = 85:5]
  %tmp_236_cast = sext i12 %tmp_236 to i64, !dbg !2891 ; [#uses=1 type=i64] [debug line = 85:5]
  %out_buf_addr_6 = getelementptr [1280 x float]* %out_buf, i64 0, i64 %tmp_236_cast, !dbg !2891 ; [#uses=1 type=float*] [debug line = 85:5]
  %tmp_237 = add i12 %tmp_233, 4, !dbg !2890      ; [#uses=1 type=i12] [debug line = 84:5]
  %tmp_237_cast = sext i12 %tmp_237 to i64, !dbg !2890 ; [#uses=1 type=i64] [debug line = 84:5]
  %out_buf_addr_7 = getelementptr [1280 x float]* %out_buf, i64 0, i64 %tmp_237_cast, !dbg !2890 ; [#uses=1 type=float*] [debug line = 84:5]
  %tmp_238 = add i12 %tmp_233, 5, !dbg !2891      ; [#uses=1 type=i12] [debug line = 85:5]
  %tmp_238_cast = sext i12 %tmp_238 to i64, !dbg !2891 ; [#uses=1 type=i64] [debug line = 85:5]
  %out_buf_addr_8 = getelementptr [1280 x float]* %out_buf, i64 0, i64 %tmp_238_cast, !dbg !2891 ; [#uses=1 type=float*] [debug line = 85:5]
  %tmp_239 = add i12 %tmp_233, 6, !dbg !2890      ; [#uses=1 type=i12] [debug line = 84:5]
  %tmp_239_cast = sext i12 %tmp_239 to i64, !dbg !2890 ; [#uses=1 type=i64] [debug line = 84:5]
  %out_buf_addr_3 = getelementptr [1280 x float]* %out_buf, i64 0, i64 %tmp_239_cast, !dbg !2890 ; [#uses=1 type=float*] [debug line = 84:5]
  %tmp_240 = add i12 %tmp_233, 7, !dbg !2891      ; [#uses=1 type=i12] [debug line = 85:5]
  %tmp_240_cast = sext i12 %tmp_240 to i64, !dbg !2891 ; [#uses=1 type=i64] [debug line = 85:5]
  %out_buf_addr_9 = getelementptr [1280 x float]* %out_buf, i64 0, i64 %tmp_240_cast, !dbg !2891 ; [#uses=1 type=float*] [debug line = 85:5]
  %tmp_241 = add i12 %tmp_233, 8, !dbg !2890      ; [#uses=1 type=i12] [debug line = 84:5]
  %tmp_241_cast = sext i12 %tmp_241 to i64, !dbg !2890 ; [#uses=1 type=i64] [debug line = 84:5]
  %out_buf_addr_4 = getelementptr [1280 x float]* %out_buf, i64 0, i64 %tmp_241_cast, !dbg !2890 ; [#uses=1 type=float*] [debug line = 84:5]
  %tmp_242 = add i12 %tmp_233, 9, !dbg !2891      ; [#uses=1 type=i12] [debug line = 85:5]
  %tmp_242_cast = sext i12 %tmp_242 to i64, !dbg !2891 ; [#uses=1 type=i64] [debug line = 85:5]
  %out_buf_addr_10 = getelementptr [1280 x float]* %out_buf, i64 0, i64 %tmp_242_cast, !dbg !2891 ; [#uses=1 type=float*] [debug line = 85:5]
  %out_buf_load = load float* %out_buf_addr, align 8, !dbg !2890 ; [#uses=1 type=float] [debug line = 84:5]
  %tmp_29 = bitcast float %out_buf_load to i32, !dbg !2890 ; [#uses=1 type=i32] [debug line = 84:5]
  %out_buf_load_1 = load float* %out_buf_addr_1, align 4, !dbg !2891 ; [#uses=1 type=float] [debug line = 85:5]
  %tmp_30 = bitcast float %out_buf_load_1 to i32, !dbg !2891 ; [#uses=1 type=i32] [debug line = 85:5]
  %converter_s = call i64 @_ssdm_op_BitConcatenate.i64.i32.i32(i32 %tmp_30, i32 %tmp_29), !dbg !2891 ; [#uses=1 type=i64] [debug line = 85:5]
  %last_assign = icmp eq i15 %os_idx_1, 10239, !dbg !2892 ; [#uses=1 type=i1] [debug line = 86:28]
  ...
  %out_buf_load_5 = load float* %out_buf_addr_5, align 8, !dbg !2890 ; [#uses=1 type=float] [debug line = 84:5]
  %tmp_33_1 = bitcast float %out_buf_load_5 to i32, !dbg !2890 ; [#uses=1 type=i32] [debug line = 84:5]
  %out_buf_load_6 = load float* %out_buf_addr_6, align 4, !dbg !2891 ; [#uses=1 type=float] [debug line = 85:5]
  %tmp_37_1 = bitcast float %out_buf_load_6 to i32, !dbg !2891 ; [#uses=1 type=i32] [debug line = 85:5]
  %converter_13_1 = call i64 @_ssdm_op_BitConcatenate.i64.i32.i32(i32 %tmp_37_1, i32 %tmp_33_1), !dbg !2891 ; [#uses=1 type=i64] [debug line = 85:5]
  %last_assign_1 = icmp eq i15 %os_idx_1, 10238, !dbg !2892 ; [#uses=1 type=i1] [debug line = 86:28]
  ...
  %out_buf_load_2 = load float* %out_buf_addr_7, align 8, !dbg !2890 ; [#uses=1 type=float] [debug line = 84:5]
  %tmp_33_2 = bitcast float %out_buf_load_2 to i32, !dbg !2890 ; [#uses=1 type=i32] [debug line = 84:5]
  %out_buf_load_7 = load float* %out_buf_addr_8, align 4, !dbg !2891 ; [#uses=1 type=float] [debug line = 85:5]
  %tmp_37_2 = bitcast float %out_buf_load_7 to i32, !dbg !2891 ; [#uses=1 type=i32] [debug line = 85:5]
  %converter_13_2 = call i64 @_ssdm_op_BitConcatenate.i64.i32.i32(i32 %tmp_37_2, i32 %tmp_33_2), !dbg !2891 ; [#uses=1 type=i64] [debug line = 85:5]
  %last_assign_2 = icmp eq i15 %os_idx_1, 10237, !dbg !2892 ; [#uses=1 type=i1] [debug line = 86:28]
  ...
  %out_buf_load_3 = load float* %out_buf_addr_3, align 8, !dbg !2890 ; [#uses=1 type=float] [debug line = 84:5]
  %tmp_33_3 = bitcast float %out_buf_load_3 to i32, !dbg !2890 ; [#uses=1 type=i32] [debug line = 84:5]
  %out_buf_load_8 = load float* %out_buf_addr_9, align 4, !dbg !2891 ; [#uses=1 type=float] [debug line = 85:5]
  %tmp_37_3 = bitcast float %out_buf_load_8 to i32, !dbg !2891 ; [#uses=1 type=i32] [debug line = 85:5]
  %converter_13_3 = call i64 @_ssdm_op_BitConcatenate.i64.i32.i32(i32 %tmp_37_3, i32 %tmp_33_3), !dbg !2891 ; [#uses=1 type=i64] [debug line = 85:5]
  %last_assign_3 = icmp eq i15 %os_idx_1, 10236, !dbg !2892 ; [#uses=1 type=i1] [debug line = 86:28]
  ...
  %out_buf_load_4 = load float* %out_buf_addr_4, align 8, !dbg !2890 ; [#uses=1 type=float] [debug line = 84:5]
  %tmp_33_4 = bitcast float %out_buf_load_4 to i32, !dbg !2890 ; [#uses=1 type=i32] [debug line = 84:5]
  %out_buf_load_9 = load float* %out_buf_addr_10, align 4, !dbg !2891 ; [#uses=1 type=float] [debug line = 85:5]
  %tmp_37_4 = bitcast float %out_buf_load_9 to i32, !dbg !2891 ; [#uses=1 type=i32] [debug line = 85:5]
  %converter_13_4 = call i64 @_ssdm_op_BitConcatenate.i64.i32.i32(i32 %tmp_37_4, i32 %tmp_33_4), !dbg !2891 ; [#uses=1 type=i64] [debug line = 85:5]
  %last_assign_4 = icmp eq i15 %os_idx_1, 10235, !dbg !2892 ; [#uses=1 type=i1] [debug line = 86:28]
  ...
  %empty_23 = call i32 (...)* @_ssdm_op_SpecRegionEnd([10 x i8]* @p_str15, i32 %tmp_27), !dbg !2893 ; [#uses=0 type=i32] [debug line = 88:3]
  call void @llvm.dbg.value(metadata !{i8 %i_5}, i64 0, metadata !2894), !dbg !2887 ; [debug line = 81:39] [debug variable = i]
  %indvars_iv_next = add i15 %indvars_iv, 5, !dbg !2887 ; [#uses=1 type=i15] [debug line = 81:39]
  br label %16, !dbg !2887                        ; [debug line = 81:39]

; <label>:18                                      ; preds = %16
  %empty_24 = call i32 (...)* @_ssdm_op_SpecRegionEnd([3 x i8]* @p_str9, i32 %tmp_10), !dbg !2895 ; [#uses=0 type=i32] [debug line = 89:2]
  %t_1 = add i12 %t, 128, !dbg !2896              ; [#uses=1 type=i12] [debug line = 55:69]
  call void @llvm.dbg.value(metadata !{i12 %t_1}, i64 0, metadata !2897), !dbg !2896 ; [debug line = 55:69] [debug variable = t]
  br label %.preheader16, !dbg !2896              ; [debug line = 55:69]

; <label>:19                                      ; preds = %.preheader16
  ret void, !dbg !2898                            ; [debug line = 90:1]

branch8:                                          ; preds = %5
  store float %bitcast2, float* %weight_buf_0_addr, align 8, !dbg !2832 ; [debug line = 49:4]
  store float %tmp_16, float* %weight_buf_0_addr_1, align 4, !dbg !2833 ; [debug line = 50:4]
  br label %6

branch9:                                          ; preds = %5
  store float %bitcast2, float* %weight_buf_1_addr, align 8, !dbg !2832 ; [debug line = 49:4]
  store float %tmp_16, float* %weight_buf_1_addr_1, align 4, !dbg !2833 ; [debug line = 50:4]
  br label %6

branch10:                                         ; preds = %5
  store float %bitcast2, float* %weight_buf_2_addr, align 8, !dbg !2832 ; [debug line = 49:4]
  store float %tmp_16, float* %weight_buf_2_addr_1, align 4, !dbg !2833 ; [debug line = 50:4]
  br label %6

branch11:                                         ; preds = %5
  store float %bitcast2, float* %weight_buf_3_addr, align 8, !dbg !2832 ; [debug line = 49:4]
  store float %tmp_16, float* %weight_buf_3_addr_1, align 4, !dbg !2833 ; [debug line = 50:4]
  br label %6

branch12:                                         ; preds = %5
  store float %bitcast2, float* %weight_buf_4_addr, align 8, !dbg !2832 ; [debug line = 49:4]
  store float %tmp_16, float* %weight_buf_4_addr_1, align 4, !dbg !2833 ; [debug line = 50:4]
  br label %6

branch13:                                         ; preds = %5
  store float %bitcast2, float* %weight_buf_5_addr, align 8, !dbg !2832 ; [debug line = 49:4]
  store float %tmp_16, float* %weight_buf_5_addr_1, align 4, !dbg !2833 ; [debug line = 50:4]
  br label %6

branch14:                                         ; preds = %5
  store float %bitcast2, float* %weight_buf_6_addr, align 8, !dbg !2832 ; [debug line = 49:4]
  store float %tmp_16, float* %weight_buf_6_addr_1, align 4, !dbg !2833 ; [debug line = 50:4]
  br label %6

branch15:                                         ; preds = %5
  store float %bitcast2, float* %weight_buf_7_addr, align 8, !dbg !2832 ; [debug line = 49:4]
  store float %tmp_16, float* %weight_buf_7_addr_1, align 4, !dbg !2833 ; [debug line = 50:4]
  br label %6

branch24:                                         ; preds = %12
  store float %bitcast, float* %in_buf_0_addr, align 8, !dbg !2855 ; [debug line = 62:5]
  store float %tmp_26, float* %in_buf_0_addr_1, align 4, !dbg !2856 ; [debug line = 63:5]
  br label %13

branch25:                                         ; preds = %12
  store float %bitcast, float* %in_buf_1_addr, align 8, !dbg !2855 ; [debug line = 62:5]
  store float %tmp_26, float* %in_buf_1_addr_1, align 4, !dbg !2856 ; [debug line = 63:5]
  br label %13

branch26:                                         ; preds = %12
  store float %bitcast, float* %in_buf_2_addr, align 8, !dbg !2855 ; [debug line = 62:5]
  store float %tmp_26, float* %in_buf_2_addr_1, align 4, !dbg !2856 ; [debug line = 63:5]
  br label %13

branch27:                                         ; preds = %12
  store float %bitcast, float* %in_buf_3_addr, align 8, !dbg !2855 ; [debug line = 62:5]
  store float %tmp_26, float* %in_buf_3_addr_1, align 4, !dbg !2856 ; [debug line = 63:5]
  br label %13

branch28:                                         ; preds = %12
  store float %bitcast, float* %in_buf_4_addr, align 8, !dbg !2855 ; [debug line = 62:5]
  store float %tmp_26, float* %in_buf_4_addr_1, align 4, !dbg !2856 ; [debug line = 63:5]
  br label %13

branch29:                                         ; preds = %12
  store float %bitcast, float* %in_buf_5_addr, align 8, !dbg !2855 ; [debug line = 62:5]
  store float %tmp_26, float* %in_buf_5_addr_1, align 4, !dbg !2856 ; [debug line = 63:5]
  br label %13

branch30:                                         ; preds = %12
  store float %bitcast, float* %in_buf_6_addr, align 8, !dbg !2855 ; [debug line = 62:5]
  store float %tmp_26, float* %in_buf_6_addr_1, align 4, !dbg !2856 ; [debug line = 63:5]
  br label %13

branch31:                                         ; preds = %12
  store float %bitcast, float* %in_buf_7_addr, align 8, !dbg !2855 ; [debug line = 62:5]
  store float %tmp_26, float* %in_buf_7_addr_1, align 4, !dbg !2856 ; [debug line = 63:5]
  br label %13
}
...
entry:
  ...
  %empty_31 = trunc i9 %empty to i4               ; [#uses=1 type=i4]
  ret i4 %empty_31
}
...
entry:
  ...
  %empty_32 = trunc i64 %empty to i32             ; [#uses=1 type=i32]
  ret i32 %empty_32
}
...
entry:
  ...
  %empty_39 = zext i5 %1 to i9                    ; [#uses=1 type=i9]
  %empty_40 = shl i9 %empty, 5                    ; [#uses=1 type=i9]
...
entry:
  ...
  %empty_42 = zext i9 %1 to i64                   ; [#uses=1 type=i64]
  %empty_43 = shl i64 %empty, 9                   ; [#uses=1 type=i64]
...
entry:
  ...
  %empty_45 = zext i13 %1 to i64                  ; [#uses=1 type=i64]
  %empty_46 = shl i64 %empty, 13                  ; [#uses=1 type=i64]
...
entry:
  ...
  %empty_48 = zext i32 %1 to i64                  ; [#uses=1 type=i64]
  %empty_49 = shl i64 %empty, 32                  ; [#uses=1 type=i64]
  %empty_50 = or i64 %empty_49, %empty_48         ; [#uses=1 type=i64]
  ret i64 %empty_50
}
...
entry:
  ...
  %empty_51 = zext i5 %1 to i13                   ; [#uses=1 type=i13]
  %empty_52 = shl i13 %empty, 5                   ; [#uses=1 type=i13]
  %empty_53 = or i13 %empty_52, %empty_51         ; [#uses=1 type=i13]
  ret i13 %empty_53
}
...
entry:
  ...
  %empty_54 = zext i3 %1 to i11                   ; [#uses=1 type=i11]
  %empty_55 = shl i11 %empty, 3                   ; [#uses=1 type=i11]
...
!2792 = metadata !{i32 786688, metadata !2793, metadata !"ret", metadata !112, i32 100, metadata !2797, i32 0, metadata !2786} ; [ DW_TAG_auto_variable ]
!2793 = metadata !{i32 786443, metadata !2794, i32 97, i32 1, metadata !112, i32 23} ; [ DW_TAG_lexical_block ]
!2794 = metadata !{i32 786478, i32 0, metadata !112, metadata !"pop_stream", metadata !"pop_stream", metadata !"_Z10pop_streamRK7ap_axiuILi64ELi4ELi5ELi5EE", metadata !112, i32 96, metadata !2795, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !138, i32 97} ; [ DW_TAG_subprogram ]
...
!2800 = metadata !{i32 100, i32 14, metadata !2793, metadata !2786}
...
!2820 = metadata !{i32 55, i32 20, metadata !2821, null}
!2821 = metadata !{i32 786443, metadata !2745, i32 55, i32 6, metadata !112, i32 7} ; [ DW_TAG_lexical_block ]
...
!2824 = metadata !{i32 46, i32 27, metadata !2825, null}
!2825 = metadata !{i32 786443, metadata !2823, i32 46, i32 13, metadata !112, i32 5} ; [ DW_TAG_lexical_block ]
!2826 = metadata !{i32 46, i32 69, metadata !2827, null}
!2827 = metadata !{i32 786443, metadata !2825, i32 46, i32 68, metadata !112, i32 6} ; [ DW_TAG_lexical_block ]
!2828 = metadata !{i32 47, i32 1, metadata !2827, null}
!2829 = metadata !{i32 48, i32 23, metadata !2827, null}
!2830 = metadata !{i32 786688, metadata !2793, metadata !"ret", metadata !112, i32 100, metadata !2797, i32 0, metadata !2829} ; [ DW_TAG_auto_variable ]
!2831 = metadata !{i32 100, i32 14, metadata !2793, metadata !2829}
!2832 = metadata !{i32 49, i32 4, metadata !2827, null}
!2833 = metadata !{i32 50, i32 4, metadata !2827, null}
!2834 = metadata !{i32 51, i32 3, metadata !2827, null}
!2835 = metadata !{i32 46, i32 38, metadata !2825, null}
!2836 = metadata !{i32 786688, metadata !2825, metadata !"j", metadata !112, i32 46, metadata !142, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!2839 = metadata !{i32 55, i32 78, metadata !2840, null}
!2840 = metadata !{i32 786443, metadata !2821, i32 55, i32 77, metadata !112, i32 8} ; [ DW_TAG_lexical_block ]
!2841 = metadata !{i32 786688, metadata !2745, metadata !"is_idx", metadata !112, i32 34, metadata !142, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2842 = metadata !{i32 58, i32 27, metadata !2843, null}
!2843 = metadata !{i32 786443, metadata !2840, i32 58, i32 13, metadata !112, i32 9} ; [ DW_TAG_lexical_block ]
!2844 = metadata !{i32 58, i32 38, metadata !2843, null}
!2845 = metadata !{i32 58, i32 44, metadata !2846, null}
!2846 = metadata !{i32 786443, metadata !2843, i32 58, i32 43, metadata !112, i32 10} ; [ DW_TAG_lexical_block ]
!2847 = metadata !{i32 59, i32 28, metadata !2848, null}
!2848 = metadata !{i32 786443, metadata !2846, i32 59, i32 14, metadata !112, i32 11} ; [ DW_TAG_lexical_block ]
!2849 = metadata !{i32 59, i32 70, metadata !2850, null}
!2850 = metadata !{i32 786443, metadata !2848, i32 59, i32 69, metadata !112, i32 12} ; [ DW_TAG_lexical_block ]
!2851 = metadata !{i32 60, i32 1, metadata !2850, null}
!2852 = metadata !{i32 61, i32 24, metadata !2850, null}
!2853 = metadata !{i32 786688, metadata !2793, metadata !"ret", metadata !112, i32 100, metadata !2797, i32 0, metadata !2852} ; [ DW_TAG_auto_variable ]
!2854 = metadata !{i32 100, i32 14, metadata !2793, metadata !2852}
!2855 = metadata !{i32 62, i32 5, metadata !2850, null}
!2856 = metadata !{i32 63, i32 5, metadata !2850, null}
!2857 = metadata !{i32 64, i32 4, metadata !2850, null}
!2858 = metadata !{i32 59, i32 39, metadata !2848, null}
!2859 = metadata !{i32 786688, metadata !2848, metadata !"j", metadata !112, i32 59, metadata !142, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2860 = metadata !{i32 65, i32 3, metadata !2846, null}
!2861 = metadata !{i32 786688, metadata !2843, metadata !"i", metadata !112, i32 58, metadata !142, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2862 = metadata !{i32 68, i32 32, metadata !2863, null}
!2863 = metadata !{i32 786443, metadata !2840, i32 68, i32 7, metadata !112, i32 13} ; [ DW_TAG_lexical_block ]
!2864 = metadata !{i32 786688, metadata !2863, metadata !"i", metadata !112, i32 68, metadata !142, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2865 = metadata !{i32 70, i32 22, metadata !2866, null}
!2866 = metadata !{i32 786443, metadata !2867, i32 70, i32 8, metadata !112, i32 15} ; [ DW_TAG_lexical_block ]
!2867 = metadata !{i32 786443, metadata !2863, i32 68, i32 37, metadata !112, i32 14} ; [ DW_TAG_lexical_block ]
!2868 = metadata !{i32 74, i32 6, metadata !2869, null}
!2869 = metadata !{i32 786443, metadata !2870, i32 73, i32 38, metadata !112, i32 18} ; [ DW_TAG_lexical_block ]
!2870 = metadata !{i32 786443, metadata !2871, i32 73, i32 9, metadata !112, i32 17} ; [ DW_TAG_lexical_block ]
!2871 = metadata !{i32 786443, metadata !2866, i32 70, i32 37, metadata !112, i32 16} ; [ DW_TAG_lexical_block ]
!2872 = metadata !{i32 76, i32 5, metadata !2871, null}
!2873 = metadata !{i32 70, i32 38, metadata !2871, null}
!2874 = metadata !{i32 71, i32 1, metadata !2871, null}
!2875 = metadata !{i32 72, i32 26, metadata !2871, null}
!2876 = metadata !{i32 786688, metadata !2871, metadata !"tmp", metadata !112, i32 72, metadata !2748, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2877 = metadata !{i32 77, i32 4, metadata !2871, null}
!2878 = metadata !{i32 70, i32 32, metadata !2866, null}
!2879 = metadata !{i32 786688, metadata !2866, metadata !"j", metadata !112, i32 70, metadata !142, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2880 = metadata !{i32 81, i32 28, metadata !2881, null}
!2881 = metadata !{i32 786443, metadata !2840, i32 81, i32 14, metadata !112, i32 19} ; [ DW_TAG_lexical_block ]
!2882 = metadata !{i32 86, i32 5, metadata !2883, null}
!2883 = metadata !{i32 786443, metadata !2884, i32 82, i32 69, metadata !112, i32 22} ; [ DW_TAG_lexical_block ]
!2884 = metadata !{i32 786443, metadata !2885, i32 82, i32 15, metadata !112, i32 21} ; [ DW_TAG_lexical_block ]
!2885 = metadata !{i32 786443, metadata !2881, i32 81, i32 44, metadata !112, i32 20} ; [ DW_TAG_lexical_block ]
!2886 = metadata !{i32 786688, metadata !2745, metadata !"os_idx", metadata !112, i32 35, metadata !142, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2887 = metadata !{i32 81, i32 39, metadata !2881, null}
!2888 = metadata !{i32 81, i32 45, metadata !2885, null}
!2889 = metadata !{i32 82, i32 1, metadata !2885, null}
!2890 = metadata !{i32 84, i32 5, metadata !2883, null}
!2891 = metadata !{i32 85, i32 5, metadata !2883, null}
!2892 = metadata !{i32 86, i32 28, metadata !2883, null}
!2893 = metadata !{i32 88, i32 3, metadata !2885, null}
!2894 = metadata !{i32 786688, metadata !2881, metadata !"i", metadata !112, i32 81, metadata !142, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2895 = metadata !{i32 89, i32 2, metadata !2840, null}
!2896 = metadata !{i32 55, i32 69, metadata !2821, null}
!2897 = metadata !{i32 786688, metadata !2821, metadata !"t", metadata !112, i32 55, metadata !142, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2898 = metadata !{i32 90, i32 1, metadata !2745, null}
