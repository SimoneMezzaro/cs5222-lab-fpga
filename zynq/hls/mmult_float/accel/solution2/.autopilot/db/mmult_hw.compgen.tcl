...
set ID 33
set MemName mmult_hw_offset_buf
...
# Memory (RAM/ROM)  definition:
set ID 34
set MemName mmult_hw_weight_bbkb
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 32
set AddrRange 320
