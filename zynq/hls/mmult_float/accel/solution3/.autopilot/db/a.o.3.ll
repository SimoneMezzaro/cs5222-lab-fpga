; ModuleID = '/home/simone/Desktop/cs5222-lab-fpga/zynq/hls/mmult_float/accel/solution3/.autopilot/db/a.o.3.bc'
...
@p_str15 = private unnamed_addr constant [10 x i8] c"STORE_O_1\00", align 1 ; [#uses=3 type=[10 x i8]*]
@p_str13 = private unnamed_addr constant [3 x i8] c"L2\00", align 1 ; [#uses=3 type=[3 x i8]*]
@p_str11 = private unnamed_addr constant [9 x i8] c"LOAD_I_2\00", align 1 ; [#uses=3 type=[9 x i8]*]
@p_str10 = private unnamed_addr constant [9 x i8] c"LOAD_I_1\00", align 1 ; [#uses=3 type=[9 x i8]*]
...
define void @mmult_hw(i64* %in_stream_data_V, i8* %in_stream_keep_V, i8* %in_stream_strb_V, i4* %in_stream_user_V, i1* %in_stream_last_V, i5* %in_stream_id_V, i5* %in_stream_dest_V, i64* %out_stream_data_V, i8* %out_stream_keep_V, i8* %out_stream_strb_V, i4* %out_stream_user_V, i1* %out_stream_last_V, i5* %out_stream_id_V, i5* %out_stream_dest_V) {
  ...
  %weight_buf_0 = alloca [640 x float], align 4   ; [#uses=66 type=[640 x float]*]
  %weight_buf_1 = alloca [640 x float], align 4   ; [#uses=66 type=[640 x float]*]
  %weight_buf_2 = alloca [640 x float], align 4   ; [#uses=66 type=[640 x float]*]
  %weight_buf_3 = alloca [640 x float], align 4   ; [#uses=66 type=[640 x float]*]
  %in_buf_0 = alloca [8192 x float], align 4      ; [#uses=66 type=[8192 x float]*]
  %in_buf_1 = alloca [8192 x float], align 4      ; [#uses=66 type=[8192 x float]*]
  %in_buf_2 = alloca [8192 x float], align 4      ; [#uses=66 type=[8192 x float]*]
  %in_buf_3 = alloca [8192 x float], align 4      ; [#uses=66 type=[8192 x float]*]
  %out_buf = alloca [1280 x float], align 4       ; [#uses=11 type=[1280 x float]*]
  ...
  call void @llvm.dbg.declare(metadata !{[640 x float]* %weight_buf_0}, metadata !2752), !dbg !2758 ; [debug line = 29:4] [debug variable = weight_buf[0]]
  call void @llvm.dbg.declare(metadata !{[640 x float]* %weight_buf_1}, metadata !2759), !dbg !2758 ; [debug line = 29:4] [debug variable = weight_buf[1]]
  call void @llvm.dbg.declare(metadata !{[640 x float]* %weight_buf_2}, metadata !2760), !dbg !2758 ; [debug line = 29:4] [debug variable = weight_buf[2]]
  call void @llvm.dbg.declare(metadata !{[640 x float]* %weight_buf_3}, metadata !2761), !dbg !2758 ; [debug line = 29:4] [debug variable = weight_buf[3]]
  call void @llvm.dbg.declare(metadata !{[8192 x float]* %in_buf_0}, metadata !2762), !dbg !2768 ; [debug line = 30:4] [debug variable = in_buf[0]]
  call void @llvm.dbg.declare(metadata !{[8192 x float]* %in_buf_1}, metadata !2769), !dbg !2768 ; [debug line = 30:4] [debug variable = in_buf[1]]
  call void @llvm.dbg.declare(metadata !{[8192 x float]* %in_buf_2}, metadata !2770), !dbg !2768 ; [debug line = 30:4] [debug variable = in_buf[2]]
  call void @llvm.dbg.declare(metadata !{[8192 x float]* %in_buf_3}, metadata !2771), !dbg !2768 ; [debug line = 30:4] [debug variable = in_buf[3]]
  call void @llvm.dbg.declare(metadata !{[1280 x float]* %out_buf}, metadata !2772), !dbg !2775 ; [debug line = 31:4] [debug variable = out_buf]
  br label %1, !dbg !2776                         ; [debug line = 38:28]

; <label>:1                                       ; preds = %2, %0
  %i = phi i4 [ 0, %0 ], [ %i_1, %2 ]             ; [#uses=3 type=i4]
  %is_idx = phi i3 [ 0, %0 ], [ %tmp_2, %2 ]      ; [#uses=2 type=i3]
  %exitcond5 = icmp eq i3 %is_idx, -3, !dbg !2776 ; [#uses=1 type=i1] [debug line = 38:28]
  %tmp_2 = add i3 %is_idx, 1, !dbg !2778          ; [#uses=1 type=i3] [debug line = 39:22]
  br i1 %exitcond5, label %.preheader17.preheader, label %2, !dbg !2776 ; [debug line = 38:28]

.preheader17.preheader:                           ; preds = %1
  br label %.preheader17, !dbg !2780              ; [debug line = 45:26]

; <label>:2                                       ; preds = %1
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 5, i64 5, i64 5) ; [#uses=0 type=i32]
  call void (...)* @_ssdm_op_SpecLoopName([11 x i8]* @p_str6) nounwind, !dbg !2782 ; [debug line = 38:69]
  %tmp_3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([11 x i8]* @p_str6), !dbg !2782 ; [#uses=1 type=i32] [debug line = 38:69]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !2783 ; [debug line = 39:1]
  ...
  call void @llvm.dbg.value(metadata !{i64 %ret}, i64 0, metadata !2784) nounwind, !dbg !2792 ; [debug line = 100:14@39:22] [debug variable = ret]
  call void @llvm.dbg.value(metadata !{i64 %ret}, i64 0, metadata !2793), !dbg !2778 ; [debug line = 39:22] [debug variable = converter]
  %tmp_5 = trunc i64 %ret to i32                  ; [#uses=1 type=i32]
  %bitcast1 = bitcast i32 %tmp_5 to float         ; [#uses=1 type=float]
  %tmp_4 = zext i4 %i to i64, !dbg !2806          ; [#uses=1 type=i64] [debug line = 40:3]
  %offset_buf_addr = getelementptr inbounds [10 x float]* %offset_buf, i64 0, i64 %tmp_4, !dbg !2806 ; [#uses=1 type=float*] [debug line = 40:3]
  store float %bitcast1, float* %offset_buf_addr, align 8, !dbg !2806 ; [debug line = 40:3]
  ...
  %tmp_8 = or i4 %i, 1, !dbg !2807                ; [#uses=1 type=i4] [debug line = 41:3]
  %tmp_9 = zext i4 %tmp_8 to i64, !dbg !2807      ; [#uses=1 type=i64] [debug line = 41:3]
  %offset_buf_addr_1 = getelementptr inbounds [10 x float]* %offset_buf, i64 0, i64 %tmp_9, !dbg !2807 ; [#uses=1 type=float*] [debug line = 41:3]
  store float %tmp_7, float* %offset_buf_addr_1, align 4, !dbg !2807 ; [debug line = 41:3]
  %empty_8 = call i32 (...)* @_ssdm_op_SpecRegionEnd([11 x i8]* @p_str6, i32 %tmp_3), !dbg !2808 ; [#uses=0 type=i32] [debug line = 42:2]
  %i_1 = add i4 2, %i, !dbg !2809                 ; [#uses=1 type=i4] [debug line = 38:38]
  call void @llvm.dbg.value(metadata !{i4 %i_1}, i64 0, metadata !2810), !dbg !2809 ; [debug line = 38:38] [debug variable = i]
  br label %1, !dbg !2809                         ; [debug line = 38:38]
...
.preheader17:                                     ; preds = %7, %.preheader17.preheader
  ...
  %exitcond6 = icmp eq i4 %i1, -6, !dbg !2780     ; [#uses=1 type=i1] [debug line = 45:26]
  %i_2 = add i4 %i1, 1, !dbg !2811                ; [#uses=1 type=i4] [debug line = 45:36]
  br i1 %exitcond6, label %.preheader16.preheader, label %3, !dbg !2780 ; [debug line = 45:26]

.preheader16.preheader:                           ; preds = %.preheader17
  br label %.preheader16, !dbg !2812              ; [debug line = 55:20]

; <label>:3                                       ; preds = %.preheader17
  %empty_9 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 10, i64 10, i64 10) ; [#uses=0 type=i32]
  call void (...)* @_ssdm_op_SpecLoopName([9 x i8]* @p_str7) nounwind, !dbg !2814 ; [debug line = 45:42]
  %tmp_1 = call i32 (...)* @_ssdm_op_SpecRegionBegin([9 x i8]* @p_str7), !dbg !2814 ; [#uses=1 type=i32] [debug line = 45:42]
  %tmp_s = add i11 %is_idx_1, 128, !dbg !2816     ; [#uses=1 type=i11] [debug line = 46:27]
  br label %4, !dbg !2816                         ; [debug line = 46:27]

; <label>:4                                       ; preds = %6, %3
  %j = phi i9 [ 0, %3 ], [ %j_1, %6 ]             ; [#uses=3 type=i9]
  %is_idx_2 = phi i11 [ %is_idx_1, %3 ], [ %tmp_11, %6 ] ; [#uses=2 type=i11]
  %exitcond9 = icmp eq i11 %is_idx_2, %indvars_iv1, !dbg !2816 ; [#uses=1 type=i1] [debug line = 46:27]
  br i1 %exitcond9, label %7, label %5, !dbg !2816 ; [debug line = 46:27]

; <label>:5                                       ; preds = %4
  %empty_10 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 128, i64 128, i64 128) ; [#uses=0 type=i32]
  call void (...)* @_ssdm_op_SpecLoopName([9 x i8]* @p_str8) nounwind, !dbg !2818 ; [debug line = 46:69]
  %tmp_12 = call i32 (...)* @_ssdm_op_SpecRegionBegin([9 x i8]* @p_str8), !dbg !2818 ; [#uses=1 type=i32] [debug line = 46:69]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !2820 ; [debug line = 47:1]
  %tmp_11 = add i11 1, %is_idx_2, !dbg !2821      ; [#uses=1 type=i11] [debug line = 48:23]
  ...
  call void @llvm.dbg.value(metadata !{i64 %ret_1}, i64 0, metadata !2822) nounwind, !dbg !2823 ; [debug line = 100:14@48:23] [debug variable = ret]
  call void @llvm.dbg.value(metadata !{i64 %ret_1}, i64 0, metadata !2793), !dbg !2821 ; [debug line = 48:23] [debug variable = converter]
  %tmp_160 = trunc i64 %ret_1 to i32              ; [#uses=1 type=i32]
  %bitcast2 = bitcast i32 %tmp_160 to float       ; [#uses=4 type=float]
  %arrayNo_cast_cast = call i3 @_ssdm_op_PartSelect.i3.i9.i32.i32(i9 %j, i32 6, i32 8) ; [#uses=1 type=i3]
  %tmp_287 = trunc i9 %j to i6                    ; [#uses=2 type=i6]
  %tmp_13 = call i10 @_ssdm_op_BitConcatenate.i10.i4.i6(i4 %i1, i6 %tmp_287) ; [#uses=1 type=i10]
  %tmp_14 = zext i10 %tmp_13 to i64, !dbg !2824   ; [#uses=4 type=i64] [debug line = 49:4]
  %weight_buf_0_addr = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_14, !dbg !2824 ; [#uses=1 type=float*] [debug line = 49:4]
  %weight_buf_1_addr = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_14, !dbg !2824 ; [#uses=1 type=float*] [debug line = 49:4]
  %weight_buf_2_addr = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_14, !dbg !2824 ; [#uses=1 type=float*] [debug line = 49:4]
  %weight_buf_3_addr = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_14, !dbg !2824 ; [#uses=1 type=float*] [debug line = 49:4]
  %tmp_15 = call i32 @_ssdm_op_PartSelect.i32.i64.i32.i32(i64 %ret_1, i32 32, i32 63) ; [#uses=1 type=i32]
  %tmp_16 = bitcast i32 %tmp_15 to float          ; [#uses=4 type=float]
  %newIndex = or i6 %tmp_287, 1, !dbg !2825       ; [#uses=1 type=i6] [debug line = 50:4]
  %tmp_17 = call i10 @_ssdm_op_BitConcatenate.i10.i4.i6(i4 %i1, i6 %newIndex) ; [#uses=1 type=i10]
  %tmp_19 = zext i10 %tmp_17 to i64, !dbg !2825   ; [#uses=4 type=i64] [debug line = 50:4]
  %weight_buf_0_addr_1 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_19, !dbg !2825 ; [#uses=1 type=float*] [debug line = 50:4]
  %weight_buf_1_addr_1 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_19, !dbg !2825 ; [#uses=1 type=float*] [debug line = 50:4]
  %weight_buf_2_addr_1 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_19, !dbg !2825 ; [#uses=1 type=float*] [debug line = 50:4]
  %weight_buf_3_addr_1 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_19, !dbg !2825 ; [#uses=1 type=float*] [debug line = 50:4]
  switch i3 %arrayNo_cast_cast, label %branch7 [
    i3 0, label %branch4
    i3 1, label %branch5
    i3 2, label %branch6
  ], !dbg !2824                                   ; [debug line = 49:4]

; <label>:6                                       ; preds = %branch7, %branch6, %branch5, %branch4
  %empty_12 = call i32 (...)* @_ssdm_op_SpecRegionEnd([9 x i8]* @p_str8, i32 %tmp_12), !dbg !2826 ; [#uses=0 type=i32] [debug line = 51:3]
  %j_1 = add i9 %j, 2, !dbg !2827                 ; [#uses=1 type=i9] [debug line = 46:38]
  call void @llvm.dbg.value(metadata !{i9 %j_1}, i64 0, metadata !2828), !dbg !2827 ; [debug line = 46:38] [debug variable = j]
  br label %4, !dbg !2827                         ; [debug line = 46:38]

; <label>:7                                       ; preds = %4
  %empty_13 = call i32 (...)* @_ssdm_op_SpecRegionEnd([9 x i8]* @p_str7, i32 %tmp_1), !dbg !2829 ; [#uses=0 type=i32] [debug line = 52:2]
  call void @llvm.dbg.value(metadata !{i4 %i_2}, i64 0, metadata !2830), !dbg !2811 ; [debug line = 45:36] [debug variable = i]
  %indvars_iv_next1 = add i11 %indvars_iv1, 128, !dbg !2811 ; [#uses=1 type=i11] [debug line = 45:36]
  br label %.preheader17, !dbg !2811              ; [debug line = 45:36]

.preheader16:                                     ; preds = %18, %.preheader16.preheader
  %t = phi i12 [ %t_1, %18 ], [ 0, %.preheader16.preheader ] ; [#uses=2 type=i12]
  %os_idx = phi i14 [ %os_idx_2, %18 ], [ 0, %.preheader16.preheader ] ; [#uses=3 type=i14]
  %is_idx_3 = phi i19 [ %is_idx_4, %18 ], [ 1285, %.preheader16.preheader ] ; [#uses=2 type=i19]
  %tmp_22 = call i1 @_ssdm_op_BitSelect.i1.i12.i32(i12 %t, i32 11), !dbg !2812 ; [#uses=1 type=i1] [debug line = 55:20]
  br i1 %tmp_22, label %19, label %8, !dbg !2812  ; [debug line = 55:20]

; <label>:8                                       ; preds = %.preheader16
  %os_idx_cast = zext i14 %os_idx to i15, !dbg !2812 ; [#uses=1 type=i15] [debug line = 55:20]
  %empty_14 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 16, i64 16, i64 16) ; [#uses=0 type=i32]
  call void (...)* @_ssdm_op_SpecLoopName([3 x i8]* @p_str9) nounwind, !dbg !2831 ; [debug line = 55:78]
  %tmp_10 = call i32 (...)* @_ssdm_op_SpecRegionBegin([3 x i8]* @p_str9), !dbg !2831 ; [#uses=1 type=i32] [debug line = 55:78]
  %is_idx_4 = add i19 %is_idx_3, 16384, !dbg !2821 ; [#uses=1 type=i19] [debug line = 48:23]
  call void @llvm.dbg.value(metadata !{i19 %is_idx_4}, i64 0, metadata !2833), !dbg !2821 ; [debug line = 48:23] [debug variable = is_idx]
  br label %9, !dbg !2834                         ; [debug line = 58:27]

; <label>:9                                       ; preds = %14, %8
  %indvars_iv5_in = phi i19 [ %is_idx_3, %8 ], [ %is_idx_6, %14 ] ; [#uses=2 type=i19]
  %i2 = phi i8 [ 0, %8 ], [ %i_3, %14 ]           ; [#uses=4 type=i8]
  %exitcond8 = icmp eq i8 %i2, -128, !dbg !2834   ; [#uses=1 type=i1] [debug line = 58:27]
  %i_3 = add i8 %i2, 1, !dbg !2836                ; [#uses=1 type=i8] [debug line = 58:38]
  br i1 %exitcond8, label %.preheader.preheader.preheader, label %10, !dbg !2834 ; [debug line = 58:27]

.preheader.preheader.preheader:                   ; preds = %9
  br label %.preheader.preheader

; <label>:10                                      ; preds = %9
  %is_idx_6 = add i19 %indvars_iv5_in, 128, !dbg !2834 ; [#uses=2 type=i19] [debug line = 58:27]
  %empty_15 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 128, i64 128, i64 128) ; [#uses=0 type=i32]
  call void (...)* @_ssdm_op_SpecLoopName([9 x i8]* @p_str10) nounwind, !dbg !2837 ; [debug line = 58:44]
  %tmp_18 = call i32 (...)* @_ssdm_op_SpecRegionBegin([9 x i8]* @p_str10), !dbg !2837 ; [#uses=1 type=i32] [debug line = 58:44]
  call void @llvm.dbg.value(metadata !{i19 %is_idx_6}, i64 0, metadata !2833), !dbg !2778 ; [debug line = 39:22] [debug variable = is_idx]
  br label %11, !dbg !2839                        ; [debug line = 59:28]

; <label>:11                                      ; preds = %13, %10
  %j3 = phi i9 [ 0, %10 ], [ %j_2, %13 ]          ; [#uses=3 type=i9]
  %is_idx_5 = phi i19 [ %indvars_iv5_in, %10 ], [ %is_idx_7, %13 ] ; [#uses=2 type=i19]
  %exitcond7 = icmp eq i19 %is_idx_5, %is_idx_6, !dbg !2839 ; [#uses=1 type=i1] [debug line = 59:28]
  br i1 %exitcond7, label %14, label %12, !dbg !2839 ; [debug line = 59:28]

; <label>:12                                      ; preds = %11
  %empty_16 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 128, i64 128, i64 128) ; [#uses=0 type=i32]
  call void (...)* @_ssdm_op_SpecLoopName([9 x i8]* @p_str11) nounwind, !dbg !2841 ; [debug line = 59:70]
  %tmp_23 = call i32 (...)* @_ssdm_op_SpecRegionBegin([9 x i8]* @p_str11), !dbg !2841 ; [#uses=1 type=i32] [debug line = 59:70]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !2843 ; [debug line = 60:1]
  %is_idx_7 = add i19 1, %is_idx_5, !dbg !2844    ; [#uses=1 type=i19] [debug line = 61:24]
  call void @llvm.dbg.value(metadata !{i19 %is_idx_7}, i64 0, metadata !2833), !dbg !2844 ; [debug line = 61:24] [debug variable = is_idx]
  ...
  call void @llvm.dbg.value(metadata !{i64 %ret_2}, i64 0, metadata !2845) nounwind, !dbg !2846 ; [debug line = 100:14@61:24] [debug variable = ret]
  call void @llvm.dbg.value(metadata !{i64 %ret_2}, i64 0, metadata !2793), !dbg !2844 ; [debug line = 61:24] [debug variable = converter]
  %tmp_436 = trunc i64 %ret_2 to i32              ; [#uses=1 type=i32]
  %bitcast = bitcast i32 %tmp_436 to float        ; [#uses=4 type=float]
  %arrayNo1_cast_cast = call i3 @_ssdm_op_PartSelect.i3.i9.i32.i32(i9 %j3, i32 6, i32 8) ; [#uses=1 type=i3]
  %tmp_437 = trunc i9 %j3 to i6                   ; [#uses=2 type=i6]
  %tmp_419 = call i14 @_ssdm_op_BitConcatenate.i14.i8.i6(i8 %i2, i6 %tmp_437) ; [#uses=1 type=i14]
  %tmp_420 = zext i14 %tmp_419 to i64, !dbg !2847 ; [#uses=4 type=i64] [debug line = 62:5]
  %in_buf_0_addr = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %tmp_420, !dbg !2847 ; [#uses=1 type=float*] [debug line = 62:5]
  %in_buf_1_addr = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %tmp_420, !dbg !2847 ; [#uses=1 type=float*] [debug line = 62:5]
  %in_buf_2_addr = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %tmp_420, !dbg !2847 ; [#uses=1 type=float*] [debug line = 62:5]
  %in_buf_3_addr = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %tmp_420, !dbg !2847 ; [#uses=1 type=float*] [debug line = 62:5]
  %tmp_25 = call i32 @_ssdm_op_PartSelect.i32.i64.i32.i32(i64 %ret_2, i32 32, i32 63) ; [#uses=1 type=i32]
  %tmp_26 = bitcast i32 %tmp_25 to float          ; [#uses=4 type=float]
  %newIndex6 = or i6 %tmp_437, 1, !dbg !2848      ; [#uses=1 type=i6] [debug line = 63:5]
  %tmp_421 = call i14 @_ssdm_op_BitConcatenate.i14.i8.i6(i8 %i2, i6 %newIndex6) ; [#uses=1 type=i14]
  %tmp_422 = zext i14 %tmp_421 to i64, !dbg !2848 ; [#uses=4 type=i64] [debug line = 63:5]
  %in_buf_0_addr_1 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %tmp_422, !dbg !2848 ; [#uses=1 type=float*] [debug line = 63:5]
  %in_buf_1_addr_1 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %tmp_422, !dbg !2848 ; [#uses=1 type=float*] [debug line = 63:5]
  %in_buf_2_addr_1 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %tmp_422, !dbg !2848 ; [#uses=1 type=float*] [debug line = 63:5]
  %in_buf_3_addr_1 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %tmp_422, !dbg !2848 ; [#uses=1 type=float*] [debug line = 63:5]
  switch i3 %arrayNo1_cast_cast, label %branch15 [
    i3 0, label %branch12
    i3 1, label %branch13
    i3 2, label %branch14
  ], !dbg !2847                                   ; [debug line = 62:5]

; <label>:13                                      ; preds = %branch15, %branch14, %branch13, %branch12
  %empty_18 = call i32 (...)* @_ssdm_op_SpecRegionEnd([9 x i8]* @p_str11, i32 %tmp_23), !dbg !2849 ; [#uses=0 type=i32] [debug line = 64:4]
  %j_2 = add i9 %j3, 2, !dbg !2850                ; [#uses=1 type=i9] [debug line = 59:39]
  call void @llvm.dbg.value(metadata !{i9 %j_2}, i64 0, metadata !2851), !dbg !2850 ; [debug line = 59:39] [debug variable = j]
  br label %11, !dbg !2850                        ; [debug line = 59:39]

; <label>:14                                      ; preds = %11
  %empty_19 = call i32 (...)* @_ssdm_op_SpecRegionEnd([9 x i8]* @p_str10, i32 %tmp_18), !dbg !2852 ; [#uses=0 type=i32] [debug line = 65:3]
  call void @llvm.dbg.value(metadata !{i8 %i_3}, i64 0, metadata !2853), !dbg !2836 ; [debug line = 58:38] [debug variable = i]
  br label %9, !dbg !2836                         ; [debug line = 58:38]
...
.preheader.preheader:                             ; preds = %.preheader, %.preheader.preheader.preheader
  ...
  %j5 = phi i4 [ %j_3, %.preheader ], [ 0, %.preheader.preheader.preheader ] ; [#uses=2 type=i4]
  %tmp_21 = call i14 @_ssdm_op_BitConcatenate.i14.i8.i6(i8 %i4, i6 0) ; [#uses=64 type=i14]
  %tmp_24 = or i14 %tmp_21, 1                     ; [#uses=1 type=i14]
  %tmp_28 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_24) ; [#uses=1 type=i64]
  %tmp_35 = or i14 %tmp_21, 2                     ; [#uses=1 type=i14]
  %tmp_36 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_35) ; [#uses=1 type=i64]
  %tmp_37 = or i14 %tmp_21, 3                     ; [#uses=1 type=i14]
  %tmp_38 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_37) ; [#uses=1 type=i64]
  %tmp_39 = or i14 %tmp_21, 4                     ; [#uses=1 type=i14]
  %tmp_40 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_39) ; [#uses=1 type=i64]
  %tmp_41 = or i14 %tmp_21, 5                     ; [#uses=1 type=i14]
  %tmp_42 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_41) ; [#uses=1 type=i64]
  %tmp_43 = or i14 %tmp_21, 6                     ; [#uses=1 type=i14]
  %tmp_44 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_43) ; [#uses=1 type=i64]
  %tmp_45 = or i14 %tmp_21, 7                     ; [#uses=1 type=i14]
  %tmp_46 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_45) ; [#uses=1 type=i64]
  %tmp_47 = or i14 %tmp_21, 8                     ; [#uses=1 type=i14]
  %tmp_48 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_47) ; [#uses=1 type=i64]
  %tmp_49 = or i14 %tmp_21, 9                     ; [#uses=1 type=i14]
  %tmp_50 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_49) ; [#uses=1 type=i64]
  %tmp_51 = or i14 %tmp_21, 10                    ; [#uses=1 type=i14]
  %tmp_52 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_51) ; [#uses=1 type=i64]
  %tmp_53 = or i14 %tmp_21, 11                    ; [#uses=1 type=i14]
  %tmp_54 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_53) ; [#uses=1 type=i64]
  %tmp_55 = or i14 %tmp_21, 12                    ; [#uses=1 type=i14]
  %tmp_56 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_55) ; [#uses=1 type=i64]
  %tmp_57 = or i14 %tmp_21, 13                    ; [#uses=1 type=i14]
  %tmp_58 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_57) ; [#uses=1 type=i64]
  %tmp_59 = or i14 %tmp_21, 14                    ; [#uses=1 type=i14]
  %tmp_60 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_59) ; [#uses=1 type=i64]
  %tmp_61 = or i14 %tmp_21, 15                    ; [#uses=1 type=i14]
  %tmp_62 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_61) ; [#uses=1 type=i64]
  %tmp_63 = or i14 %tmp_21, 16                    ; [#uses=1 type=i14]
  %tmp_64 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_63) ; [#uses=1 type=i64]
  %tmp_65 = or i14 %tmp_21, 17                    ; [#uses=1 type=i14]
  %tmp_66 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_65) ; [#uses=1 type=i64]
  %tmp_67 = or i14 %tmp_21, 18                    ; [#uses=1 type=i14]
  %tmp_68 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_67) ; [#uses=1 type=i64]
  %tmp_69 = or i14 %tmp_21, 19                    ; [#uses=1 type=i14]
  %tmp_70 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_69) ; [#uses=1 type=i64]
  %tmp_71 = or i14 %tmp_21, 20                    ; [#uses=1 type=i14]
  %tmp_72 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_71) ; [#uses=1 type=i64]
  %tmp_73 = or i14 %tmp_21, 21                    ; [#uses=1 type=i14]
  %tmp_74 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_73) ; [#uses=1 type=i64]
  %tmp_75 = or i14 %tmp_21, 22                    ; [#uses=1 type=i14]
  %tmp_76 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_75) ; [#uses=1 type=i64]
  %tmp_77 = or i14 %tmp_21, 23                    ; [#uses=1 type=i14]
  %tmp_78 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_77) ; [#uses=1 type=i64]
  %tmp_79 = or i14 %tmp_21, 24                    ; [#uses=1 type=i14]
  %tmp_80 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_79) ; [#uses=1 type=i64]
  %tmp_81 = or i14 %tmp_21, 25                    ; [#uses=1 type=i14]
  %tmp_82 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_81) ; [#uses=1 type=i64]
  %tmp_83 = or i14 %tmp_21, 26                    ; [#uses=1 type=i14]
  %tmp_84 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_83) ; [#uses=1 type=i64]
  %tmp_85 = or i14 %tmp_21, 27                    ; [#uses=1 type=i14]
  %tmp_86 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_85) ; [#uses=1 type=i64]
  %tmp_87 = or i14 %tmp_21, 28                    ; [#uses=1 type=i14]
  %tmp_88 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_87) ; [#uses=1 type=i64]
  %tmp_89 = or i14 %tmp_21, 29                    ; [#uses=1 type=i14]
  %tmp_90 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_89) ; [#uses=1 type=i64]
  %tmp_91 = or i14 %tmp_21, 30                    ; [#uses=1 type=i14]
  %tmp_92 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_91) ; [#uses=1 type=i64]
  %tmp_93 = or i14 %tmp_21, 31                    ; [#uses=1 type=i14]
  %tmp_94 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_93) ; [#uses=1 type=i64]
  %tmp_95 = or i14 %tmp_21, 32                    ; [#uses=1 type=i14]
  %tmp_96 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_95) ; [#uses=1 type=i64]
  %tmp_97 = or i14 %tmp_21, 33                    ; [#uses=1 type=i14]
  %tmp_98 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_97) ; [#uses=1 type=i64]
  %tmp_99 = or i14 %tmp_21, 34                    ; [#uses=1 type=i14]
  %tmp_100 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_99) ; [#uses=1 type=i64]
  %tmp_101 = or i14 %tmp_21, 35                   ; [#uses=1 type=i14]
  %tmp_102 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_101) ; [#uses=1 type=i64]
  %tmp_103 = or i14 %tmp_21, 36                   ; [#uses=1 type=i14]
  %tmp_104 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_103) ; [#uses=1 type=i64]
  %tmp_105 = or i14 %tmp_21, 37                   ; [#uses=1 type=i14]
  %tmp_106 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_105) ; [#uses=1 type=i64]
  %tmp_107 = or i14 %tmp_21, 38                   ; [#uses=1 type=i14]
  %tmp_108 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_107) ; [#uses=1 type=i64]
  %tmp_109 = or i14 %tmp_21, 39                   ; [#uses=1 type=i14]
  %tmp_110 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_109) ; [#uses=1 type=i64]
  %tmp_111 = or i14 %tmp_21, 40                   ; [#uses=1 type=i14]
  %tmp_112 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_111) ; [#uses=1 type=i64]
  %tmp_113 = or i14 %tmp_21, 41                   ; [#uses=1 type=i14]
  %tmp_114 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_113) ; [#uses=1 type=i64]
  %tmp_115 = or i14 %tmp_21, 42                   ; [#uses=1 type=i14]
  %tmp_116 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_115) ; [#uses=1 type=i64]
  %tmp_117 = or i14 %tmp_21, 43                   ; [#uses=1 type=i14]
  %tmp_118 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_117) ; [#uses=1 type=i64]
  %tmp_119 = or i14 %tmp_21, 44                   ; [#uses=1 type=i14]
  %tmp_120 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_119) ; [#uses=1 type=i64]
  %tmp_121 = or i14 %tmp_21, 45                   ; [#uses=1 type=i14]
  %tmp_122 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_121) ; [#uses=1 type=i64]
  %tmp_123 = or i14 %tmp_21, 46                   ; [#uses=1 type=i14]
  %tmp_124 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_123) ; [#uses=1 type=i64]
  %tmp_125 = or i14 %tmp_21, 47                   ; [#uses=1 type=i14]
  %tmp_126 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_125) ; [#uses=1 type=i64]
  %tmp_127 = or i14 %tmp_21, 48                   ; [#uses=1 type=i14]
  %tmp_128 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_127) ; [#uses=1 type=i64]
  %tmp_129 = or i14 %tmp_21, 49                   ; [#uses=1 type=i14]
  %tmp_130 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_129) ; [#uses=1 type=i64]
  %tmp_131 = or i14 %tmp_21, 50                   ; [#uses=1 type=i14]
  %tmp_132 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_131) ; [#uses=1 type=i64]
  %tmp_133 = or i14 %tmp_21, 51                   ; [#uses=1 type=i14]
  %tmp_134 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_133) ; [#uses=1 type=i64]
  %tmp_135 = or i14 %tmp_21, 52                   ; [#uses=1 type=i14]
  %tmp_136 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_135) ; [#uses=1 type=i64]
  %tmp_137 = or i14 %tmp_21, 53                   ; [#uses=1 type=i14]
  %tmp_138 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_137) ; [#uses=1 type=i64]
  %tmp_139 = or i14 %tmp_21, 54                   ; [#uses=1 type=i14]
  %tmp_140 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_139) ; [#uses=1 type=i64]
  %tmp_141 = or i14 %tmp_21, 55                   ; [#uses=1 type=i14]
  %tmp_142 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_141) ; [#uses=1 type=i64]
  %tmp_143 = or i14 %tmp_21, 56                   ; [#uses=1 type=i14]
  %tmp_144 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_143) ; [#uses=1 type=i64]
  %tmp_145 = or i14 %tmp_21, 57                   ; [#uses=1 type=i14]
  %tmp_146 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_145) ; [#uses=1 type=i64]
  %tmp_147 = or i14 %tmp_21, 58                   ; [#uses=1 type=i14]
  %tmp_148 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_147) ; [#uses=1 type=i64]
  %tmp_149 = or i14 %tmp_21, 59                   ; [#uses=1 type=i14]
  %tmp_150 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_149) ; [#uses=1 type=i64]
  %tmp_151 = or i14 %tmp_21, 60                   ; [#uses=1 type=i14]
  %tmp_152 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_151) ; [#uses=1 type=i64]
  %tmp_153 = or i14 %tmp_21, 61                   ; [#uses=1 type=i14]
  %tmp_154 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_153) ; [#uses=1 type=i64]
  %tmp_155 = or i14 %tmp_21, 62                   ; [#uses=1 type=i14]
  %tmp_156 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_155) ; [#uses=1 type=i64]
  %tmp_157 = or i14 %tmp_21, 63                   ; [#uses=1 type=i14]
  %tmp_158 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_157) ; [#uses=1 type=i64]
...
.preheader:                                       ; preds = %.preheader.preheader
  %i_4 = add i8 %i4, 1, !dbg !2854                ; [#uses=2 type=i8] [debug line = 68:32]
  call void @llvm.dbg.value(metadata !{i8 %i_4}, i64 0, metadata !2856), !dbg !2854 ; [debug line = 68:32] [debug variable = i]
  ...
  %exitcond = icmp eq i4 %j5, -6, !dbg !2857      ; [#uses=66 type=i1] [debug line = 70:22]
  %j5_mid2 = select i1 %exitcond, i4 0, i4 %j5    ; [#uses=4 type=i4]
  %tmp_159 = call i14 @_ssdm_op_BitConcatenate.i14.i8.i6(i8 %i_4, i6 0) ; [#uses=64 type=i14]
  %tmp_161 = or i14 %tmp_159, 1                   ; [#uses=1 type=i14]
  %tmp_162 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_161) ; [#uses=1 type=i64]
  %tmp_163 = or i14 %tmp_159, 2                   ; [#uses=1 type=i14]
  %tmp_164 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_163) ; [#uses=1 type=i64]
  %tmp_165 = or i14 %tmp_159, 3                   ; [#uses=1 type=i14]
  %tmp_166 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_165) ; [#uses=1 type=i64]
  %tmp_167 = or i14 %tmp_159, 4                   ; [#uses=1 type=i14]
  %tmp_168 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_167) ; [#uses=1 type=i64]
  %tmp_169 = or i14 %tmp_159, 5                   ; [#uses=1 type=i14]
  %tmp_170 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_169) ; [#uses=1 type=i64]
  %tmp_171 = or i14 %tmp_159, 6                   ; [#uses=1 type=i14]
  %tmp_172 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_171) ; [#uses=1 type=i64]
  %tmp_173 = or i14 %tmp_159, 7                   ; [#uses=1 type=i14]
  %tmp_174 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_173) ; [#uses=1 type=i64]
  %tmp_175 = or i14 %tmp_159, 8                   ; [#uses=1 type=i14]
  %tmp_176 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_175) ; [#uses=1 type=i64]
  %tmp_177 = or i14 %tmp_159, 9                   ; [#uses=1 type=i14]
  %tmp_178 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_177) ; [#uses=1 type=i64]
  %tmp_179 = or i14 %tmp_159, 10                  ; [#uses=1 type=i14]
  %tmp_180 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_179) ; [#uses=1 type=i64]
  %tmp_181 = or i14 %tmp_159, 11                  ; [#uses=1 type=i14]
  %tmp_182 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_181) ; [#uses=1 type=i64]
  %tmp_183 = or i14 %tmp_159, 12                  ; [#uses=1 type=i14]
  %tmp_184 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_183) ; [#uses=1 type=i64]
  %tmp_185 = or i14 %tmp_159, 13                  ; [#uses=1 type=i14]
  %tmp_186 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_185) ; [#uses=1 type=i64]
  %tmp_187 = or i14 %tmp_159, 14                  ; [#uses=1 type=i14]
  %tmp_188 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_187) ; [#uses=1 type=i64]
  %tmp_189 = or i14 %tmp_159, 15                  ; [#uses=1 type=i14]
  %tmp_190 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_189) ; [#uses=1 type=i64]
  %tmp_191 = or i14 %tmp_159, 16                  ; [#uses=1 type=i14]
  %tmp_192 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_191) ; [#uses=1 type=i64]
  %tmp_193 = or i14 %tmp_159, 17                  ; [#uses=1 type=i14]
  %tmp_194 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_193) ; [#uses=1 type=i64]
  %tmp_195 = or i14 %tmp_159, 18                  ; [#uses=1 type=i14]
  %tmp_196 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_195) ; [#uses=1 type=i64]
  %tmp_197 = or i14 %tmp_159, 19                  ; [#uses=1 type=i14]
  %tmp_198 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_197) ; [#uses=1 type=i64]
  %tmp_199 = or i14 %tmp_159, 20                  ; [#uses=1 type=i14]
  %tmp_200 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_199) ; [#uses=1 type=i64]
  %tmp_201 = or i14 %tmp_159, 21                  ; [#uses=1 type=i14]
  %tmp_202 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_201) ; [#uses=1 type=i64]
  %tmp_203 = or i14 %tmp_159, 22                  ; [#uses=1 type=i14]
  %tmp_204 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_203) ; [#uses=1 type=i64]
  %tmp_205 = or i14 %tmp_159, 23                  ; [#uses=1 type=i14]
  %tmp_206 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_205) ; [#uses=1 type=i64]
  %tmp_207 = or i14 %tmp_159, 24                  ; [#uses=1 type=i14]
  %tmp_208 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_207) ; [#uses=1 type=i64]
  %tmp_209 = or i14 %tmp_159, 25                  ; [#uses=1 type=i14]
  %tmp_210 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_209) ; [#uses=1 type=i64]
  %tmp_211 = or i14 %tmp_159, 26                  ; [#uses=1 type=i14]
  %tmp_212 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_211) ; [#uses=1 type=i64]
  %tmp_213 = or i14 %tmp_159, 27                  ; [#uses=1 type=i14]
  %tmp_214 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_213) ; [#uses=1 type=i64]
  %tmp_215 = or i14 %tmp_159, 28                  ; [#uses=1 type=i14]
  %tmp_216 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_215) ; [#uses=1 type=i64]
  %tmp_217 = or i14 %tmp_159, 29                  ; [#uses=1 type=i14]
  %tmp_218 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_217) ; [#uses=1 type=i64]
  %tmp_219 = or i14 %tmp_159, 30                  ; [#uses=1 type=i14]
  %tmp_220 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_219) ; [#uses=1 type=i64]
  %tmp_221 = or i14 %tmp_159, 31                  ; [#uses=1 type=i14]
  %tmp_222 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_221) ; [#uses=1 type=i64]
  %tmp_223 = or i14 %tmp_159, 32                  ; [#uses=1 type=i14]
  %tmp_224 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_223) ; [#uses=1 type=i64]
  %tmp_225 = or i14 %tmp_159, 33                  ; [#uses=1 type=i14]
  %tmp_226 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_225) ; [#uses=1 type=i64]
  %tmp_227 = or i14 %tmp_159, 34                  ; [#uses=1 type=i14]
  %tmp_228 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_227) ; [#uses=1 type=i64]
  %tmp_229 = or i14 %tmp_159, 35                  ; [#uses=1 type=i14]
  %tmp_230 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_229) ; [#uses=1 type=i64]
  %tmp_231 = or i14 %tmp_159, 36                  ; [#uses=1 type=i14]
  %tmp_232 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_231) ; [#uses=1 type=i64]
  %tmp_233 = or i14 %tmp_159, 37                  ; [#uses=1 type=i14]
  %tmp_234 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_233) ; [#uses=1 type=i64]
  %tmp_235 = or i14 %tmp_159, 38                  ; [#uses=1 type=i14]
  %tmp_236 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_235) ; [#uses=1 type=i64]
  %tmp_237 = or i14 %tmp_159, 39                  ; [#uses=1 type=i14]
  %tmp_238 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_237) ; [#uses=1 type=i64]
  %tmp_239 = or i14 %tmp_159, 40                  ; [#uses=1 type=i14]
  %tmp_240 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_239) ; [#uses=1 type=i64]
  %tmp_241 = or i14 %tmp_159, 41                  ; [#uses=1 type=i14]
  %tmp_242 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_241) ; [#uses=1 type=i64]
  %tmp_243 = or i14 %tmp_159, 42                  ; [#uses=1 type=i14]
  %tmp_244 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_243) ; [#uses=1 type=i64]
  %tmp_245 = or i14 %tmp_159, 43                  ; [#uses=1 type=i14]
  %tmp_246 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_245) ; [#uses=1 type=i64]
  %tmp_247 = or i14 %tmp_159, 44                  ; [#uses=1 type=i14]
  %tmp_248 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_247) ; [#uses=1 type=i64]
  %tmp_249 = or i14 %tmp_159, 45                  ; [#uses=1 type=i14]
  %tmp_250 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_249) ; [#uses=1 type=i64]
  %tmp_251 = or i14 %tmp_159, 46                  ; [#uses=1 type=i14]
  %tmp_252 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_251) ; [#uses=1 type=i64]
  %tmp_253 = or i14 %tmp_159, 47                  ; [#uses=1 type=i14]
  %tmp_254 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_253) ; [#uses=1 type=i64]
  %tmp_255 = or i14 %tmp_159, 48                  ; [#uses=1 type=i14]
  %tmp_256 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_255) ; [#uses=1 type=i64]
  %tmp_257 = or i14 %tmp_159, 49                  ; [#uses=1 type=i14]
  %tmp_258 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_257) ; [#uses=1 type=i64]
  %tmp_259 = or i14 %tmp_159, 50                  ; [#uses=1 type=i14]
  %tmp_260 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_259) ; [#uses=1 type=i64]
  %tmp_261 = or i14 %tmp_159, 51                  ; [#uses=1 type=i14]
  %tmp_262 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_261) ; [#uses=1 type=i64]
  %tmp_263 = or i14 %tmp_159, 52                  ; [#uses=1 type=i14]
  %tmp_264 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_263) ; [#uses=1 type=i64]
  %tmp_265 = or i14 %tmp_159, 53                  ; [#uses=1 type=i14]
  %tmp_266 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_265) ; [#uses=1 type=i64]
  %tmp_267 = or i14 %tmp_159, 54                  ; [#uses=1 type=i14]
  %tmp_268 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_267) ; [#uses=1 type=i64]
  %tmp_269 = or i14 %tmp_159, 55                  ; [#uses=1 type=i14]
  %tmp_270 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_269) ; [#uses=1 type=i64]
  %tmp_271 = or i14 %tmp_159, 56                  ; [#uses=1 type=i14]
  %tmp_272 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_271) ; [#uses=1 type=i64]
  %tmp_273 = or i14 %tmp_159, 57                  ; [#uses=1 type=i14]
  %tmp_274 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_273) ; [#uses=1 type=i64]
  %tmp_275 = or i14 %tmp_159, 58                  ; [#uses=1 type=i14]
  %tmp_276 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_275) ; [#uses=1 type=i64]
  %tmp_277 = or i14 %tmp_159, 59                  ; [#uses=1 type=i14]
  %tmp_278 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_277) ; [#uses=1 type=i64]
  %tmp_279 = or i14 %tmp_159, 60                  ; [#uses=1 type=i14]
  %tmp_280 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_279) ; [#uses=1 type=i64]
  %tmp_281 = or i14 %tmp_159, 61                  ; [#uses=1 type=i14]
  %tmp_282 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_281) ; [#uses=1 type=i64]
  %tmp_283 = or i14 %tmp_159, 62                  ; [#uses=1 type=i14]
  %tmp_284 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_283) ; [#uses=1 type=i64]
  %tmp_285 = or i14 %tmp_159, 63                  ; [#uses=1 type=i14]
  %tmp_286 = call i64 @_ssdm_op_BitConcatenate.i64.i50.i14(i50 0, i14 %tmp_285) ; [#uses=1 type=i64]
  %tmp_21_mid2_v = select i1 %exitcond, i8 %i_4, i8 %i4, !dbg !2860 ; [#uses=3 type=i8] [debug line = 74:6]
  %tmp_288 = call i11 @_ssdm_op_BitConcatenate.i11.i8.i3(i8 %tmp_21_mid2_v, i3 0) ; [#uses=1 type=i11]
  %p_shl_cast = zext i11 %tmp_288 to i12          ; [#uses=1 type=i12]
  %tmp_435 = call i9 @_ssdm_op_BitConcatenate.i9.i8.i1(i8 %tmp_21_mid2_v, i1 false) ; [#uses=1 type=i9]
  %p_shl1_cast = zext i9 %tmp_435 to i12, !dbg !2864 ; [#uses=1 type=i12] [debug line = 76:5]
  %tmp_289 = add i12 %p_shl1_cast, %p_shl_cast, !dbg !2864 ; [#uses=1 type=i12] [debug line = 76:5]
  %in_buf_0_load_mid2_s = select i1 %exitcond, i14 %tmp_159, i14 %tmp_21, !dbg !2860 ; [#uses=1 type=i14] [debug line = 74:6]
  %in_buf_0_load_mid2 = zext i14 %in_buf_0_load_mid2_s to i64, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_2 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_mid2 ; [#uses=1 type=float*]
  %in_buf_0_load = load float* %in_buf_0_addr_2, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_1_mid = select i1 %exitcond, i64 %tmp_162, i64 %tmp_28, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_3 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_1_mid ; [#uses=1 type=float*]
  %in_buf_0_load_1 = load float* %in_buf_0_addr_3, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_2_mid = select i1 %exitcond, i64 %tmp_164, i64 %tmp_36, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_4 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_2_mid ; [#uses=1 type=float*]
  %in_buf_0_load_2 = load float* %in_buf_0_addr_4, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_3_mid = select i1 %exitcond, i64 %tmp_166, i64 %tmp_38, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_5 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_3_mid ; [#uses=1 type=float*]
  %in_buf_0_load_3 = load float* %in_buf_0_addr_5, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_4_mid = select i1 %exitcond, i64 %tmp_168, i64 %tmp_40, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_6 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_4_mid ; [#uses=1 type=float*]
  %in_buf_0_load_4 = load float* %in_buf_0_addr_6, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_5_mid = select i1 %exitcond, i64 %tmp_170, i64 %tmp_42, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_7 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_5_mid ; [#uses=1 type=float*]
  %in_buf_0_load_5 = load float* %in_buf_0_addr_7, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_6_mid = select i1 %exitcond, i64 %tmp_172, i64 %tmp_44, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_8 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_6_mid ; [#uses=1 type=float*]
  %in_buf_0_load_6 = load float* %in_buf_0_addr_8, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_7_mid = select i1 %exitcond, i64 %tmp_174, i64 %tmp_46, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_9 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_7_mid ; [#uses=1 type=float*]
  %in_buf_0_load_7 = load float* %in_buf_0_addr_9, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_8_mid = select i1 %exitcond, i64 %tmp_176, i64 %tmp_48, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_10 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_8_mid ; [#uses=1 type=float*]
  %in_buf_0_load_8 = load float* %in_buf_0_addr_10, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_9_mid = select i1 %exitcond, i64 %tmp_178, i64 %tmp_50, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_11 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_9_mid ; [#uses=1 type=float*]
  %in_buf_0_load_9 = load float* %in_buf_0_addr_11, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_10_mi = select i1 %exitcond, i64 %tmp_180, i64 %tmp_52, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_12 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_10_mi ; [#uses=1 type=float*]
  %in_buf_0_load_10 = load float* %in_buf_0_addr_12, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_11_mi = select i1 %exitcond, i64 %tmp_182, i64 %tmp_54, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_13 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_11_mi ; [#uses=1 type=float*]
  %in_buf_0_load_11 = load float* %in_buf_0_addr_13, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_12_mi = select i1 %exitcond, i64 %tmp_184, i64 %tmp_56, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_14 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_12_mi ; [#uses=1 type=float*]
  %in_buf_0_load_12 = load float* %in_buf_0_addr_14, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_13_mi = select i1 %exitcond, i64 %tmp_186, i64 %tmp_58, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_15 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_13_mi ; [#uses=1 type=float*]
  %in_buf_0_load_13 = load float* %in_buf_0_addr_15, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_14_mi = select i1 %exitcond, i64 %tmp_188, i64 %tmp_60, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_16 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_14_mi ; [#uses=1 type=float*]
  %in_buf_0_load_14 = load float* %in_buf_0_addr_16, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_15_mi = select i1 %exitcond, i64 %tmp_190, i64 %tmp_62, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_17 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_15_mi ; [#uses=1 type=float*]
  %in_buf_0_load_15 = load float* %in_buf_0_addr_17, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_16_mi = select i1 %exitcond, i64 %tmp_192, i64 %tmp_64, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_18 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_16_mi ; [#uses=1 type=float*]
  %in_buf_0_load_16 = load float* %in_buf_0_addr_18, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_17_mi = select i1 %exitcond, i64 %tmp_194, i64 %tmp_66, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_19 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_17_mi ; [#uses=1 type=float*]
  %in_buf_0_load_17 = load float* %in_buf_0_addr_19, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_18_mi = select i1 %exitcond, i64 %tmp_196, i64 %tmp_68, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_20 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_18_mi ; [#uses=1 type=float*]
  %in_buf_0_load_18 = load float* %in_buf_0_addr_20, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_19_mi = select i1 %exitcond, i64 %tmp_198, i64 %tmp_70, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_21 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_19_mi ; [#uses=1 type=float*]
  %in_buf_0_load_19 = load float* %in_buf_0_addr_21, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_20_mi = select i1 %exitcond, i64 %tmp_200, i64 %tmp_72, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_22 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_20_mi ; [#uses=1 type=float*]
  %in_buf_0_load_20 = load float* %in_buf_0_addr_22, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_21_mi = select i1 %exitcond, i64 %tmp_202, i64 %tmp_74, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_23 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_21_mi ; [#uses=1 type=float*]
  %in_buf_0_load_21 = load float* %in_buf_0_addr_23, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_22_mi = select i1 %exitcond, i64 %tmp_204, i64 %tmp_76, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_24 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_22_mi ; [#uses=1 type=float*]
  %in_buf_0_load_22 = load float* %in_buf_0_addr_24, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_23_mi = select i1 %exitcond, i64 %tmp_206, i64 %tmp_78, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_25 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_23_mi ; [#uses=1 type=float*]
  %in_buf_0_load_23 = load float* %in_buf_0_addr_25, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_24_mi = select i1 %exitcond, i64 %tmp_208, i64 %tmp_80, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_26 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_24_mi ; [#uses=1 type=float*]
  %in_buf_0_load_24 = load float* %in_buf_0_addr_26, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_25_mi = select i1 %exitcond, i64 %tmp_210, i64 %tmp_82, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_27 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_25_mi ; [#uses=1 type=float*]
  %in_buf_0_load_25 = load float* %in_buf_0_addr_27, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_26_mi = select i1 %exitcond, i64 %tmp_212, i64 %tmp_84, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_28 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_26_mi ; [#uses=1 type=float*]
  %in_buf_0_load_26 = load float* %in_buf_0_addr_28, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_27_mi = select i1 %exitcond, i64 %tmp_214, i64 %tmp_86, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_29 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_27_mi ; [#uses=1 type=float*]
  %in_buf_0_load_27 = load float* %in_buf_0_addr_29, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_28_mi = select i1 %exitcond, i64 %tmp_216, i64 %tmp_88, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_30 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_28_mi ; [#uses=1 type=float*]
  %in_buf_0_load_28 = load float* %in_buf_0_addr_30, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_29_mi = select i1 %exitcond, i64 %tmp_218, i64 %tmp_90, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_31 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_29_mi ; [#uses=1 type=float*]
  %in_buf_0_load_29 = load float* %in_buf_0_addr_31, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_30_mi = select i1 %exitcond, i64 %tmp_220, i64 %tmp_92, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_32 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_30_mi ; [#uses=1 type=float*]
  %in_buf_0_load_30 = load float* %in_buf_0_addr_32, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_31_mi = select i1 %exitcond, i64 %tmp_222, i64 %tmp_94, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_33 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_31_mi ; [#uses=1 type=float*]
  %in_buf_0_load_31 = load float* %in_buf_0_addr_33, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_32_mi = select i1 %exitcond, i64 %tmp_224, i64 %tmp_96, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_34 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_32_mi ; [#uses=1 type=float*]
  %in_buf_0_load_32 = load float* %in_buf_0_addr_34, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_33_mi = select i1 %exitcond, i64 %tmp_226, i64 %tmp_98, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_35 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_33_mi ; [#uses=1 type=float*]
  %in_buf_0_load_33 = load float* %in_buf_0_addr_35, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_34_mi = select i1 %exitcond, i64 %tmp_228, i64 %tmp_100, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_36 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_34_mi ; [#uses=1 type=float*]
  %in_buf_0_load_34 = load float* %in_buf_0_addr_36, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_35_mi = select i1 %exitcond, i64 %tmp_230, i64 %tmp_102, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_37 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_35_mi ; [#uses=1 type=float*]
  %in_buf_0_load_35 = load float* %in_buf_0_addr_37, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_36_mi = select i1 %exitcond, i64 %tmp_232, i64 %tmp_104, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_38 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_36_mi ; [#uses=1 type=float*]
  %in_buf_0_load_36 = load float* %in_buf_0_addr_38, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_37_mi = select i1 %exitcond, i64 %tmp_234, i64 %tmp_106, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_39 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_37_mi ; [#uses=1 type=float*]
  %in_buf_0_load_37 = load float* %in_buf_0_addr_39, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_38_mi = select i1 %exitcond, i64 %tmp_236, i64 %tmp_108, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_40 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_38_mi ; [#uses=1 type=float*]
  %in_buf_0_load_38 = load float* %in_buf_0_addr_40, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_39_mi = select i1 %exitcond, i64 %tmp_238, i64 %tmp_110, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_41 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_39_mi ; [#uses=1 type=float*]
  %in_buf_0_load_39 = load float* %in_buf_0_addr_41, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_40_mi = select i1 %exitcond, i64 %tmp_240, i64 %tmp_112, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_42 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_40_mi ; [#uses=1 type=float*]
  %in_buf_0_load_40 = load float* %in_buf_0_addr_42, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_41_mi = select i1 %exitcond, i64 %tmp_242, i64 %tmp_114, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_43 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_41_mi ; [#uses=1 type=float*]
  %in_buf_0_load_41 = load float* %in_buf_0_addr_43, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_42_mi = select i1 %exitcond, i64 %tmp_244, i64 %tmp_116, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_44 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_42_mi ; [#uses=1 type=float*]
  %in_buf_0_load_42 = load float* %in_buf_0_addr_44, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_43_mi = select i1 %exitcond, i64 %tmp_246, i64 %tmp_118, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_45 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_43_mi ; [#uses=1 type=float*]
  %in_buf_0_load_43 = load float* %in_buf_0_addr_45, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_44_mi = select i1 %exitcond, i64 %tmp_248, i64 %tmp_120, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_46 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_44_mi ; [#uses=1 type=float*]
  %in_buf_0_load_44 = load float* %in_buf_0_addr_46, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_45_mi = select i1 %exitcond, i64 %tmp_250, i64 %tmp_122, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_47 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_45_mi ; [#uses=1 type=float*]
  %in_buf_0_load_45 = load float* %in_buf_0_addr_47, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_46_mi = select i1 %exitcond, i64 %tmp_252, i64 %tmp_124, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_48 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_46_mi ; [#uses=1 type=float*]
  %in_buf_0_load_46 = load float* %in_buf_0_addr_48, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_47_mi = select i1 %exitcond, i64 %tmp_254, i64 %tmp_126, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_49 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_47_mi ; [#uses=1 type=float*]
  %in_buf_0_load_47 = load float* %in_buf_0_addr_49, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_48_mi = select i1 %exitcond, i64 %tmp_256, i64 %tmp_128, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_50 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_48_mi ; [#uses=1 type=float*]
  %in_buf_0_load_48 = load float* %in_buf_0_addr_50, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_49_mi = select i1 %exitcond, i64 %tmp_258, i64 %tmp_130, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_51 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_49_mi ; [#uses=1 type=float*]
  %in_buf_0_load_49 = load float* %in_buf_0_addr_51, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_50_mi = select i1 %exitcond, i64 %tmp_260, i64 %tmp_132, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_52 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_50_mi ; [#uses=1 type=float*]
  %in_buf_0_load_50 = load float* %in_buf_0_addr_52, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_51_mi = select i1 %exitcond, i64 %tmp_262, i64 %tmp_134, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_53 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_51_mi ; [#uses=1 type=float*]
  %in_buf_0_load_51 = load float* %in_buf_0_addr_53, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_52_mi = select i1 %exitcond, i64 %tmp_264, i64 %tmp_136, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_54 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_52_mi ; [#uses=1 type=float*]
  %in_buf_0_load_52 = load float* %in_buf_0_addr_54, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_53_mi = select i1 %exitcond, i64 %tmp_266, i64 %tmp_138, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_55 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_53_mi ; [#uses=1 type=float*]
  %in_buf_0_load_53 = load float* %in_buf_0_addr_55, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_54_mi = select i1 %exitcond, i64 %tmp_268, i64 %tmp_140, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_56 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_54_mi ; [#uses=1 type=float*]
  %in_buf_0_load_54 = load float* %in_buf_0_addr_56, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_55_mi = select i1 %exitcond, i64 %tmp_270, i64 %tmp_142, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_57 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_55_mi ; [#uses=1 type=float*]
  %in_buf_0_load_55 = load float* %in_buf_0_addr_57, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_56_mi = select i1 %exitcond, i64 %tmp_272, i64 %tmp_144, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_58 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_56_mi ; [#uses=1 type=float*]
  %in_buf_0_load_56 = load float* %in_buf_0_addr_58, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_57_mi = select i1 %exitcond, i64 %tmp_274, i64 %tmp_146, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_59 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_57_mi ; [#uses=1 type=float*]
  %in_buf_0_load_57 = load float* %in_buf_0_addr_59, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_58_mi = select i1 %exitcond, i64 %tmp_276, i64 %tmp_148, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_60 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_58_mi ; [#uses=1 type=float*]
  %in_buf_0_load_58 = load float* %in_buf_0_addr_60, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_59_mi = select i1 %exitcond, i64 %tmp_278, i64 %tmp_150, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_61 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_59_mi ; [#uses=1 type=float*]
  %in_buf_0_load_59 = load float* %in_buf_0_addr_61, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_60_mi = select i1 %exitcond, i64 %tmp_280, i64 %tmp_152, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_62 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_60_mi ; [#uses=1 type=float*]
  %in_buf_0_load_60 = load float* %in_buf_0_addr_62, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_61_mi = select i1 %exitcond, i64 %tmp_282, i64 %tmp_154, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_63 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_61_mi ; [#uses=1 type=float*]
  %in_buf_0_load_61 = load float* %in_buf_0_addr_63, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_62_mi = select i1 %exitcond, i64 %tmp_284, i64 %tmp_156, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_64 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_62_mi ; [#uses=1 type=float*]
  %in_buf_0_load_62 = load float* %in_buf_0_addr_64, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_0_load_63_mi = select i1 %exitcond, i64 %tmp_286, i64 %tmp_158, !dbg !2860 ; [#uses=4 type=i64] [debug line = 74:6]
  %in_buf_0_addr_65 = getelementptr [8192 x float]* %in_buf_0, i64 0, i64 %in_buf_0_load_63_mi ; [#uses=1 type=float*]
  %in_buf_0_load_63 = load float* %in_buf_0_addr_65, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_2 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_mid2 ; [#uses=1 type=float*]
  %in_buf_1_load = load float* %in_buf_1_addr_2, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_3 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_1_mid ; [#uses=1 type=float*]
  %in_buf_1_load_1 = load float* %in_buf_1_addr_3, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_4 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_2_mid ; [#uses=1 type=float*]
  %in_buf_1_load_2 = load float* %in_buf_1_addr_4, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_5 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_3_mid ; [#uses=1 type=float*]
  %in_buf_1_load_3 = load float* %in_buf_1_addr_5, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_6 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_4_mid ; [#uses=1 type=float*]
  %in_buf_1_load_4 = load float* %in_buf_1_addr_6, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_7 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_5_mid ; [#uses=1 type=float*]
  %in_buf_1_load_5 = load float* %in_buf_1_addr_7, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_8 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_6_mid ; [#uses=1 type=float*]
  %in_buf_1_load_6 = load float* %in_buf_1_addr_8, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_9 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_7_mid ; [#uses=1 type=float*]
  %in_buf_1_load_7 = load float* %in_buf_1_addr_9, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_10 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_8_mid ; [#uses=1 type=float*]
  %in_buf_1_load_8 = load float* %in_buf_1_addr_10, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_11 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_9_mid ; [#uses=1 type=float*]
  %in_buf_1_load_9 = load float* %in_buf_1_addr_11, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_12 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_10_mi ; [#uses=1 type=float*]
  %in_buf_1_load_10 = load float* %in_buf_1_addr_12, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_13 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_11_mi ; [#uses=1 type=float*]
  %in_buf_1_load_11 = load float* %in_buf_1_addr_13, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_14 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_12_mi ; [#uses=1 type=float*]
  %in_buf_1_load_12 = load float* %in_buf_1_addr_14, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_15 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_13_mi ; [#uses=1 type=float*]
  %in_buf_1_load_13 = load float* %in_buf_1_addr_15, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_16 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_14_mi ; [#uses=1 type=float*]
  %in_buf_1_load_14 = load float* %in_buf_1_addr_16, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_17 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_15_mi ; [#uses=1 type=float*]
  %in_buf_1_load_15 = load float* %in_buf_1_addr_17, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_18 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_16_mi ; [#uses=1 type=float*]
  %in_buf_1_load_16 = load float* %in_buf_1_addr_18, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_19 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_17_mi ; [#uses=1 type=float*]
  %in_buf_1_load_17 = load float* %in_buf_1_addr_19, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_20 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_18_mi ; [#uses=1 type=float*]
  %in_buf_1_load_18 = load float* %in_buf_1_addr_20, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_21 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_19_mi ; [#uses=1 type=float*]
  %in_buf_1_load_19 = load float* %in_buf_1_addr_21, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_22 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_20_mi ; [#uses=1 type=float*]
  %in_buf_1_load_20 = load float* %in_buf_1_addr_22, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_23 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_21_mi ; [#uses=1 type=float*]
  %in_buf_1_load_21 = load float* %in_buf_1_addr_23, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_24 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_22_mi ; [#uses=1 type=float*]
  %in_buf_1_load_22 = load float* %in_buf_1_addr_24, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_25 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_23_mi ; [#uses=1 type=float*]
  %in_buf_1_load_23 = load float* %in_buf_1_addr_25, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_26 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_24_mi ; [#uses=1 type=float*]
  %in_buf_1_load_24 = load float* %in_buf_1_addr_26, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_27 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_25_mi ; [#uses=1 type=float*]
  %in_buf_1_load_25 = load float* %in_buf_1_addr_27, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_28 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_26_mi ; [#uses=1 type=float*]
  %in_buf_1_load_26 = load float* %in_buf_1_addr_28, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_29 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_27_mi ; [#uses=1 type=float*]
  %in_buf_1_load_27 = load float* %in_buf_1_addr_29, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_30 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_28_mi ; [#uses=1 type=float*]
  %in_buf_1_load_28 = load float* %in_buf_1_addr_30, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_31 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_29_mi ; [#uses=1 type=float*]
  %in_buf_1_load_29 = load float* %in_buf_1_addr_31, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_32 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_30_mi ; [#uses=1 type=float*]
  %in_buf_1_load_30 = load float* %in_buf_1_addr_32, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_33 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_31_mi ; [#uses=1 type=float*]
  %in_buf_1_load_31 = load float* %in_buf_1_addr_33, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_34 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_32_mi ; [#uses=1 type=float*]
  %in_buf_1_load_32 = load float* %in_buf_1_addr_34, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_35 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_33_mi ; [#uses=1 type=float*]
  %in_buf_1_load_33 = load float* %in_buf_1_addr_35, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_36 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_34_mi ; [#uses=1 type=float*]
  %in_buf_1_load_34 = load float* %in_buf_1_addr_36, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_37 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_35_mi ; [#uses=1 type=float*]
  %in_buf_1_load_35 = load float* %in_buf_1_addr_37, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_38 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_36_mi ; [#uses=1 type=float*]
  %in_buf_1_load_36 = load float* %in_buf_1_addr_38, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_39 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_37_mi ; [#uses=1 type=float*]
  %in_buf_1_load_37 = load float* %in_buf_1_addr_39, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_40 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_38_mi ; [#uses=1 type=float*]
  %in_buf_1_load_38 = load float* %in_buf_1_addr_40, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_41 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_39_mi ; [#uses=1 type=float*]
  %in_buf_1_load_39 = load float* %in_buf_1_addr_41, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_42 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_40_mi ; [#uses=1 type=float*]
  %in_buf_1_load_40 = load float* %in_buf_1_addr_42, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_43 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_41_mi ; [#uses=1 type=float*]
  %in_buf_1_load_41 = load float* %in_buf_1_addr_43, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_44 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_42_mi ; [#uses=1 type=float*]
  %in_buf_1_load_42 = load float* %in_buf_1_addr_44, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_45 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_43_mi ; [#uses=1 type=float*]
  %in_buf_1_load_43 = load float* %in_buf_1_addr_45, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_46 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_44_mi ; [#uses=1 type=float*]
  %in_buf_1_load_44 = load float* %in_buf_1_addr_46, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_47 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_45_mi ; [#uses=1 type=float*]
  %in_buf_1_load_45 = load float* %in_buf_1_addr_47, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_48 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_46_mi ; [#uses=1 type=float*]
  %in_buf_1_load_46 = load float* %in_buf_1_addr_48, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_49 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_47_mi ; [#uses=1 type=float*]
  %in_buf_1_load_47 = load float* %in_buf_1_addr_49, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_50 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_48_mi ; [#uses=1 type=float*]
  %in_buf_1_load_48 = load float* %in_buf_1_addr_50, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_51 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_49_mi ; [#uses=1 type=float*]
  %in_buf_1_load_49 = load float* %in_buf_1_addr_51, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_52 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_50_mi ; [#uses=1 type=float*]
  %in_buf_1_load_50 = load float* %in_buf_1_addr_52, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_53 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_51_mi ; [#uses=1 type=float*]
  %in_buf_1_load_51 = load float* %in_buf_1_addr_53, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_54 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_52_mi ; [#uses=1 type=float*]
  %in_buf_1_load_52 = load float* %in_buf_1_addr_54, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_55 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_53_mi ; [#uses=1 type=float*]
  %in_buf_1_load_53 = load float* %in_buf_1_addr_55, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_56 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_54_mi ; [#uses=1 type=float*]
  %in_buf_1_load_54 = load float* %in_buf_1_addr_56, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_57 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_55_mi ; [#uses=1 type=float*]
  %in_buf_1_load_55 = load float* %in_buf_1_addr_57, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_58 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_56_mi ; [#uses=1 type=float*]
  %in_buf_1_load_56 = load float* %in_buf_1_addr_58, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_59 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_57_mi ; [#uses=1 type=float*]
  %in_buf_1_load_57 = load float* %in_buf_1_addr_59, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_60 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_58_mi ; [#uses=1 type=float*]
  %in_buf_1_load_58 = load float* %in_buf_1_addr_60, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_61 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_59_mi ; [#uses=1 type=float*]
  %in_buf_1_load_59 = load float* %in_buf_1_addr_61, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_62 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_60_mi ; [#uses=1 type=float*]
  %in_buf_1_load_60 = load float* %in_buf_1_addr_62, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_63 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_61_mi ; [#uses=1 type=float*]
  %in_buf_1_load_61 = load float* %in_buf_1_addr_63, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_64 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_62_mi ; [#uses=1 type=float*]
  %in_buf_1_load_62 = load float* %in_buf_1_addr_64, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_1_addr_65 = getelementptr [8192 x float]* %in_buf_1, i64 0, i64 %in_buf_0_load_63_mi ; [#uses=1 type=float*]
  %in_buf_1_load_63 = load float* %in_buf_1_addr_65, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_2 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_mid2 ; [#uses=1 type=float*]
  %in_buf_2_load = load float* %in_buf_2_addr_2, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_3 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_1_mid ; [#uses=1 type=float*]
  %in_buf_2_load_1 = load float* %in_buf_2_addr_3, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_4 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_2_mid ; [#uses=1 type=float*]
  %in_buf_2_load_2 = load float* %in_buf_2_addr_4, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_5 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_3_mid ; [#uses=1 type=float*]
  %in_buf_2_load_3 = load float* %in_buf_2_addr_5, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_6 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_4_mid ; [#uses=1 type=float*]
  %in_buf_2_load_4 = load float* %in_buf_2_addr_6, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_7 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_5_mid ; [#uses=1 type=float*]
  %in_buf_2_load_5 = load float* %in_buf_2_addr_7, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_8 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_6_mid ; [#uses=1 type=float*]
  %in_buf_2_load_6 = load float* %in_buf_2_addr_8, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_9 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_7_mid ; [#uses=1 type=float*]
  %in_buf_2_load_7 = load float* %in_buf_2_addr_9, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_10 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_8_mid ; [#uses=1 type=float*]
  %in_buf_2_load_8 = load float* %in_buf_2_addr_10, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_11 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_9_mid ; [#uses=1 type=float*]
  %in_buf_2_load_9 = load float* %in_buf_2_addr_11, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_12 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_10_mi ; [#uses=1 type=float*]
  %in_buf_2_load_10 = load float* %in_buf_2_addr_12, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_13 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_11_mi ; [#uses=1 type=float*]
  %in_buf_2_load_11 = load float* %in_buf_2_addr_13, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_14 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_12_mi ; [#uses=1 type=float*]
  %in_buf_2_load_12 = load float* %in_buf_2_addr_14, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_15 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_13_mi ; [#uses=1 type=float*]
  %in_buf_2_load_13 = load float* %in_buf_2_addr_15, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_16 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_14_mi ; [#uses=1 type=float*]
  %in_buf_2_load_14 = load float* %in_buf_2_addr_16, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_17 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_15_mi ; [#uses=1 type=float*]
  %in_buf_2_load_15 = load float* %in_buf_2_addr_17, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_18 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_16_mi ; [#uses=1 type=float*]
  %in_buf_2_load_16 = load float* %in_buf_2_addr_18, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_19 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_17_mi ; [#uses=1 type=float*]
  %in_buf_2_load_17 = load float* %in_buf_2_addr_19, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_20 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_18_mi ; [#uses=1 type=float*]
  %in_buf_2_load_18 = load float* %in_buf_2_addr_20, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_21 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_19_mi ; [#uses=1 type=float*]
  %in_buf_2_load_19 = load float* %in_buf_2_addr_21, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_22 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_20_mi ; [#uses=1 type=float*]
  %in_buf_2_load_20 = load float* %in_buf_2_addr_22, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_23 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_21_mi ; [#uses=1 type=float*]
  %in_buf_2_load_21 = load float* %in_buf_2_addr_23, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_24 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_22_mi ; [#uses=1 type=float*]
  %in_buf_2_load_22 = load float* %in_buf_2_addr_24, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_25 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_23_mi ; [#uses=1 type=float*]
  %in_buf_2_load_23 = load float* %in_buf_2_addr_25, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_26 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_24_mi ; [#uses=1 type=float*]
  %in_buf_2_load_24 = load float* %in_buf_2_addr_26, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_27 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_25_mi ; [#uses=1 type=float*]
  %in_buf_2_load_25 = load float* %in_buf_2_addr_27, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_28 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_26_mi ; [#uses=1 type=float*]
  %in_buf_2_load_26 = load float* %in_buf_2_addr_28, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_29 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_27_mi ; [#uses=1 type=float*]
  %in_buf_2_load_27 = load float* %in_buf_2_addr_29, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_30 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_28_mi ; [#uses=1 type=float*]
  %in_buf_2_load_28 = load float* %in_buf_2_addr_30, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_31 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_29_mi ; [#uses=1 type=float*]
  %in_buf_2_load_29 = load float* %in_buf_2_addr_31, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_32 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_30_mi ; [#uses=1 type=float*]
  %in_buf_2_load_30 = load float* %in_buf_2_addr_32, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_33 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_31_mi ; [#uses=1 type=float*]
  %in_buf_2_load_31 = load float* %in_buf_2_addr_33, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_34 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_32_mi ; [#uses=1 type=float*]
  %in_buf_2_load_32 = load float* %in_buf_2_addr_34, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_35 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_33_mi ; [#uses=1 type=float*]
  %in_buf_2_load_33 = load float* %in_buf_2_addr_35, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_36 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_34_mi ; [#uses=1 type=float*]
  %in_buf_2_load_34 = load float* %in_buf_2_addr_36, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_37 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_35_mi ; [#uses=1 type=float*]
  %in_buf_2_load_35 = load float* %in_buf_2_addr_37, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_38 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_36_mi ; [#uses=1 type=float*]
  %in_buf_2_load_36 = load float* %in_buf_2_addr_38, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_39 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_37_mi ; [#uses=1 type=float*]
  %in_buf_2_load_37 = load float* %in_buf_2_addr_39, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_40 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_38_mi ; [#uses=1 type=float*]
  %in_buf_2_load_38 = load float* %in_buf_2_addr_40, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_41 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_39_mi ; [#uses=1 type=float*]
  %in_buf_2_load_39 = load float* %in_buf_2_addr_41, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_42 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_40_mi ; [#uses=1 type=float*]
  %in_buf_2_load_40 = load float* %in_buf_2_addr_42, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_43 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_41_mi ; [#uses=1 type=float*]
  %in_buf_2_load_41 = load float* %in_buf_2_addr_43, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_44 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_42_mi ; [#uses=1 type=float*]
  %in_buf_2_load_42 = load float* %in_buf_2_addr_44, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_45 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_43_mi ; [#uses=1 type=float*]
  %in_buf_2_load_43 = load float* %in_buf_2_addr_45, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_46 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_44_mi ; [#uses=1 type=float*]
  %in_buf_2_load_44 = load float* %in_buf_2_addr_46, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_47 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_45_mi ; [#uses=1 type=float*]
  %in_buf_2_load_45 = load float* %in_buf_2_addr_47, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_48 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_46_mi ; [#uses=1 type=float*]
  %in_buf_2_load_46 = load float* %in_buf_2_addr_48, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_49 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_47_mi ; [#uses=1 type=float*]
  %in_buf_2_load_47 = load float* %in_buf_2_addr_49, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_50 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_48_mi ; [#uses=1 type=float*]
  %in_buf_2_load_48 = load float* %in_buf_2_addr_50, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_51 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_49_mi ; [#uses=1 type=float*]
  %in_buf_2_load_49 = load float* %in_buf_2_addr_51, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_52 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_50_mi ; [#uses=1 type=float*]
  %in_buf_2_load_50 = load float* %in_buf_2_addr_52, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_53 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_51_mi ; [#uses=1 type=float*]
  %in_buf_2_load_51 = load float* %in_buf_2_addr_53, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_54 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_52_mi ; [#uses=1 type=float*]
  %in_buf_2_load_52 = load float* %in_buf_2_addr_54, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_55 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_53_mi ; [#uses=1 type=float*]
  %in_buf_2_load_53 = load float* %in_buf_2_addr_55, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_56 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_54_mi ; [#uses=1 type=float*]
  %in_buf_2_load_54 = load float* %in_buf_2_addr_56, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_57 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_55_mi ; [#uses=1 type=float*]
  %in_buf_2_load_55 = load float* %in_buf_2_addr_57, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_58 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_56_mi ; [#uses=1 type=float*]
  %in_buf_2_load_56 = load float* %in_buf_2_addr_58, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_59 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_57_mi ; [#uses=1 type=float*]
  %in_buf_2_load_57 = load float* %in_buf_2_addr_59, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_60 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_58_mi ; [#uses=1 type=float*]
  %in_buf_2_load_58 = load float* %in_buf_2_addr_60, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_61 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_59_mi ; [#uses=1 type=float*]
  %in_buf_2_load_59 = load float* %in_buf_2_addr_61, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_62 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_60_mi ; [#uses=1 type=float*]
  %in_buf_2_load_60 = load float* %in_buf_2_addr_62, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_63 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_61_mi ; [#uses=1 type=float*]
  %in_buf_2_load_61 = load float* %in_buf_2_addr_63, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_64 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_62_mi ; [#uses=1 type=float*]
  %in_buf_2_load_62 = load float* %in_buf_2_addr_64, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_2_addr_65 = getelementptr [8192 x float]* %in_buf_2, i64 0, i64 %in_buf_0_load_63_mi ; [#uses=1 type=float*]
  %in_buf_2_load_63 = load float* %in_buf_2_addr_65, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_2 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_mid2 ; [#uses=1 type=float*]
  %in_buf_3_load = load float* %in_buf_3_addr_2, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_3 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_1_mid ; [#uses=1 type=float*]
  %in_buf_3_load_1 = load float* %in_buf_3_addr_3, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_4 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_2_mid ; [#uses=1 type=float*]
  %in_buf_3_load_2 = load float* %in_buf_3_addr_4, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_5 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_3_mid ; [#uses=1 type=float*]
  %in_buf_3_load_3 = load float* %in_buf_3_addr_5, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_6 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_4_mid ; [#uses=1 type=float*]
  %in_buf_3_load_4 = load float* %in_buf_3_addr_6, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_7 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_5_mid ; [#uses=1 type=float*]
  %in_buf_3_load_5 = load float* %in_buf_3_addr_7, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_8 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_6_mid ; [#uses=1 type=float*]
  %in_buf_3_load_6 = load float* %in_buf_3_addr_8, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_9 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_7_mid ; [#uses=1 type=float*]
  %in_buf_3_load_7 = load float* %in_buf_3_addr_9, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_10 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_8_mid ; [#uses=1 type=float*]
  %in_buf_3_load_8 = load float* %in_buf_3_addr_10, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_11 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_9_mid ; [#uses=1 type=float*]
  %in_buf_3_load_9 = load float* %in_buf_3_addr_11, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_12 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_10_mi ; [#uses=1 type=float*]
  %in_buf_3_load_10 = load float* %in_buf_3_addr_12, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_13 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_11_mi ; [#uses=1 type=float*]
  %in_buf_3_load_11 = load float* %in_buf_3_addr_13, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_14 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_12_mi ; [#uses=1 type=float*]
  %in_buf_3_load_12 = load float* %in_buf_3_addr_14, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_15 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_13_mi ; [#uses=1 type=float*]
  %in_buf_3_load_13 = load float* %in_buf_3_addr_15, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_16 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_14_mi ; [#uses=1 type=float*]
  %in_buf_3_load_14 = load float* %in_buf_3_addr_16, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_17 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_15_mi ; [#uses=1 type=float*]
  %in_buf_3_load_15 = load float* %in_buf_3_addr_17, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_18 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_16_mi ; [#uses=1 type=float*]
  %in_buf_3_load_16 = load float* %in_buf_3_addr_18, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_19 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_17_mi ; [#uses=1 type=float*]
  %in_buf_3_load_17 = load float* %in_buf_3_addr_19, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_20 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_18_mi ; [#uses=1 type=float*]
  %in_buf_3_load_18 = load float* %in_buf_3_addr_20, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_21 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_19_mi ; [#uses=1 type=float*]
  %in_buf_3_load_19 = load float* %in_buf_3_addr_21, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_22 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_20_mi ; [#uses=1 type=float*]
  %in_buf_3_load_20 = load float* %in_buf_3_addr_22, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_23 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_21_mi ; [#uses=1 type=float*]
  %in_buf_3_load_21 = load float* %in_buf_3_addr_23, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_24 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_22_mi ; [#uses=1 type=float*]
  %in_buf_3_load_22 = load float* %in_buf_3_addr_24, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_25 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_23_mi ; [#uses=1 type=float*]
  %in_buf_3_load_23 = load float* %in_buf_3_addr_25, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_26 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_24_mi ; [#uses=1 type=float*]
  %in_buf_3_load_24 = load float* %in_buf_3_addr_26, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_27 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_25_mi ; [#uses=1 type=float*]
  %in_buf_3_load_25 = load float* %in_buf_3_addr_27, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_28 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_26_mi ; [#uses=1 type=float*]
  %in_buf_3_load_26 = load float* %in_buf_3_addr_28, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_29 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_27_mi ; [#uses=1 type=float*]
  %in_buf_3_load_27 = load float* %in_buf_3_addr_29, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_30 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_28_mi ; [#uses=1 type=float*]
  %in_buf_3_load_28 = load float* %in_buf_3_addr_30, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_31 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_29_mi ; [#uses=1 type=float*]
  %in_buf_3_load_29 = load float* %in_buf_3_addr_31, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_32 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_30_mi ; [#uses=1 type=float*]
  %in_buf_3_load_30 = load float* %in_buf_3_addr_32, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_33 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_31_mi ; [#uses=1 type=float*]
  %in_buf_3_load_31 = load float* %in_buf_3_addr_33, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_34 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_32_mi ; [#uses=1 type=float*]
  %in_buf_3_load_32 = load float* %in_buf_3_addr_34, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_35 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_33_mi ; [#uses=1 type=float*]
  %in_buf_3_load_33 = load float* %in_buf_3_addr_35, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_36 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_34_mi ; [#uses=1 type=float*]
  %in_buf_3_load_34 = load float* %in_buf_3_addr_36, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_37 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_35_mi ; [#uses=1 type=float*]
  %in_buf_3_load_35 = load float* %in_buf_3_addr_37, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_38 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_36_mi ; [#uses=1 type=float*]
  %in_buf_3_load_36 = load float* %in_buf_3_addr_38, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_39 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_37_mi ; [#uses=1 type=float*]
  %in_buf_3_load_37 = load float* %in_buf_3_addr_39, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_40 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_38_mi ; [#uses=1 type=float*]
  %in_buf_3_load_38 = load float* %in_buf_3_addr_40, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_41 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_39_mi ; [#uses=1 type=float*]
  %in_buf_3_load_39 = load float* %in_buf_3_addr_41, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_42 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_40_mi ; [#uses=1 type=float*]
  %in_buf_3_load_40 = load float* %in_buf_3_addr_42, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_43 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_41_mi ; [#uses=1 type=float*]
  %in_buf_3_load_41 = load float* %in_buf_3_addr_43, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_44 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_42_mi ; [#uses=1 type=float*]
  %in_buf_3_load_42 = load float* %in_buf_3_addr_44, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_45 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_43_mi ; [#uses=1 type=float*]
  %in_buf_3_load_43 = load float* %in_buf_3_addr_45, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_46 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_44_mi ; [#uses=1 type=float*]
  %in_buf_3_load_44 = load float* %in_buf_3_addr_46, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_47 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_45_mi ; [#uses=1 type=float*]
  %in_buf_3_load_45 = load float* %in_buf_3_addr_47, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_48 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_46_mi ; [#uses=1 type=float*]
  %in_buf_3_load_46 = load float* %in_buf_3_addr_48, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_49 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_47_mi ; [#uses=1 type=float*]
  %in_buf_3_load_47 = load float* %in_buf_3_addr_49, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_50 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_48_mi ; [#uses=1 type=float*]
  %in_buf_3_load_48 = load float* %in_buf_3_addr_50, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_51 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_49_mi ; [#uses=1 type=float*]
  %in_buf_3_load_49 = load float* %in_buf_3_addr_51, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_52 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_50_mi ; [#uses=1 type=float*]
  %in_buf_3_load_50 = load float* %in_buf_3_addr_52, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_53 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_51_mi ; [#uses=1 type=float*]
  %in_buf_3_load_51 = load float* %in_buf_3_addr_53, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_54 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_52_mi ; [#uses=1 type=float*]
  %in_buf_3_load_52 = load float* %in_buf_3_addr_54, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_55 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_53_mi ; [#uses=1 type=float*]
  %in_buf_3_load_53 = load float* %in_buf_3_addr_55, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_56 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_54_mi ; [#uses=1 type=float*]
  %in_buf_3_load_54 = load float* %in_buf_3_addr_56, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_57 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_55_mi ; [#uses=1 type=float*]
  %in_buf_3_load_55 = load float* %in_buf_3_addr_57, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_58 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_56_mi ; [#uses=1 type=float*]
  %in_buf_3_load_56 = load float* %in_buf_3_addr_58, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_59 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_57_mi ; [#uses=1 type=float*]
  %in_buf_3_load_57 = load float* %in_buf_3_addr_59, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_60 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_58_mi ; [#uses=1 type=float*]
  %in_buf_3_load_58 = load float* %in_buf_3_addr_60, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_61 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_59_mi ; [#uses=1 type=float*]
  %in_buf_3_load_59 = load float* %in_buf_3_addr_61, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_62 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_60_mi ; [#uses=1 type=float*]
  %in_buf_3_load_60 = load float* %in_buf_3_addr_62, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_63 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_61_mi ; [#uses=1 type=float*]
  %in_buf_3_load_61 = load float* %in_buf_3_addr_63, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_64 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_62_mi ; [#uses=1 type=float*]
  %in_buf_3_load_62 = load float* %in_buf_3_addr_64, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %in_buf_3_addr_65 = getelementptr [8192 x float]* %in_buf_3, i64 0, i64 %in_buf_0_load_63_mi ; [#uses=1 type=float*]
  %in_buf_3_load_63 = load float* %in_buf_3_addr_65, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  call void (...)* @_ssdm_op_SpecLoopName([3 x i8]* @p_str13) nounwind, !dbg !2865 ; [debug line = 70:38]
  %tmp_32 = call i32 (...)* @_ssdm_op_SpecRegionBegin([3 x i8]* @p_str13), !dbg !2865 ; [#uses=1 type=i32] [debug line = 70:38]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !2866 ; [debug line = 71:1]
  %tmp_31 = zext i4 %j5_mid2 to i64, !dbg !2867   ; [#uses=1 type=i64] [debug line = 72:26]
  %tmp_31_cast = zext i4 %j5_mid2 to i12          ; [#uses=1 type=i12]
  %tmp_290 = call i10 @_ssdm_op_BitConcatenate.i10.i4.i6(i4 %j5_mid2, i6 0) ; [#uses=64 type=i10]
  %tmp_291 = zext i10 %tmp_290 to i64             ; [#uses=4 type=i64]
  %weight_buf_0_addr_2 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_291 ; [#uses=1 type=float*]
  %tmp_292 = or i10 %tmp_290, 1                   ; [#uses=1 type=i10]
  %tmp_293 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_292) ; [#uses=4 type=i64]
  %weight_buf_0_addr_3 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_293 ; [#uses=1 type=float*]
  %tmp_294 = or i10 %tmp_290, 2                   ; [#uses=1 type=i10]
  %tmp_295 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_294) ; [#uses=4 type=i64]
  %weight_buf_0_addr_4 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_295 ; [#uses=1 type=float*]
  %tmp_296 = or i10 %tmp_290, 3                   ; [#uses=1 type=i10]
  %tmp_297 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_296) ; [#uses=4 type=i64]
  %weight_buf_0_addr_5 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_297 ; [#uses=1 type=float*]
  %tmp_298 = or i10 %tmp_290, 4                   ; [#uses=1 type=i10]
  %tmp_299 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_298) ; [#uses=4 type=i64]
  %weight_buf_0_addr_6 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_299 ; [#uses=1 type=float*]
  %tmp_300 = or i10 %tmp_290, 5                   ; [#uses=1 type=i10]
  %tmp_301 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_300) ; [#uses=4 type=i64]
  %weight_buf_0_addr_7 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_301 ; [#uses=1 type=float*]
  %tmp_302 = or i10 %tmp_290, 6                   ; [#uses=1 type=i10]
  %tmp_303 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_302) ; [#uses=4 type=i64]
  %weight_buf_0_addr_8 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_303 ; [#uses=1 type=float*]
  %tmp_304 = or i10 %tmp_290, 7                   ; [#uses=1 type=i10]
  %tmp_305 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_304) ; [#uses=4 type=i64]
  %weight_buf_0_addr_9 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_305 ; [#uses=1 type=float*]
  %tmp_306 = or i10 %tmp_290, 8                   ; [#uses=1 type=i10]
  %tmp_307 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_306) ; [#uses=4 type=i64]
  %weight_buf_0_addr_10 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_307 ; [#uses=1 type=float*]
  %tmp_308 = or i10 %tmp_290, 9                   ; [#uses=1 type=i10]
  %tmp_309 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_308) ; [#uses=4 type=i64]
  %weight_buf_0_addr_11 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_309 ; [#uses=1 type=float*]
  %tmp_310 = or i10 %tmp_290, 10                  ; [#uses=1 type=i10]
  %tmp_311 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_310) ; [#uses=4 type=i64]
  %weight_buf_0_addr_12 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_311 ; [#uses=1 type=float*]
  %tmp_312 = or i10 %tmp_290, 11                  ; [#uses=1 type=i10]
  %tmp_313 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_312) ; [#uses=4 type=i64]
  %weight_buf_0_addr_13 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_313 ; [#uses=1 type=float*]
  %tmp_314 = or i10 %tmp_290, 12                  ; [#uses=1 type=i10]
  %tmp_315 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_314) ; [#uses=4 type=i64]
  %weight_buf_0_addr_14 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_315 ; [#uses=1 type=float*]
  %tmp_316 = or i10 %tmp_290, 13                  ; [#uses=1 type=i10]
  %tmp_317 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_316) ; [#uses=4 type=i64]
  %weight_buf_0_addr_15 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_317 ; [#uses=1 type=float*]
  %tmp_318 = or i10 %tmp_290, 14                  ; [#uses=1 type=i10]
  %tmp_319 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_318) ; [#uses=4 type=i64]
  %weight_buf_0_addr_16 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_319 ; [#uses=1 type=float*]
  %tmp_320 = or i10 %tmp_290, 15                  ; [#uses=1 type=i10]
  %tmp_321 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_320) ; [#uses=4 type=i64]
  %weight_buf_0_addr_17 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_321 ; [#uses=1 type=float*]
  %tmp_322 = or i10 %tmp_290, 16                  ; [#uses=1 type=i10]
  %tmp_323 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_322) ; [#uses=4 type=i64]
  %weight_buf_0_addr_18 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_323 ; [#uses=1 type=float*]
  %tmp_324 = or i10 %tmp_290, 17                  ; [#uses=1 type=i10]
  %tmp_325 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_324) ; [#uses=4 type=i64]
  %weight_buf_0_addr_19 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_325 ; [#uses=1 type=float*]
  %tmp_326 = or i10 %tmp_290, 18                  ; [#uses=1 type=i10]
  %tmp_327 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_326) ; [#uses=4 type=i64]
  %weight_buf_0_addr_20 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_327 ; [#uses=1 type=float*]
  %tmp_328 = or i10 %tmp_290, 19                  ; [#uses=1 type=i10]
  %tmp_329 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_328) ; [#uses=4 type=i64]
  %weight_buf_0_addr_21 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_329 ; [#uses=1 type=float*]
  %tmp_330 = or i10 %tmp_290, 20                  ; [#uses=1 type=i10]
  %tmp_331 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_330) ; [#uses=4 type=i64]
  %weight_buf_0_addr_22 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_331 ; [#uses=1 type=float*]
  %tmp_332 = or i10 %tmp_290, 21                  ; [#uses=1 type=i10]
  %tmp_333 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_332) ; [#uses=4 type=i64]
  %weight_buf_0_addr_23 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_333 ; [#uses=1 type=float*]
  %tmp_334 = or i10 %tmp_290, 22                  ; [#uses=1 type=i10]
  %tmp_335 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_334) ; [#uses=4 type=i64]
  %weight_buf_0_addr_24 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_335 ; [#uses=1 type=float*]
  %tmp_336 = or i10 %tmp_290, 23                  ; [#uses=1 type=i10]
  %tmp_337 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_336) ; [#uses=4 type=i64]
  %weight_buf_0_addr_25 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_337 ; [#uses=1 type=float*]
  %tmp_338 = or i10 %tmp_290, 24                  ; [#uses=1 type=i10]
  %tmp_339 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_338) ; [#uses=4 type=i64]
  %weight_buf_0_addr_26 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_339 ; [#uses=1 type=float*]
  %tmp_340 = or i10 %tmp_290, 25                  ; [#uses=1 type=i10]
  %tmp_341 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_340) ; [#uses=4 type=i64]
  %weight_buf_0_addr_27 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_341 ; [#uses=1 type=float*]
  %tmp_342 = or i10 %tmp_290, 26                  ; [#uses=1 type=i10]
  %tmp_343 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_342) ; [#uses=4 type=i64]
  %weight_buf_0_addr_28 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_343 ; [#uses=1 type=float*]
  %tmp_344 = or i10 %tmp_290, 27                  ; [#uses=1 type=i10]
  %tmp_345 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_344) ; [#uses=4 type=i64]
  %weight_buf_0_addr_29 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_345 ; [#uses=1 type=float*]
  %tmp_346 = or i10 %tmp_290, 28                  ; [#uses=1 type=i10]
  %tmp_347 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_346) ; [#uses=4 type=i64]
  %weight_buf_0_addr_30 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_347 ; [#uses=1 type=float*]
  %tmp_348 = or i10 %tmp_290, 29                  ; [#uses=1 type=i10]
  %tmp_349 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_348) ; [#uses=4 type=i64]
  %weight_buf_0_addr_31 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_349 ; [#uses=1 type=float*]
  %tmp_350 = or i10 %tmp_290, 30                  ; [#uses=1 type=i10]
  %tmp_351 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_350) ; [#uses=4 type=i64]
  %weight_buf_0_addr_32 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_351 ; [#uses=1 type=float*]
  %tmp_352 = or i10 %tmp_290, 31                  ; [#uses=1 type=i10]
  %tmp_353 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_352) ; [#uses=4 type=i64]
  %weight_buf_0_addr_33 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_353 ; [#uses=1 type=float*]
  %tmp_354 = or i10 %tmp_290, 32                  ; [#uses=1 type=i10]
  %tmp_355 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_354) ; [#uses=4 type=i64]
  %weight_buf_0_addr_34 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_355 ; [#uses=1 type=float*]
  %tmp_356 = or i10 %tmp_290, 33                  ; [#uses=1 type=i10]
  %tmp_357 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_356) ; [#uses=4 type=i64]
  %weight_buf_0_addr_35 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_357 ; [#uses=1 type=float*]
  %tmp_358 = or i10 %tmp_290, 34                  ; [#uses=1 type=i10]
  %tmp_359 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_358) ; [#uses=4 type=i64]
  %weight_buf_0_addr_36 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_359 ; [#uses=1 type=float*]
  %tmp_360 = or i10 %tmp_290, 35                  ; [#uses=1 type=i10]
  %tmp_361 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_360) ; [#uses=4 type=i64]
  %weight_buf_0_addr_37 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_361 ; [#uses=1 type=float*]
  %tmp_362 = or i10 %tmp_290, 36                  ; [#uses=1 type=i10]
  %tmp_363 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_362) ; [#uses=4 type=i64]
  %weight_buf_0_addr_38 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_363 ; [#uses=1 type=float*]
  %tmp_364 = or i10 %tmp_290, 37                  ; [#uses=1 type=i10]
  %tmp_365 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_364) ; [#uses=4 type=i64]
  %weight_buf_0_addr_39 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_365 ; [#uses=1 type=float*]
  %tmp_366 = or i10 %tmp_290, 38                  ; [#uses=1 type=i10]
  %tmp_367 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_366) ; [#uses=4 type=i64]
  %weight_buf_0_addr_40 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_367 ; [#uses=1 type=float*]
  %tmp_368 = or i10 %tmp_290, 39                  ; [#uses=1 type=i10]
  %tmp_369 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_368) ; [#uses=4 type=i64]
  %weight_buf_0_addr_41 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_369 ; [#uses=1 type=float*]
  %tmp_370 = or i10 %tmp_290, 40                  ; [#uses=1 type=i10]
  %tmp_371 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_370) ; [#uses=4 type=i64]
  %weight_buf_0_addr_42 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_371 ; [#uses=1 type=float*]
  %tmp_372 = or i10 %tmp_290, 41                  ; [#uses=1 type=i10]
  %tmp_373 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_372) ; [#uses=4 type=i64]
  %weight_buf_0_addr_43 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_373 ; [#uses=1 type=float*]
  %tmp_374 = or i10 %tmp_290, 42                  ; [#uses=1 type=i10]
  %tmp_375 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_374) ; [#uses=4 type=i64]
  %weight_buf_0_addr_44 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_375 ; [#uses=1 type=float*]
  %tmp_376 = or i10 %tmp_290, 43                  ; [#uses=1 type=i10]
  %tmp_377 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_376) ; [#uses=4 type=i64]
  %weight_buf_0_addr_45 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_377 ; [#uses=1 type=float*]
  %tmp_378 = or i10 %tmp_290, 44                  ; [#uses=1 type=i10]
  %tmp_379 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_378) ; [#uses=4 type=i64]
  %weight_buf_0_addr_46 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_379 ; [#uses=1 type=float*]
  %tmp_380 = or i10 %tmp_290, 45                  ; [#uses=1 type=i10]
  %tmp_381 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_380) ; [#uses=4 type=i64]
  %weight_buf_0_addr_47 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_381 ; [#uses=1 type=float*]
  %tmp_382 = or i10 %tmp_290, 46                  ; [#uses=1 type=i10]
  %tmp_383 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_382) ; [#uses=4 type=i64]
  %weight_buf_0_addr_48 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_383 ; [#uses=1 type=float*]
  %tmp_384 = or i10 %tmp_290, 47                  ; [#uses=1 type=i10]
  %tmp_385 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_384) ; [#uses=4 type=i64]
  %weight_buf_0_addr_49 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_385 ; [#uses=1 type=float*]
  %tmp_386 = or i10 %tmp_290, 48                  ; [#uses=1 type=i10]
  %tmp_387 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_386) ; [#uses=4 type=i64]
  %weight_buf_0_addr_50 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_387 ; [#uses=1 type=float*]
  %tmp_388 = or i10 %tmp_290, 49                  ; [#uses=1 type=i10]
  %tmp_389 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_388) ; [#uses=4 type=i64]
  %weight_buf_0_addr_51 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_389 ; [#uses=1 type=float*]
  %tmp_390 = or i10 %tmp_290, 50                  ; [#uses=1 type=i10]
  %tmp_391 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_390) ; [#uses=4 type=i64]
  %weight_buf_0_addr_52 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_391 ; [#uses=1 type=float*]
  %tmp_392 = or i10 %tmp_290, 51                  ; [#uses=1 type=i10]
  %tmp_393 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_392) ; [#uses=4 type=i64]
  %weight_buf_0_addr_53 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_393 ; [#uses=1 type=float*]
  %tmp_394 = or i10 %tmp_290, 52                  ; [#uses=1 type=i10]
  %tmp_395 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_394) ; [#uses=4 type=i64]
  %weight_buf_0_addr_54 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_395 ; [#uses=1 type=float*]
  %tmp_396 = or i10 %tmp_290, 53                  ; [#uses=1 type=i10]
  %tmp_397 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_396) ; [#uses=4 type=i64]
  %weight_buf_0_addr_55 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_397 ; [#uses=1 type=float*]
  %tmp_398 = or i10 %tmp_290, 54                  ; [#uses=1 type=i10]
  %tmp_399 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_398) ; [#uses=4 type=i64]
  %weight_buf_0_addr_56 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_399 ; [#uses=1 type=float*]
  %tmp_400 = or i10 %tmp_290, 55                  ; [#uses=1 type=i10]
  %tmp_401 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_400) ; [#uses=4 type=i64]
  %weight_buf_0_addr_57 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_401 ; [#uses=1 type=float*]
  %tmp_402 = or i10 %tmp_290, 56                  ; [#uses=1 type=i10]
  %tmp_403 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_402) ; [#uses=4 type=i64]
  %weight_buf_0_addr_58 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_403 ; [#uses=1 type=float*]
  %tmp_404 = or i10 %tmp_290, 57                  ; [#uses=1 type=i10]
  %tmp_405 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_404) ; [#uses=4 type=i64]
  %weight_buf_0_addr_59 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_405 ; [#uses=1 type=float*]
  %tmp_406 = or i10 %tmp_290, 58                  ; [#uses=1 type=i10]
  %tmp_407 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_406) ; [#uses=4 type=i64]
  %weight_buf_0_addr_60 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_407 ; [#uses=1 type=float*]
  %tmp_408 = or i10 %tmp_290, 59                  ; [#uses=1 type=i10]
  %tmp_409 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_408) ; [#uses=4 type=i64]
  %weight_buf_0_addr_61 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_409 ; [#uses=1 type=float*]
  %tmp_410 = or i10 %tmp_290, 60                  ; [#uses=1 type=i10]
  %tmp_411 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_410) ; [#uses=4 type=i64]
  %weight_buf_0_addr_62 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_411 ; [#uses=1 type=float*]
  %tmp_412 = or i10 %tmp_290, 61                  ; [#uses=1 type=i10]
  %tmp_413 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_412) ; [#uses=4 type=i64]
  %weight_buf_0_addr_63 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_413 ; [#uses=1 type=float*]
  %tmp_414 = or i10 %tmp_290, 62                  ; [#uses=1 type=i10]
  %tmp_415 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_414) ; [#uses=4 type=i64]
  %weight_buf_0_addr_64 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_415 ; [#uses=1 type=float*]
  %tmp_416 = or i10 %tmp_290, 63                  ; [#uses=1 type=i10]
  %tmp_417 = call i64 @_ssdm_op_BitConcatenate.i64.i54.i10(i54 0, i10 %tmp_416) ; [#uses=4 type=i64]
  %weight_buf_0_addr_65 = getelementptr [640 x float]* %weight_buf_0, i64 0, i64 %tmp_417 ; [#uses=1 type=float*]
  %weight_buf_1_addr_2 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_291 ; [#uses=1 type=float*]
  %weight_buf_1_addr_3 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_293 ; [#uses=1 type=float*]
  %weight_buf_1_addr_4 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_295 ; [#uses=1 type=float*]
  %weight_buf_1_addr_5 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_297 ; [#uses=1 type=float*]
  %weight_buf_1_addr_6 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_299 ; [#uses=1 type=float*]
  %weight_buf_1_addr_7 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_301 ; [#uses=1 type=float*]
  %weight_buf_1_addr_8 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_303 ; [#uses=1 type=float*]
  %weight_buf_1_addr_9 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_305 ; [#uses=1 type=float*]
  %weight_buf_1_addr_10 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_307 ; [#uses=1 type=float*]
  %weight_buf_1_addr_11 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_309 ; [#uses=1 type=float*]
  %weight_buf_1_addr_12 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_311 ; [#uses=1 type=float*]
  %weight_buf_1_addr_13 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_313 ; [#uses=1 type=float*]
  %weight_buf_1_addr_14 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_315 ; [#uses=1 type=float*]
  %weight_buf_1_addr_15 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_317 ; [#uses=1 type=float*]
  %weight_buf_1_addr_16 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_319 ; [#uses=1 type=float*]
  %weight_buf_1_addr_17 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_321 ; [#uses=1 type=float*]
  %weight_buf_1_addr_18 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_323 ; [#uses=1 type=float*]
  %weight_buf_1_addr_19 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_325 ; [#uses=1 type=float*]
  %weight_buf_1_addr_20 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_327 ; [#uses=1 type=float*]
  %weight_buf_1_addr_21 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_329 ; [#uses=1 type=float*]
  %weight_buf_1_addr_22 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_331 ; [#uses=1 type=float*]
  %weight_buf_1_addr_23 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_333 ; [#uses=1 type=float*]
  %weight_buf_1_addr_24 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_335 ; [#uses=1 type=float*]
  %weight_buf_1_addr_25 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_337 ; [#uses=1 type=float*]
  %weight_buf_1_addr_26 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_339 ; [#uses=1 type=float*]
  %weight_buf_1_addr_27 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_341 ; [#uses=1 type=float*]
  %weight_buf_1_addr_28 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_343 ; [#uses=1 type=float*]
  %weight_buf_1_addr_29 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_345 ; [#uses=1 type=float*]
  %weight_buf_1_addr_30 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_347 ; [#uses=1 type=float*]
  %weight_buf_1_addr_31 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_349 ; [#uses=1 type=float*]
  %weight_buf_1_addr_32 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_351 ; [#uses=1 type=float*]
  %weight_buf_1_addr_33 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_353 ; [#uses=1 type=float*]
  %weight_buf_1_addr_34 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_355 ; [#uses=1 type=float*]
  %weight_buf_1_addr_35 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_357 ; [#uses=1 type=float*]
  %weight_buf_1_addr_36 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_359 ; [#uses=1 type=float*]
  %weight_buf_1_addr_37 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_361 ; [#uses=1 type=float*]
  %weight_buf_1_addr_38 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_363 ; [#uses=1 type=float*]
  %weight_buf_1_addr_39 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_365 ; [#uses=1 type=float*]
  %weight_buf_1_addr_40 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_367 ; [#uses=1 type=float*]
  %weight_buf_1_addr_41 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_369 ; [#uses=1 type=float*]
  %weight_buf_1_addr_42 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_371 ; [#uses=1 type=float*]
  %weight_buf_1_addr_43 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_373 ; [#uses=1 type=float*]
  %weight_buf_1_addr_44 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_375 ; [#uses=1 type=float*]
  %weight_buf_1_addr_45 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_377 ; [#uses=1 type=float*]
  %weight_buf_1_addr_46 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_379 ; [#uses=1 type=float*]
  %weight_buf_1_addr_47 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_381 ; [#uses=1 type=float*]
  %weight_buf_1_addr_48 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_383 ; [#uses=1 type=float*]
  %weight_buf_1_addr_49 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_385 ; [#uses=1 type=float*]
  %weight_buf_1_addr_50 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_387 ; [#uses=1 type=float*]
  %weight_buf_1_addr_51 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_389 ; [#uses=1 type=float*]
  %weight_buf_1_addr_52 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_391 ; [#uses=1 type=float*]
  %weight_buf_1_addr_53 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_393 ; [#uses=1 type=float*]
  %weight_buf_1_addr_54 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_395 ; [#uses=1 type=float*]
  %weight_buf_1_addr_55 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_397 ; [#uses=1 type=float*]
  %weight_buf_1_addr_56 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_399 ; [#uses=1 type=float*]
  %weight_buf_1_addr_57 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_401 ; [#uses=1 type=float*]
  %weight_buf_1_addr_58 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_403 ; [#uses=1 type=float*]
  %weight_buf_1_addr_59 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_405 ; [#uses=1 type=float*]
  %weight_buf_1_addr_60 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_407 ; [#uses=1 type=float*]
  %weight_buf_1_addr_61 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_409 ; [#uses=1 type=float*]
  %weight_buf_1_addr_62 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_411 ; [#uses=1 type=float*]
  %weight_buf_1_addr_63 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_413 ; [#uses=1 type=float*]
  %weight_buf_1_addr_64 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_415 ; [#uses=1 type=float*]
  %weight_buf_1_addr_65 = getelementptr [640 x float]* %weight_buf_1, i64 0, i64 %tmp_417 ; [#uses=1 type=float*]
  %weight_buf_2_addr_2 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_291 ; [#uses=1 type=float*]
  %weight_buf_2_addr_3 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_293 ; [#uses=1 type=float*]
  %weight_buf_2_addr_4 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_295 ; [#uses=1 type=float*]
  %weight_buf_2_addr_5 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_297 ; [#uses=1 type=float*]
  %weight_buf_2_addr_6 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_299 ; [#uses=1 type=float*]
  %weight_buf_2_addr_7 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_301 ; [#uses=1 type=float*]
  %weight_buf_2_addr_8 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_303 ; [#uses=1 type=float*]
  %weight_buf_2_addr_9 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_305 ; [#uses=1 type=float*]
  %weight_buf_2_addr_10 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_307 ; [#uses=1 type=float*]
  %weight_buf_2_addr_11 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_309 ; [#uses=1 type=float*]
  %weight_buf_2_addr_12 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_311 ; [#uses=1 type=float*]
  %weight_buf_2_addr_13 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_313 ; [#uses=1 type=float*]
  %weight_buf_2_addr_14 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_315 ; [#uses=1 type=float*]
  %weight_buf_2_addr_15 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_317 ; [#uses=1 type=float*]
  %weight_buf_2_addr_16 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_319 ; [#uses=1 type=float*]
  %weight_buf_2_addr_17 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_321 ; [#uses=1 type=float*]
  %weight_buf_2_addr_18 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_323 ; [#uses=1 type=float*]
  %weight_buf_2_addr_19 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_325 ; [#uses=1 type=float*]
  %weight_buf_2_addr_20 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_327 ; [#uses=1 type=float*]
  %weight_buf_2_addr_21 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_329 ; [#uses=1 type=float*]
  %weight_buf_2_addr_22 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_331 ; [#uses=1 type=float*]
  %weight_buf_2_addr_23 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_333 ; [#uses=1 type=float*]
  %weight_buf_2_addr_24 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_335 ; [#uses=1 type=float*]
  %weight_buf_2_addr_25 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_337 ; [#uses=1 type=float*]
  %weight_buf_2_addr_26 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_339 ; [#uses=1 type=float*]
  %weight_buf_2_addr_27 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_341 ; [#uses=1 type=float*]
  %weight_buf_2_addr_28 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_343 ; [#uses=1 type=float*]
  %weight_buf_2_addr_29 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_345 ; [#uses=1 type=float*]
  %weight_buf_2_addr_30 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_347 ; [#uses=1 type=float*]
  %weight_buf_2_addr_31 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_349 ; [#uses=1 type=float*]
  %weight_buf_2_addr_32 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_351 ; [#uses=1 type=float*]
  %weight_buf_2_addr_33 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_353 ; [#uses=1 type=float*]
  %weight_buf_2_addr_34 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_355 ; [#uses=1 type=float*]
  %weight_buf_2_addr_35 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_357 ; [#uses=1 type=float*]
  %weight_buf_2_addr_36 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_359 ; [#uses=1 type=float*]
  %weight_buf_2_addr_37 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_361 ; [#uses=1 type=float*]
  %weight_buf_2_addr_38 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_363 ; [#uses=1 type=float*]
  %weight_buf_2_addr_39 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_365 ; [#uses=1 type=float*]
  %weight_buf_2_addr_40 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_367 ; [#uses=1 type=float*]
  %weight_buf_2_addr_41 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_369 ; [#uses=1 type=float*]
  %weight_buf_2_addr_42 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_371 ; [#uses=1 type=float*]
  %weight_buf_2_addr_43 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_373 ; [#uses=1 type=float*]
  %weight_buf_2_addr_44 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_375 ; [#uses=1 type=float*]
  %weight_buf_2_addr_45 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_377 ; [#uses=1 type=float*]
  %weight_buf_2_addr_46 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_379 ; [#uses=1 type=float*]
  %weight_buf_2_addr_47 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_381 ; [#uses=1 type=float*]
  %weight_buf_2_addr_48 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_383 ; [#uses=1 type=float*]
  %weight_buf_2_addr_49 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_385 ; [#uses=1 type=float*]
  %weight_buf_2_addr_50 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_387 ; [#uses=1 type=float*]
  %weight_buf_2_addr_51 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_389 ; [#uses=1 type=float*]
  %weight_buf_2_addr_52 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_391 ; [#uses=1 type=float*]
  %weight_buf_2_addr_53 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_393 ; [#uses=1 type=float*]
  %weight_buf_2_addr_54 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_395 ; [#uses=1 type=float*]
  %weight_buf_2_addr_55 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_397 ; [#uses=1 type=float*]
  %weight_buf_2_addr_56 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_399 ; [#uses=1 type=float*]
  %weight_buf_2_addr_57 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_401 ; [#uses=1 type=float*]
  %weight_buf_2_addr_58 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_403 ; [#uses=1 type=float*]
  %weight_buf_2_addr_59 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_405 ; [#uses=1 type=float*]
  %weight_buf_2_addr_60 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_407 ; [#uses=1 type=float*]
  %weight_buf_2_addr_61 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_409 ; [#uses=1 type=float*]
  %weight_buf_2_addr_62 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_411 ; [#uses=1 type=float*]
  %weight_buf_2_addr_63 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_413 ; [#uses=1 type=float*]
  %weight_buf_2_addr_64 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_415 ; [#uses=1 type=float*]
  %weight_buf_2_addr_65 = getelementptr [640 x float]* %weight_buf_2, i64 0, i64 %tmp_417 ; [#uses=1 type=float*]
  %weight_buf_3_addr_2 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_291 ; [#uses=1 type=float*]
  %weight_buf_3_addr_3 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_293 ; [#uses=1 type=float*]
  %weight_buf_3_addr_4 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_295 ; [#uses=1 type=float*]
  %weight_buf_3_addr_5 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_297 ; [#uses=1 type=float*]
  %weight_buf_3_addr_6 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_299 ; [#uses=1 type=float*]
  %weight_buf_3_addr_7 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_301 ; [#uses=1 type=float*]
  %weight_buf_3_addr_8 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_303 ; [#uses=1 type=float*]
  %weight_buf_3_addr_9 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_305 ; [#uses=1 type=float*]
  %weight_buf_3_addr_10 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_307 ; [#uses=1 type=float*]
  %weight_buf_3_addr_11 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_309 ; [#uses=1 type=float*]
  %weight_buf_3_addr_12 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_311 ; [#uses=1 type=float*]
  %weight_buf_3_addr_13 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_313 ; [#uses=1 type=float*]
  %weight_buf_3_addr_14 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_315 ; [#uses=1 type=float*]
  %weight_buf_3_addr_15 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_317 ; [#uses=1 type=float*]
  %weight_buf_3_addr_16 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_319 ; [#uses=1 type=float*]
  %weight_buf_3_addr_17 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_321 ; [#uses=1 type=float*]
  %weight_buf_3_addr_18 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_323 ; [#uses=1 type=float*]
  %weight_buf_3_addr_19 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_325 ; [#uses=1 type=float*]
  %weight_buf_3_addr_20 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_327 ; [#uses=1 type=float*]
  %weight_buf_3_addr_21 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_329 ; [#uses=1 type=float*]
  %weight_buf_3_addr_22 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_331 ; [#uses=1 type=float*]
  %weight_buf_3_addr_23 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_333 ; [#uses=1 type=float*]
  %weight_buf_3_addr_24 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_335 ; [#uses=1 type=float*]
  %weight_buf_3_addr_25 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_337 ; [#uses=1 type=float*]
  %weight_buf_3_addr_26 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_339 ; [#uses=1 type=float*]
  %weight_buf_3_addr_27 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_341 ; [#uses=1 type=float*]
  %weight_buf_3_addr_28 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_343 ; [#uses=1 type=float*]
  %weight_buf_3_addr_29 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_345 ; [#uses=1 type=float*]
  %weight_buf_3_addr_30 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_347 ; [#uses=1 type=float*]
  %weight_buf_3_addr_31 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_349 ; [#uses=1 type=float*]
  %weight_buf_3_addr_32 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_351 ; [#uses=1 type=float*]
  %weight_buf_3_addr_33 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_353 ; [#uses=1 type=float*]
  %weight_buf_3_addr_34 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_355 ; [#uses=1 type=float*]
  %weight_buf_3_addr_35 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_357 ; [#uses=1 type=float*]
  %weight_buf_3_addr_36 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_359 ; [#uses=1 type=float*]
  %weight_buf_3_addr_37 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_361 ; [#uses=1 type=float*]
  %weight_buf_3_addr_38 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_363 ; [#uses=1 type=float*]
  %weight_buf_3_addr_39 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_365 ; [#uses=1 type=float*]
  %weight_buf_3_addr_40 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_367 ; [#uses=1 type=float*]
  %weight_buf_3_addr_41 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_369 ; [#uses=1 type=float*]
  %weight_buf_3_addr_42 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_371 ; [#uses=1 type=float*]
  %weight_buf_3_addr_43 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_373 ; [#uses=1 type=float*]
  %weight_buf_3_addr_44 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_375 ; [#uses=1 type=float*]
  %weight_buf_3_addr_45 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_377 ; [#uses=1 type=float*]
  %weight_buf_3_addr_46 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_379 ; [#uses=1 type=float*]
  %weight_buf_3_addr_47 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_381 ; [#uses=1 type=float*]
  %weight_buf_3_addr_48 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_383 ; [#uses=1 type=float*]
  %weight_buf_3_addr_49 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_385 ; [#uses=1 type=float*]
  %weight_buf_3_addr_50 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_387 ; [#uses=1 type=float*]
  %weight_buf_3_addr_51 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_389 ; [#uses=1 type=float*]
  %weight_buf_3_addr_52 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_391 ; [#uses=1 type=float*]
  %weight_buf_3_addr_53 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_393 ; [#uses=1 type=float*]
  %weight_buf_3_addr_54 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_395 ; [#uses=1 type=float*]
  %weight_buf_3_addr_55 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_397 ; [#uses=1 type=float*]
  %weight_buf_3_addr_56 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_399 ; [#uses=1 type=float*]
  %weight_buf_3_addr_57 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_401 ; [#uses=1 type=float*]
  %weight_buf_3_addr_58 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_403 ; [#uses=1 type=float*]
  %weight_buf_3_addr_59 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_405 ; [#uses=1 type=float*]
  %weight_buf_3_addr_60 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_407 ; [#uses=1 type=float*]
  %weight_buf_3_addr_61 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_409 ; [#uses=1 type=float*]
  %weight_buf_3_addr_62 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_411 ; [#uses=1 type=float*]
  %weight_buf_3_addr_63 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_413 ; [#uses=1 type=float*]
  %weight_buf_3_addr_64 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_415 ; [#uses=1 type=float*]
  %weight_buf_3_addr_65 = getelementptr [640 x float]* %weight_buf_3, i64 0, i64 %tmp_417 ; [#uses=1 type=float*]
  %tmp_418 = add i12 %tmp_289, %tmp_31_cast, !dbg !2864 ; [#uses=1 type=i12] [debug line = 76:5]
  %tmp_418_cast = zext i12 %tmp_418 to i64, !dbg !2864 ; [#uses=1 type=i64] [debug line = 76:5]
  %out_buf_addr_2 = getelementptr [1280 x float]* %out_buf, i64 0, i64 %tmp_418_cast, !dbg !2864 ; [#uses=1 type=float*] [debug line = 76:5]
  %offset_buf_addr_2 = getelementptr inbounds [10 x float]* %offset_buf, i64 0, i64 %tmp_31, !dbg !2867 ; [#uses=1 type=float*] [debug line = 72:26]
  %tmp = load float* %offset_buf_addr_2, align 4, !dbg !2867 ; [#uses=1 type=float] [debug line = 72:26]
  call void @llvm.dbg.value(metadata !{float %tmp}, i64 0, metadata !2868), !dbg !2867 ; [debug line = 72:26] [debug variable = tmp]
  %weight_buf_0_load = load float* %weight_buf_0_addr_2, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_33 = fmul float %in_buf_0_load, %weight_buf_0_load, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_34 = fadd float %tmp, %tmp_33, !dbg !2860  ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_1 = load float* %weight_buf_0_addr_3, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_1 = fmul float %in_buf_0_load_1, %weight_buf_0_load_1, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_1 = fadd float %tmp_34, %tmp_43_1, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_2 = load float* %weight_buf_0_addr_4, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_2 = fmul float %in_buf_0_load_2, %weight_buf_0_load_2, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_2 = fadd float %tmp_44_1, %tmp_43_2, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_3 = load float* %weight_buf_0_addr_5, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_3 = fmul float %in_buf_0_load_3, %weight_buf_0_load_3, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_3 = fadd float %tmp_44_2, %tmp_43_3, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_4 = load float* %weight_buf_0_addr_6, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_4 = fmul float %in_buf_0_load_4, %weight_buf_0_load_4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_4 = fadd float %tmp_44_3, %tmp_43_4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_5 = load float* %weight_buf_0_addr_7, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_5 = fmul float %in_buf_0_load_5, %weight_buf_0_load_5, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_5 = fadd float %tmp_44_4, %tmp_43_5, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_6 = load float* %weight_buf_0_addr_8, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_6 = fmul float %in_buf_0_load_6, %weight_buf_0_load_6, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_6 = fadd float %tmp_44_5, %tmp_43_6, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_7 = load float* %weight_buf_0_addr_9, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_7 = fmul float %in_buf_0_load_7, %weight_buf_0_load_7, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_7 = fadd float %tmp_44_6, %tmp_43_7, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_8 = load float* %weight_buf_0_addr_10, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_8 = fmul float %in_buf_0_load_8, %weight_buf_0_load_8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_8 = fadd float %tmp_44_7, %tmp_43_8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_9 = load float* %weight_buf_0_addr_11, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_9 = fmul float %in_buf_0_load_9, %weight_buf_0_load_9, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_9 = fadd float %tmp_44_8, %tmp_43_9, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_10 = load float* %weight_buf_0_addr_12, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_s = fmul float %in_buf_0_load_10, %weight_buf_0_load_10, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_s = fadd float %tmp_44_9, %tmp_43_s, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_11 = load float* %weight_buf_0_addr_13, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_10 = fmul float %in_buf_0_load_11, %weight_buf_0_load_11, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_10 = fadd float %tmp_44_s, %tmp_43_10, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_12 = load float* %weight_buf_0_addr_14, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_11 = fmul float %in_buf_0_load_12, %weight_buf_0_load_12, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_11 = fadd float %tmp_44_10, %tmp_43_11, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_13 = load float* %weight_buf_0_addr_15, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_12 = fmul float %in_buf_0_load_13, %weight_buf_0_load_13, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_12 = fadd float %tmp_44_11, %tmp_43_12, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_14 = load float* %weight_buf_0_addr_16, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_13 = fmul float %in_buf_0_load_14, %weight_buf_0_load_14, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_13 = fadd float %tmp_44_12, %tmp_43_13, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_15 = load float* %weight_buf_0_addr_17, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_14 = fmul float %in_buf_0_load_15, %weight_buf_0_load_15, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_14 = fadd float %tmp_44_13, %tmp_43_14, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_16 = load float* %weight_buf_0_addr_18, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_15 = fmul float %in_buf_0_load_16, %weight_buf_0_load_16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_15 = fadd float %tmp_44_14, %tmp_43_15, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_17 = load float* %weight_buf_0_addr_19, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_16 = fmul float %in_buf_0_load_17, %weight_buf_0_load_17, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_16 = fadd float %tmp_44_15, %tmp_43_16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_18 = load float* %weight_buf_0_addr_20, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_17 = fmul float %in_buf_0_load_18, %weight_buf_0_load_18, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_17 = fadd float %tmp_44_16, %tmp_43_17, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_19 = load float* %weight_buf_0_addr_21, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_18 = fmul float %in_buf_0_load_19, %weight_buf_0_load_19, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_18 = fadd float %tmp_44_17, %tmp_43_18, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_20 = load float* %weight_buf_0_addr_22, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_19 = fmul float %in_buf_0_load_20, %weight_buf_0_load_20, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_19 = fadd float %tmp_44_18, %tmp_43_19, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_21 = load float* %weight_buf_0_addr_23, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_20 = fmul float %in_buf_0_load_21, %weight_buf_0_load_21, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_20 = fadd float %tmp_44_19, %tmp_43_20, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_22 = load float* %weight_buf_0_addr_24, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_21 = fmul float %in_buf_0_load_22, %weight_buf_0_load_22, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_21 = fadd float %tmp_44_20, %tmp_43_21, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_23 = load float* %weight_buf_0_addr_25, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_22 = fmul float %in_buf_0_load_23, %weight_buf_0_load_23, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_22 = fadd float %tmp_44_21, %tmp_43_22, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_24 = load float* %weight_buf_0_addr_26, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_23 = fmul float %in_buf_0_load_24, %weight_buf_0_load_24, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_23 = fadd float %tmp_44_22, %tmp_43_23, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_25 = load float* %weight_buf_0_addr_27, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_24 = fmul float %in_buf_0_load_25, %weight_buf_0_load_25, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_24 = fadd float %tmp_44_23, %tmp_43_24, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_26 = load float* %weight_buf_0_addr_28, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_25 = fmul float %in_buf_0_load_26, %weight_buf_0_load_26, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_25 = fadd float %tmp_44_24, %tmp_43_25, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_27 = load float* %weight_buf_0_addr_29, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_26 = fmul float %in_buf_0_load_27, %weight_buf_0_load_27, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_26 = fadd float %tmp_44_25, %tmp_43_26, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_28 = load float* %weight_buf_0_addr_30, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_27 = fmul float %in_buf_0_load_28, %weight_buf_0_load_28, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_27 = fadd float %tmp_44_26, %tmp_43_27, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_29 = load float* %weight_buf_0_addr_31, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_28 = fmul float %in_buf_0_load_29, %weight_buf_0_load_29, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_28 = fadd float %tmp_44_27, %tmp_43_28, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_30 = load float* %weight_buf_0_addr_32, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_29 = fmul float %in_buf_0_load_30, %weight_buf_0_load_30, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_29 = fadd float %tmp_44_28, %tmp_43_29, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_31 = load float* %weight_buf_0_addr_33, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_30 = fmul float %in_buf_0_load_31, %weight_buf_0_load_31, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_30 = fadd float %tmp_44_29, %tmp_43_30, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_32 = load float* %weight_buf_0_addr_34, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_31 = fmul float %in_buf_0_load_32, %weight_buf_0_load_32, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_31 = fadd float %tmp_44_30, %tmp_43_31, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_33 = load float* %weight_buf_0_addr_35, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_32 = fmul float %in_buf_0_load_33, %weight_buf_0_load_33, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_32 = fadd float %tmp_44_31, %tmp_43_32, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_34 = load float* %weight_buf_0_addr_36, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_33 = fmul float %in_buf_0_load_34, %weight_buf_0_load_34, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_33 = fadd float %tmp_44_32, %tmp_43_33, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_35 = load float* %weight_buf_0_addr_37, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_34 = fmul float %in_buf_0_load_35, %weight_buf_0_load_35, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_34 = fadd float %tmp_44_33, %tmp_43_34, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_36 = load float* %weight_buf_0_addr_38, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_35 = fmul float %in_buf_0_load_36, %weight_buf_0_load_36, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_35 = fadd float %tmp_44_34, %tmp_43_35, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_37 = load float* %weight_buf_0_addr_39, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_36 = fmul float %in_buf_0_load_37, %weight_buf_0_load_37, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_36 = fadd float %tmp_44_35, %tmp_43_36, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_38 = load float* %weight_buf_0_addr_40, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_37 = fmul float %in_buf_0_load_38, %weight_buf_0_load_38, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_37 = fadd float %tmp_44_36, %tmp_43_37, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_39 = load float* %weight_buf_0_addr_41, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_38 = fmul float %in_buf_0_load_39, %weight_buf_0_load_39, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_38 = fadd float %tmp_44_37, %tmp_43_38, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_40 = load float* %weight_buf_0_addr_42, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_39 = fmul float %in_buf_0_load_40, %weight_buf_0_load_40, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_39 = fadd float %tmp_44_38, %tmp_43_39, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_41 = load float* %weight_buf_0_addr_43, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_40 = fmul float %in_buf_0_load_41, %weight_buf_0_load_41, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_40 = fadd float %tmp_44_39, %tmp_43_40, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_42 = load float* %weight_buf_0_addr_44, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_41 = fmul float %in_buf_0_load_42, %weight_buf_0_load_42, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_41 = fadd float %tmp_44_40, %tmp_43_41, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_43 = load float* %weight_buf_0_addr_45, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_42 = fmul float %in_buf_0_load_43, %weight_buf_0_load_43, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_42 = fadd float %tmp_44_41, %tmp_43_42, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_44 = load float* %weight_buf_0_addr_46, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_43 = fmul float %in_buf_0_load_44, %weight_buf_0_load_44, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_43 = fadd float %tmp_44_42, %tmp_43_43, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_45 = load float* %weight_buf_0_addr_47, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_44 = fmul float %in_buf_0_load_45, %weight_buf_0_load_45, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_44 = fadd float %tmp_44_43, %tmp_43_44, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_46 = load float* %weight_buf_0_addr_48, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_45 = fmul float %in_buf_0_load_46, %weight_buf_0_load_46, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_45 = fadd float %tmp_44_44, %tmp_43_45, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_47 = load float* %weight_buf_0_addr_49, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_46 = fmul float %in_buf_0_load_47, %weight_buf_0_load_47, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_46 = fadd float %tmp_44_45, %tmp_43_46, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_48 = load float* %weight_buf_0_addr_50, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_47 = fmul float %in_buf_0_load_48, %weight_buf_0_load_48, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_47 = fadd float %tmp_44_46, %tmp_43_47, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_49 = load float* %weight_buf_0_addr_51, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_48 = fmul float %in_buf_0_load_49, %weight_buf_0_load_49, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_48 = fadd float %tmp_44_47, %tmp_43_48, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_50 = load float* %weight_buf_0_addr_52, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_49 = fmul float %in_buf_0_load_50, %weight_buf_0_load_50, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_49 = fadd float %tmp_44_48, %tmp_43_49, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_51 = load float* %weight_buf_0_addr_53, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_50 = fmul float %in_buf_0_load_51, %weight_buf_0_load_51, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_50 = fadd float %tmp_44_49, %tmp_43_50, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_52 = load float* %weight_buf_0_addr_54, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_51 = fmul float %in_buf_0_load_52, %weight_buf_0_load_52, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_51 = fadd float %tmp_44_50, %tmp_43_51, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_53 = load float* %weight_buf_0_addr_55, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_52 = fmul float %in_buf_0_load_53, %weight_buf_0_load_53, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_52 = fadd float %tmp_44_51, %tmp_43_52, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_54 = load float* %weight_buf_0_addr_56, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_53 = fmul float %in_buf_0_load_54, %weight_buf_0_load_54, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_53 = fadd float %tmp_44_52, %tmp_43_53, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_55 = load float* %weight_buf_0_addr_57, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_54 = fmul float %in_buf_0_load_55, %weight_buf_0_load_55, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_54 = fadd float %tmp_44_53, %tmp_43_54, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_56 = load float* %weight_buf_0_addr_58, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_55 = fmul float %in_buf_0_load_56, %weight_buf_0_load_56, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_55 = fadd float %tmp_44_54, %tmp_43_55, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_57 = load float* %weight_buf_0_addr_59, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_56 = fmul float %in_buf_0_load_57, %weight_buf_0_load_57, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_56 = fadd float %tmp_44_55, %tmp_43_56, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_58 = load float* %weight_buf_0_addr_60, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_57 = fmul float %in_buf_0_load_58, %weight_buf_0_load_58, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_57 = fadd float %tmp_44_56, %tmp_43_57, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_59 = load float* %weight_buf_0_addr_61, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_58 = fmul float %in_buf_0_load_59, %weight_buf_0_load_59, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_58 = fadd float %tmp_44_57, %tmp_43_58, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_60 = load float* %weight_buf_0_addr_62, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_59 = fmul float %in_buf_0_load_60, %weight_buf_0_load_60, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_59 = fadd float %tmp_44_58, %tmp_43_59, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_61 = load float* %weight_buf_0_addr_63, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_60 = fmul float %in_buf_0_load_61, %weight_buf_0_load_61, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_60 = fadd float %tmp_44_59, %tmp_43_60, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_62 = load float* %weight_buf_0_addr_64, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_61 = fmul float %in_buf_0_load_62, %weight_buf_0_load_62, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_61 = fadd float %tmp_44_60, %tmp_43_61, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_0_load_63 = load float* %weight_buf_0_addr_65, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_62 = fmul float %in_buf_0_load_63, %weight_buf_0_load_63, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_62 = fadd float %tmp_44_61, %tmp_43_62, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load = load float* %weight_buf_1_addr_2, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_63 = fmul float %in_buf_1_load, %weight_buf_1_load, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_63 = fadd float %tmp_44_62, %tmp_43_63, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_1 = load float* %weight_buf_1_addr_3, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_64 = fmul float %in_buf_1_load_1, %weight_buf_1_load_1, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_64 = fadd float %tmp_44_63, %tmp_43_64, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_2 = load float* %weight_buf_1_addr_4, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_65 = fmul float %in_buf_1_load_2, %weight_buf_1_load_2, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_65 = fadd float %tmp_44_64, %tmp_43_65, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_3 = load float* %weight_buf_1_addr_5, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_66 = fmul float %in_buf_1_load_3, %weight_buf_1_load_3, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_66 = fadd float %tmp_44_65, %tmp_43_66, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_4 = load float* %weight_buf_1_addr_6, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_67 = fmul float %in_buf_1_load_4, %weight_buf_1_load_4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_67 = fadd float %tmp_44_66, %tmp_43_67, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_5 = load float* %weight_buf_1_addr_7, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_68 = fmul float %in_buf_1_load_5, %weight_buf_1_load_5, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_68 = fadd float %tmp_44_67, %tmp_43_68, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_6 = load float* %weight_buf_1_addr_8, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_69 = fmul float %in_buf_1_load_6, %weight_buf_1_load_6, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_69 = fadd float %tmp_44_68, %tmp_43_69, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_7 = load float* %weight_buf_1_addr_9, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_70 = fmul float %in_buf_1_load_7, %weight_buf_1_load_7, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_70 = fadd float %tmp_44_69, %tmp_43_70, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_8 = load float* %weight_buf_1_addr_10, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_71 = fmul float %in_buf_1_load_8, %weight_buf_1_load_8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_71 = fadd float %tmp_44_70, %tmp_43_71, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_9 = load float* %weight_buf_1_addr_11, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_72 = fmul float %in_buf_1_load_9, %weight_buf_1_load_9, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_72 = fadd float %tmp_44_71, %tmp_43_72, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_10 = load float* %weight_buf_1_addr_12, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_73 = fmul float %in_buf_1_load_10, %weight_buf_1_load_10, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_73 = fadd float %tmp_44_72, %tmp_43_73, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_11 = load float* %weight_buf_1_addr_13, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_74 = fmul float %in_buf_1_load_11, %weight_buf_1_load_11, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_74 = fadd float %tmp_44_73, %tmp_43_74, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_12 = load float* %weight_buf_1_addr_14, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_75 = fmul float %in_buf_1_load_12, %weight_buf_1_load_12, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_75 = fadd float %tmp_44_74, %tmp_43_75, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_13 = load float* %weight_buf_1_addr_15, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_76 = fmul float %in_buf_1_load_13, %weight_buf_1_load_13, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_76 = fadd float %tmp_44_75, %tmp_43_76, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_14 = load float* %weight_buf_1_addr_16, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_77 = fmul float %in_buf_1_load_14, %weight_buf_1_load_14, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_77 = fadd float %tmp_44_76, %tmp_43_77, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_15 = load float* %weight_buf_1_addr_17, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_78 = fmul float %in_buf_1_load_15, %weight_buf_1_load_15, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_78 = fadd float %tmp_44_77, %tmp_43_78, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_16 = load float* %weight_buf_1_addr_18, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_79 = fmul float %in_buf_1_load_16, %weight_buf_1_load_16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_79 = fadd float %tmp_44_78, %tmp_43_79, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_17 = load float* %weight_buf_1_addr_19, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_80 = fmul float %in_buf_1_load_17, %weight_buf_1_load_17, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_80 = fadd float %tmp_44_79, %tmp_43_80, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_18 = load float* %weight_buf_1_addr_20, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_81 = fmul float %in_buf_1_load_18, %weight_buf_1_load_18, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_81 = fadd float %tmp_44_80, %tmp_43_81, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_19 = load float* %weight_buf_1_addr_21, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_82 = fmul float %in_buf_1_load_19, %weight_buf_1_load_19, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_82 = fadd float %tmp_44_81, %tmp_43_82, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_20 = load float* %weight_buf_1_addr_22, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_83 = fmul float %in_buf_1_load_20, %weight_buf_1_load_20, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_83 = fadd float %tmp_44_82, %tmp_43_83, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_21 = load float* %weight_buf_1_addr_23, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_84 = fmul float %in_buf_1_load_21, %weight_buf_1_load_21, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_84 = fadd float %tmp_44_83, %tmp_43_84, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_22 = load float* %weight_buf_1_addr_24, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_85 = fmul float %in_buf_1_load_22, %weight_buf_1_load_22, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_85 = fadd float %tmp_44_84, %tmp_43_85, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_23 = load float* %weight_buf_1_addr_25, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_86 = fmul float %in_buf_1_load_23, %weight_buf_1_load_23, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_86 = fadd float %tmp_44_85, %tmp_43_86, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_24 = load float* %weight_buf_1_addr_26, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_87 = fmul float %in_buf_1_load_24, %weight_buf_1_load_24, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_87 = fadd float %tmp_44_86, %tmp_43_87, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_25 = load float* %weight_buf_1_addr_27, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_88 = fmul float %in_buf_1_load_25, %weight_buf_1_load_25, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_88 = fadd float %tmp_44_87, %tmp_43_88, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_26 = load float* %weight_buf_1_addr_28, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_89 = fmul float %in_buf_1_load_26, %weight_buf_1_load_26, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_89 = fadd float %tmp_44_88, %tmp_43_89, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_27 = load float* %weight_buf_1_addr_29, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_90 = fmul float %in_buf_1_load_27, %weight_buf_1_load_27, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_90 = fadd float %tmp_44_89, %tmp_43_90, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_28 = load float* %weight_buf_1_addr_30, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_91 = fmul float %in_buf_1_load_28, %weight_buf_1_load_28, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_91 = fadd float %tmp_44_90, %tmp_43_91, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_29 = load float* %weight_buf_1_addr_31, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_92 = fmul float %in_buf_1_load_29, %weight_buf_1_load_29, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_92 = fadd float %tmp_44_91, %tmp_43_92, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_30 = load float* %weight_buf_1_addr_32, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_93 = fmul float %in_buf_1_load_30, %weight_buf_1_load_30, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_93 = fadd float %tmp_44_92, %tmp_43_93, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_31 = load float* %weight_buf_1_addr_33, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_94 = fmul float %in_buf_1_load_31, %weight_buf_1_load_31, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_94 = fadd float %tmp_44_93, %tmp_43_94, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_32 = load float* %weight_buf_1_addr_34, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_95 = fmul float %in_buf_1_load_32, %weight_buf_1_load_32, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_95 = fadd float %tmp_44_94, %tmp_43_95, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_33 = load float* %weight_buf_1_addr_35, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_96 = fmul float %in_buf_1_load_33, %weight_buf_1_load_33, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_96 = fadd float %tmp_44_95, %tmp_43_96, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_34 = load float* %weight_buf_1_addr_36, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_97 = fmul float %in_buf_1_load_34, %weight_buf_1_load_34, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_97 = fadd float %tmp_44_96, %tmp_43_97, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_35 = load float* %weight_buf_1_addr_37, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_98 = fmul float %in_buf_1_load_35, %weight_buf_1_load_35, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_98 = fadd float %tmp_44_97, %tmp_43_98, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_36 = load float* %weight_buf_1_addr_38, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_99 = fmul float %in_buf_1_load_36, %weight_buf_1_load_36, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_99 = fadd float %tmp_44_98, %tmp_43_99, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_37 = load float* %weight_buf_1_addr_39, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_100 = fmul float %in_buf_1_load_37, %weight_buf_1_load_37, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_100 = fadd float %tmp_44_99, %tmp_43_100, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_38 = load float* %weight_buf_1_addr_40, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_101 = fmul float %in_buf_1_load_38, %weight_buf_1_load_38, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_101 = fadd float %tmp_44_100, %tmp_43_101, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_39 = load float* %weight_buf_1_addr_41, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_102 = fmul float %in_buf_1_load_39, %weight_buf_1_load_39, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_102 = fadd float %tmp_44_101, %tmp_43_102, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_40 = load float* %weight_buf_1_addr_42, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_103 = fmul float %in_buf_1_load_40, %weight_buf_1_load_40, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_103 = fadd float %tmp_44_102, %tmp_43_103, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_41 = load float* %weight_buf_1_addr_43, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_104 = fmul float %in_buf_1_load_41, %weight_buf_1_load_41, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_104 = fadd float %tmp_44_103, %tmp_43_104, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_42 = load float* %weight_buf_1_addr_44, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_105 = fmul float %in_buf_1_load_42, %weight_buf_1_load_42, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_105 = fadd float %tmp_44_104, %tmp_43_105, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_43 = load float* %weight_buf_1_addr_45, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_106 = fmul float %in_buf_1_load_43, %weight_buf_1_load_43, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_106 = fadd float %tmp_44_105, %tmp_43_106, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_44 = load float* %weight_buf_1_addr_46, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_107 = fmul float %in_buf_1_load_44, %weight_buf_1_load_44, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_107 = fadd float %tmp_44_106, %tmp_43_107, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_45 = load float* %weight_buf_1_addr_47, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_108 = fmul float %in_buf_1_load_45, %weight_buf_1_load_45, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_108 = fadd float %tmp_44_107, %tmp_43_108, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_46 = load float* %weight_buf_1_addr_48, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_109 = fmul float %in_buf_1_load_46, %weight_buf_1_load_46, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_109 = fadd float %tmp_44_108, %tmp_43_109, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_47 = load float* %weight_buf_1_addr_49, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_110 = fmul float %in_buf_1_load_47, %weight_buf_1_load_47, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_110 = fadd float %tmp_44_109, %tmp_43_110, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_48 = load float* %weight_buf_1_addr_50, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_111 = fmul float %in_buf_1_load_48, %weight_buf_1_load_48, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_111 = fadd float %tmp_44_110, %tmp_43_111, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_49 = load float* %weight_buf_1_addr_51, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_112 = fmul float %in_buf_1_load_49, %weight_buf_1_load_49, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_112 = fadd float %tmp_44_111, %tmp_43_112, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_50 = load float* %weight_buf_1_addr_52, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_113 = fmul float %in_buf_1_load_50, %weight_buf_1_load_50, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_113 = fadd float %tmp_44_112, %tmp_43_113, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_51 = load float* %weight_buf_1_addr_53, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_114 = fmul float %in_buf_1_load_51, %weight_buf_1_load_51, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_114 = fadd float %tmp_44_113, %tmp_43_114, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_52 = load float* %weight_buf_1_addr_54, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_115 = fmul float %in_buf_1_load_52, %weight_buf_1_load_52, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_115 = fadd float %tmp_44_114, %tmp_43_115, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_53 = load float* %weight_buf_1_addr_55, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_116 = fmul float %in_buf_1_load_53, %weight_buf_1_load_53, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_116 = fadd float %tmp_44_115, %tmp_43_116, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_54 = load float* %weight_buf_1_addr_56, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_117 = fmul float %in_buf_1_load_54, %weight_buf_1_load_54, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_117 = fadd float %tmp_44_116, %tmp_43_117, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_55 = load float* %weight_buf_1_addr_57, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_118 = fmul float %in_buf_1_load_55, %weight_buf_1_load_55, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_118 = fadd float %tmp_44_117, %tmp_43_118, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_56 = load float* %weight_buf_1_addr_58, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_119 = fmul float %in_buf_1_load_56, %weight_buf_1_load_56, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_119 = fadd float %tmp_44_118, %tmp_43_119, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_57 = load float* %weight_buf_1_addr_59, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_120 = fmul float %in_buf_1_load_57, %weight_buf_1_load_57, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_120 = fadd float %tmp_44_119, %tmp_43_120, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_58 = load float* %weight_buf_1_addr_60, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_121 = fmul float %in_buf_1_load_58, %weight_buf_1_load_58, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_121 = fadd float %tmp_44_120, %tmp_43_121, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_59 = load float* %weight_buf_1_addr_61, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_122 = fmul float %in_buf_1_load_59, %weight_buf_1_load_59, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_122 = fadd float %tmp_44_121, %tmp_43_122, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_60 = load float* %weight_buf_1_addr_62, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_123 = fmul float %in_buf_1_load_60, %weight_buf_1_load_60, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_123 = fadd float %tmp_44_122, %tmp_43_123, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_61 = load float* %weight_buf_1_addr_63, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_124 = fmul float %in_buf_1_load_61, %weight_buf_1_load_61, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_124 = fadd float %tmp_44_123, %tmp_43_124, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_62 = load float* %weight_buf_1_addr_64, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_125 = fmul float %in_buf_1_load_62, %weight_buf_1_load_62, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_125 = fadd float %tmp_44_124, %tmp_43_125, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_1_load_63 = load float* %weight_buf_1_addr_65, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_126 = fmul float %in_buf_1_load_63, %weight_buf_1_load_63, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_126 = fadd float %tmp_44_125, %tmp_43_126, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load = load float* %weight_buf_2_addr_2, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_127 = fmul float %in_buf_2_load, %weight_buf_2_load, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_127 = fadd float %tmp_44_126, %tmp_43_127, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_1 = load float* %weight_buf_2_addr_3, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_128 = fmul float %in_buf_2_load_1, %weight_buf_2_load_1, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_128 = fadd float %tmp_44_127, %tmp_43_128, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_2 = load float* %weight_buf_2_addr_4, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_129 = fmul float %in_buf_2_load_2, %weight_buf_2_load_2, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_129 = fadd float %tmp_44_128, %tmp_43_129, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_3 = load float* %weight_buf_2_addr_5, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_130 = fmul float %in_buf_2_load_3, %weight_buf_2_load_3, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_130 = fadd float %tmp_44_129, %tmp_43_130, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_4 = load float* %weight_buf_2_addr_6, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_131 = fmul float %in_buf_2_load_4, %weight_buf_2_load_4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_131 = fadd float %tmp_44_130, %tmp_43_131, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_5 = load float* %weight_buf_2_addr_7, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_132 = fmul float %in_buf_2_load_5, %weight_buf_2_load_5, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_132 = fadd float %tmp_44_131, %tmp_43_132, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_6 = load float* %weight_buf_2_addr_8, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_133 = fmul float %in_buf_2_load_6, %weight_buf_2_load_6, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_133 = fadd float %tmp_44_132, %tmp_43_133, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_7 = load float* %weight_buf_2_addr_9, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_134 = fmul float %in_buf_2_load_7, %weight_buf_2_load_7, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_134 = fadd float %tmp_44_133, %tmp_43_134, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_8 = load float* %weight_buf_2_addr_10, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_135 = fmul float %in_buf_2_load_8, %weight_buf_2_load_8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_135 = fadd float %tmp_44_134, %tmp_43_135, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_9 = load float* %weight_buf_2_addr_11, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_136 = fmul float %in_buf_2_load_9, %weight_buf_2_load_9, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_136 = fadd float %tmp_44_135, %tmp_43_136, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_10 = load float* %weight_buf_2_addr_12, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_137 = fmul float %in_buf_2_load_10, %weight_buf_2_load_10, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_137 = fadd float %tmp_44_136, %tmp_43_137, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_11 = load float* %weight_buf_2_addr_13, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_138 = fmul float %in_buf_2_load_11, %weight_buf_2_load_11, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_138 = fadd float %tmp_44_137, %tmp_43_138, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_12 = load float* %weight_buf_2_addr_14, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_139 = fmul float %in_buf_2_load_12, %weight_buf_2_load_12, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_139 = fadd float %tmp_44_138, %tmp_43_139, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_13 = load float* %weight_buf_2_addr_15, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_140 = fmul float %in_buf_2_load_13, %weight_buf_2_load_13, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_140 = fadd float %tmp_44_139, %tmp_43_140, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_14 = load float* %weight_buf_2_addr_16, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_141 = fmul float %in_buf_2_load_14, %weight_buf_2_load_14, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_141 = fadd float %tmp_44_140, %tmp_43_141, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_15 = load float* %weight_buf_2_addr_17, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_142 = fmul float %in_buf_2_load_15, %weight_buf_2_load_15, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_142 = fadd float %tmp_44_141, %tmp_43_142, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_16 = load float* %weight_buf_2_addr_18, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_143 = fmul float %in_buf_2_load_16, %weight_buf_2_load_16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_143 = fadd float %tmp_44_142, %tmp_43_143, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_17 = load float* %weight_buf_2_addr_19, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_144 = fmul float %in_buf_2_load_17, %weight_buf_2_load_17, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_144 = fadd float %tmp_44_143, %tmp_43_144, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_18 = load float* %weight_buf_2_addr_20, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_145 = fmul float %in_buf_2_load_18, %weight_buf_2_load_18, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_145 = fadd float %tmp_44_144, %tmp_43_145, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_19 = load float* %weight_buf_2_addr_21, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_146 = fmul float %in_buf_2_load_19, %weight_buf_2_load_19, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_146 = fadd float %tmp_44_145, %tmp_43_146, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_20 = load float* %weight_buf_2_addr_22, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_147 = fmul float %in_buf_2_load_20, %weight_buf_2_load_20, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_147 = fadd float %tmp_44_146, %tmp_43_147, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_21 = load float* %weight_buf_2_addr_23, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_148 = fmul float %in_buf_2_load_21, %weight_buf_2_load_21, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_148 = fadd float %tmp_44_147, %tmp_43_148, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_22 = load float* %weight_buf_2_addr_24, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_149 = fmul float %in_buf_2_load_22, %weight_buf_2_load_22, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_149 = fadd float %tmp_44_148, %tmp_43_149, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_23 = load float* %weight_buf_2_addr_25, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_150 = fmul float %in_buf_2_load_23, %weight_buf_2_load_23, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_150 = fadd float %tmp_44_149, %tmp_43_150, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_24 = load float* %weight_buf_2_addr_26, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_151 = fmul float %in_buf_2_load_24, %weight_buf_2_load_24, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_151 = fadd float %tmp_44_150, %tmp_43_151, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_25 = load float* %weight_buf_2_addr_27, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_152 = fmul float %in_buf_2_load_25, %weight_buf_2_load_25, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_152 = fadd float %tmp_44_151, %tmp_43_152, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_26 = load float* %weight_buf_2_addr_28, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_153 = fmul float %in_buf_2_load_26, %weight_buf_2_load_26, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_153 = fadd float %tmp_44_152, %tmp_43_153, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_27 = load float* %weight_buf_2_addr_29, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_154 = fmul float %in_buf_2_load_27, %weight_buf_2_load_27, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_154 = fadd float %tmp_44_153, %tmp_43_154, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_28 = load float* %weight_buf_2_addr_30, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_155 = fmul float %in_buf_2_load_28, %weight_buf_2_load_28, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_155 = fadd float %tmp_44_154, %tmp_43_155, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_29 = load float* %weight_buf_2_addr_31, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_156 = fmul float %in_buf_2_load_29, %weight_buf_2_load_29, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_156 = fadd float %tmp_44_155, %tmp_43_156, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_30 = load float* %weight_buf_2_addr_32, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_157 = fmul float %in_buf_2_load_30, %weight_buf_2_load_30, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_157 = fadd float %tmp_44_156, %tmp_43_157, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_31 = load float* %weight_buf_2_addr_33, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_158 = fmul float %in_buf_2_load_31, %weight_buf_2_load_31, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_158 = fadd float %tmp_44_157, %tmp_43_158, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_32 = load float* %weight_buf_2_addr_34, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_159 = fmul float %in_buf_2_load_32, %weight_buf_2_load_32, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_159 = fadd float %tmp_44_158, %tmp_43_159, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_33 = load float* %weight_buf_2_addr_35, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_160 = fmul float %in_buf_2_load_33, %weight_buf_2_load_33, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_160 = fadd float %tmp_44_159, %tmp_43_160, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_34 = load float* %weight_buf_2_addr_36, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_161 = fmul float %in_buf_2_load_34, %weight_buf_2_load_34, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_161 = fadd float %tmp_44_160, %tmp_43_161, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_35 = load float* %weight_buf_2_addr_37, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_162 = fmul float %in_buf_2_load_35, %weight_buf_2_load_35, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_162 = fadd float %tmp_44_161, %tmp_43_162, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_36 = load float* %weight_buf_2_addr_38, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_163 = fmul float %in_buf_2_load_36, %weight_buf_2_load_36, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_163 = fadd float %tmp_44_162, %tmp_43_163, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_37 = load float* %weight_buf_2_addr_39, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_164 = fmul float %in_buf_2_load_37, %weight_buf_2_load_37, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_164 = fadd float %tmp_44_163, %tmp_43_164, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_38 = load float* %weight_buf_2_addr_40, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_165 = fmul float %in_buf_2_load_38, %weight_buf_2_load_38, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_165 = fadd float %tmp_44_164, %tmp_43_165, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_39 = load float* %weight_buf_2_addr_41, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_166 = fmul float %in_buf_2_load_39, %weight_buf_2_load_39, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_166 = fadd float %tmp_44_165, %tmp_43_166, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_40 = load float* %weight_buf_2_addr_42, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_167 = fmul float %in_buf_2_load_40, %weight_buf_2_load_40, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_167 = fadd float %tmp_44_166, %tmp_43_167, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_41 = load float* %weight_buf_2_addr_43, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_168 = fmul float %in_buf_2_load_41, %weight_buf_2_load_41, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_168 = fadd float %tmp_44_167, %tmp_43_168, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_42 = load float* %weight_buf_2_addr_44, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_169 = fmul float %in_buf_2_load_42, %weight_buf_2_load_42, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_169 = fadd float %tmp_44_168, %tmp_43_169, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_43 = load float* %weight_buf_2_addr_45, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_170 = fmul float %in_buf_2_load_43, %weight_buf_2_load_43, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_170 = fadd float %tmp_44_169, %tmp_43_170, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_44 = load float* %weight_buf_2_addr_46, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_171 = fmul float %in_buf_2_load_44, %weight_buf_2_load_44, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_171 = fadd float %tmp_44_170, %tmp_43_171, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_45 = load float* %weight_buf_2_addr_47, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_172 = fmul float %in_buf_2_load_45, %weight_buf_2_load_45, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_172 = fadd float %tmp_44_171, %tmp_43_172, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_46 = load float* %weight_buf_2_addr_48, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_173 = fmul float %in_buf_2_load_46, %weight_buf_2_load_46, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_173 = fadd float %tmp_44_172, %tmp_43_173, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_47 = load float* %weight_buf_2_addr_49, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_174 = fmul float %in_buf_2_load_47, %weight_buf_2_load_47, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_174 = fadd float %tmp_44_173, %tmp_43_174, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_48 = load float* %weight_buf_2_addr_50, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_175 = fmul float %in_buf_2_load_48, %weight_buf_2_load_48, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_175 = fadd float %tmp_44_174, %tmp_43_175, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_49 = load float* %weight_buf_2_addr_51, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_176 = fmul float %in_buf_2_load_49, %weight_buf_2_load_49, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_176 = fadd float %tmp_44_175, %tmp_43_176, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_50 = load float* %weight_buf_2_addr_52, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_177 = fmul float %in_buf_2_load_50, %weight_buf_2_load_50, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_177 = fadd float %tmp_44_176, %tmp_43_177, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_51 = load float* %weight_buf_2_addr_53, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_178 = fmul float %in_buf_2_load_51, %weight_buf_2_load_51, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_178 = fadd float %tmp_44_177, %tmp_43_178, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_52 = load float* %weight_buf_2_addr_54, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_179 = fmul float %in_buf_2_load_52, %weight_buf_2_load_52, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_179 = fadd float %tmp_44_178, %tmp_43_179, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_53 = load float* %weight_buf_2_addr_55, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_180 = fmul float %in_buf_2_load_53, %weight_buf_2_load_53, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_180 = fadd float %tmp_44_179, %tmp_43_180, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_54 = load float* %weight_buf_2_addr_56, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_181 = fmul float %in_buf_2_load_54, %weight_buf_2_load_54, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_181 = fadd float %tmp_44_180, %tmp_43_181, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_55 = load float* %weight_buf_2_addr_57, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_182 = fmul float %in_buf_2_load_55, %weight_buf_2_load_55, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_182 = fadd float %tmp_44_181, %tmp_43_182, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_56 = load float* %weight_buf_2_addr_58, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_183 = fmul float %in_buf_2_load_56, %weight_buf_2_load_56, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_183 = fadd float %tmp_44_182, %tmp_43_183, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_57 = load float* %weight_buf_2_addr_59, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_184 = fmul float %in_buf_2_load_57, %weight_buf_2_load_57, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_184 = fadd float %tmp_44_183, %tmp_43_184, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_58 = load float* %weight_buf_2_addr_60, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_185 = fmul float %in_buf_2_load_58, %weight_buf_2_load_58, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_185 = fadd float %tmp_44_184, %tmp_43_185, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_59 = load float* %weight_buf_2_addr_61, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_186 = fmul float %in_buf_2_load_59, %weight_buf_2_load_59, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_186 = fadd float %tmp_44_185, %tmp_43_186, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_60 = load float* %weight_buf_2_addr_62, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_187 = fmul float %in_buf_2_load_60, %weight_buf_2_load_60, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_187 = fadd float %tmp_44_186, %tmp_43_187, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_61 = load float* %weight_buf_2_addr_63, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_188 = fmul float %in_buf_2_load_61, %weight_buf_2_load_61, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_188 = fadd float %tmp_44_187, %tmp_43_188, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_62 = load float* %weight_buf_2_addr_64, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_189 = fmul float %in_buf_2_load_62, %weight_buf_2_load_62, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_189 = fadd float %tmp_44_188, %tmp_43_189, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_2_load_63 = load float* %weight_buf_2_addr_65, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_190 = fmul float %in_buf_2_load_63, %weight_buf_2_load_63, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_190 = fadd float %tmp_44_189, %tmp_43_190, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load = load float* %weight_buf_3_addr_2, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_191 = fmul float %in_buf_3_load, %weight_buf_3_load, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_191 = fadd float %tmp_44_190, %tmp_43_191, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_1 = load float* %weight_buf_3_addr_3, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_192 = fmul float %in_buf_3_load_1, %weight_buf_3_load_1, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_192 = fadd float %tmp_44_191, %tmp_43_192, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_2 = load float* %weight_buf_3_addr_4, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_193 = fmul float %in_buf_3_load_2, %weight_buf_3_load_2, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_193 = fadd float %tmp_44_192, %tmp_43_193, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_3 = load float* %weight_buf_3_addr_5, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_194 = fmul float %in_buf_3_load_3, %weight_buf_3_load_3, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_194 = fadd float %tmp_44_193, %tmp_43_194, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_4 = load float* %weight_buf_3_addr_6, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_195 = fmul float %in_buf_3_load_4, %weight_buf_3_load_4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_195 = fadd float %tmp_44_194, %tmp_43_195, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_5 = load float* %weight_buf_3_addr_7, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_196 = fmul float %in_buf_3_load_5, %weight_buf_3_load_5, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_196 = fadd float %tmp_44_195, %tmp_43_196, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_6 = load float* %weight_buf_3_addr_8, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_197 = fmul float %in_buf_3_load_6, %weight_buf_3_load_6, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_197 = fadd float %tmp_44_196, %tmp_43_197, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_7 = load float* %weight_buf_3_addr_9, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_198 = fmul float %in_buf_3_load_7, %weight_buf_3_load_7, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_198 = fadd float %tmp_44_197, %tmp_43_198, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_8 = load float* %weight_buf_3_addr_10, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_199 = fmul float %in_buf_3_load_8, %weight_buf_3_load_8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_199 = fadd float %tmp_44_198, %tmp_43_199, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_9 = load float* %weight_buf_3_addr_11, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_200 = fmul float %in_buf_3_load_9, %weight_buf_3_load_9, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_200 = fadd float %tmp_44_199, %tmp_43_200, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_10 = load float* %weight_buf_3_addr_12, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_201 = fmul float %in_buf_3_load_10, %weight_buf_3_load_10, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_201 = fadd float %tmp_44_200, %tmp_43_201, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_11 = load float* %weight_buf_3_addr_13, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_202 = fmul float %in_buf_3_load_11, %weight_buf_3_load_11, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_202 = fadd float %tmp_44_201, %tmp_43_202, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_12 = load float* %weight_buf_3_addr_14, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_203 = fmul float %in_buf_3_load_12, %weight_buf_3_load_12, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_203 = fadd float %tmp_44_202, %tmp_43_203, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_13 = load float* %weight_buf_3_addr_15, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_204 = fmul float %in_buf_3_load_13, %weight_buf_3_load_13, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_204 = fadd float %tmp_44_203, %tmp_43_204, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_14 = load float* %weight_buf_3_addr_16, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_205 = fmul float %in_buf_3_load_14, %weight_buf_3_load_14, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_205 = fadd float %tmp_44_204, %tmp_43_205, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_15 = load float* %weight_buf_3_addr_17, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_206 = fmul float %in_buf_3_load_15, %weight_buf_3_load_15, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_206 = fadd float %tmp_44_205, %tmp_43_206, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_16 = load float* %weight_buf_3_addr_18, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_207 = fmul float %in_buf_3_load_16, %weight_buf_3_load_16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_207 = fadd float %tmp_44_206, %tmp_43_207, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_17 = load float* %weight_buf_3_addr_19, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_208 = fmul float %in_buf_3_load_17, %weight_buf_3_load_17, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_208 = fadd float %tmp_44_207, %tmp_43_208, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_18 = load float* %weight_buf_3_addr_20, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_209 = fmul float %in_buf_3_load_18, %weight_buf_3_load_18, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_209 = fadd float %tmp_44_208, %tmp_43_209, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_19 = load float* %weight_buf_3_addr_21, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_210 = fmul float %in_buf_3_load_19, %weight_buf_3_load_19, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_210 = fadd float %tmp_44_209, %tmp_43_210, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_20 = load float* %weight_buf_3_addr_22, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_211 = fmul float %in_buf_3_load_20, %weight_buf_3_load_20, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_211 = fadd float %tmp_44_210, %tmp_43_211, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_21 = load float* %weight_buf_3_addr_23, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_212 = fmul float %in_buf_3_load_21, %weight_buf_3_load_21, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_212 = fadd float %tmp_44_211, %tmp_43_212, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_22 = load float* %weight_buf_3_addr_24, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_213 = fmul float %in_buf_3_load_22, %weight_buf_3_load_22, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_213 = fadd float %tmp_44_212, %tmp_43_213, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_23 = load float* %weight_buf_3_addr_25, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_214 = fmul float %in_buf_3_load_23, %weight_buf_3_load_23, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_214 = fadd float %tmp_44_213, %tmp_43_214, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_24 = load float* %weight_buf_3_addr_26, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_215 = fmul float %in_buf_3_load_24, %weight_buf_3_load_24, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_215 = fadd float %tmp_44_214, %tmp_43_215, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_25 = load float* %weight_buf_3_addr_27, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_216 = fmul float %in_buf_3_load_25, %weight_buf_3_load_25, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_216 = fadd float %tmp_44_215, %tmp_43_216, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_26 = load float* %weight_buf_3_addr_28, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_217 = fmul float %in_buf_3_load_26, %weight_buf_3_load_26, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_217 = fadd float %tmp_44_216, %tmp_43_217, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_27 = load float* %weight_buf_3_addr_29, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_218 = fmul float %in_buf_3_load_27, %weight_buf_3_load_27, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_218 = fadd float %tmp_44_217, %tmp_43_218, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_28 = load float* %weight_buf_3_addr_30, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_219 = fmul float %in_buf_3_load_28, %weight_buf_3_load_28, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_219 = fadd float %tmp_44_218, %tmp_43_219, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_29 = load float* %weight_buf_3_addr_31, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_220 = fmul float %in_buf_3_load_29, %weight_buf_3_load_29, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_220 = fadd float %tmp_44_219, %tmp_43_220, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_30 = load float* %weight_buf_3_addr_32, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_221 = fmul float %in_buf_3_load_30, %weight_buf_3_load_30, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_221 = fadd float %tmp_44_220, %tmp_43_221, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_31 = load float* %weight_buf_3_addr_33, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_222 = fmul float %in_buf_3_load_31, %weight_buf_3_load_31, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_222 = fadd float %tmp_44_221, %tmp_43_222, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_32 = load float* %weight_buf_3_addr_34, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_223 = fmul float %in_buf_3_load_32, %weight_buf_3_load_32, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_223 = fadd float %tmp_44_222, %tmp_43_223, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_33 = load float* %weight_buf_3_addr_35, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_224 = fmul float %in_buf_3_load_33, %weight_buf_3_load_33, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_224 = fadd float %tmp_44_223, %tmp_43_224, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_34 = load float* %weight_buf_3_addr_36, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_225 = fmul float %in_buf_3_load_34, %weight_buf_3_load_34, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_225 = fadd float %tmp_44_224, %tmp_43_225, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_35 = load float* %weight_buf_3_addr_37, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_226 = fmul float %in_buf_3_load_35, %weight_buf_3_load_35, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_226 = fadd float %tmp_44_225, %tmp_43_226, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_36 = load float* %weight_buf_3_addr_38, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_227 = fmul float %in_buf_3_load_36, %weight_buf_3_load_36, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_227 = fadd float %tmp_44_226, %tmp_43_227, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_37 = load float* %weight_buf_3_addr_39, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_228 = fmul float %in_buf_3_load_37, %weight_buf_3_load_37, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_228 = fadd float %tmp_44_227, %tmp_43_228, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_38 = load float* %weight_buf_3_addr_40, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_229 = fmul float %in_buf_3_load_38, %weight_buf_3_load_38, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_229 = fadd float %tmp_44_228, %tmp_43_229, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_39 = load float* %weight_buf_3_addr_41, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_230 = fmul float %in_buf_3_load_39, %weight_buf_3_load_39, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_230 = fadd float %tmp_44_229, %tmp_43_230, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_40 = load float* %weight_buf_3_addr_42, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_231 = fmul float %in_buf_3_load_40, %weight_buf_3_load_40, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_231 = fadd float %tmp_44_230, %tmp_43_231, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_41 = load float* %weight_buf_3_addr_43, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_232 = fmul float %in_buf_3_load_41, %weight_buf_3_load_41, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_232 = fadd float %tmp_44_231, %tmp_43_232, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_42 = load float* %weight_buf_3_addr_44, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_233 = fmul float %in_buf_3_load_42, %weight_buf_3_load_42, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_233 = fadd float %tmp_44_232, %tmp_43_233, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_43 = load float* %weight_buf_3_addr_45, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_234 = fmul float %in_buf_3_load_43, %weight_buf_3_load_43, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_234 = fadd float %tmp_44_233, %tmp_43_234, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_44 = load float* %weight_buf_3_addr_46, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_235 = fmul float %in_buf_3_load_44, %weight_buf_3_load_44, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_235 = fadd float %tmp_44_234, %tmp_43_235, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_45 = load float* %weight_buf_3_addr_47, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_236 = fmul float %in_buf_3_load_45, %weight_buf_3_load_45, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_236 = fadd float %tmp_44_235, %tmp_43_236, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_46 = load float* %weight_buf_3_addr_48, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_237 = fmul float %in_buf_3_load_46, %weight_buf_3_load_46, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_237 = fadd float %tmp_44_236, %tmp_43_237, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_47 = load float* %weight_buf_3_addr_49, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_238 = fmul float %in_buf_3_load_47, %weight_buf_3_load_47, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_238 = fadd float %tmp_44_237, %tmp_43_238, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_48 = load float* %weight_buf_3_addr_50, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_239 = fmul float %in_buf_3_load_48, %weight_buf_3_load_48, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_239 = fadd float %tmp_44_238, %tmp_43_239, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_49 = load float* %weight_buf_3_addr_51, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_240 = fmul float %in_buf_3_load_49, %weight_buf_3_load_49, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_240 = fadd float %tmp_44_239, %tmp_43_240, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_50 = load float* %weight_buf_3_addr_52, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_241 = fmul float %in_buf_3_load_50, %weight_buf_3_load_50, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_241 = fadd float %tmp_44_240, %tmp_43_241, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_51 = load float* %weight_buf_3_addr_53, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_242 = fmul float %in_buf_3_load_51, %weight_buf_3_load_51, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_242 = fadd float %tmp_44_241, %tmp_43_242, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_52 = load float* %weight_buf_3_addr_54, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_243 = fmul float %in_buf_3_load_52, %weight_buf_3_load_52, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_243 = fadd float %tmp_44_242, %tmp_43_243, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_53 = load float* %weight_buf_3_addr_55, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_244 = fmul float %in_buf_3_load_53, %weight_buf_3_load_53, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_244 = fadd float %tmp_44_243, %tmp_43_244, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_54 = load float* %weight_buf_3_addr_56, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_245 = fmul float %in_buf_3_load_54, %weight_buf_3_load_54, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_245 = fadd float %tmp_44_244, %tmp_43_245, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_55 = load float* %weight_buf_3_addr_57, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_246 = fmul float %in_buf_3_load_55, %weight_buf_3_load_55, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_246 = fadd float %tmp_44_245, %tmp_43_246, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_56 = load float* %weight_buf_3_addr_58, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_247 = fmul float %in_buf_3_load_56, %weight_buf_3_load_56, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_247 = fadd float %tmp_44_246, %tmp_43_247, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_57 = load float* %weight_buf_3_addr_59, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_248 = fmul float %in_buf_3_load_57, %weight_buf_3_load_57, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_248 = fadd float %tmp_44_247, %tmp_43_248, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_58 = load float* %weight_buf_3_addr_60, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_249 = fmul float %in_buf_3_load_58, %weight_buf_3_load_58, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_249 = fadd float %tmp_44_248, %tmp_43_249, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_59 = load float* %weight_buf_3_addr_61, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_250 = fmul float %in_buf_3_load_59, %weight_buf_3_load_59, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_250 = fadd float %tmp_44_249, %tmp_43_250, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_60 = load float* %weight_buf_3_addr_62, align 16, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_251 = fmul float %in_buf_3_load_60, %weight_buf_3_load_60, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_251 = fadd float %tmp_44_250, %tmp_43_251, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_61 = load float* %weight_buf_3_addr_63, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_252 = fmul float %in_buf_3_load_61, %weight_buf_3_load_61, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_252 = fadd float %tmp_44_251, %tmp_43_252, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_62 = load float* %weight_buf_3_addr_64, align 8, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_253 = fmul float %in_buf_3_load_62, %weight_buf_3_load_62, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_253 = fadd float %tmp_44_252, %tmp_43_253, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %weight_buf_3_load_63 = load float* %weight_buf_3_addr_65, align 4, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_43_254 = fmul float %in_buf_3_load_63, %weight_buf_3_load_63, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  %tmp_44_254 = fadd float %tmp_44_253, %tmp_43_254, !dbg !2860 ; [#uses=1 type=float] [debug line = 74:6]
  store float %tmp_44_254, float* %out_buf_addr_2, align 4, !dbg !2864 ; [debug line = 76:5]
  %empty_21 = call i32 (...)* @_ssdm_op_SpecRegionEnd([3 x i8]* @p_str13, i32 %tmp_32), !dbg !2869 ; [#uses=0 type=i32] [debug line = 77:4]
  %j_3 = add i4 %j5_mid2, 1, !dbg !2870           ; [#uses=1 type=i4] [debug line = 70:32]
  call void @llvm.dbg.value(metadata !{i4 %j_3}, i64 0, metadata !2871), !dbg !2870 ; [debug line = 70:32] [debug variable = j]
  br label %.preheader.preheader

; <label>:15                                      ; preds = %.preheader.preheader
  %tmp_20 = or i14 %os_idx, 5, !dbg !2872         ; [#uses=1 type=i14] [debug line = 81:28]
  %tmp_20_cast = zext i14 %tmp_20 to i15, !dbg !2872 ; [#uses=1 type=i15] [debug line = 81:28]
  %os_idx_2 = add i14 %os_idx, 640, !dbg !2874    ; [#uses=1 type=i14] [debug line = 86:5]
  call void @llvm.dbg.value(metadata !{i14 %os_idx_2}, i64 0, metadata !2878), !dbg !2874 ; [debug line = 86:5] [debug variable = os_idx]
  br label %16, !dbg !2872                        ; [debug line = 81:28]

; <label>:16                                      ; preds = %17, %15
  %indvars_iv = phi i15 [ %tmp_20_cast, %15 ], [ %indvars_iv_next, %17 ] ; [#uses=2 type=i15]
  %os_idx_1 = phi i15 [ %os_idx_cast, %15 ], [ %indvars_iv, %17 ] ; [#uses=5 type=i15]
  %i6 = phi i8 [ 0, %15 ], [ %i_5, %17 ]          ; [#uses=4 type=i8]
  %exitcond1 = icmp eq i8 %i6, -128, !dbg !2872   ; [#uses=1 type=i1] [debug line = 81:28]
  %i_5 = add i8 %i6, 1, !dbg !2879                ; [#uses=1 type=i8] [debug line = 81:39]
  br i1 %exitcond1, label %18, label %17, !dbg !2872 ; [debug line = 81:28]

; <label>:17                                      ; preds = %16
  %empty_22 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 128, i64 128, i64 128) ; [#uses=0 type=i32]
  call void (...)* @_ssdm_op_SpecLoopName([10 x i8]* @p_str15) nounwind, !dbg !2880 ; [debug line = 81:45]
  %tmp_27 = call i32 (...)* @_ssdm_op_SpecRegionBegin([10 x i8]* @p_str15), !dbg !2880 ; [#uses=1 type=i32] [debug line = 81:45]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !2881 ; [debug line = 82:1]
  %tmp_423 = call i11 @_ssdm_op_BitConcatenate.i11.i8.i3(i8 %i6, i3 0) ; [#uses=1 type=i11]
  %p_shl2_cast = zext i11 %tmp_423 to i12         ; [#uses=1 type=i12]
  %tmp_424 = call i9 @_ssdm_op_BitConcatenate.i9.i8.i1(i8 %i6, i1 false) ; [#uses=1 type=i9]
  %p_shl3_cast = zext i9 %tmp_424 to i12, !dbg !2882 ; [#uses=1 type=i12] [debug line = 84:5]
  %tmp_425 = add i12 %p_shl3_cast, %p_shl2_cast, !dbg !2882 ; [#uses=10 type=i12] [debug line = 84:5]
  %tmp_425_cast = zext i12 %tmp_425 to i64, !dbg !2882 ; [#uses=1 type=i64] [debug line = 84:5]
  %out_buf_addr = getelementptr [1280 x float]* %out_buf, i64 0, i64 %tmp_425_cast, !dbg !2882 ; [#uses=1 type=float*] [debug line = 84:5]
  %tmp_426 = or i12 %tmp_425, 1, !dbg !2883       ; [#uses=1 type=i12] [debug line = 85:5]
  %tmp_426_cast = zext i12 %tmp_426 to i64, !dbg !2883 ; [#uses=1 type=i64] [debug line = 85:5]
  %out_buf_addr_1 = getelementptr [1280 x float]* %out_buf, i64 0, i64 %tmp_426_cast, !dbg !2883 ; [#uses=1 type=float*] [debug line = 85:5]
  %tmp_427 = add i12 %tmp_425, 2, !dbg !2882      ; [#uses=1 type=i12] [debug line = 84:5]
  %tmp_427_cast = sext i12 %tmp_427 to i64, !dbg !2882 ; [#uses=1 type=i64] [debug line = 84:5]
  %out_buf_addr_5 = getelementptr [1280 x float]* %out_buf, i64 0, i64 %tmp_427_cast, !dbg !2882 ; [#uses=1 type=float*] [debug line = 84:5]
  %tmp_428 = add i12 %tmp_425, 3, !dbg !2883      ; [#uses=1 type=i12] [debug line = 85:5]
  %tmp_428_cast = sext i12 %tmp_428 to i64, !dbg !2883 ; [#uses=1 type=i64] [debug line = 85:5]
  %out_buf_addr_6 = getelementptr [1280 x float]* %out_buf, i64 0, i64 %tmp_428_cast, !dbg !2883 ; [#uses=1 type=float*] [debug line = 85:5]
  %tmp_429 = add i12 %tmp_425, 4, !dbg !2882      ; [#uses=1 type=i12] [debug line = 84:5]
  %tmp_429_cast = sext i12 %tmp_429 to i64, !dbg !2882 ; [#uses=1 type=i64] [debug line = 84:5]
  %out_buf_addr_7 = getelementptr [1280 x float]* %out_buf, i64 0, i64 %tmp_429_cast, !dbg !2882 ; [#uses=1 type=float*] [debug line = 84:5]
  %tmp_430 = add i12 %tmp_425, 5, !dbg !2883      ; [#uses=1 type=i12] [debug line = 85:5]
  %tmp_430_cast = sext i12 %tmp_430 to i64, !dbg !2883 ; [#uses=1 type=i64] [debug line = 85:5]
  %out_buf_addr_8 = getelementptr [1280 x float]* %out_buf, i64 0, i64 %tmp_430_cast, !dbg !2883 ; [#uses=1 type=float*] [debug line = 85:5]
  %tmp_431 = add i12 %tmp_425, 6, !dbg !2882      ; [#uses=1 type=i12] [debug line = 84:5]
  %tmp_431_cast = sext i12 %tmp_431 to i64, !dbg !2882 ; [#uses=1 type=i64] [debug line = 84:5]
  %out_buf_addr_3 = getelementptr [1280 x float]* %out_buf, i64 0, i64 %tmp_431_cast, !dbg !2882 ; [#uses=1 type=float*] [debug line = 84:5]
  %tmp_432 = add i12 %tmp_425, 7, !dbg !2883      ; [#uses=1 type=i12] [debug line = 85:5]
  %tmp_432_cast = sext i12 %tmp_432 to i64, !dbg !2883 ; [#uses=1 type=i64] [debug line = 85:5]
  %out_buf_addr_9 = getelementptr [1280 x float]* %out_buf, i64 0, i64 %tmp_432_cast, !dbg !2883 ; [#uses=1 type=float*] [debug line = 85:5]
  %tmp_433 = add i12 %tmp_425, 8, !dbg !2882      ; [#uses=1 type=i12] [debug line = 84:5]
  %tmp_433_cast = sext i12 %tmp_433 to i64, !dbg !2882 ; [#uses=1 type=i64] [debug line = 84:5]
  %out_buf_addr_4 = getelementptr [1280 x float]* %out_buf, i64 0, i64 %tmp_433_cast, !dbg !2882 ; [#uses=1 type=float*] [debug line = 84:5]
  %tmp_434 = add i12 %tmp_425, 9, !dbg !2883      ; [#uses=1 type=i12] [debug line = 85:5]
  %tmp_434_cast = sext i12 %tmp_434 to i64, !dbg !2883 ; [#uses=1 type=i64] [debug line = 85:5]
  %out_buf_addr_10 = getelementptr [1280 x float]* %out_buf, i64 0, i64 %tmp_434_cast, !dbg !2883 ; [#uses=1 type=float*] [debug line = 85:5]
  %out_buf_load = load float* %out_buf_addr, align 8, !dbg !2882 ; [#uses=1 type=float] [debug line = 84:5]
  %tmp_29 = bitcast float %out_buf_load to i32, !dbg !2882 ; [#uses=1 type=i32] [debug line = 84:5]
  %out_buf_load_1 = load float* %out_buf_addr_1, align 4, !dbg !2883 ; [#uses=1 type=float] [debug line = 85:5]
  %tmp_30 = bitcast float %out_buf_load_1 to i32, !dbg !2883 ; [#uses=1 type=i32] [debug line = 85:5]
  %converter_s = call i64 @_ssdm_op_BitConcatenate.i64.i32.i32(i32 %tmp_30, i32 %tmp_29), !dbg !2883 ; [#uses=1 type=i64] [debug line = 85:5]
  %last_assign = icmp eq i15 %os_idx_1, 10239, !dbg !2884 ; [#uses=1 type=i1] [debug line = 86:28]
  ...
  %out_buf_load_5 = load float* %out_buf_addr_5, align 8, !dbg !2882 ; [#uses=1 type=float] [debug line = 84:5]
  %tmp_33_1 = bitcast float %out_buf_load_5 to i32, !dbg !2882 ; [#uses=1 type=i32] [debug line = 84:5]
  %out_buf_load_6 = load float* %out_buf_addr_6, align 4, !dbg !2883 ; [#uses=1 type=float] [debug line = 85:5]
  %tmp_37_1 = bitcast float %out_buf_load_6 to i32, !dbg !2883 ; [#uses=1 type=i32] [debug line = 85:5]
  %converter_13_1 = call i64 @_ssdm_op_BitConcatenate.i64.i32.i32(i32 %tmp_37_1, i32 %tmp_33_1), !dbg !2883 ; [#uses=1 type=i64] [debug line = 85:5]
  %last_assign_1 = icmp eq i15 %os_idx_1, 10238, !dbg !2884 ; [#uses=1 type=i1] [debug line = 86:28]
  ...
  %out_buf_load_2 = load float* %out_buf_addr_7, align 8, !dbg !2882 ; [#uses=1 type=float] [debug line = 84:5]
  %tmp_33_2 = bitcast float %out_buf_load_2 to i32, !dbg !2882 ; [#uses=1 type=i32] [debug line = 84:5]
  %out_buf_load_7 = load float* %out_buf_addr_8, align 4, !dbg !2883 ; [#uses=1 type=float] [debug line = 85:5]
  %tmp_37_2 = bitcast float %out_buf_load_7 to i32, !dbg !2883 ; [#uses=1 type=i32] [debug line = 85:5]
  %converter_13_2 = call i64 @_ssdm_op_BitConcatenate.i64.i32.i32(i32 %tmp_37_2, i32 %tmp_33_2), !dbg !2883 ; [#uses=1 type=i64] [debug line = 85:5]
  %last_assign_2 = icmp eq i15 %os_idx_1, 10237, !dbg !2884 ; [#uses=1 type=i1] [debug line = 86:28]
  ...
  %out_buf_load_3 = load float* %out_buf_addr_3, align 8, !dbg !2882 ; [#uses=1 type=float] [debug line = 84:5]
  %tmp_33_3 = bitcast float %out_buf_load_3 to i32, !dbg !2882 ; [#uses=1 type=i32] [debug line = 84:5]
  %out_buf_load_8 = load float* %out_buf_addr_9, align 4, !dbg !2883 ; [#uses=1 type=float] [debug line = 85:5]
  %tmp_37_3 = bitcast float %out_buf_load_8 to i32, !dbg !2883 ; [#uses=1 type=i32] [debug line = 85:5]
  %converter_13_3 = call i64 @_ssdm_op_BitConcatenate.i64.i32.i32(i32 %tmp_37_3, i32 %tmp_33_3), !dbg !2883 ; [#uses=1 type=i64] [debug line = 85:5]
  %last_assign_3 = icmp eq i15 %os_idx_1, 10236, !dbg !2884 ; [#uses=1 type=i1] [debug line = 86:28]
  ...
  %out_buf_load_4 = load float* %out_buf_addr_4, align 8, !dbg !2882 ; [#uses=1 type=float] [debug line = 84:5]
  %tmp_33_4 = bitcast float %out_buf_load_4 to i32, !dbg !2882 ; [#uses=1 type=i32] [debug line = 84:5]
  %out_buf_load_9 = load float* %out_buf_addr_10, align 4, !dbg !2883 ; [#uses=1 type=float] [debug line = 85:5]
  %tmp_37_4 = bitcast float %out_buf_load_9 to i32, !dbg !2883 ; [#uses=1 type=i32] [debug line = 85:5]
  %converter_13_4 = call i64 @_ssdm_op_BitConcatenate.i64.i32.i32(i32 %tmp_37_4, i32 %tmp_33_4), !dbg !2883 ; [#uses=1 type=i64] [debug line = 85:5]
  %last_assign_4 = icmp eq i15 %os_idx_1, 10235, !dbg !2884 ; [#uses=1 type=i1] [debug line = 86:28]
  ...
  %empty_23 = call i32 (...)* @_ssdm_op_SpecRegionEnd([10 x i8]* @p_str15, i32 %tmp_27), !dbg !2885 ; [#uses=0 type=i32] [debug line = 88:3]
  call void @llvm.dbg.value(metadata !{i8 %i_5}, i64 0, metadata !2886), !dbg !2879 ; [debug line = 81:39] [debug variable = i]
  %indvars_iv_next = add i15 %indvars_iv, 5, !dbg !2879 ; [#uses=1 type=i15] [debug line = 81:39]
  br label %16, !dbg !2879                        ; [debug line = 81:39]

; <label>:18                                      ; preds = %16
  %empty_24 = call i32 (...)* @_ssdm_op_SpecRegionEnd([3 x i8]* @p_str9, i32 %tmp_10), !dbg !2887 ; [#uses=0 type=i32] [debug line = 89:2]
  %t_1 = add i12 %t, 128, !dbg !2888              ; [#uses=1 type=i12] [debug line = 55:69]
  call void @llvm.dbg.value(metadata !{i12 %t_1}, i64 0, metadata !2889), !dbg !2888 ; [debug line = 55:69] [debug variable = t]
  br label %.preheader16, !dbg !2888              ; [debug line = 55:69]

; <label>:19                                      ; preds = %.preheader16
  ret void, !dbg !2890                            ; [debug line = 90:1]

branch4:                                          ; preds = %5
  store float %bitcast2, float* %weight_buf_0_addr, align 8, !dbg !2824 ; [debug line = 49:4]
  store float %tmp_16, float* %weight_buf_0_addr_1, align 4, !dbg !2825 ; [debug line = 50:4]
  br label %6

branch5:                                          ; preds = %5
  store float %bitcast2, float* %weight_buf_1_addr, align 8, !dbg !2824 ; [debug line = 49:4]
  store float %tmp_16, float* %weight_buf_1_addr_1, align 4, !dbg !2825 ; [debug line = 50:4]
  br label %6

branch6:                                          ; preds = %5
  store float %bitcast2, float* %weight_buf_2_addr, align 8, !dbg !2824 ; [debug line = 49:4]
  store float %tmp_16, float* %weight_buf_2_addr_1, align 4, !dbg !2825 ; [debug line = 50:4]
  br label %6

branch7:                                          ; preds = %5
  store float %bitcast2, float* %weight_buf_3_addr, align 8, !dbg !2824 ; [debug line = 49:4]
  store float %tmp_16, float* %weight_buf_3_addr_1, align 4, !dbg !2825 ; [debug line = 50:4]
  br label %6

branch12:                                         ; preds = %12
  store float %bitcast, float* %in_buf_0_addr, align 8, !dbg !2847 ; [debug line = 62:5]
  store float %tmp_26, float* %in_buf_0_addr_1, align 4, !dbg !2848 ; [debug line = 63:5]
  br label %13

branch13:                                         ; preds = %12
  store float %bitcast, float* %in_buf_1_addr, align 8, !dbg !2847 ; [debug line = 62:5]
  store float %tmp_26, float* %in_buf_1_addr_1, align 4, !dbg !2848 ; [debug line = 63:5]
  br label %13

branch14:                                         ; preds = %12
  store float %bitcast, float* %in_buf_2_addr, align 8, !dbg !2847 ; [debug line = 62:5]
  store float %tmp_26, float* %in_buf_2_addr_1, align 4, !dbg !2848 ; [debug line = 63:5]
  br label %13

branch15:                                         ; preds = %12
  store float %bitcast, float* %in_buf_3_addr, align 8, !dbg !2847 ; [debug line = 62:5]
  store float %tmp_26, float* %in_buf_3_addr_1, align 4, !dbg !2848 ; [debug line = 63:5]
  br label %13
}
...
entry:
  ...
  %empty_25 = load i8* %1                         ; [#uses=1 type=i8]
  %empty_26 = load i8* %2                         ; [#uses=1 type=i8]
  %empty_27 = load i4* %3                         ; [#uses=1 type=i4]
  %empty_28 = load i1* %4                         ; [#uses=1 type=i1]
  %empty_29 = load i5* %5                         ; [#uses=1 type=i5]
  %empty_30 = load i5* %6                         ; [#uses=1 type=i5]
  %mrv_0 = insertvalue { i64, i8, i8, i4, i1, i5, i5 } undef, i64 %empty, 0 ; [#uses=1 type={ i64, i8, i8, i4, i1, i5, i5 }]
  %mrv1 = insertvalue { i64, i8, i8, i4, i1, i5, i5 } %mrv_0, i8 %empty_25, 1 ; [#uses=1 type={ i64, i8, i8, i4, i1, i5, i5 }]
  %mrv2 = insertvalue { i64, i8, i8, i4, i1, i5, i5 } %mrv1, i8 %empty_26, 2 ; [#uses=1 type={ i64, i8, i8, i4, i1, i5, i5 }]
  %mrv3 = insertvalue { i64, i8, i8, i4, i1, i5, i5 } %mrv2, i4 %empty_27, 3 ; [#uses=1 type={ i64, i8, i8, i4, i1, i5, i5 }]
  %mrv4 = insertvalue { i64, i8, i8, i4, i1, i5, i5 } %mrv3, i1 %empty_28, 4 ; [#uses=1 type={ i64, i8, i8, i4, i1, i5, i5 }]
  %mrv5 = insertvalue { i64, i8, i8, i4, i1, i5, i5 } %mrv4, i5 %empty_29, 5 ; [#uses=1 type={ i64, i8, i8, i4, i1, i5, i5 }]
  %mrv6 = insertvalue { i64, i8, i8, i4, i1, i5, i5 } %mrv5, i5 %empty_30, 6 ; [#uses=1 type={ i64, i8, i8, i4, i1, i5, i5 }]
...
entry:
  ...
  %empty_32 = trunc i9 %empty to i3               ; [#uses=1 type=i3]
  ret i3 %empty_32
}
...
entry:
  ...
  %empty_33 = shl i12 1, %empty                   ; [#uses=1 type=i12]
  %empty_34 = and i12 %0, %empty_33               ; [#uses=1 type=i12]
  %empty_35 = icmp ne i12 %empty_34, 0            ; [#uses=1 type=i1]
  ret i1 %empty_35
}
...
entry:
  ...
  %empty_36 = zext i1 %1 to i9                    ; [#uses=1 type=i9]
  %empty_37 = shl i9 %empty, 1                    ; [#uses=1 type=i9]
...
entry:
  ...
  %empty_39 = zext i10 %1 to i64                  ; [#uses=1 type=i64]
  %empty_40 = shl i64 %empty, 10                  ; [#uses=1 type=i64]
...
entry:
  ...
  %empty_42 = zext i14 %1 to i64                  ; [#uses=1 type=i64]
  %empty_43 = shl i64 %empty, 14                  ; [#uses=1 type=i64]
...
entry:
  ...
  %empty_45 = zext i32 %1 to i64                  ; [#uses=1 type=i64]
...
entry:
  ...
  %empty_48 = zext i6 %1 to i14                   ; [#uses=1 type=i14]
  %empty_49 = shl i14 %empty, 6                   ; [#uses=1 type=i14]
  %empty_50 = or i14 %empty_49, %empty_48         ; [#uses=1 type=i14]
  ret i14 %empty_50
}
...
entry:
  ...
  %empty_51 = zext i3 %1 to i11                   ; [#uses=1 type=i11]
  %empty_52 = shl i11 %empty, 3                   ; [#uses=1 type=i11]
...
entry:
  ...
  %empty_54 = zext i6 %1 to i10                   ; [#uses=1 type=i10]
  %empty_55 = shl i10 %empty, 6                   ; [#uses=1 type=i10]
...
!2757 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 20480, i64 32, i32 0, i32 0, metadata !2748, metadata !2755, i32 0, i32 0} ; [ DW_TAG_array_type ]
...
!2762 = metadata !{i32 790529, metadata !2763, metadata !"in_buf[0]", null, i32 30, metadata !2767, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2763 = metadata !{i32 786688, metadata !2745, metadata !"in_buf", metadata !112, i32 30, metadata !2764, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2764 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 1048576, i64 32, i32 0, i32 0, metadata !2748, metadata !2765, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2765 = metadata !{metadata !2766, metadata !2756}
!2766 = metadata !{i32 786465, i64 0, i64 127}    ; [ DW_TAG_subrange_type ]
!2767 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 262144, i64 32, i32 0, i32 0, metadata !2748, metadata !2765, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2768 = metadata !{i32 30, i32 4, metadata !2745, null}
!2769 = metadata !{i32 790529, metadata !2763, metadata !"in_buf[1]", null, i32 30, metadata !2767, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2770 = metadata !{i32 790529, metadata !2763, metadata !"in_buf[2]", null, i32 30, metadata !2767, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2771 = metadata !{i32 790529, metadata !2763, metadata !"in_buf[3]", null, i32 30, metadata !2767, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2772 = metadata !{i32 786688, metadata !2745, metadata !"out_buf", metadata !112, i32 31, metadata !2773, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2773 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 40960, i64 32, i32 0, i32 0, metadata !2748, metadata !2774, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2774 = metadata !{metadata !2766, metadata !2750}
!2775 = metadata !{i32 31, i32 4, metadata !2745, null}
!2776 = metadata !{i32 38, i32 28, metadata !2777, null}
!2777 = metadata !{i32 786443, metadata !2745, i32 38, i32 14, metadata !112, i32 1} ; [ DW_TAG_lexical_block ]
!2778 = metadata !{i32 39, i32 22, metadata !2779, null}
!2779 = metadata !{i32 786443, metadata !2777, i32 38, i32 68, metadata !112, i32 2} ; [ DW_TAG_lexical_block ]
!2780 = metadata !{i32 45, i32 26, metadata !2781, null}
!2781 = metadata !{i32 786443, metadata !2745, i32 45, i32 12, metadata !112, i32 3} ; [ DW_TAG_lexical_block ]
!2782 = metadata !{i32 38, i32 69, metadata !2779, null}
!2783 = metadata !{i32 39, i32 1, metadata !2779, null}
!2784 = metadata !{i32 786688, metadata !2785, metadata !"ret", metadata !112, i32 100, metadata !2789, i32 0, metadata !2778} ; [ DW_TAG_auto_variable ]
!2785 = metadata !{i32 786443, metadata !2786, i32 97, i32 1, metadata !112, i32 23} ; [ DW_TAG_lexical_block ]
!2786 = metadata !{i32 786478, i32 0, metadata !112, metadata !"pop_stream", metadata !"pop_stream", metadata !"_Z10pop_streamRK7ap_axiuILi64ELi4ELi5ELi5EE", metadata !112, i32 96, metadata !2787, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !138, i32 97} ; [ DW_TAG_subprogram ]
...
!2789 = metadata !{i32 786454, null, metadata !"axi_T", metadata !112, i32 5, i64 0, i64 0, i64 0, i32 0, metadata !206} ; [ DW_TAG_typedef ]
!2790 = metadata !{i32 786448, null, null, null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !2791} ; [ DW_TAG_reference_type ]
!2791 = metadata !{i32 786470, null, metadata !"", null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !116} ; [ DW_TAG_const_type ]
!2792 = metadata !{i32 100, i32 14, metadata !2785, metadata !2778}
!2793 = metadata !{i32 786688, metadata !2745, metadata !"converter", metadata !112, i32 25, metadata !2794, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2794 = metadata !{i32 786455, metadata !111, metadata !"", metadata !112, i32 21, i64 64, i64 64, i64 0, i32 0, null, metadata !2795, i32 0, null} ; [ DW_TAG_union_type ]
!2795 = metadata !{metadata !2796, metadata !2797, metadata !2802}
!2796 = metadata !{i32 786445, metadata !2794, metadata !"packet", metadata !112, i32 23, i64 64, i64 64, i64 0, i32 0, metadata !2789} ; [ DW_TAG_member ]
!2797 = metadata !{i32 786445, metadata !2794, metadata !"val", metadata !112, i32 24, i64 64, i64 32, i64 0, i32 0, metadata !2798} ; [ DW_TAG_member ]
!2798 = metadata !{i32 786434, metadata !2794, metadata !"", metadata !112, i32 24, i64 64, i64 32, i32 0, i32 0, null, metadata !2799, i32 0, null, null} ; [ DW_TAG_class_type ]
!2799 = metadata !{metadata !2800, metadata !2801}
!2800 = metadata !{i32 786445, metadata !2798, metadata !"f0", metadata !112, i32 24, i64 32, i64 32, i64 0, i32 0, metadata !2748} ; [ DW_TAG_member ]
!2801 = metadata !{i32 786445, metadata !2798, metadata !"f1", metadata !112, i32 24, i64 32, i64 32, i64 32, i32 0, metadata !2748} ; [ DW_TAG_member ]
!2802 = metadata !{i32 786478, i32 0, metadata !2794, metadata !"", metadata !"", metadata !"", metadata !112, i32 21, metadata !2803, i1 false, i1 false, i32 0, i32 0, null, i32 320, i1 false, null, null, i32 0, metadata !138, i32 21} ; [ DW_TAG_subprogram ]
...
!2804 = metadata !{null, metadata !2805}
!2805 = metadata !{i32 786447, i32 0, metadata !"", i32 0, i32 0, i64 64, i64 64, i64 0, i32 64, metadata !2794} ; [ DW_TAG_pointer_type ]
!2806 = metadata !{i32 40, i32 3, metadata !2779, null}
!2807 = metadata !{i32 41, i32 3, metadata !2779, null}
!2808 = metadata !{i32 42, i32 2, metadata !2779, null}
!2809 = metadata !{i32 38, i32 38, metadata !2777, null}
!2810 = metadata !{i32 786688, metadata !2777, metadata !"i", metadata !112, i32 38, metadata !142, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2811 = metadata !{i32 45, i32 36, metadata !2781, null}
!2812 = metadata !{i32 55, i32 20, metadata !2813, null}
!2813 = metadata !{i32 786443, metadata !2745, i32 55, i32 6, metadata !112, i32 7} ; [ DW_TAG_lexical_block ]
!2814 = metadata !{i32 45, i32 42, metadata !2815, null}
!2815 = metadata !{i32 786443, metadata !2781, i32 45, i32 41, metadata !112, i32 4} ; [ DW_TAG_lexical_block ]
!2816 = metadata !{i32 46, i32 27, metadata !2817, null}
!2817 = metadata !{i32 786443, metadata !2815, i32 46, i32 13, metadata !112, i32 5} ; [ DW_TAG_lexical_block ]
!2818 = metadata !{i32 46, i32 69, metadata !2819, null}
!2819 = metadata !{i32 786443, metadata !2817, i32 46, i32 68, metadata !112, i32 6} ; [ DW_TAG_lexical_block ]
!2820 = metadata !{i32 47, i32 1, metadata !2819, null}
!2821 = metadata !{i32 48, i32 23, metadata !2819, null}
!2822 = metadata !{i32 786688, metadata !2785, metadata !"ret", metadata !112, i32 100, metadata !2789, i32 0, metadata !2821} ; [ DW_TAG_auto_variable ]
!2823 = metadata !{i32 100, i32 14, metadata !2785, metadata !2821}
!2824 = metadata !{i32 49, i32 4, metadata !2819, null}
!2825 = metadata !{i32 50, i32 4, metadata !2819, null}
!2826 = metadata !{i32 51, i32 3, metadata !2819, null}
!2827 = metadata !{i32 46, i32 38, metadata !2817, null}
!2828 = metadata !{i32 786688, metadata !2817, metadata !"j", metadata !112, i32 46, metadata !142, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2829 = metadata !{i32 52, i32 2, metadata !2815, null}
!2830 = metadata !{i32 786688, metadata !2781, metadata !"i", metadata !112, i32 45, metadata !142, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2831 = metadata !{i32 55, i32 78, metadata !2832, null}
!2832 = metadata !{i32 786443, metadata !2813, i32 55, i32 77, metadata !112, i32 8} ; [ DW_TAG_lexical_block ]
!2833 = metadata !{i32 786688, metadata !2745, metadata !"is_idx", metadata !112, i32 34, metadata !142, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2834 = metadata !{i32 58, i32 27, metadata !2835, null}
!2835 = metadata !{i32 786443, metadata !2832, i32 58, i32 13, metadata !112, i32 9} ; [ DW_TAG_lexical_block ]
!2836 = metadata !{i32 58, i32 38, metadata !2835, null}
!2837 = metadata !{i32 58, i32 44, metadata !2838, null}
!2838 = metadata !{i32 786443, metadata !2835, i32 58, i32 43, metadata !112, i32 10} ; [ DW_TAG_lexical_block ]
!2839 = metadata !{i32 59, i32 28, metadata !2840, null}
!2840 = metadata !{i32 786443, metadata !2838, i32 59, i32 14, metadata !112, i32 11} ; [ DW_TAG_lexical_block ]
!2841 = metadata !{i32 59, i32 70, metadata !2842, null}
!2842 = metadata !{i32 786443, metadata !2840, i32 59, i32 69, metadata !112, i32 12} ; [ DW_TAG_lexical_block ]
!2843 = metadata !{i32 60, i32 1, metadata !2842, null}
!2844 = metadata !{i32 61, i32 24, metadata !2842, null}
!2845 = metadata !{i32 786688, metadata !2785, metadata !"ret", metadata !112, i32 100, metadata !2789, i32 0, metadata !2844} ; [ DW_TAG_auto_variable ]
!2846 = metadata !{i32 100, i32 14, metadata !2785, metadata !2844}
!2847 = metadata !{i32 62, i32 5, metadata !2842, null}
!2848 = metadata !{i32 63, i32 5, metadata !2842, null}
!2849 = metadata !{i32 64, i32 4, metadata !2842, null}
!2850 = metadata !{i32 59, i32 39, metadata !2840, null}
!2851 = metadata !{i32 786688, metadata !2840, metadata !"j", metadata !112, i32 59, metadata !142, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2852 = metadata !{i32 65, i32 3, metadata !2838, null}
!2853 = metadata !{i32 786688, metadata !2835, metadata !"i", metadata !112, i32 58, metadata !142, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2854 = metadata !{i32 68, i32 32, metadata !2855, null}
!2855 = metadata !{i32 786443, metadata !2832, i32 68, i32 7, metadata !112, i32 13} ; [ DW_TAG_lexical_block ]
!2856 = metadata !{i32 786688, metadata !2855, metadata !"i", metadata !112, i32 68, metadata !142, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2857 = metadata !{i32 70, i32 22, metadata !2858, null}
!2858 = metadata !{i32 786443, metadata !2859, i32 70, i32 8, metadata !112, i32 15} ; [ DW_TAG_lexical_block ]
!2859 = metadata !{i32 786443, metadata !2855, i32 68, i32 37, metadata !112, i32 14} ; [ DW_TAG_lexical_block ]
!2860 = metadata !{i32 74, i32 6, metadata !2861, null}
!2861 = metadata !{i32 786443, metadata !2862, i32 73, i32 38, metadata !112, i32 18} ; [ DW_TAG_lexical_block ]
!2862 = metadata !{i32 786443, metadata !2863, i32 73, i32 9, metadata !112, i32 17} ; [ DW_TAG_lexical_block ]
!2863 = metadata !{i32 786443, metadata !2858, i32 70, i32 37, metadata !112, i32 16} ; [ DW_TAG_lexical_block ]
!2864 = metadata !{i32 76, i32 5, metadata !2863, null}
!2865 = metadata !{i32 70, i32 38, metadata !2863, null}
!2866 = metadata !{i32 71, i32 1, metadata !2863, null}
!2867 = metadata !{i32 72, i32 26, metadata !2863, null}
!2868 = metadata !{i32 786688, metadata !2863, metadata !"tmp", metadata !112, i32 72, metadata !2748, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2869 = metadata !{i32 77, i32 4, metadata !2863, null}
!2870 = metadata !{i32 70, i32 32, metadata !2858, null}
!2871 = metadata !{i32 786688, metadata !2858, metadata !"j", metadata !112, i32 70, metadata !142, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2872 = metadata !{i32 81, i32 28, metadata !2873, null}
!2873 = metadata !{i32 786443, metadata !2832, i32 81, i32 14, metadata !112, i32 19} ; [ DW_TAG_lexical_block ]
!2874 = metadata !{i32 86, i32 5, metadata !2875, null}
!2875 = metadata !{i32 786443, metadata !2876, i32 82, i32 69, metadata !112, i32 22} ; [ DW_TAG_lexical_block ]
!2876 = metadata !{i32 786443, metadata !2877, i32 82, i32 15, metadata !112, i32 21} ; [ DW_TAG_lexical_block ]
!2877 = metadata !{i32 786443, metadata !2873, i32 81, i32 44, metadata !112, i32 20} ; [ DW_TAG_lexical_block ]
!2878 = metadata !{i32 786688, metadata !2745, metadata !"os_idx", metadata !112, i32 35, metadata !142, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2879 = metadata !{i32 81, i32 39, metadata !2873, null}
!2880 = metadata !{i32 81, i32 45, metadata !2877, null}
!2881 = metadata !{i32 82, i32 1, metadata !2877, null}
!2882 = metadata !{i32 84, i32 5, metadata !2875, null}
!2883 = metadata !{i32 85, i32 5, metadata !2875, null}
!2884 = metadata !{i32 86, i32 28, metadata !2875, null}
!2885 = metadata !{i32 88, i32 3, metadata !2877, null}
!2886 = metadata !{i32 786688, metadata !2873, metadata !"i", metadata !112, i32 81, metadata !142, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2887 = metadata !{i32 89, i32 2, metadata !2832, null}
!2888 = metadata !{i32 55, i32 69, metadata !2813, null}
!2889 = metadata !{i32 786688, metadata !2813, metadata !"t", metadata !112, i32 55, metadata !142, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2890 = metadata !{i32 90, i32 1, metadata !2745, null}
